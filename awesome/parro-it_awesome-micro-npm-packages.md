...
* [node-slug](https://github.com/dodo/node-slug) - slugifies even utf-8 chars. :star:950
...
* [deep-equal](https://github.com/substack/node-deep-equal) - Node's assert.deepEqual() algorithm as a standalone module. :star:303
...
* [mem](https://github.com/sindresorhus/mem) - An optimization technique used to speed up consecutive function calls by caching the result of calls with identical input. :star:351
* [throttle-debounce](https://github.com/niksy/throttle-debounce) - Throttle/debounce your functions. :star:177

### Math

* [is-number](https://github.com/jonschlinkert/is-number) - Returns `true` if the value is a number. :star:77
...
* [pump](https://github.com/mafintosh/pump) - pipe streams together and close all of them if one of them closes. :star:534
...
* [rimraf](https://github.com/isaacs/rimraf) - A deep deletion module for node (like rm -rf). :star:2404
* [mkdirp](https://github.com/substack/node-mkdirp) - Recursively mkdir, like mkdir -p. :star:1738
...
* [semver](https://github.com/npm/node-semver) - The semantic version parser used by npm. :star:2205
...
* [glob](https://github.com/isaacs/node-glob) - Glob functionality for node.js. :star:4551
* [username](https://github.com/sindresorhus/username) - Get the username of the current user. :star:72
* [minimist](https://github.com/substack/minimist) - Parse argument options. :star:2880
...
* [uuid](https://github.com/kelektiv/node-uuid) - Generate RFC-compliant UUIDs in JavaScript. :star:5640
* [node-mime](https://github.com/broofa/node-mime) - Comprehensive MIME type mapping API based on mime-db module. :star:1146
...
* [awesome-nodejs](https://github.com/sindresorhus/awesome-nodejs) - A curated list of delightful Node.js packages and resources. :star:23467
* [awesome-npm](https://github.com/sindresorhus/awesome-npm) - Awesome npm resources and tips. :star:2894
