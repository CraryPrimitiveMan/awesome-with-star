...
* [Module best practices](https://github.com/mattdesl/module-best-practices) :star:1017
...
* [strip-ansi](https://github.com/chalk/strip-ansi) - Strip ANSI escape codes. :star:106
* [striptags](https://github.com/ericnorris/striptags) - An implementation of PHP's strip_tags in Node.js. :star:230
...
* [fecha](https://github.com/taylorhakes/fecha) - Javascript Date formatting and parsing. :star:1293
...
* [timeago.js](https://github.com/hustcc/timeago.js) - A tiny(~1.7kb) library used to format date with `*** time ago` statement. :star:2972
...
* [deep-equal](https://github.com/substack/node-deep-equal) - Node's assert.deepEqual() algorithm as a standalone module. :star:270
...
* [mem](https://github.com/sindresorhus/mem) - An optimization technique used to speed up consecutive function calls by caching the result of calls with identical input. :star:323
...
### Stream
* [through2](https://github.com/rvagg/through2) - Tiny wrapper around Node streams2 Transform to avoid explicit subclassing noise. :star:1266
...
* [rimraf](https://github.com/isaacs/rimraf) - A deep deletion module for node (like rm -rf). :star:2189
* [mkdirp](https://github.com/substack/node-mkdirp) - Recursively mkdir, like mkdir -p. :star:1649
...
* [tmp](https://github.com/raszi/node-tmp) - Temporary file and directory creator for node.js. :star:349
...
* [glob](https://github.com/isaacs/node-glob) - Glob functionality for node.js. :star:4194
* [username](https://github.com/sindresorhus/username) - Get the username of the current user. :star:73
* [minimist](https://github.com/substack/minimist) - Parse argument options. :star:2684
...
* [uuid](https://github.com/kelektiv/node-uuid) - Generate RFC-compliant UUIDs in JavaScript. :star:5175
* [node-mime](https://github.com/broofa/node-mime) - Comprehensive MIME type mapping API based on mime-db module. :star:1078
...
* [awesome-nodejs](https://github.com/sindresorhus/awesome-nodejs) - A curated list of delightful Node.js packages and resources. :star:21087
* [awesome-npm](https://github.com/sindresorhus/awesome-npm) - Awesome npm resources and tips. :star:2762
