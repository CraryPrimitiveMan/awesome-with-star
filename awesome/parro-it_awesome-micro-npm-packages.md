...
* [Module best practices](https://github.com/mattdesl/module-best-practices) :star:1031
...
* [striptags](https://github.com/ericnorris/striptags) - An implementation of PHP's strip_tags in Node.js. :star:234
...
* [fecha](https://github.com/taylorhakes/fecha) - Javascript Date formatting and parsing. :star:1319
...
* [timeago.js](https://github.com/hustcc/timeago.js) - A tiny(~1.7kb) library used to format date with `*** time ago` statement. :star:2990
...
* [get-value](https://github.com/jonschlinkert/get-value) - Use property paths (a.b.c) to get a nested value from an object. :star:53
* [has-value](https://github.com/jonschlinkert/has-value) - Returns true if a value exists, false if empty. Works with deeply nested values using dot notation (`'a.b.c'`) paths. :star:11
...
### Stream
* [through2](https://github.com/rvagg/through2) - Tiny wrapper around Node streams2 Transform to avoid explicit subclassing noise. :star:1280
...
* [pump](https://github.com/mafintosh/pump) - pipe streams together and close all of them if one of them closes. :star:478
...
* [rimraf](https://github.com/isaacs/rimraf) - A deep deletion module for node (like rm -rf). :star:2237
...
* [tmp](https://github.com/raszi/node-tmp) - Temporary file and directory creator for node.js. :star:356
...
* [semver](https://github.com/npm/node-semver) - The semantic version parser used by npm. :star:2088
...
* [glob](https://github.com/isaacs/node-glob) - Glob functionality for node.js. :star:4270
* [username](https://github.com/sindresorhus/username) - Get the username of the current user. :star:73
* [minimist](https://github.com/substack/minimist) - Parse argument options. :star:2730
...
* [uuid](https://github.com/kelektiv/node-uuid) - Generate RFC-compliant UUIDs in JavaScript. :star:5280
...
* [awesome-nodejs](https://github.com/sindresorhus/awesome-nodejs) - A curated list of delightful Node.js packages and resources. :star:21563
* [awesome-npm](https://github.com/sindresorhus/awesome-npm) - Awesome npm resources and tips. :star:2792
