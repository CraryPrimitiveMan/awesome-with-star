...
* [Module best practices](https://github.com/mattdesl/module-best-practices) :star:1059
...
* [strip-ansi](https://github.com/chalk/strip-ansi) - Strip ANSI escape codes. :star:121
...
* [fecha](https://github.com/taylorhakes/fecha) - Javascript Date formatting and parsing. :star:1365
...
* [timeago.js](https://github.com/hustcc/timeago.js) - A tiny(~1.7kb) library used to format date with `*** time ago` statement. :star:3035
...
* [set-value](https://github.com/jonschlinkert/set-value) - Create nested values and any intermediaries dot notation (`'a.b.c'`) paths. :star:46
* [get-value](https://github.com/jonschlinkert/get-value) - Use property paths (a.b.c) to get a nested value from an object. :star:69
...
* [once](https://github.com/isaacs/once) - Run a function exactly one time. :star:145
...
### Stream
* [through2](https://github.com/rvagg/through2) - Tiny wrapper around Node streams2 Transform to avoid explicit subclassing noise. :star:1304
...
* [pump](https://github.com/mafintosh/pump) - pipe streams together and close all of them if one of them closes. :star:515
...
* [pify](https://github.com/sindresorhus/pify) - Promisify a callback-style function. :star:831
...
* [rimraf](https://github.com/isaacs/rimraf) - A deep deletion module for node (like rm -rf). :star:2312
* [mkdirp](https://github.com/substack/node-mkdirp) - Recursively mkdir, like mkdir -p. :star:1704
...
* [tmp](https://github.com/raszi/node-tmp) - Temporary file and directory creator for node.js. :star:368
* [fs-promise](https://github.com/kevinbeaty/fs-promise) - Node fs methods as Promise/A+ (optional fs-extra, graceful-fs). :star:174

### Browser

* [delegate](https://github.com/zenorocha/delegate) - Lightweight event delegation. :star:105
...
* [semver](https://github.com/npm/node-semver) - The semantic version parser used by npm. :star:2137
...
* [glob](https://github.com/isaacs/node-glob) - Glob functionality for node.js. :star:4402
* [username](https://github.com/sindresorhus/username) - Get the username of the current user. :star:72
* [minimist](https://github.com/substack/minimist) - Parse argument options. :star:2802
...
* [uuid](https://github.com/kelektiv/node-uuid) - Generate RFC-compliant UUIDs in JavaScript. :star:5419
...
* [awesome-nodejs](https://github.com/sindresorhus/awesome-nodejs) - A curated list of delightful Node.js packages and resources. :star:22179
* [awesome-npm](https://github.com/sindresorhus/awesome-npm) - Awesome npm resources and tips. :star:2830
