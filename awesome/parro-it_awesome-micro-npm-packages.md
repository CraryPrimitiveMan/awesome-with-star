...
* [strip-ansi](https://github.com/chalk/strip-ansi) - Strip ANSI escape codes. :star:130
...
* [fecha](https://github.com/taylorhakes/fecha) - Javascript Date formatting and parsing. :star:1440
...
* [timeago.js](https://github.com/hustcc/timeago.js) - A tiny(~1.7kb) library used to format date with `*** time ago` statement. :star:3100
...
### Stream
* [through2](https://github.com/rvagg/through2) - Tiny wrapper around Node streams2 Transform to avoid explicit subclassing noise. :star:1341
...
* [pump](https://github.com/mafintosh/pump) - pipe streams together and close all of them if one of them closes. :star:537
...
* [rimraf](https://github.com/isaacs/rimraf) - A deep deletion module for node (like rm -rf). :star:2407
* [mkdirp](https://github.com/substack/node-mkdirp) - Recursively mkdir, like mkdir -p. :star:1741
...
* [glob](https://github.com/isaacs/node-glob) - Glob functionality for node.js. :star:4558
...
* [uuid](https://github.com/kelektiv/node-uuid) - Generate RFC-compliant UUIDs in JavaScript. :star:5654
...
* [awesome-nodejs](https://github.com/sindresorhus/awesome-nodejs) - A curated list of delightful Node.js packages and resources. :star:23538
* [awesome-npm](https://github.com/sindresorhus/awesome-npm) - Awesome npm resources and tips. :star:2897
