...
* [Module best practices](https://github.com/mattdesl/module-best-practices) :star:1102
...
* [concat-stream](https://github.com/maxogden/concat-stream) - writable stream that concatenates strings or data and calls a callback with the result. :star:459
...
* [rimraf](https://github.com/isaacs/rimraf) - A deep deletion module for node (like rm -rf). :star:2451
...
* [semver](https://github.com/npm/node-semver) - The semantic version parser used by npm. :star:2242
...
* [glob](https://github.com/isaacs/node-glob) - Glob functionality for node.js. :star:4616
* [username](https://github.com/sindresorhus/username) - Get the username of the current user. :star:73
* [minimist](https://github.com/substack/minimist) - Parse argument options. :star:2926
...
* [uuid](https://github.com/kelektiv/node-uuid) - Generate RFC-compliant UUIDs in JavaScript. :star:5757
* [node-mime](https://github.com/broofa/node-mime) - Comprehensive MIME type mapping API based on mime-db module. :star:1167
...
* [awesome-nodejs](https://github.com/sindresorhus/awesome-nodejs) - A curated list of delightful Node.js packages and resources. :star:23886
* [awesome-npm](https://github.com/sindresorhus/awesome-npm) - Awesome npm resources and tips. :star:2912
