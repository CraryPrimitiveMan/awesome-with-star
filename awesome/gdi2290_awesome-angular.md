# Info come from [gdi2290/awesome-angular](https://github.com/gdi2290/awesome-angular)
<p align="center">
...
* [Official GitHub Repo](https://github.com/angular/angular) :star:31654
...
* [Angular 2 Universal Repository (GitHub)](https://github.com/angular/universal) :star:2749
...
* [nativescript-angular](https://github.com/NativeScript/nativescript-angular) :star:740
* [react-native-renderer](https://github.com/angular/react-native-renderer) :star:732

### Angular 2 Components
* [Axponents: of Accessible Web Components (Dylan Barrell)](https://github.com/dylanb/Axponents/tree/master/angular2)
* [ng2-bootstrap: Native Angular2 bootstrap components](https://github.com/valor-software/ng2-bootstrap) :star:3562
* [ngx-meta/core](https://github.com/ngx-meta/core) - Dynamic page title & meta tags utility for Angular (w/server-side rendering) by @fulls1z3 :star:151
* [ngx-config/core](https://github.com/ngx-config/core) - Configuration utility for Angular (incl. Angular Universal loader) by @fulls1z3 :star:61
* [ngx-cache/core](https://github.com/ngx-cache/core) - Cache utility for Angular (incl. browser & server platform implementations) by @fulls1z3 :star:45
* [ngx-i18n-router/core](https://github.com/ngx-i18n-router/core) - Route internationalization utility for Angular by @fulls1z3 :star:18
...
* [Universal Angular 2 Repository (GitHub)](https://github.com/angular/universal) :star:2749
...
* [ng-seed/universal](https://github.com/ng-seed/universal) - Seed project for Angular Universal apps featuring Server-Side Rendering (SSR), Webpack, dev/prod modes, DLLs, AoT compilation, HMR, SCSS compilation, lazy loading, config, cache, i18n, SEO, and TSLint/codelyzer by @fulls1z3 :star:353
