# Information comes from [beaconinside/awesome-beacon](https://github.com/beaconinside/awesome-beacon)
...
* [Eddystone Protocol Specification & Tools](https://github.com/google/eddystone) :star:2713
* Advertising frame types
  * [Eddystone-UID](https://github.com/google/eddystone/tree/master/eddystone-uid) :star:2713
  * [Eddystone-TLM](https://github.com/google/eddystone/tree/master/eddystone-tlm) :star:2713
  * [Eddystone-URL](https://github.com/google/eddystone/tree/master/eddystone-url) :star:2713
* [Eddystone Validator](https://github.com/google/eddystone/tree/master/tools/eddystone-validator) :star:2713
* [Eddystone GATT Configuration Service & Google Nearby API and Proximity API](* [](https://github.com/NordicSemiconductor/Android-nRF-Beacon-for-Eddystone)) (by Nordic Semiconductor) :star:28
* [Web Bluetooth Eddystone Configurator](https://beaufortfrancois.github.io/sandbox/web-bluetooth/eddystone-url-config/)
* [Eddystone Branding Guidelines](https://github.com/google/eddystone/tree/master/branding) & [Logos](https://github.com/google/eddystone/tree/master/branding/assets) :star:2713
...
* [Physical Web Implementation Status](https://github.com/google/physical-web/blob/master/implementation-status.md) :star:6063
* [Physical Web Branding Guidelines](https://github.com/google/physical-web/blob/master/documentation/branding_guidelines.md) & [Logos](https://github.com/google/physical-web/tree/master/documentation/images/logo) :star:6063
...
* [ScanBeacon](https://github.com/RadiusNetworks/scanbeacon-gem) - A ruby gem that allows you to scan for beacon advertisements using IOBluetooth (on Mac OS X) or a BlueGiga BLE112 device (on mac or linux) :star:23
...
* [iOS Eddystone Scanner Sample Application ](https://github.com/google/eddystone/tree/master/tools/ios-eddystone-scanner-sample) :star:2713
...
* [iOS & OSX Bluetooth library for RxSwift](https://github.com/Polidea/RxBluetoothKit) :star:855
...
* [BeaconKit](https://github.com/igor-makarov/BeaconKit) - Beacon detection framework using CoreBluetooth, supporting Eddystone-UID, Eddystone-URL, AltBeacon. :star:6

## Objective-C

* [Generic iBeacon Management and Utilities by KinveyLabs](https://github.com/KinveyLabs/KCSIBeacon/) :star:190
* [Replicates detecting and broadcasting iBeacons in the background](https://github.com/Instrument/Vicinity) :star:373
...
* [Android BLE advertising library](https://github.com/uriio/beacons-android) :star:81
* [Locate by Radius Networks - Virtual iBeacon](https://itunes.apple.com/us/app/locate-beacon/id738709014?mt=8)
* [Chrome App to advertise Eddystone packets](https://github.com/google/eddystone/tree/master/tools/eddystone-chrome-app-sample) - uses [Eddystone Advertising Library](https://github.com/google/eddystone/tree/master/libraries/javascript/eddystone-advertising) :star:2713
* [Linux iBeacon broadcaster](https://github.com/dburr/linux-ibeacon) :star:119
...
* [BLE SDK for Android](https://github.com/RedBearLab/Android) :star:167
* [Bluetooth LE Library for Android](https://github.com/alt236/Bluetooth-LE-Library---Android) :star:749
...
* [Cordova iBeacon Plugin](https://github.com/petermetz/cordova-plugin-ibeacon) :star:680
...
* [iBeacon Scanning Utility App for OSX](https://github.com/mlwelles/BeaconScanner) :star:446
* [iBeacon Scanner - Scan for nearby iBeacons regardless of their UUID](https://github.com/liamnichols/iBeaconScanner) :star:137
* [Beacon OSX](https://github.com/mttrb/BeaconOSX) - Mavericks as an iBeacon :star:860
* [Electron Physical Web Scan](https://github.com/dermike/electron-physical-web-scan) - Mac OSX desktop app to scan for Physical Web (Eddystone) bluetooth beacons :star:41
* [Electron Slide Beacon](https://github.com/dermike/electron-slide-beacon) - Share links from your Mac using this app to broadcast them as an Eddystone URL (Physical Web) bluetooth beacon. :star:122
* [BeaconKit](https://github.com/igor-makarov/BeaconKit) - Beacon detection framework ns Swift using CoreBluetooth, supporting Eddystone-UID, Eddystone-URL, AltBeacon, iBeacon. :star:6
...
* [A node.js BLE (Bluetooth low energy) central module](https://github.com/sandeepmistry/noble) :star:2307
* [A node.js module for implementing BLE (Bluetooth low energy) peripherals](https://github.com/sandeepmistry/bleno) :star:1440

# Windows

* [Universal Bluetooth Beacon Library](https://github.com/andijakl/universal-beacon) - open source library and links to apps to talk to Eddystone and iBeacon beacons :star:139
...
* [Web Bluetooth Demos](https://github.com/WebBluetoothCG/demos) :star:285
...
* [Nordic Semiconductor nRF51822 Bluetooth Smart Beacon Kit](https://www.nordicsemi.com/eng/Products/Bluetooth-R-low-energy/nRF51822-Bluetooth-Smart-Beacon-Kit)
  * [Eddystone GATT Configuration Service for nRF5 devices](https://github.com/NordicSemiconductor/nrf5-sdk-for-eddystone) :star:35
