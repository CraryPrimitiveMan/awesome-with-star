...
- [SEO](https://github.com/ethercreative/seo) - Search engine optimization utilities for Craft CMS. :star:105
...
- [Retour](https://github.com/nystudio107/retour) - Intelligently redirect legacy URLs,and flexible. :star:165
...
- [LJ Dynamic Fields](https://github.com/lewisjenkins/craft-lj-dynamicfields) - Simple plugin for populating fields with dynamic data. :star:123
...
- [SuperTable](https://github.com/verbb/SuperTable) - Create powerful tables utilising native Craft field types, including Assets, Users, Entries and even Matrix. :star:257
...
- [Workflow](https://github.com/verbb/Workflow) - Plugin to create a workflow for publishing entries. :star:114
...
### Navigation
- [a&m nav](https://github.com/am-impact/amnav) - Navigations in Craft, made easy. :star:178
...
- [MailChimp Subscribe](https://github.com/aelvan/mailchimp-subscribe-craft) - Simple Craft plugin for subscribing to MailChimp lists. :star:99
...
##### Etc.
- [Admin Bar](https://github.com/wbrowar/adminbar) - Front-end shortcuts for clients logged in. :star:75
...
- [craft-scripts](https://github.com/nystudio107/craft-scripts) - Shell scripts to manage database backups, asset backups, file permissions, asset syncing, cache clearing, and database syncing between Craft CMS environments. :star:208
