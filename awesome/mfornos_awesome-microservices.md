...
- [Lagom](https://github.com/lagom/lagom) - Reactive microservices for the JVM. :star:1729
- [Light Java](https://github.com/networknt/light-java) - A fast, lightweight and more productive microservices framework. :star:658
...
- [Quasar](https://github.com/puniverse/quasar) - Fibers, channels and actors for the JVM. :star:2966
...
- [Wangle](https://github.com/facebook/wangle) - A framework providing a set of common client/server abstractions for building services in a consistent, modular, and composable way. :star:1840
...
- [Apex](https://github.com/apex/apex) - Tool for deploying and managing AWS Lambda functions. With shims for languages not yet supported by Lambda, you can use Golang out of the box. :star:6653
...
- [Onion](https://github.com/davidmoreno/onion) - C library to create simple HTTP servers and web applications. :star:1332
...
- [Pistache](https://github.com/oktal/pistache) - A high-performance REST toolkit written in C++. :star:664
...
- [ULib](https://github.com/stefanocasazza/ULib) - Highly optimized class framework for writing C++ applications. :star:605
...
- [Plug](https://github.com/elixir-lang/plug) - A specification and conveniences for composable modules between web applications. :star:1643

#### Erlang

- [Cowboy](https://github.com/ninenines/cowboy) - Small, fast, modular HTTP server written in Erlang. :star:4740
...
- [Gizmo](https://github.com/nytimes/gizmo) - Microservices toolkit. :star:2089
- [Goa](https://github.com/goadesign/goa) - Design-based HTTP microservices in Go. :star:2610
...
- [Go kit](https://github.com/go-kit/kit) - Distributed programming toolkit for microservices in the modern enterprise. :star:9001
- [Go-micro](https://github.com/micro/go-micro) - A pluggable RPC microservice framework. :star:2899
- [Gopencils](https://github.com/bndr/gopencils) - Easily consume REST APIs with Go. :star:403
- [Gorilla](http://www.gorillatoolkit.org/) - Web toolkit for the Go programming language.
- [Iris](https://github.com/kataras/iris) - Fast, simple and efficient micro web framework for Go. :star:9112
- [Kite](https://github.com/koding/kite) - Microservices framework in Go. :star:1810
...
- [Micro](https://github.com/micro/micro) - A microservices toolchain in Go. :star:3969
...
- [Negroni](https://github.com/codegangsta/negroni) - Idiomatic HTTP middleware for Golang. :star:5323
- [Neutrino](https://github.com/neutrinoapp/neutrino) - Realtime/REST backend service. :star:137
- [RPCX](https://github.com/smallnest/rpcx) - A distributed RPC service framework based on NET/RPC like Alibaba Dubbo and Weibo Motan. :star:1916
...
- [Servant](https://github.com/haskell-servant/servant) - Type-level web DSL. :star:903
- [Yesod](https://github.com/yesodweb/yesod) - The Haskell RESTful web framework. :star:1875
...
- [Disruptor](https://github.com/LMAX-Exchange/disruptor) - High-performance inter-thread messaging library. :star:7121
...
- [Micro](http://github.com/zeithq/micro) - Asynchronous HTTP microservices. :star:6027
...
- [Serverless](https://github.com/serverless/serverless) - Build and maintain web, mobile and IoT applications running on AWS Lambda and API Gateway (formerly known as JAWS). :star:21653
...
- [Flight](https://github.com/mikecao/flight) - An extensible micro-framework. :star:1870
...
- [API Star](https://github.com/tomchristie/apistar) - A fast and expressive API framework, designed for Python 3. :star:3370
- [Flask](http://flask.pocoo.org/) - Python framework for microservices based on Werkzeug and Jinja 2.
- [Nameko](https://github.com/onefinestay/nameko) - Python framework for building microservices. :star:1769
- [Sanic](https://github.com/channelcat/sanic) - Sanic is a Flask-like Python 3.5+ web server that's written to go fast. :star:8479
...
- [Zappa](https://github.com/Miserlou/Zappa) - Framework for building and deploying server-less Python event-driven and web applications. :star:6092
...
- [Envoy](https://github.com/lyft/envoy) - Open source edge and service proxy, from the developers at Lyft. :star:3795
- [Fabio](https://github.com/eBay/fabio) - A fast, modern, zero-conf load balancing HTTP/S router for deploying microservices managed by Consul. :star:4490
- [HAProxy](http://www.haproxy.org/) - Reliable, high Performance TCP/HTTP load balancer.
- [Istio](https://istio.io/) - An open platform to connect, manage, and secure microservices.
- [Janus](https://github.com/hellofresh/janus) - An API Gateway written in Go. :star:937
...
- [Skipper](https://github.com/zalando/skipper) - HTTP router useful for decoupling routing from service logic. :star:552
...
- [Zuul](https://github.com/Netflix/zuul) - An edge service that provides dynamic routing, monitoring, resiliency, security, and more. :star:3786
...
- [Doozer](https://github.com/ha/doozerd) - Highly-available, completely consistent store for small amounts of data. When the data changes, it can notify connected clients immediately. :star:2955
- [Etcd](https://github.com/coreos/etcd) - Highly-available key-value store for shared configuration and service discovery. :star:16735
...
- [Conductor](https://github.com/Netflix/conductor) - A microservices orchestration engine. :star:953
...
- [Redisson](https://github.com/mrniko/redisson) - Distributed and scalable Java data structures on top of Redis server. :star:4392
...
- [Bunyan](https://github.com/trentm/node-bunyan) - Simple and fast JSON logging library for Node.js services. :star:4794
...
- [Aeron](https://github.com/real-logic/Aeron) - Efficient reliable UDP unicast, UDP multicast, and IPC message transport. :star:3166
...
- [Disque](https://github.com/antirez/disque) - Distributed message broker. :star:6565
...
- [RocketMQ](https://github.com/apache/incubator-rocketmq) - A low latency, reliable, scalable, easy to use message oriented middleware born from alibaba massive messaging business. :star:3597
...
- [Elastalert](https://github.com/yelp/elastalert) - Easy & flexible alerting for Elasticsearch. :star:4067
...
- [Parallec](https://github.com/eBay/parallec) - Fast parallel asynchronous HTTP/SSH/TCP/Ping client Java library. :star:615
...
- [Reactive Kafka](https://github.com/softwaremill/reactive-kafka) - Reactive Streams API for Apache Kafka. :star:921
...
- [Hystrix](https://github.com/Netflix/Hystrix) - Latency and fault tolerance library designed to isolate points of access to remote systems, services and 3rd party libraries, stop cascading failure and enable resilience in complex distributed systems where failure is inevitable. :star:12489
...
- [Simian Army](https://github.com/Netflix/SimianArmy) - Suite of tools for keeping your cloud operating in top form. Chaos Monkey, the first member, is a resiliency tool that helps ensure that your applications can tolerate random instance failures. :star:6177
- [Toxiproxy](https://github.com/shopify/toxiproxy) - TCP proxy to simulate network and system conditions for chaos and resiliency testing. :star:2455

### Security

- [Crtauth](https://github.com/spotify/crtauth) - A public key backed client/server authentication system. :star:87
- [Dex](https://github.com/coreos/dex) - Opinionated auth/directory service with pluggable connectors. OpenID Connect provider and third-party OAuth 2.0 delegation. :star:1851
...
- [Keycloak](https://github.com/keycloak/keycloak) - Full-featured and extensible auth service. OpenID Connect provider and third-party OAuth 2.0 delegation. :star:1973
...
- [Fastjson](https://github.com/alibaba/fastjson) - Fast JSON Processor. :star:12507
- [Ffjson](https://github.com/pquerna/ffjson) - Faster JSON serialization for Go. :star:2090
- [FST](https://github.com/RuedigerMoeller/fast-serialization) - Fast java serialization drop in-replacemen. :star:922
- [Jackson](https://github.com/FasterXML/jackson) -  A multi-purpose Java library for processing JSON data format. :star:3585
...
- [Kryo](https://github.com/EsotericSoftware/kryo) - Java serialization and cloning: fast, efficient, automatic. :star:3132
...
- [AtlasDB](https://github.com/palantir/atlasdb) - Transactional layer on top of a key value store. :star:554
...
- [InfluxDB](https://github.com/influxdata/influxdb) - Scalable datastore for metrics, events, and real-time analytics. :star:12529
...
- [Goreplay](https://github.com/buger/goreplay) - A tool for capturing and replaying live HTTP traffic into a test environment. :star:8429
...
- [Aglio](https://github.com/danielgtaylor/aglio) - API Blueprint renderer with theme support that outputs static HTML. :star:3583
...
- [Slate](https://github.com/tripit/slate) - Beautiful static documentation for your API. :star:22028
