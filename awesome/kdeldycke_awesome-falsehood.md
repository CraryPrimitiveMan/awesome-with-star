...
- [`tax`](https://github.com/commerceguys/tax) - A PHP 5.4+ tax management :star:202
library.
...
- [`libphonenumber`](https://github.com/googlei18n/libphonenumber) - Google's :star:6482
...
- [`addressing`](https://github.com/commerceguys/addressing) - A PHP 5.4+ :star:539
addressing library, powered by Google's dataset.
- [`postal-address`](https://github.com/scaleway/postal-address) - Python :star:75
