...
- [`tax`](https://github.com/commerceguys/tax) - A PHP 5.4+ tax management :star:233
library.
...
- [`libphonenumber`](https://github.com/googlei18n/libphonenumber) - Google's :star:10166
...
- [`libaddressinput`](https://github.com/googlei18n/libaddressinput) - Google's :star:423
common C++ and Java library for parsing, formatting, and validating
international postal addresses.
- [`addressing`](https://github.com/commerceguys/addressing) - A PHP 5.4+ :star:695
addressing library, powered by Google's dataset.
- [`postal-address`](https://github.com/scaleway/postal-address) - Python :star:119
module to parse, normalize and render postal addresses.
- [`address`](https://github.com/Boostport/address) - Go library to validate :star:42
