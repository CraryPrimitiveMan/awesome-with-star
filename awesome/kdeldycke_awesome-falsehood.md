...
- [Falsehoods About Falsehoods Lists](https://github.com/kdeldycke/kevin-deldycke-blog/blob/master/content/posts/falsehoods-programmers-believe-about-falsehoods-lists.md) - Meta :star:33
...
- [Falsehoods About IBANs](https://github.com/globalcitizen/php-iban/blob/master/docs/FALSEHOODS.md) - International :star:324
...
- [Falsehoods About Cars](https://github.com/driveto/falsehoods-about-cars) - Even :star:2
...
- [`tax`](https://github.com/commerceguys/tax) - A PHP 5.4+ tax management :star:236
library.
...
- [Awesome Unicode](https://github.com/Wisdom/Awesome-Unicode) - A curated list :star:614
...
spice.
- [i18n Testing Data](https://github.com/patch/i18n-testing) - Compilation of :star:48
real-word international and diverse name data for unit testing and QA.
- [Big List of Naughty Strings](https://github.com/minimaxir/big-list-of-naughty-strings) - A :star:35945
...
- [`hostname-validate`](https://github.com/jakeogh/hostname-validate) - An :star:1
attempt to validate hostnames in Python.


## Phone Numbers

- [Falsehoods About Phone Numbers](https://github.com/googlei18n/libphonenumber/blob/master/FALSEHOODS.md) - Covers :star:10796
phone numbers, their representation and meaning.
- [`libphonenumber`](https://github.com/googlei18n/libphonenumber) - Google's :star:10796
...
- [`libaddressinput`](https://github.com/googlei18n/libaddressinput) - Google's :star:446
common C++ and Java library for parsing, formatting, and validating
international postal addresses.
- [`addressing`](https://github.com/commerceguys/addressing) - A PHP 5.4+ :star:735
addressing library, powered by Google's dataset.
- [`postal-address`](https://github.com/scaleway/postal-address) - Python :star:125
module to parse, normalize and render postal addresses.
- [`address`](https://github.com/Boostport/address) - Go library to validate :star:50
...
- [Falsehoods About Versions](https://github.com/xenoterracide/falsehoods/blob/master/versions.md) - Attributing :star:52
...
- [Falsehoods About Fonts](https://github.com/RoelN/Font-Falsehoods) - Assumptions :star:78
