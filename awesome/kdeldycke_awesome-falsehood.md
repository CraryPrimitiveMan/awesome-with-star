...
- [Falsehoods About Falsehoods Lists](https://github.com/kdeldycke/kevin-deldycke-blog/blob/master/content/posts/falsehoods-programmers-believe-about-falsehoods-lists.md) - Meta :star:32
...
- [Falsehoods About IBANs](https://github.com/globalcitizen/php-iban/blob/master/docs/FALSEHOODS.md) - International :star:318
...
- [`tax`](https://github.com/commerceguys/tax) - A PHP 5.4+ tax management :star:234
library.
...
- [Awesome Unicode](https://github.com/Wisdom/Awesome-Unicode) - A curated list :star:605
...
- [Big List of Naughty Strings](https://github.com/minimaxir/big-list-of-naughty-strings) - A :star:35524
...
- [Falsehoods About Phone Numbers](https://github.com/googlei18n/libphonenumber/blob/master/FALSEHOODS.md) - Covers :star:10620
phone numbers, their representation and meaning.
- [`libphonenumber`](https://github.com/googlei18n/libphonenumber) - Google's :star:10620
...
- [`libaddressinput`](https://github.com/googlei18n/libaddressinput) - Google's :star:439
common C++ and Java library for parsing, formatting, and validating
international postal addresses.
- [`addressing`](https://github.com/commerceguys/addressing) - A PHP 5.4+ :star:727
...
- [`address`](https://github.com/Boostport/address) - Go library to validate :star:45
