...
- [`tax`](https://github.com/commerceguys/tax) - A PHP 5.4+ tax management :star:206
library.
...
- [`libphonenumber`](https://github.com/googlei18n/libphonenumber) - Google's :star:6727
...
- [`libaddressinput`](https://github.com/googlei18n/libaddressinput) - Google's :star:314
common C++ and Java library for parsing, formatting, and validating
international postal addresses.
- [`addressing`](https://github.com/commerceguys/addressing) - A PHP 5.4+ :star:575
addressing library, powered by Google's dataset.
- [`postal-address`](https://github.com/scaleway/postal-address) - Python :star:79
