...
- [`libphonenumber`](https://github.com/googlei18n/libphonenumber) - Google's :star:6506
...
- [`addressing`](https://github.com/commerceguys/addressing) - A PHP 5.4+ :star:559
addressing library, powered by Google's dataset.
- [`postal-address`](https://github.com/scaleway/postal-address) - Python :star:76
