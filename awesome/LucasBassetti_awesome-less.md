...
- [Official Repository](https://github.com/less/less.js) :star:15347
...
- [Material Design for Bootstrap](https://github.com/FezVrasta/bootstrap-material-design) - Material Design for Bootstrap is a Bootstrap V3 compatible theme; it is an easy way to use the new Material Design guidelines by Google in your Bootstrap 3 based application. :star:18990
...
- [Bootstrap Grid Only](https://github.com/zirafa/bootstrap-grid-only) - Bootstrap's responsive grid and responsive utility classes only, without any extras. Lightweight yet still powerful. Style to taste. :star:439
...
- [Animate Less](https://github.com/machito/animate.less) - Port of Dan Eden's [Animate.css](https://daneden.github.io/animate.css/) to Less. :star:533
...
- [Dynamic Stylesheet](https://github.com/mrkrupski/LESS-Dynamic-Stylesheet) - Set of useful mixins. :star:106
...
- [Lesshat](https://github.com/madebysource/lesshat) - Smart mixins library. :star:2249
...
- [Handshake Style Guide](https://github.com/handshake/less-style-guide) - This guide presents a collection of best-practices and coding conventions. :star:4
...
- [Pyhton Compiler](https://github.com/lesscpy/lesscpy) - Compiler written in Python. :star:107
...
- [CSS Less(ish)](https://github.com/kizza/CSS-Less-ish) - Sublime Text 2 & 3 plugin that implements a stripped down version of the functionality in css preprocessors (such as Less). :star:49
...
- [Grunt Contrib](https://github.com/gruntjs/grunt-contrib-less) - Compile Less files to CSS using Grunt. :star:700
- [Grunt Lint](https://github.com/jgable/grunt-lesslint) - Lint your Less files using CSS Lint from Grunt. :star:79
- [Gulp Less](https://github.com/plus3network/gulp-less) - Plugin for Gulp. :star:544
- [Hayaky](https://github.com/hayaku/hayaku) - Hayaku is a bundle of useful scripts aiming for rapid front-end web development. :star:943
...
- [Less Sublime](https://github.com/danro/Less-sublime) - Syntax highlighting for Sublime Text. :star:512
- [Lesshint](https://github.com/lesshint/lesshint) - Tool to aid you in writing clean and consistent Less. :star:104
...
- [Sublime Less2CSS](https://github.com/timdouglas/sublime-less2css) - Sublime Text 2 Plugin to compile Less files to css on save. :star:205
...
- [Vim Less](https://github.com/groenewege/vim-less) - This vim bundle adds syntax highlighting, indenting and autocompletion. :star:599
