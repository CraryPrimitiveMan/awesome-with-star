...
- [Official Repository](https://github.com/less/less.js) :star:16179
...
- [Ant Design](https://github.com/ant-design/ant-design/) - 	An enterprise-class UI design language and React-based implementation. :star:52853
...
- [Less Rails](https://github.com/metaskills/less-rails) - Less for Rails. :star:345
- [Material Design for Bootstrap](https://github.com/FezVrasta/bootstrap-material-design) - Material Design for Bootstrap is a Bootstrap V3 compatible theme; it is an easy way to use the new Material Design guidelines by Google in your Bootstrap 3 based application. :star:20039
...
- [Open Color](https://github.com/yeun/open-color) - Open color is a color scheme for UI design. Available in CSS, SCSS, Less, Stylus, Adobe library, Photoshop/Illustrator swatches and Sketch palette. :star:3771
...
- [Lesshat](https://github.com/madebysource/lesshat) - Smart mixins library. :star:2243
...
- [Preboot](https://github.com/mdo/preboot) - Collection of mixins and variables for writing better CSS. :star:1716
- [Retina.js](https://github.com/imulus/retinajs) - JavaScript, SCSS, Sass, Less, and Stylus helpers for rendering high-resolution image variants. :star:4448
...
- [JLessC](https://github.com/i-net-software/jlessc) - Less compiler written completely in Java. :star:40
- [Less Engine](https://github.com/Asual/lesscss-engine) - Runs Less in the Rhino JVM-based JavaScript interpreter. :star:227
- [Less CSS Compiler for Java](https://github.com/marceloverdijk/lesscss-java) - Runs Less in the Rhino JVM-based JavaScript interprete. :star:164
- [Less4j](https://github.com/SomMeri/less4j) - Native Java implementation. :star:137
...
- [Hayaky](https://github.com/hayaku/hayaku) - Hayaku is a bundle of useful scripts aiming for rapid front-end web development. :star:972
...
- [Less Sublime](https://github.com/danro/Less-sublime) - Syntax highlighting for Sublime Text. :star:506
...
- [Vim Less](https://github.com/groenewege/vim-less) - This vim bundle adds syntax highlighting, indenting and autocompletion. :star:603
...
- [Contributing to Less](https://github.com/less/less.js/blob/master/CONTRIBUTING.md) :star:16179
