...
- [heron](https://github.com/apache/incubator-heron) [Java] - Twitter's real-time analytics platform that is fully API-compatible with Storm. Storm has been replaced by Heron at Twitter.
