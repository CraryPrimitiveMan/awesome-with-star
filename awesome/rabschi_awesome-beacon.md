...
* [Eddystone Protocol Specification & Tools](https://github.com/google/eddystone) :star:2879
* Advertising frame types
  * [Eddystone-UID](https://github.com/google/eddystone/tree/master/eddystone-uid) :star:2879
  * [Eddystone-TLM](https://github.com/google/eddystone/tree/master/eddystone-tlm) :star:2879
  * [Eddystone-URL](https://github.com/google/eddystone/tree/master/eddystone-url) :star:2879
* [Eddystone Validator](https://github.com/google/eddystone/tree/master/tools/eddystone-validator) :star:2879
* [Eddystone GATT Configuration Service & Google Nearby API and Proximity API](* [](https://github.com/NordicSemiconductor/Android-nRF-Beacon-for-Eddystone)) (by Nordic Semiconductor) :star:40
* [Web Bluetooth Eddystone Configurator](https://beaufortfrancois.github.io/sandbox/web-bluetooth/eddystone-url-config/)
* [Eddystone Branding Guidelines](https://github.com/google/eddystone/tree/master/branding) & [Logos](https://github.com/google/eddystone/tree/master/branding/assets) :star:2879
...
* [Physical Web Implementation Status](https://github.com/google/physical-web/blob/master/implementation-status.md) :star:6083
* [Physical Web Branding Guidelines](https://github.com/google/physical-web/blob/master/documentation/branding_guidelines.md) & [Logos](https://github.com/google/physical-web/tree/master/documentation/images/logo) :star:6083
...
* [iOS Eddystone Scanner Sample Application ](https://github.com/google/eddystone/tree/master/tools/ios-eddystone-scanner-sample) :star:2879
...
* [iOS & OSX Bluetooth library for RxSwift](https://github.com/Polidea/RxBluetoothKit) :star:1086
...
* [BeaconKit](https://github.com/igor-makarov/BeaconKit) - Beacon detection framework using CoreBluetooth, supporting Eddystone-UID, Eddystone-URL, AltBeacon. :star:16

## Objective-C

* [Generic iBeacon Management and Utilities by KinveyLabs](https://github.com/KinveyLabs/KCSIBeacon/) :star:187
* [Replicates detecting and broadcasting iBeacons in the background](https://github.com/Instrument/Vicinity) :star:378
...
* [Android BLE advertising library](https://github.com/uriio/beacons-android) :star:102
* [Locate by Radius Networks - Virtual iBeacon](https://itunes.apple.com/us/app/locate-beacon/id738709014?mt=8)
* [Chrome App to advertise Eddystone packets](https://github.com/google/eddystone/tree/master/tools/eddystone-chrome-app-sample) - uses [Eddystone Advertising Library](https://github.com/google/eddystone/tree/master/libraries/javascript/eddystone-advertising) :star:2879
* [Linux iBeacon broadcaster](https://github.com/dburr/linux-ibeacon) :star:134
...
* [Bluetooth LE Library for Android](https://github.com/alt236/Bluetooth-LE-Library---Android) :star:793
...
* [Cordova iBeacon Plugin](https://github.com/petermetz/cordova-plugin-ibeacon) :star:716
...
* [iBeacon Scanning Utility App for OSX](https://github.com/mlwelles/BeaconScanner) :star:468
...
* [Electron Slide Beacon](https://github.com/dermike/electron-slide-beacon) - Share links from your Mac using this app to broadcast them as an Eddystone URL (Physical Web) bluetooth beacon. :star:128
* [BeaconKit](https://github.com/igor-makarov/BeaconKit) - Beacon detection framework ns Swift using CoreBluetooth, supporting Eddystone-UID, Eddystone-URL, AltBeacon, iBeacon. :star:16
...
* [A node.js BLE (Bluetooth low energy) central module](https://github.com/sandeepmistry/noble) :star:2801
* [A node.js module for implementing BLE (Bluetooth low energy) peripherals](https://github.com/sandeepmistry/bleno) :star:1747

# Windows

* [Universal Bluetooth Beacon Library](https://github.com/andijakl/universal-beacon) - open source library and links to apps to talk to Eddystone and iBeacon beacons :star:172
...
* [Web Bluetooth Demos](https://github.com/WebBluetoothCG/demos) :star:361
