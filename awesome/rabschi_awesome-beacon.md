...
* [Eddystone Protocol Specification & Tools](https://github.com/google/eddystone) :star:2907
* Advertising frame types
  * [Eddystone-UID](https://github.com/google/eddystone/tree/master/eddystone-uid) :star:2907
  * [Eddystone-TLM](https://github.com/google/eddystone/tree/master/eddystone-tlm) :star:2907
  * [Eddystone-URL](https://github.com/google/eddystone/tree/master/eddystone-url) :star:2907
* [Eddystone Validator](https://github.com/google/eddystone/tree/master/tools/eddystone-validator) :star:2907
...
* [Eddystone Branding Guidelines](https://github.com/google/eddystone/tree/master/branding) & [Logos](https://github.com/google/eddystone/tree/master/branding/assets) :star:2907
...
* [Physical Web Implementation Status](https://github.com/google/physical-web/blob/master/implementation-status.md) :star:6071
* [Physical Web Branding Guidelines](https://github.com/google/physical-web/blob/master/documentation/branding_guidelines.md) & [Logos](https://github.com/google/physical-web/tree/master/documentation/images/logo) :star:6071
...
* [iOS Eddystone Scanner Sample Application ](https://github.com/google/eddystone/tree/master/tools/ios-eddystone-scanner-sample) :star:2907
...
* [iOS & OSX Bluetooth library for RxSwift](https://github.com/Polidea/RxBluetoothKit) :star:1106
...
* [BeaconKit](https://github.com/igor-makarov/BeaconKit) - Beacon detection framework using CoreBluetooth, supporting Eddystone-UID, Eddystone-URL, AltBeacon. :star:17

## Objective-C

* [Generic iBeacon Management and Utilities by KinveyLabs](https://github.com/KinveyLabs/KCSIBeacon/) :star:187
* [Replicates detecting and broadcasting iBeacons in the background](https://github.com/Instrument/Vicinity) :star:380
...
* [Android BLE advertising library](https://github.com/uriio/beacons-android) :star:106
* [Locate by Radius Networks - Virtual iBeacon](https://itunes.apple.com/us/app/locate-beacon/id738709014?mt=8)
* [Chrome App to advertise Eddystone packets](https://github.com/google/eddystone/tree/master/tools/eddystone-chrome-app-sample) - uses [Eddystone Advertising Library](https://github.com/google/eddystone/tree/master/libraries/javascript/eddystone-advertising) :star:2907
* [Linux iBeacon broadcaster](https://github.com/dburr/linux-ibeacon) :star:136
...
* [Bluetooth LE Library for Android](https://github.com/alt236/Bluetooth-LE-Library---Android) :star:799
...
* [Cordova iBeacon Plugin](https://github.com/petermetz/cordova-plugin-ibeacon) :star:718
* [Using iBeacon with Xamarin.iOS and Xamarin.Android](http://de.slideshare.net/glennthomasstephens/ibeacon-support)
* [iBeacon advertising and scanning in a Titanium module](https://github.com/jbeuckm/TiBeacons) :star:142



# OS X

* [iBeacon Scanning Utility App for OSX](https://github.com/mlwelles/BeaconScanner) :star:473
...
* [Electron Slide Beacon](https://github.com/dermike/electron-slide-beacon) - Share links from your Mac using this app to broadcast them as an Eddystone URL (Physical Web) bluetooth beacon. :star:129
* [BeaconKit](https://github.com/igor-makarov/BeaconKit) - Beacon detection framework ns Swift using CoreBluetooth, supporting Eddystone-UID, Eddystone-URL, AltBeacon, iBeacon. :star:17

# Linux

* [Python script for scanning and advertising urls over Eddystone-URL](https://github.com/forksociety/PyBeacon) :star:63

# Node.js

* [Node-RED nodes to interact with the Physical Web](http://flows.nodered.org/node/node-red-node-physical-web)
* [A node.js BLE (Bluetooth low energy) central module](https://github.com/sandeepmistry/noble) :star:2853
* [A node.js module for implementing BLE (Bluetooth low energy) peripherals](https://github.com/sandeepmistry/bleno) :star:1764

# Windows

* [Universal Bluetooth Beacon Library](https://github.com/andijakl/universal-beacon) - open source library and links to apps to talk to Eddystone and iBeacon beacons :star:177
...
* [Web Bluetooth Demos](https://github.com/WebBluetoothCG/demos) :star:370
