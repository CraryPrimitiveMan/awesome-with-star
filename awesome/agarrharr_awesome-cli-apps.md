...
- [cmus](https://github.com/cmus/cmus) - Small, fast and powerful console music player for Unix-like operating systems. :star:2601
...
- [facebook-cli](https://github.com/specious/facebook-cli) - Facebook command line interface :star:195
...
- [boilr](https://github.com/tmrts/boilr) - Dependency free CLI to create projects from boilerplate templates. :star:650
- [cookiecutter](https://github.com/audreyr/cookiecutter) - creates projects from cookiecutters (project templates)
- [dockly](https://github.com/lirantal/dockly) - Interactive CLI for managing Docker containers. :star:437
...
- [acmetool](https://github.com/hlandau/acme) - An easy-to-use command line tool for automatically acquiring certificates from ACME servers. :star:1484
...
- [HTTPie](https://github.com/jkbrzt/httpie) - A user-friendly HTTP client. :star:34508
- [serve](https://github.com/zeit/serve) - Easy to use static file server with features like https, CORS and GZIP compression. :star:2187
...
- [deviceframe](https://github.com/c0bra/deviceframe) - Put device frames around your mobile/web/progressive app screenshots. :star:323

## Devops

- [aws-cli](https://github.com/aws/aws-cli) - Universal Command Line Interface for Amazon Web Services. :star:6172
...
- [ffscreencast](https://github.com/cytopia/ffscreencast) - ffmpeg screencast with video overlay and multi monitor support. :star:732
...
- [aria2](https://github.com/tatsuhiro-t/aria2) - Lightweight multi-protocol and multi-source, cross platform download utility. It supports HTTP/HTTPS, FTP, SFTP, BitTorrent and Metalink. :star:8843
...
- [mapscii](https://github.com/rastapasta/mapscii) - Terminal Map Viewer - the whole world in your console! :star:2790
...
- [The Fuck](https://github.com/nvbn/thefuck) - Magnificent app which corrects your previous console command. :star:34323
- [tldr](https://github.com/tldr-pages/tldr) - Simplified and community-driven man pages. :star:16649
- [Wat](https://github.com/dthree/wat) - Instant, central, community-built docs. :star:391


## Data Manipulation

- [jq](https://github.com/stedolan/jq) - Command-line JSON processor [http://stedolan.github.io/jq/](http://stedolan.github.io/jq/). :star:10964
...
- [fx](https://github.com/antonmedv/fx) - Command-line JSON processing tool :star:209

## Files and Directories

### File managers
- [ranger](https://github.com/ranger/ranger) - a console file manager with VI key bindings. :star:3293
- [midnight-commander](https://github.com/MidnightCommander/mc) - a feature rich visual file manager :star:713
...
- [DocToc](https://github.com/thlorenz/doctoc) - Generates table of contents for markdown files inside local git repository. Links are compatible with anchors generated by github or other sites. :star:1792

### Directory Listing

- [alder](https://github.com/aweary/alder) - A minimal implementation of the UNIX tree command with colors! :star:125
- [exa](https://github.com/ogham/exa) - An improved version of `ls` written in Rust. :star:4131

### Directory Navigation

- [autojump](https://github.com/wting/autojump) - A cd command that learns - easily navigate directories from the command line- [https://github.com/wting/autojump/wiki](https://github.com/wting/autojump/wiki). :star:6504
- [fasd](https://github.com/clvv/fasd) - Command-line productivity booster, offers quick access to files and directories, inspired by autojump, z and v. :star:3570
...
- [gotty](https://github.com/yudai/gotty) - Share your terminal as a web application. :star:9965
- [localtunnel](https://github.com/localtunnel/localtunnel) - Exposes your localhost to the world for easy testing and sharing. :star:6437
...
- [git-stats](https://github.com/IonicaBizau/git-stats) - :four_leaf_clover: A GitHub-like contributions calendar, but locally, with all your git commits. :star:4573
- [hub](https://github.com/github/hub) - A command-line wrapper for git that makes you better at GitHub. :star:12460
...
- [tig](https://github.com/jonas/tig) - Text-mode interface for Git. :star:5795
- [git-standup](https://github.com/kamranahmedse/git-standup) - Recall what you did on the last working day. :star:4906
- [starring](https://github.com/ritz078/starring) - Automatically star the npm-packages that you are using on GitHub. :star:106
- [git-secret](https://github.com/sobolevn/git-secret) - Store your private data inside a git repository. :star:815
...
- [git-extras](https://github.com/tj/git-extras) - Little git extras like git-ignore, git-setup, git-changelog, git-release, git-effort and more. :star:11205
...
- [gifsicle](https://github.com/kohler/gifsicle) - Create, manipulate, and optimize GIF images and animations. :star:1327
- [ttygif](https://github.com/icholy/ttygif) - Convert terminal recordings to animated gifs. :star:2562
...
- [asciinema](https://github.com/asciinema/asciinema) - Terminal session recorder and the best companion of asciinema.org. :star:4468
...
- [SVGO](https://github.com/svg/svgo) - SVG Optimizer is a Nodejs-based tool for optimizing SVG vector graphics files. :star:9213
...
- [cmatrix](https://github.com/Treri/cmatrix) - Show a scrolling 'Matrix' like screen- ([original](http://www.asty.org/cmatrix/)). :star:312
...
- [gdb-dashboard](https://github.com/cyrus-and/gdb-dashboard) - Modular visual interface for GDB in Python. :star:4401
...
- [alex](https://github.com/wooorm/alex) - This enhances texts with checking for insensitive, inconsiderate writing by catching many possible offences. :star:2206
...
- [awesome-git-addons](https://github.com/stevemao/awesome-git-addons) - A curated list of addons that extends git cli. :star:635
