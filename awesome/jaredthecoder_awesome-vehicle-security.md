...
- [Udacity's Self Driving Car Engineer Course](https://github.com/udacity/self-driving-car) - The content for Udacity's self driving car software engineer course. The actual course on Udacity's website is [here](https://www.udacity.com/course/self-driving-car-engineer-nanodegree--nd013). :star:3615
...
- [CANToolz](https://github.com/eik00d/CANToolz) - CANToolz is a framework for analysing CAN networks and devices. It is based on several modules which can be assembled in a pipeline. :star:273
...
- [openpilot](https://github.com/commaai/openpilot) - openpilot is an open source driving agent that performs the functions of Adaptive Cruise Control (ACC) and Lane Keeping Assist System (LKAS) for Hondas and Acuras. :star:7056
- [openalpr](https://github.com/openalpr/openalpr) - An open source Automatic License Plate Recognition library written in C++ with bindings in C#, Java, Node.js, Go, and Python. :star:6679
...
- [SocketCAN Utils](https://github.com/linux-can/can-utils) - Userspace utilites for SocketCAN on Linux. :star:427
...
- [Python-OBD](https://github.com/brendan-w/python-OBD) - A Python module for handling realtime sensor data from OBD-II vehicle ports. Works with ELM327 OBD-II adapters, and is fit for the Raspberry Pi. :star:220
...
- Security
  ...
  - [Security](https://github.com/sbilly/awesome-security) :star:2462
  - [Capture the Flag](https://github.com/apsdehal/awesome-ctf) :star:1796
  - [Malware Analysis](https://github.com/rshipp/awesome-malware-analysis) :star:3085
  - [Android Security](https://github.com/ashishb/android-security-awesome) :star:2822
  - [Hacking](https://github.com/carpedm20/awesome-hacking) :star:3389
  - [Honeypots](https://github.com/paralax/awesome-honeypots) :star:2039
