...
* [GitHub repository](https://github.com/tootsuite/mastodon) :star:11784
...
* [Tooty](https://github.com/n1k0/tooty) - Experimental multi-account Mastodon Web client (Elm). :star:84
* [Mustor](https://itunes.apple.com/app/id1229531204) - iOS app for Mastodon.
* [toot](https://github.com/ihabunek/toot) - Mastodon CLI client (Python). :star:79
* [madonctl](https://github.com/McKael/madonctl) - Mastodon CLI client (Go). :star:60
...
* [Mastodon.py](https://github.com/halcy/Mastodon.py) - Python wrapper for the Mastodon API. :star:188
