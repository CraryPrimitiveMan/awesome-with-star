...
* [GitHub repository](https://github.com/tootsuite/mastodon) :star:20504
* [Frequently Asked Questions](https://github.com/tootsuite/documentation/blob/master/Using-Mastodon/FAQ.md) :star:1385
...
* [API overview](https://github.com/tootsuite/documentation/blob/master/Using-the-API/API.md) :star:1385
...
* [Tooty](https://github.com/n1k0/tooty) - Experimental multi-account Mastodon Web client (Elm). :star:123
* [toot](https://github.com/ihabunek/toot) - Mastodon CLI client (Python). :star:325
* [madonctl](https://github.com/McKael/madonctl) - Mastodon CLI client (Go). :star:120
...
* [Pinafore](https://github.com/nolanlawson/pinafore) - Alternative web client for Mastodon, focused on speed and simplicity. :star:476
* [Brutaldon](https://github.com/jfmcbrayer/brutaldon) - Brutaldon is a brutalist, Web 1.0 web interface for Mastodon. :star:123
...
* [hnbot](https://github.com/raymestalez/mastodon-hnbot) - Posts the Hacker News stories with 100+ points (Python). :star:34
...
* [Mastodon.py](https://github.com/halcy/Mastodon.py) - Python wrapper for the Mastodon API. :star:379
