...
* [GitHub repository](https://github.com/tootsuite/mastodon) :star:20982
* [Frequently Asked Questions](https://github.com/tootsuite/documentation/blob/master/Using-Mastodon/FAQ.md) :star:1386
...
* [API overview](https://github.com/tootsuite/documentation/blob/master/Using-the-API/API.md) :star:1386
...
* [toot](https://github.com/ihabunek/toot) - Mastodon CLI client (Python). :star:356
* [madonctl](https://github.com/McKael/madonctl) - Mastodon CLI client (Go). :star:122
...
* [Pinafore](https://github.com/nolanlawson/pinafore) - Alternative web client for Mastodon, focused on speed and simplicity. :star:489
* [Brutaldon](https://github.com/jfmcbrayer/brutaldon) - Brutaldon is a brutalist, Web 1.0 web interface for Mastodon. :star:127
...
* [usercount](https://github.com/josefkenny/usercount) - Bot which posts user statistics to Mastodon (Python). :star:43
...
* [Mastodon.py](https://github.com/halcy/Mastodon.py) - Python wrapper for the Mastodon API. :star:390
