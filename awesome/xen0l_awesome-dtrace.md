...
- [node-dtrace-provider](https://github.com/chrisa/node-dtrace-provider) - Native DTrace probes for Node.js apps. :star:307
...
- [FlameGraph](https://github.com/brendangregg/FlameGraph) - Stack trace visualizer. :star:8966
...
- [dtrace-cloud-tools](https://github.com/brendangregg/dtrace-cloud-tools) - DTrace tools written for the SmartOS/SmartDataCenter cloud (illumos-based). :star:180
