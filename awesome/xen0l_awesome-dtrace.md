...
- [node-dtrace-provider](https://github.com/chrisa/node-dtrace-provider) - Native DTrace probes for Node.js apps. :star:299
...
- [FlameGraph](https://github.com/brendangregg/FlameGraph) - Stack trace visualizer. :star:6683
...
- [dtrace-cloud-tools](https://github.com/brendangregg/dtrace-cloud-tools) - DTrace tools written for the SmartOS/SmartDataCenter cloud (illumos-based). :star:166
- [pgsql tools](https://github.com/joyent/pgsqlstat) - Report top-level PostgreSQL stats. :star:118
- [portsnoop](https://github.com/davepacheco/portsnoop) - Trace event port activity. :star:3
- [storage tools](https://github.com/richardelling/tools) - Report NFS, CIFS and iSCSI stats. :star:26
