...
- [w3c/csswg-drafts](https://github.com/w3c/csswg-drafts) - Mirror of CSS WG Editor Draft repository. :star:1891
- [w3c/css-houdini-drafts](https://github.com/w3c/css-houdini-drafts) - Mirror of Houdini WG Editor repository. :star:1619

## Parsers :mag:

* [CSSOM](https://github.com/NV/CSSOM) - CSS Object Model implemented in pure JavaScript. :star:645
* [CSSTree](https://github.com/csstree/csstree) - Detailed CSS parser with syntax validator. :star:760
* [Gonzales](https://github.com/css/gonzales) - Fast CSS parser. :star:116
* [Gonzales PE](https://github.com/tonyganch/gonzales-pe) - CSS parser with support for preprocessors. :star:270
* [mensch](https://github.com/brettstimmerman/mensch) - A decent CSS parser. :star:94
* [ParserLib](https://github.com/CSSLint/parser-lib) - CSSLint/parser-lib. :star:274
* [PostCSS](https://github.com/postcss/postcss) - Transforming styles with JS plugins. :star:21793
* [Rework](https://github.com/reworkcss/rework) - Plugin framework for CSS preprocessing in Node.js. :star:2783
* [Stylecow](https://github.com/stylecow/stylecow) - Modern CSS for all browsers. :star:135
...
* [LESS](https://github.com/less/less.js) - Backwards compatible with CSS, and the extra features it adds use existing CSS syntax. :star:16204
* [PostCSS](https://github.com/postcss/postcss) - Transforming CSS with JS plugins. :star:21793
* [Sass](https://github.com/sass/sass) - Mature, stable, and powerful professional-grade CSS extension language. :star:12247
* [STYLIS](https://github.com/thysultan/stylis.js) - Light-weight CSS preprocessor. :star:785
...
* [material-components-web](https://github.com/material-components/material-components-web) - Modular and customizable Material Design UI components for the web. :star:13459
...
* [Strawberry](https://github.com/jfet97/strawberry) - A set of common flexbox utilities focused on making your life easier and faster with nested flexboxes. :star:74
* [Tachyons](http://tachyons.io/) - Functional CSS for humans.
* [Tacit](https://yegor256.github.io/tacit/) - CSS framework for dummies with zero skills in graphic design.
* [tailwindcss](https://github.com/tailwindcss/tailwindcss) - A utility-first CSS framework for rapid UI development. :star:16753
...
- [RSCSS](https://github.com/rstacruz/rscss) - Reasonable Standard for CSS Stylesheet Structure. :star:3675
...
- [Normalize](https://github.com/necolas/normalize.css) - A set of CSS rules that provide better cross-browser consistency in the default styling of HTML elements. :star:36866
- [Normalize-OpenType](https://github.com/kennethormandy/normalize-opentype.css) - Adds OpenType features—ligatures, kerning, and more—to Normalize.css. :star:806
- [MiniReset.css](https://github.com/jgthms/minireset.css) - A tiny modern CSS reset. :star:1775
- [sanitize.css](https://github.com/jonathantneal/sanitize.css/) - A set of CSS rules that style with today’s best practices out-of-the-box. :star:3805
- [unstyle.css](https://github.com/Martin-Pitt/css-unstyle) - Specialised stylesheet for removing user agent styles, style the web with your baseline. :star:12
...
* [scalable-css-reading-list](https://github.com/davidtheclark/scalable-css-reading-list) :star:1332
...
- [Hologram](https://github.com/trulia/hologram) :star:2176
- [mdcss](https://github.com/jonathantneal/mdcss) :star:668
- [Source](https://github.com/sourcejs/Source) :star:553
- [styledoc](https://github.com/Joony/styledoc/) :star:4
- [styledocco](https://github.com/jacobrask/styledocco) :star:1076
- [styledown](https://github.com/styledown/styledown) :star:672
- [sc5-styleguide](https://github.com/SC5/sc5-styleguide) :star:1265
...
* [idiomatic-css](https://github.com/necolas/idiomatic-css) :star:5896
* [Atomic Design](http://patternlab.io/resources.html)
* [SUIT CSS](https://github.com/suitcss/suit/blob/master/doc/naming-conventions.md#u-utilityname) :star:3658
...
* [aphrodite](https://github.com/Khan/aphrodite) :star:4864
* [babel-plugin-css-in-js](https://github.com/martinandert/babel-plugin-css-in-js) :star:289
* [classy](https://github.com/inturn/classy) :star:22
* [csjs](https://github.com/rtsao/csjs) :star:561
* [css-loader](https://github.com/webpack/css-loader) :star:3626
* [JSS](https://github.com/cssinjs/jss) :star:5285
* [react-styled](https://github.com/bloodyowl/react-styled) :star:34
* [react-with-styles](https://github.com/airbnb/react-with-styles) :star:1531
* [styled-jsx](https://github.com/zeit/styled-jsx) :star:4934
* [styled-components](https://github.com/styled-components/styled-components) :star:26623
...
* [polyfill.js](https://github.com/philipwalton/polyfill/) - A library to make creating CSS polyfills much easier. :star:293
* [prefixfree](https://github.com/LeaVerou/prefixfree) - Break free from CSS prefix hell. :star:3762
* [fixed-sticky](https://github.com/filamentgroup/fixed-sticky) - A CSS position:sticky polyfill. :star:1484
* [selectivizr](https://github.com/keithclark/selectivizr) - A JavaScript utility that emulates CSS3 pseudo-classes and attribute selectors in Internet Explorer 6-8. :star:1755
...
* [Single Div Project](https://github.com/ManrajGrover/SingleDivProject) - One `<div>`. Many possibilities. :star:1558
...
* [Live editor for CSS and LESS](https://github.com/webextensions/live-css-editor) - Magic CSS extension for Chrome, Firefox and Edge. :star:81
* [You Might Not Need JS](http://youmightnotneedjs.com/) - CSS alternatives for common JS UI components.
* [RevengeCSS](https://github.com/Heydon/REVENGE.CSS) - A CSS bookmarklet that uses selectors to find bad markup, displaying ugly pink error messages in comic sans serif wherever you write bad HTML  :star:569
