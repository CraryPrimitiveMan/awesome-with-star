# Information comes from [awesome-css-group/awesome-css](https://github.com/awesome-css-group/awesome-css)
...
- [w3c/csswg-drafts](https://github.com/w3c/csswg-drafts) - Mirror of CSS WG Editor Draft repository. :star:2250
- [w3c/css-houdini-drafts](https://github.com/w3c/css-houdini-drafts) - Mirror of Houdini WG Editor repository. :star:1667

## Parsers :mag:

* [CSSOM](https://github.com/NV/CSSOM) - CSS Object Model implemented in pure JavaScript. :star:653
* [CSSTree](https://github.com/csstree/csstree) - Detailed CSS parser with syntax validator. :star:913
* [Gonzales PE](https://github.com/tonyganch/gonzales-pe) - CSS parser with support for preprocessors. :star:282
* [mensch](https://github.com/brettstimmerman/mensch) - A decent CSS parser. :star:96
* [ParserLib](https://github.com/CSSLint/parser-lib) - CSSLint/parser-lib. :star:274
* [PostCSS](https://github.com/postcss/postcss) - Transforming styles with JS plugins. :star:22614
* [Rework](https://github.com/reworkcss/rework) - Plugin framework for CSS preprocessing in Node.js. :star:2784
* [Stylecow](https://github.com/stylecow/stylecow) - Modern CSS for all browsers. :star:138
...
* [LESS](https://github.com/less/less.js) - Backwards compatible with CSS, and the extra features it adds use existing CSS syntax. :star:16301
* [PostCSS](https://github.com/postcss/postcss) - Transforming CSS with JS plugins. :star:22614
* [Sass](https://github.com/sass/sass) - Mature, stable, and powerful professional-grade CSS extension language. :star:12534
* [STYLIS](https://github.com/thysultan/stylis.js) - Light-weight CSS preprocessor. :star:933
...
* [Hasser CSS](https://github.com/HeavenMercy/HasserCSS) - A lightweight (12k, not minified) but useful CSS framework with flexible Grid, Hero and more. :star:2
* [inuit.css](http://inuitcss.com/) - Powerful, scalable, Sass-based, BEM, OOCSS framework.
* [material-components-web](https://github.com/material-components/material-components-web) - Modular and customizable Material Design UI components for the web. :star:14358
...
* [Shorthand Framework](https://github.com/shorthandcss/shorthand) - Feature rich CSS framework for the new decade. :star:193
* [Spectre.css](https://picturepan2.github.io/spectre/index.html) - A lightweight, responsive and modern CSS framework.
* [Strawberry](https://github.com/jfet97/strawberry) - A set of common flexbox utilities focused on making your life easier and faster with nested flexboxes. :star:72
* [Tachyons](http://tachyons.io/) - Functional CSS for humans.
* [Tacit](https://yegor256.github.io/tacit/) - CSS framework for dummies with zero skills in graphic design.
* [tailwindcss](https://github.com/tailwindcss/tailwindcss) - A utility-first CSS framework for rapid UI development. :star:22938
...
- [RSCSS](https://github.com/rstacruz/rscss) - Reasonable Standard for CSS Stylesheet Structure. :star:3710
...
- [Normalize](https://github.com/necolas/normalize.css) - A set of CSS rules that provide better cross-browser consistency in the default styling of HTML elements. :star:38883
- [Normalize-OpenType](https://github.com/kennethormandy/normalize-opentype.css) - Adds OpenType features—ligatures, kerning, and more—to Normalize.css. :star:802
- [MiniReset.css](https://github.com/jgthms/minireset.css) - A tiny modern CSS reset. :star:1932
- [sanitize.css](https://github.com/jonathantneal/sanitize.css/) - A set of CSS rules that style with today’s best practices out-of-the-box. :star:3964
- [unstyle.css](https://github.com/Martin-Pitt/css-unstyle) - Specialised stylesheet for removing user agent styles, style the web with your baseline. :star:16
...
* [scalable-css-reading-list](https://github.com/davidtheclark/scalable-css-reading-list) :star:1352
...
- [Hologram](https://github.com/trulia/hologram) :star:2182
- [mdcss](https://github.com/jonathantneal/mdcss) :star:672
- [Source](https://github.com/sourcejs/Source) :star:557
- [styledoc](https://github.com/Joony/styledoc/) :star:4
- [styledocco](https://github.com/jacobrask/styledocco) :star:1072
- [styledown](https://github.com/styledown/styledown) :star:680
- [sc5-styleguide](https://github.com/SC5/sc5-styleguide) :star:1270
...
* [idiomatic-css](https://github.com/necolas/idiomatic-css) :star:5987
* [Atomic Design](http://patternlab.io/resources.html)
* [SUIT CSS](https://github.com/suitcss/suit/blob/master/doc/naming-conventions.md#u-utilityname) :star:3693
...
* [aphrodite](https://github.com/Khan/aphrodite) :star:5017
* [babel-plugin-css-in-js](https://github.com/martinandert/babel-plugin-css-in-js) :star:295
* [classy](https://github.com/inturn/classy) :star:22
* [csjs](https://github.com/rtsao/csjs) :star:577
* [css-loader](https://github.com/webpack/css-loader) :star:3790
* [JSS](https://github.com/cssinjs/jss) :star:5705
* [react-styled](https://github.com/bloodyowl/react-styled) :star:34
* [react-with-styles](https://github.com/airbnb/react-with-styles) :star:1595
* [styled-jsx](https://github.com/zeit/styled-jsx) :star:5473
* [styled-components](https://github.com/styled-components/styled-components) :star:29354
...
* [polyfill.js](https://github.com/philipwalton/polyfill/) - A library to make creating CSS polyfills much easier. :star:296
* [prefixfree](https://github.com/LeaVerou/prefixfree) - Break free from CSS prefix hell. :star:3791
* [fixed-sticky](https://github.com/filamentgroup/fixed-sticky) - A CSS position:sticky polyfill. :star:1487
* [selectivizr](https://github.com/keithclark/selectivizr) - A JavaScript utility that emulates CSS3 pseudo-classes and attribute selectors in Internet Explorer 6-8. :star:1747
* [PIE](https://github.com/lojjic/PIE) - Allows Internet Explorer to recognize and render various CSS3 box decoration properties. :star:2841
...
* [Single Div Project](https://github.com/ManrajGrover/SingleDivProject) - One `<div>`. Many possibilities. :star:1560
* [Can I use](https://caniuse.com/) - Browser support for CSS, HTML5 and other front-end web technologies.
* [Live editor for CSS and LESS](https://github.com/webextensions/live-css-editor) - Magic CSS extension for Chrome, Firefox and Edge. :star:100
* [You Might Not Need JS](http://youmightnotneedjs.com/) - CSS alternatives for common JS UI components.
* [RevengeCSS](https://github.com/Heydon/REVENGE.CSS) - A CSS bookmarklet that uses selectors to find bad markup, displaying ugly pink error messages in comic sans serif wherever you write bad HTML :star:604
