...
- [Echarts](https://github.com/ecomfe/echarts) - Highly customizable and interactive charts ready for big datasets. [React wrapper](https://github.com/hustcc/echarts-for-react) :star:1612
- [Epoch](https://github.com/epochjs/epoch) - Perfect to create real-time charts. :star:4941
- [Highcharts](https://github.com/highcharts/highcharts) - Highcharts makes it easy for developers to set up interactive charts in their web pages. :star:8080
- [MetricsGraphics.js](https://metricsgraphicsjs.org/) - Optimized for time-series data.
- [NVD3](https://github.com/novus/nvd3) - A reusable charting library written in d3.js. :star:6708
- [Plotly.js](https://github.com/plotly/plotly.js/) - Powerful declarative library with support for 20 chart types. :star:9131
...
- [VivaGraph](https://github.com/anvaka/VivaGraphJS) - Graph drawing library for JavaScript. :star:2694

### Maps
- [CARTO](https://github.com/CartoDB/cartodb) - CARTO is an open source tool that allows for the storage and visualization of geospatial data on the web. :star:1978
- [Cesium](https://github.com/AnalyticalGraphicsInc/cesium) - WebGL 3D globes and maps. :star:3618
- [DataMaps](https://github.com/markmarkoh/datamaps) - Interactive SVG maps using D3.js. :star:2974
- [Leaflet](http://leafletjs.com) - JavaScript library for mobile-friendly interactive maps.
- [Mapael](https://github.com/neveldo/jQuery-Mapael) - jQuery plugin based on raphael.js to display vector maps. :star:886
...
### React
- [React-vis](https://github.com/uber/react-vis) - React components to build data visualizations. :star:4530
- [Recharts](https://github.com/recharts/recharts) - Declarative react components to render D3 charts. :star:10150
- [Victory](https://formidable.com/open-source/victory/) - Composable components for building interactive data visualizations
- [nivo](https://github.com/plouc/nivo) - Supercharged dataviz components for React with isomorphic ability, [demo](http://nivo.rocks). :star:2883
...
- [React Svg Textures](https://github.com/finnfiddle/react-svg-textures) - Textures.js ported to React. Fully isomorphic. :star:17
...
### Misc
- [Piecon](https://github.com/lipka/piecon) - Pie charts in your favicon. :star:2352
...
## Android tools
- [DecoView](https://github.com/bmarrdev/android-DecoView-charting) - Animated circular wheel chart library. :star:907
- [MPAndroidChart](https://github.com/PhilJay/MPAndroidChart) - A powerful & easy to use chart library. :star:24569
- [WilliamChart](https://github.com/diogobernardino/WilliamChart) - Simple chart library. :star:3975

## Excel tools
- [Best Excel Maps](http://bestexcelmaps.com/) - Choropleth maps for Microsoft Excel.

## C++ tools
- [LargeVis](https://github.com/lferry007/LargeVis) - implementation of the [LargeVis paper](https://arxiv.org/abs/1602.00370), used to visualize large-scale and high-dimensional data. :star:437
- [PlotJuggler](https://github.com/facontidavide/PlotJuggler) - open-source Qt5 application to plot charts (based on Qwt). :star:144
...
- [Charts](https://github.com/danielgindi/Charts) -  iOS port of MPAndroidChart. You can create charts for both platforms with very similar code. :star:19472
- [JBChartView](https://github.com/Jawbone/JBChartView) - Charting library for both line and bar graphs. :star:3810
- [PNChart](https://github.com/kevinzhow/PNChart) - A simple and beautiful chart lib used in Piner and CoinsMan. :star:9465
...
- [diagram](https://github.com/tehmaze/diagram) - Text mode diagrams using UTF-8 characters :star:330
- [ggplot](https://github.com/yhat/ggpy) - plotting system based on [R's](#r-tools) ggplot2. :star:3386
- [glumpy](https://github.com/glumpy/glumpy) - OpenGL scientific visualizations library. :star:478
...
- [missingno](https://github.com/ResidentMario/missingno) - provides flexible toolset of data-visualization utilities that allows quick visual summary of the completeness of your dataset, based on matplotlib. :star:1170
- [plotly](https://plot.ly/python/) - Interactive web based visualization built on top of [plotly.js](https://github.com/plotly/plotly.js) :star:9131
...
- [plotly](https://github.com/ropensci/plotly) - Interactive charts (including adding interactivity to ggplot2 output), cartograms and simple network diagrams :star:1360
...
## Ruby tools
- [Chartkick](https://github.com/ankane/chartkick) - Create charts with one line of Ruby. :star:4941
...
- [Gephi](https://github.com/gephi/gephi) - An open-source platform for visualizing and manipulating large graphs :star:2901
...
- [Spark](https://github.com/holman/spark) - Sparklines for the shell. It have several [implementations in different languages](https://github.com/holman/spark/wiki/Alternative-Implementations). :star:5198
