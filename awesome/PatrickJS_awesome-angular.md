...
* [Official GitHub Repo](https://github.com/angular/angular) :star:60302
...
* [Angular 2 Universal Repository (GitHub)](https://github.com/angular/universal) :star:3560
...
* [Angular2 Dart cheatsheet](https://github.com/andresaraujo/angular2_cheatsheet_dart) :star:11
...
* [nativescript-angular](https://github.com/NativeScript/nativescript-angular) :star:1133
* [react-native-renderer](https://github.com/angular/react-native-renderer) :star:802

### Angular 2 Components
* [Axponents: of Accessible Web Components (Dylan Barrell)](https://github.com/dylanb/Axponents/tree/master/angular2) :star:20
* [ng2-bootstrap: Native Angular2 bootstrap components](https://github.com/valor-software/ng2-bootstrap) :star:5083
* [ngx-meta/core](https://github.com/ngx-meta/core) - Dynamic page title & meta tags utility for Angular (w/server-side rendering) by @fulls1z3 :star:304
* [ngx-config/core](https://github.com/ngx-config/core) - Configuration utility for Angular (incl. Angular Universal loader) by @fulls1z3 :star:124
* [ngx-cache/core](https://github.com/ngx-cache/core) - Cache utility for Angular (incl. browser & server platform implementations) by @fulls1z3 :star:128
* [ngx-i18n-router/core](https://github.com/ngx-i18n-router/core) - Route internationalization utility for Angular by @fulls1z3 :star:38

### Angular 2 Generators
* Node.js
  * Slush
    * [TheVelourFog/slush-angular2](https://github.com/TheVelourFog/slush-angular2) :star:45
  * Yeoman
    * [swirlycheetah/generator-angular2](https://github.com/swirlycheetah/generator-angular2) :star:263
* Dart
  * Stagehand
...
* [Universal Angular 2 Repository (GitHub)](https://github.com/angular/universal) :star:3560
...
* [ng-seed/universal](https://github.com/ng-seed/universal) - Seed project for Angular Universal apps featuring Server-Side Rendering (SSR), Webpack, dev/prod modes, DLLs, AoT compilation, HMR, SCSS compilation, lazy loading, config, cache, i18n, SEO, and TSLint/codelyzer by @fulls1z3 :star:638
...
* [ng-seed/spa](https://github.com/ng-seed/spa) - Seed project for Angular apps featuring Webpack, dev/prod modes, DLLs, AoT compilation, HMR, SCSS compilation, lazy loading, config, cache, i18n, SEO, and TSLint/codelyzer by @fulls1z3 :star:26
