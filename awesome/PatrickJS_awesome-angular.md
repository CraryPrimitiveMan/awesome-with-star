...
* [Official GitHub Repo](https://github.com/angular/angular) :star:55359
...
* [Angular 2 Universal Repository (GitHub)](https://github.com/angular/universal) :star:3443
...
* [nativescript-angular](https://github.com/NativeScript/nativescript-angular) :star:1110
* [react-native-renderer](https://github.com/angular/react-native-renderer) :star:799

### Angular 2 Components
* [Axponents: of Accessible Web Components (Dylan Barrell)](https://github.com/dylanb/Axponents/tree/master/angular2) :star:20
* [ng2-bootstrap: Native Angular2 bootstrap components](https://github.com/valor-software/ng2-bootstrap) :star:4959
* [ngx-meta/core](https://github.com/ngx-meta/core) - Dynamic page title & meta tags utility for Angular (w/server-side rendering) by @fulls1z3 :star:281
* [ngx-config/core](https://github.com/ngx-config/core) - Configuration utility for Angular (incl. Angular Universal loader) by @fulls1z3 :star:114
* [ngx-cache/core](https://github.com/ngx-cache/core) - Cache utility for Angular (incl. browser & server platform implementations) by @fulls1z3 :star:118
...
* [Universal Angular 2 Repository (GitHub)](https://github.com/angular/universal) :star:3443
...
* [ng-seed/universal](https://github.com/ng-seed/universal) - Seed project for Angular Universal apps featuring Server-Side Rendering (SSR), Webpack, dev/prod modes, DLLs, AoT compilation, HMR, SCSS compilation, lazy loading, config, cache, i18n, SEO, and TSLint/codelyzer by @fulls1z3 :star:618
