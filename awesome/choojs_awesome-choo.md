...
- [bel](https://github.com/shama/bel) - Create composable DOM elements using :star:591
  template strings.
...
- [kaktus](https://github.com/kaktus/kaktus) - A new minimalistic web browser, built on `choo` and IndexedDB. :star:397
