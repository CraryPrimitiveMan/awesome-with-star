...
- [Custom Forms (Official)](https://github.com/tailwindcss/custom-forms) - Adds better default styles to form elements. :star:831
- [Theming (Dark/Light)](https://github.com/hawezo/tailwindcss-theming) - Adds powerful theming capabilities with CSS variables and `prefers-color-scheme`. :star:192
- [Text Indent](https://github.com/hacknug/tailwindcss-text-indent) - Adds `text-indent` utilities. :star:12
- [Image Rendering](https://github.com/hacknug/tailwindcss-image-rendering) - Adds `image-rendering` utilities. :star:6
- [Filters](https://github.com/benface/tailwindcss-filters) - Adds `filter` utilities. :star:45
- [Spinner](https://github.com/aniftyco/tailwindcss-spinner) - Adds a spinner utility. :star:105
- [Elevation](https://github.com/jonaskay/tailwindcss-elevation) - Adds [Material UI `elevation`](https://material.io/design/environment/elevation.html) utilities. :star:22
- [Caret Color](https://github.com/naoray/tailwind-caret-color) - Adds `caret` color utilities. :star:5
- [Direction](https://github.com/RonMelkhior/tailwindcss-dir) - Adds `RTL` and `LTR` variants. :star:85
- [Touch](https://github.com/SteadfastCollective/tailwindcss-touch) - Adds `touch` variants. :star:7
- [Blend Mode](https://github.com/hacknug/tailwindcss-blend-mode) - Adds `blend-mode` utilities. :star:37
- [Colorize](https://github.com/philippbosch/tailwindcss-colorize) - Adds `filter` utilities. :star:3
- [Writing Mode](https://github.com/magicspon/tailwindcss-writing-mode) - Adds `writing-mode` utilities. :star:5
- [Responsive Embed](https://github.com/drdogbot7/tailwindcss-responsive-embed) - Adds a `responsive-embed` component. :star:31
- [Aspect Ratio](https://github.com/webdna/tailwindcss-aspect-ratio) - Adds `aspect-ratio` utilities. :star:133
- [Hyphens](https://github.com/philippbosch/tailwindcss-hyphens) - Adds `hyphens` utilities. :star:5
- [Border Gradients](https://github.com/cossssmin/tailwindcss-border-gradients) - Adds `border-image` gradient utilities. :star:51
- [RFS](https://github.com/aerni/tailwindcss-rfs) - Adds [`RFS`](https://github.com/twbs/rfs) utilities. :star:11
- [Font Variant Numeric](https://github.com/philippbosch/tailwindcss-font-variant-numeric) - Adds `font-variant-numeric` utilities. :star:6
- [Dark Mode](https://github.com/ChanceArthur/tailwindcss-dark-mode) - Adds `dark` variants based on the `prefers-color-scheme` media query. :star:358
- [Vue.js](https://github.com/opdavies/tailwindcss-vuejs) - Adds visibility classes that work with Vue.js's `v-cloak` directive. :star:7
- [List Reset](https://github.com/opdavies/tailwindcss-list-reset) - Re-adds the `list-reset` class that was removed prior to Tailwind CSS 1.0. :star:1
- [Fluid](https://github.com/bradlc/tailwindcss-fluid) - Adds fluid sizing utilities. :star:66
- [Flexbox Order](https://github.com/035media/tailwindcss-flexbox-order) - Extends `order` utilities. :star:33
- [benface's gradients](https://github.com/benface/tailwindcss-gradients) - Adds gradient utilities. :star:126
- [lorisleiva's gradients](https://github.com/lorisleiva/tailwindcss-plugins/tree/master/gradients) - Adds background gradient utilities. :star:192
- [Alpha](https://github.com/bradlc/tailwindcss-alpha) - Adds alpha color variants. :star:59
- [Bootstrap Tables](https://github.com/drehimself/tailwindcss-tables) - Adds table utilities based on Bootstrap's tables. :star:64
- [Typography](https://github.com/benface/tailwindcss-typography) - Adds typography utilities. :star:145
- [Card](https://github.com/NathanHeffley/tailwindcss-card) - Adds card components. :star:16
- [Triangle After](https://github.com/chrisrowe/tailwindcss-triangle-after) - Adds CSS triangles utilities. :star:15
- [Scrims](https://github.com/brettgullan/tailwindcss-scrims) - Adds scrims utilities. :star:16
- [Colors to CSS Variables](https://github.com/n1kk/tailwind-color-vars) - Exports color configuration to CSS Custom Properties. :star:18
- [CSS Variables](https://github.com/omarkhatibco/tailwind-css-variables) - Exports configuration to CSS Custom Properties. :star:73
- [Spaced Items](https://github.com/n1kk/tailwindcss-spaced-items) - Adds `spaced` components that add fixed margins to all container items, except the last one. :star:14
- [Heropatterns](https://github.com/AndreaMinato/tailwind-heropatterns) - Adds [Hero Patterns](https://www.heropatterns.com) components. :star:49
- [Localized](https://github.com/hdodov/tailwindcss-localized) - Adds variants based on the HTML `lang` attribute, to use utilities only with certain languages. :star:4
- [Skip link](https://github.com/opdavies/tailwindcss-skip-link) - Adds a _Skip to main content_ accessible component. :star:3
- [Pseudo](https://github.com/Log1x/tailwindcss-pseudo) - Adds custom variants to Tailwind CSS's configuration. :star:24
- [Custom Native](https://github.com/SirNavith/tailwindcss-custom-native) - Leverages Tailwind CSS's configuration to allow the creation of utilities. :star:37
- [Truncate Multiline](https://github.com/jhta/tailwindcss-truncate-multiline) - Adds utilities to truncate multi-line text elements. :star:22
- [Debug Screens](https://github.com/jorenvanhee/tailwindcss-debug-screens) - Adds a component that shows the currently active screen (responsive breakpoint). :star:28
- [Dark Mode with Class](https://github.com/danestves/tailwindcss-darkmode) - Adds `dark` variants based on CSS classes. :star:9
- [CSS Logical Properties](https://github.com/omarkhatibco/tailwind-css-logical-properties) - Generate classnames for CSS Logical Properties for margin, padding, border-width, border-raduis, text-align, float & writing-mode. :star:11
- [CSS Scroll Snap](https://github.com/hawezo/tailwindcss-scroll-snap) - Adds `scroll-snap` utilities. :star:27
- [Shadow Outline Colors](https://github.com/octoper/tailwindcss-shadow-outline-colors) - Adds `box-shadow` utilities based on configured colors. :star:2
- [Tooltip Arrows After](https://github.com/gvital3230/tailwindcss-tooltip-arrow-after) - Adds CSS utilities for tooltip arrows with configurable border and background. :star:2
- [Bidirectional](https://github.com/20lives/tailwindcss-rtl) - Adds utilities for creating multilingual bidirectional layouts. :star:13
- [Fluid Utilities](https://github.com/soberwp/tailwindcss-fl) - Generate `fl:` utilities by leveraging existing config. :star:2
...
- [tails-ui](https://github.com/knipferrc/tails-ui) - React UI library using Tailwind CSS. :star:115
- [VueTailwind](https://github.com/alfonsobries/vue-tailwind) - Vue.js UI library using Tailwind CSS. :star:345
...
- [Tailwind CSS on GitHub](https://github.com/tailwindcss/tailwindcss) - Official Tailwind CSS repository. :star:22938
- 🌟 [Tailwind UI](https://tailwindui.com) 🌟 - Component library made with Tailwind CSS.
- [Discussion Repository](https://github.com/tailwindcss/discuss) - Official Tailwind CSS repository for discussions. :star:159
...
- [Tailwind Cheat Sheet](https://github.com/LeCoupa/awesome-cheatsheets/blob/master/frontend/tailwind.css) - Tailwind CSS class names in one single file. :star:12409
...
- [Tailwind CSS IntelliSense for Neovim](https://github.com/iamcco/coc-tailwindcss) - Neovim IntelliSense extension for Tailwind CSS. :star:91
- [Headwind for VS Code](https://github.com/heybourn/headwind) - Visual Studio Code class sorter for Tailwind CSS. :star:348

### Open-Source Projects

- [Goodwork](https://github.com/iluminar/goodwork) - Project Management & Collaboration tool. :star:1086
- [Statusfy](https://github.com/bazzite/statusfy) - Status page system using Tailwind CSS. :star:1862
- [Todolist](https://github.com/guillaumebriday/todolist-frontend-vuejs) - To-do list application using Tailwind CSS. :star:86
- [LeagueStats](https://github.com/vkaelin/LeagueStats) - Statistics website for League of Legends players. :star:86
- [SapperCommerce](https://github.com/itswadesh/sapper-ecommerce) - E-commerce storefront using Svelte & Tailwind CSS. :star:138
- [Misiki Books](https://github.com/itswadesh/misiki-books) - Book shop using Vue + Moltin + Tailwind CSS. :star:4
