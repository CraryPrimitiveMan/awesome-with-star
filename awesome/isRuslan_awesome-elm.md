...
* [Elm Flatris](https://github.com/w0rm/elm-flatris) - A Flatris clone in Elm language v0.18. :star:282
...
* [Elm cheat sheet](https://github.com/izdi/elm-cheat-sheet) - Syntax and features overview. :star:757
...
* [core](https://github.com/elm-lang/core) - Elm Core Libraries. :star:1739
...
* [http](https://github.com/elm-lang/http) - Make HTTP requests in Elm. :star:90
* [elm-http-builder](https://github.com/lukewestby/elm-http-builder) - Build and handle JSON requests more naturally than with low-level elm-http. :star:129
...
* [elm-mdl](https://github.com/debois/elm-mdl) - Material Design component library in Elm. With [demo](https://debois.github.io/elm-mdl/). :star:882
...
* [elm-bootstrap](https://github.com/rundis/elm-bootstrap) - Comprehensive Bootstrap 4 library for Elm. [Docs site](http://elm-bootstrap.info). :star:235
...
* [elm-compiler](https://github.com/elm-lang/elm-compiler) - Compiler for the Elm programming language. :star:4448
* [elm-make](https://github.com/elm-lang/elm-make) - A build tool for Elm projects. :star:164
* [elm-reactor](https://github.com/elm-lang/elm-reactor) - Interactive development tool that makes it easy to develop and debug Elm programs. :star:418
* [elm-live](https://github.com/tomekwi/elm-live) - A flexible dev server for Elm. Live reload included! :star:504
...
* [elm-format](https://github.com/avh4/elm-format) - Automatic Elm code formatter adhering to [Elm Style Guide](http://elm-lang.org/docs/style-guide). :star:905
* [grunt-elm](https://github.com/rtfeldman/grunt-elm) - Grunt plugin that compiles Elm files to JavaScript. :star:17
* [elm-webpack-loader](https://github.com/rtfeldman/elm-webpack-loader) - Webpack loader for the Elm programming language. :star:397
...
* [elm-analyse](https://github.com/stil4m/elm-analyse) - Linter for the Elm programming language. :star:226
* [run-elm](https://github.com/jfairbank/run-elm) — Run Elm code from the command line
* [type-o-rama](https://github.com/stereobooster/type-o-rama) - JS type systems interportability. :star:43
...
* [emmet-vim](https://github.com/mattn/emmet-vim) - Markup expansion with elm support. :star:4136
...
* [elm-webpack-starter](https://github.com/moarwick/elm-webpack-starter) - A simple Webpack setup for writing Elm apps. :star:845
...
* [create-elm-app](https://github.com/halfzebra/create-elm-app) - Create Elm apps with no build configuration. :star:793
