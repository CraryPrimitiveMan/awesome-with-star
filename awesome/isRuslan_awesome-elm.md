...
* [core](https://github.com/elm-lang/core) - Elm Core Libraries. :star:1654
* [html](https://github.com/elm-lang/html) - Use HTML in Elm, based on the idea of a "virtual DOM". :star:263
...
* [elm-ui](https://github.com/gdotdesign/elm-ui) - UI Library in Elm. :star:665
...
* [elm-compiler](https://github.com/elm-lang/elm-compiler) - Compiler for the Elm programming language. :star:4353
...
* [elm-format](https://github.com/avh4/elm-format) - Automatic Elm code formatter adhering to [Elm Style Guide](http://elm-lang.org/docs/style-guide). :star:880
...
* [create-elm-app](https://github.com/halfzebra/create-elm-app) - Create Elm apps with no build configuration. :star:733
...
* [Elm-vim](https://github.com/ElmCast/elm-vim) - Elm mode for vim. :star:385
* [vim-elm-help](https://github.com/hoelzro/vim-elm-help) - Offline Elm documentation access in your editor. :star:5
* [emmet-vim](https://github.com/mattn/emmet-vim) - Markup expansion with elm support. :star:4066
...
* [elm-webpack-starter](https://github.com/moarwick/elm-webpack-starter) - A simple Webpack setup for writing Elm apps. :star:829
