...
- [wlapi](https://github.com/arbox/wlapi) - Ruby client library for :star:19
  [Wortschatz Leipzig](http://wortschatz.uni-leipzig.de/de) web services.
- [monkeylearn-ruby](https://github.com/monkeylearn/monkeylearn-ruby) - Sentiment :star:74
...
- [stopwords-filter](https://github.com/brenes/stopwords-filter) - Filter and :star:62
...
- [Neural Machine Translation Implementations](https://github.com/jonsafari/nmt-list) :star:340
