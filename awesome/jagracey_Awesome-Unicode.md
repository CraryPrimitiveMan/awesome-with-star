...
- [ESReverser](https://github.com/mathiasbynens/esrever) - A Unicode-aware string reverser written in JavaScript. :star:557
- [mimic](https://github.com/reinderien/mimic) - [ab]using Unicode to create tragedy :star:3365
- [python-ftfy](https://github.com/LuminosoInsight/python-ftfy) - Given Unicode text, make its representation consistent and possibly less broken. :star:2210
