...
* [Babel](https://github.com/babel/babel) - Turn ES6+ code into vanilla ES5 with no runtime :star:34456
...
* [Lebab](https://github.com/mohebifar/lebab) - Transformations for ES5 code to ES6 (approximates) :star:4887
...
* [grunt-microlib](https://github.com/thomasboyt/grunt-microlib) - tools for libs using ES6 module transpiler (sample [Gruntfile](https://github.com/jakearchibald/es6-promise/blob/c3336087fffc52e66cf5398e5b56b23a291080fc/Gruntfile.js)) :star:6773
...
* [Babel Module Loader](https://github.com/babel/babel-loader) :star:3908
...
* [core-js](https://github.com/zloirock/core-js) - Modular and compact polyfills for ES6 including Symbols, Map, Set, Iterators, Promises, setImmediate, Array generics, etc. The standard library used by [Babel](https://github.com/babel/babel). :star:10071
* [es6-shim](https://github.com/paulmillr/es6-shim) - almost all new ES6 methods — from Map, Set, String, Array, Object, Object.is and more. :star:2877
...
* [`String.prototype.startsWith`](https://github.com/mathiasbynens/String.prototype.startsWith) :star:141
...
* [`Object.assign`](https://github.com/sindresorhus/object-assign) :star:829
...
* [es6-promise](https://github.com/jakearchibald/es6-promise) - polyfill for Promises matching the ES6 API :star:6773
...
* [ES6 shim](https://github.com/inexorabletash/polyfill/blob/master/es6.md) :star:1195
...
* [Esprima](http://esprima.org) - JavaScript parser supporting ES6, parses to [ESTree AST format](https://github.com/estree/estree) :star:2384
* [Acorn](https://github.com/ternjs/acorn) - A small, fast, JavaScript-based JavaScript parser with ES6 support, parses to [SpiderMonkey AST](https://developer.mozilla.org/en-US/docs/Mozilla/Projects/SpiderMonkey/Parser_API) format. :star:5175
