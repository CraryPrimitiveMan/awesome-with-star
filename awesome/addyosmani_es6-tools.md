...
* [Babel](https://github.com/babel/babel) - Turn ES6+ code into vanilla ES5 with no runtime :star:35417
* [Traceur compiler](https://github.com/google/traceur-compiler) - ES6 features > ES5. Includes classes, generators, promises, destructuring patterns, default parameters & more. :star:8041
...
* [babelify](https://github.com/babel/babelify) - Babel transpiler wrapped as a [Browserify](http://browserify.org/) transform :star:1636
...
* [Lebab](https://github.com/mohebifar/lebab) - Transformations for ES5 code to ES6 (approximates) :star:4989
...
* [grunt-microlib](https://github.com/thomasboyt/grunt-microlib) - tools for libs using ES6 module transpiler (sample [Gruntfile](https://github.com/jakearchibald/es6-promise/blob/c3336087fffc52e66cf5398e5b56b23a291080fc/Gruntfile.js)) :star:6854
...
* [Babel Module Loader](https://github.com/babel/babel-loader) :star:4038
...
* [core-js](https://github.com/zloirock/core-js) - Modular and compact polyfills for ES6 including Symbols, Map, Set, Iterators, Promises, setImmediate, Array generics, etc. The standard library used by [Babel](https://github.com/babel/babel). :star:11184
* [es6-shim](https://github.com/paulmillr/es6-shim) - almost all new ES6 methods — from Map, Set, String, Array, Object, Object.is and more. :star:2922
...
* [`String.prototype.startsWith`](https://github.com/mathiasbynens/String.prototype.startsWith) :star:142
* [`String.prototype.endsWith`](https://github.com/mathiasbynens/String.prototype.endsWith) :star:30
* [`String.prototype.at`](https://github.com/mathiasbynens/String.prototype.at) :star:49
...
* [`String.fromCodePoint`](https://github.com/mathiasbynens/String.fromCodePoint) :star:50
...
* [`Object.assign`](https://github.com/sindresorhus/object-assign) :star:840
...
* [es6-promise](https://github.com/jakearchibald/es6-promise) - polyfill for Promises matching the ES6 API :star:6854
...
* [ES6 shim](https://github.com/inexorabletash/polyfill/blob/master/es6.md) :star:1225
* [ES6 Symbol polyfill](https://github.com/medikoo/es6-symbol) :star:159
...
* [Esprima](http://esprima.org) - JavaScript parser supporting ES6, parses to [ESTree AST format](https://github.com/estree/estree) :star:2600
* [Acorn](https://github.com/ternjs/acorn) - A small, fast, JavaScript-based JavaScript parser with ES6 support, parses to [SpiderMonkey AST](https://developer.mozilla.org/en-US/docs/Mozilla/Projects/SpiderMonkey/Parser_API) format. :star:5532
...
* [ES.next showcase](https://github.com/sindresorhus/esnext-showcase) - real-world usage examples of ES6 features :star:302
