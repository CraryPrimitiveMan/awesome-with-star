...
- **Custom Elements** provide a way for authors to build their own fully-featured DOM elements.
  ...
  - [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/custom-elements) :star:2483
...
- **Shadow DOM** describes a method of combining multiple DOM trees into one hierarchy and how these trees interact with each other within a document, thus enabling better composition of the DOM.
  ...
  - [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/shadow-dom) :star:2483
...
- [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/css/css-shadow-parts) :star:2483
...
- [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/custom-elements/form-associated) :star:2483

#### Constructable Stylesheet Objects

- [Specification Draft](https://wicg.github.io/construct-stylesheets/)
- [web-platform-tests](https://github.com/web-platform-tests/wpt/blob/master/css/cssom/CSSStyleSheet-constructable.html) :star:2483
...
- [std-toast](https://github.com/jackbsteinberg/std-toast) - Proposal for `<std-toast>` HTML element implementing a 'toast' pop-up notification. :star:69
  - [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/std-toast) :star:2483
...
- [@webcomponents/custom-elements](https://github.com/webcomponents/polyfills/tree/master/packages/custom-elements) - Polyfill for HTML Custom Elements v1. :star:185
- [@webcomponents/shadydom](https://github.com/webcomponents/polyfills/tree/master/packages/shadydom) - ShadowDOM v1 shim. :star:185
- [@webcomponents/shadycss](https://github.com/webcomponents/polyfills/tree/master/packages/shadycss) - ShadowDOM style encapsulation shim. :star:185
- [@webcomponents/template](https://github.com/webcomponents/polyfills/tree/master/packages/template) - Minimal polyfill for `<template>`. :star:185
...
- [Shadow DOM in depth](https://github.com/praveenpuglia/shadow-dom-in-depth) :star:148
...
- [Gold Standard Checklist for Web Components](https://github.com/webcomponents/gold-standard/wiki) :star:782
...
- [Lightning Web Components](https://github.com/salesforce/lwc) - blazing fast, enterprise-grade Web Components foundation. :star:552
- [Omi](https://github.com/Tencent/omi) - Next generation web framework in 4kb JavaScript (Web Components + JSX + Proxy + Store + Path Updating). :star:9824
...
- [Skate](https://github.com/skatejs/skatejs) - Web component library focusing on a functional rendering pipeline and a small footprint. :star:3072
- [slim.js](https://github.com/slimjs/slim.js) - Fast & Robust Front-End Micro-framework based on modern standards. :star:665
...
- [reLift-HTML](https://github.com/mardix/relift-html) - Small (3kb) view library allowing to create Web Components and to make HTML pages reactive. :star:323
...
- [remount](https://github.com/rstacruz/remount) - Mount React components to the DOM using custom elements. :star:453
...
- [AMP HTML](https://github.com/ampproject/amphtml) - Web component library for building web pages that render with reliable and fast performance. :star:13148
...
- [Elix](https://github.com/elix/elix) - High-quality, customizable web components for common user interface patterns. :star:298
...
- [UI5 Web Components](https://github.com/SAP/ui5-webcomponents) - Components library providing the enterprise-flavored sugar on top of native APIs. :star:541
- [Vaadin components](https://github.com/vaadin/vaadin) - Evolving set of high-quality web components for building business web applications. :star:261
- [Wired Elements](https://github.com/wiredjs/wired-elements) - Set of common UI elements with a hand-drawn, sketchy look. :star:7498
...
- [Cypress Daywalker](https://github.com/JaySunSyn/cypress-daywalker) - Web Components and Shadow DOM support for Cypress. :star:53
...
- [web-components-examples](https://github.com/mdn/web-components-examples) - Series of web components examples, related to the MDN web components documentation. :star:760
