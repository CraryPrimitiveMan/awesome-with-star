...
- Database Honeypots
    ...
    - [Elastic honey](https://github.com/jordan-wright/elastichoney) - A Simple Elasticsearch Honeypot. :star:101
...
- Web honeypots
    - [Glastopf](https://github.com/mushorg/glastopf) - Web Application Honeypot. :star:312
    - Snare/Tanner - successors to Glastopf
      - [Snare](https://github.com/mushorg/snare) - Super Next generation Advanced Reactive honEypot :star:69
    ...
    - [Laravel Application Honeypot](https://github.com/msurguy/Honeypot) - Honeypot - Simple spam prevention package for Laravel applications. :star:298
    ...
    - [django-admin-honeypot](https://github.com/dmpayton/django-admin-honeypot) - A fake Django admin login screen to notify admins of attempted unauthorized access.  :star:411
...
- Service Honeypots
    ...
    - [HoneyPy](https://github.com/foospidy/HoneyPy) - A low interaction honeypot. :star:265
    - [Ensnare](https://github.com/ahoernecke/ensnare) - Easy to deploy Ruby honeypot. :star:67
    - [RDPy](https://github.com/citronneur/rdpy) - A Microsoft Remote Desktop Protocol (RDP) honeypot in python. :star:716
    - [Honeyprint](https://github.com/glaslos/honeyprint) - Printer honeypot. :star:7
...
- ICS/SCADA honeypots
    - [Conpot](https://github.com/mushorg/conpot) - ICS/SCADA honeypot. :star:387
    ...
    - [GasPot](https://github.com/sjhilt/GasPot) - Veeder Root Gaurdian AST, common in the oil and gas industry. :star:52
...
- Distributed sensor deployment
    ...
    - [Modern Honey Network](https://github.com/threatstream/mhn) - Multi-snort and honeypot sensor management, uses a network of VMs, small footprint SNORT installations, stealthy dionaeas, and a centralized server for management. :star:1326
...
- Honeypot for USB-spreading malware
    - [Ghost-usb](https://github.com/honeynet/ghost-usb-honeypot) -  honeypot for malware that propagates via USB storage devices. :star:45
...
- VM monitoring and tools
    ...
    - [Antivmdetect](https://github.com/nsmfoo/antivmdetection) - Script to create templates to use with VirtualBox to make vm detection harder. :star:218
    - [VMCloak](https://github.com/jbremer/vmcloak) - Automated Virtual Machine Generation and Cloaking for Cuckoo Sandbox. :star:212
...
- Mobile Analysis Tool
    ...
    - [Androguard](https://github.com/androguard/androguard) - Reverse engineering, Malware and goodware analysis of Android applications ... and more. :star:1814
...
- Server
    ...
    - [Heralding](https://github.com/johnnykv/heralding) - A credentials catching honeypot. :star:135
    ...
    - [telnetlogger](https://github.com/robertdavidgraham/telnetlogger) - A Telnet honeypot designed to track the Mirai botnet. :star:169
    ...
    - [portlurker](https://github.com/bartnv/portlurker) - Port listener / honeypot in Rust with protocol guessing and safe string display. :star:2
    - [arctic-swallow](https://github.com/ajackal/arctic-swallow) - a low interaction honeypot.
    - [glutton](https://github.com/mushorg/glutton) - All eating honeypot. :star:67
...
- PDF document inspector
    - [peepdf](https://github.com/jesparza/peepdf) :star:286
...
- SSH Honeypots
    ...
    - [Kippo](https://github.com/desaster/kippo) - Medium interaction SSH honeypot :star:997
    ...
    - [ssh-honeypot](https://github.com/droberson/ssh-honeypot) - Fake sshd that logs ip addresses, usernames, and passwords. :star:133
    ...
    - [sshesame](https://github.com/jaksi/sshesame) - A fake SSH server that lets everyone in and logs their activity. :star:818
...
- SSH proxy
    - [HonSSH](https://github.com/tnich/honssh) :star:252
...
- Spamtrap
    ...
    - [Shiva](https://github.com/shiva-spampot/shiva) - Spam Honeypot with Intelligent Virtual Analyzer :star:98
...
- Server (Bluetooth)
    - [Bluepot](https://github.com/andrewmichaelsmith/bluepot) :star:80
...
- Honeytokens
    - [Honeyλ](https://github.com/0x4D31/honeylambda) - honeyLambda 'serverless trap' is a simple, serverless application designed to create and monitor URL honeytokens, on top of AWS Lambda and Amazon API Gateway. :star:349
    ...
    - [dcept](https://github.com/secureworks/dcept) - A tool for deploying and detecting use of Active Directory honeytokens. :star:380
...
- Sandbox
    ...
    - [libemu](https://github.com/buffer/libemu) - Shellcode emulation library, useful for shellcode detection. :star:30
    - [Pylibemu](https://github.com/buffer/pylibemu) - A Libemu Cython wrapper. :star:92
    - [imalse](https://github.com/hbhzwj/imalse) - Integrated MALware Simulator and Emulator. :star:5
...
- Front Ends
    ...
    - [DionaeaFR](https://github.com/rubenespadas/DionaeaFR) - Front Web to Dionaea low-interaction honeypot. :star:36
...
- Visualization
    ...
    - [HoneyMap](https://github.com/fw42/honeymap) - Real-time websocket stream of GPS events on a fancy SVG world map.  :star:186
