...
- Database Honeypots
    ...
    - [NoSQLpot](https://github.com/torque59/nosqlpot) - The NoSQL Honeypot Framework. :star:85
...
- Web honeypots
    - [Glastopf](https://github.com/mushorg/glastopf) - Web Application Honeypot. :star:322
    ...
    - [Laravel Application Honeypot](https://github.com/msurguy/Honeypot) - Honeypot - Simple spam prevention package for Laravel applications. :star:308
    ...
    - [django-admin-honeypot](https://github.com/dmpayton/django-admin-honeypot) - A fake Django admin login screen to notify admins of attempted unauthorized access.  :star:433
    - [WebTrap](https://github.com/IllusiveNetworks-Labs/WebTrap) - Designed to create deceptive webpages to deceive and redirect attackers away from real websites. :star:17
    - WordPress honeypots
        ...
        - [wordpot](https://github.com/gbrindisi/wordpot) - A WordPress Honeypot. :star:109
...
- Service Honeypots
    ...
    - [HoneyPy](https://github.com/foospidy/HoneyPy) - A low interaction honeypot. :star:277
    - [Ensnare](https://github.com/ahoernecke/ensnare) - Easy to deploy Ruby honeypot. :star:67
    - [RDPy](https://github.com/citronneur/rdpy) - A Microsoft Remote Desktop Protocol (RDP) honeypot in python. :star:771
    ...
    - [honeytrap](https://github.com/honeytrap/honeytrap) - Advanced Honeypot framework written in Go. Can be connected up with other Honeypot software. :star:315
...
- ICS/SCADA honeypots
    - [Conpot](https://github.com/mushorg/conpot) - ICS/SCADA honeypot. :star:411
...
- Other/random
    ...
    - [OpenCanary](https://github.com/thinkst/opencanary) - Modular and decentralised honeypot. :star:288
...
- Distributed sensor deployment
    ...
    - [Modern Honey Network](https://github.com/threatstream/mhn) - Multi-snort and honeypot sensor management, uses a network of VMs, small footprint SNORT installations, stealthy dionaeas, and a centralized server for management. :star:1378
...
- VM monitoring and tools
    ...
    - [Antivmdetect](https://github.com/nsmfoo/antivmdetection) - Script to create templates to use with VirtualBox to make vm detection harder. :star:236
    - [VMCloak](https://github.com/jbremer/vmcloak) - Automated Virtual Machine Generation and Cloaking for Cuckoo Sandbox. :star:221

- Binary debugger
    - [Hexgolems - Schem Debugger Frontend](https://github.com/hexgolems/schem) - A debugger frontend. :star:138
...
- Mobile Analysis Tool
    ...
    - [Androguard](https://github.com/androguard/androguard) - Reverse engineering, Malware and goodware analysis of Android applications ... and more. :star:1881
...
- Server
    ...
    - [Hontel](https://github.com/stamparm/hontel) - Telnet Honeypot. :star:83
    - [MTPot](https://github.com/Cymmetria/MTPot) - Open Source Telnet Honeypot, focused on Mirai malware. :star:83
    - [Heralding](https://github.com/johnnykv/heralding) - A credentials catching honeypot. :star:149
    ...
    - [honeytrap](https://github.com/tillmannw/honeytrap) - a low-interaction honeypot and network security tool written to catch attacks against TCP and UDP services. :star:64
    ...
    - [glutton](https://github.com/mushorg/glutton) - All eating honeypot. :star:73
...
- Client
    - [Pwnypot](https://github.com/shjalayeri/pwnypot) - High Interaction Client Honeypot :star:29
...
- PDF document inspector
    - [peepdf](https://github.com/jesparza/peepdf) :star:299
...
- SSH Honeypots
    ...
    - [Kippo](https://github.com/desaster/kippo) - Medium interaction SSH honeypot :star:1015
    ...
    - [sshhipot](https://github.com/magisterquis/sshhipot) - High-interaction MitM SSH honeypot :star:115
    ...
    - [ssh-honeypot](https://github.com/droberson/ssh-honeypot) - Fake sshd that logs ip addresses, usernames, and passwords. :star:146
    ...
    - [sshesame](https://github.com/jaksi/sshesame) - A fake SSH server that lets everyone in and logs their activity. :star:831
    - [sshsyrup](https://github.com/mkishere/sshsyrup) - A simple SSH Honeypot with features to capture terminal activity and upload to asciinema.org :star:61
...
- SSH proxy
    - [HonSSH](https://github.com/tnich/honssh) :star:253
...
- IOT Honeypot
    - [HoneyThing](https://github.com/omererdem/honeything) - TR-069 Honeypot :star:54

- Honeytokens
    - [Honeyλ](https://github.com/0x4D31/honeylambda) - honeyLambda 'serverless trap' is a simple, serverless application designed to create and monitor URL honeytokens, on top of AWS Lambda and Amazon API Gateway. :star:367
    ...
    - [dcept](https://github.com/secureworks/dcept) - A tool for deploying and detecting use of Active Directory honeytokens. :star:383
...
- Sandbox
    ...
    - [Pylibemu](https://github.com/buffer/pylibemu) - A Libemu Cython wrapper. :star:91
...
- Visualization
    ...
    - [The Intelligent HoneyNet](https://github.com/jpyorre/IntelligentHoneyNet) - The Intelligent Honey Net Project attempts to create actionable information from honeypots. :star:37
