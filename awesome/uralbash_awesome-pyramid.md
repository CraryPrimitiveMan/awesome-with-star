...
* [aiopyramid](https://github.com/housleyjk/aiopyramid) - Run pyramid using :star:73
  asyncio.
* [gevent-socketio](https://github.com/abourget/gevent-socketio) -
  ...
  languages.
* [Stargate](https://github.com/boothead/stargate) - Stargate is a package for :star:39
  adding WebSockets support to pyramid applications using the excellent
  eventlet library for long running connections.
* [channelstream](https://github.com/AppEnlight/channelstream) - websocket communication server (gevent). :star:19
...
* [Python Social Auth](https://github.com/omab/python-social-auth) - Social :star:2752
...
* [Authomatic](https://github.com/authomatic/authomatic) -  Simple yet powerful :star:884
...
* [pyramid_authsanity](https://github.com/usingnamespace/pyramid_authsanity) -
  ...
  to use backend.
* [pyramid_jwt](https://github.com/wichert/pyramid_jwt) - This package :star:53
...
* [pyramid_mailer](https://github.com/Pylons/pyramid_mailer) - A package for :star:51
...
* [deform](https://github.com/Pylons/deform) - is a Python HTML form generation :star:304
  library.
* [colander](https://github.com/Pylons/colander) - A :star:339
  serialization/deserialization/validation library for strings, mappings and
  lists.
* [WTForms](https://github.com/wtforms/wtforms) - is a flexible forms :star:864
...
* [ColanderAlchemy](https://github.com/stefanofontanelli/ColanderAlchemy) -
  ...
  mapped classes.
* [marshmallow](https://github.com/marshmallow-code/marshmallow) - A :star:2991
...
* [pyramid_storage](https://github.com/danjac/pyramid_storage) - This is a package for handling file uploads in your Pyramid framework application. :star:10

## RESTful API

*Packages for developing RESTful APIs.*

* [cornice](https://github.com/Cornices/cornice) - provides helpers to :star:333
...
* [cliquet](https://github.com/mozilla-services/cliquet) - Cliquet is a toolkit :star:68
  ...
  APIs.
* [webargs](https://github.com/sloria/webargs) - A friendly library for parsing :star:683
  HTTP request arguments, with built-in support for popular web frameworks.
* [ramses](https://github.com/ramses-tech/ramses) - Generate a RESTful API using :star:294
  RAML. It uses Nefertari which provides ElasticSearch-powered views.
* [nefertari](https://github.com/ramses-tech/nefertari) -  Nefertari is a REST :star:56
...
* [pyramid_jsonapi](https://github.com/colinhiggs/pyramid-jsonapi) - Automatically  :star:19
  create a [JSON API](http://jsonapi.org/) standard API from a database using the
  sqlAlchemy ORM and pyramid framework.
* [pyramid_apispec](https://github.com/ergo/pyramid_apispec) - Create an OpenAPI :star:7
...
* [hypatia](https://github.com/Pylons/hypatia) - A Python indexing and :star:28
  searching system.
...
* [pyramid_services](https://github.com/mmerickel/pyramid_services) - defines a :star:66
  pattern and helper methods for accessing a pluggable service layer from
  within your Pyramid apps.
* [hupper](https://github.com/Pylons/hupper) - A process monitor/reloader for developers :star:80
...
* [pyramid_celery](https://github.com/sontek/pyramid_celery) - Pyramid :star:94
...
* [pyramid_chameleon](https://github.com/Pylons/pyramid_chameleon) - Chameleon :star:11
...
* [Kajiki](https://github.com/nandoflorestan/kajiki) - provides fast well-formed XML templates, with [Pyramid integration](https://github.com/nandoflorestan/kajiki/blob/master/kajiki/integration/pyramid.py) :star:18

## Testing

*Packages that help test code or generate test data.*

* [webtest](https://github.com/Pylons/webtest) - Wraps any WSGI application and :star:236
...
* [PyramidVue](https://github.com/eddyekofo94/pyramidVue) - Pyramid and VueJs (JavaScript) template with Hot-Module-Replacement starter template. :star:22
...
* [waitress](https://github.com/Pylons/waitress) - Waitress is meant to be a :star:464
...
* [pyramid_rpc](https://github.com/Pylons/pyramid_rpc) - RPC service add-on for :star:23
...
* [pyramid_pages](https://github.com/uralbash/pyramid_pages) - Provides a :star:10
  ...
  in URL dispath.
* [paginate](https://github.com/Pylons/paginate) - Python pagination module. :star:39
...
* [nive_cms](https://github.com/nive/nive_cms) - Nive is professional out the :star:14
...
* [substanced](https://github.com/Pylons/substanced) - An application server :star:137
  ...
  create applications.
* [Kotti](https://github.com/Kotti/Kotti) - A user-friendly, light-weight and :star:323
...
* [shootout](https://github.com/Pylons/shootout) - An example “idea :star:104
...
* [warehouse](https://github.com/pypa/warehouse) - Warehouse is a next :star:1972
  generation Python Package Repository designed to replace the legacy code base
  that currently powers PyPI.
* [travelcrm](https://github.com/mazvv/travelcrm) - TravelCRM is effective free and open source application for the automation of customer relationships for travel agencies at all levels, from small to large networks. :star:17
