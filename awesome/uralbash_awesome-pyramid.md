...
* [pyramid_sacrud](https://github.com/sacrud/pyramid_sacrud) -    Pyramid CRUD interface. :star:44
...
* [deform](https://github.com/Pylons/deform) - is a Python HTML form generation :star:291
  library.
* [colander](https://github.com/Pylons/colander) - A :star:319
  serialization/deserialization/validation library for strings, mappings and
  lists.
* [WTForms](https://github.com/wtforms/wtforms) - is a flexible forms :star:786
...
* [ColanderAlchemy](https://github.com/stefanofontanelli/ColanderAlchemy) -
  ...
  mapped classes.
* [marshmallow](https://github.com/marshmallow-code/marshmallow) - A :star:2434
...
* [cliquet](https://github.com/mozilla-services/cliquet) - Cliquet is a toolkit :star:69
  ...
  APIs.
* [webargs](https://github.com/sloria/webargs) - A friendly library for parsing :star:582
  HTTP request arguments, with built-in support for popular web frameworks.
* [ramses](https://github.com/ramses-tech/ramses) - Generate a RESTful API using :star:285
...
* [pyramid_swagger](https://github.com/striglia/pyramid_swagger) - Convenient :star:57
...
* [pyramid_services](https://github.com/mmerickel/pyramid_services) - defines a :star:58
  pattern and helper methods for accessing a pluggable service layer from
  within your Pyramid apps.
* [hupper](https://github.com/Pylons/hupper) - A process monitor/reloader for developers :star:57
...
* [webtest](https://github.com/Pylons/webtest) - Wraps any WSGI application and :star:219
...
* [waitress](https://github.com/Pylons/waitress) - Waitress is meant to be a :star:397
...
* [warehouse](https://github.com/pypa/warehouse) - Warehouse is a next :star:1627
