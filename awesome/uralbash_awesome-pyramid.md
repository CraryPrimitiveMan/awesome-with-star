...
* [pyramid_sacrud](https://github.com/sacrud/pyramid_sacrud) -    Pyramid CRUD interface. :star:43
...
* [Python Social Auth](https://github.com/omab/python-social-auth) - Social :star:2727
...
* [Authomatic](https://github.com/authomatic/authomatic) -  Simple yet powerful :star:844
...
* [pyramid_authsanity](https://github.com/usingnamespace/pyramid_authsanity) -
  ...
  to use backend.
* [pyramid_jwt](https://github.com/wichert/pyramid_jwt) - This package :star:42
...
* [deform](https://github.com/Pylons/deform) - is a Python HTML form generation :star:288
  library.
* [colander](https://github.com/Pylons/colander) - A :star:315
  ...
  lists.
* [WTForms](https://github.com/wtforms/wtforms) - is a flexible forms :star:766
...
* [ColanderAlchemy](https://github.com/stefanofontanelli/ColanderAlchemy) -
  ...
  mapped classes.
* [marshmallow](https://github.com/marshmallow-code/marshmallow) - A :star:2271
...
* [cornice](https://github.com/Cornices/cornice) - provides helpers to :star:318
...
* [cliquet](https://github.com/mozilla-services/cliquet) - Cliquet is a toolkit :star:69
  ...
  APIs.
* [webargs](https://github.com/sloria/webargs) - A friendly library for parsing :star:568
...
* [pyramid_swagger](https://github.com/striglia/pyramid_swagger) - Convenient :star:56
  tools for using Swagger to define and validate your interfaces in a Pyramid webapp.
* [pyramid_jsonapi](https://github.com/colinhiggs/pyramid-jsonapi) - Automatically  :star:13
...
* [hypatia](https://github.com/Pylons/hypatia) - A Python indexing and :star:26
  searching system.
...
* [hupper](https://github.com/Pylons/hupper) - A process monitor/reloader for developers :star:52
...
* [webtest](https://github.com/Pylons/webtest) - Wraps any WSGI application and :star:213
...
* [lingua](https://github.com/wichert/lingua) - Lingua is a package with tools :star:43
...
* [waitress](https://github.com/Pylons/waitress) - Waitress is meant to be a :star:383
...
* [cone.app](https://github.com/bluedynamics/cone.app) - A comprehensive web application stub on top of Pyramid. :star:6
...
* [substanced](https://github.com/Pylons/substanced) - An application server :star:131
...
* [shootout](https://github.com/Pylons/shootout) - An example “idea :star:100
...
* [warehouse](https://github.com/pypa/warehouse) - Warehouse is a next :star:1433
