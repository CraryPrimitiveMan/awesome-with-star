...
* [pyramid_sacrud](https://github.com/sacrud/pyramid_sacrud) -    Pyramid CRUD interface. :star:49
...
* [channelstream](https://github.com/AppEnlight/channelstream) - websocket communication server (gevent). :star:52
...
* [pyramid_ldap3](https://github.com/Cito/pyramid_ldap3) - Provides LDAP authentication :star:11
...
* [Python Social Auth](https://github.com/omab/python-social-auth) - Social :star:2787
...
* [Authomatic](https://github.com/authomatic/authomatic) -  Simple yet powerful :star:942
...
* [pyramid_authsanity](https://github.com/usingnamespace/pyramid_authsanity) -
  ...
  to use backend.
* [pyramid_jwt](https://github.com/wichert/pyramid_jwt) - This package :star:64
...
* [horus](https://github.com/Pylons/horus) - User registration and login system :star:14
...
* [deform](https://github.com/Pylons/deform) - is a Python HTML form generation :star:331
  library.
* [colander](https://github.com/Pylons/colander) - A :star:387
  serialization/deserialization/validation library for strings, mappings and
  lists.
* [WTForms](https://github.com/wtforms/wtforms) - is a flexible forms :star:1099
...
* [ColanderAlchemy](https://github.com/stefanofontanelli/ColanderAlchemy) -
  ...
  mapped classes.
* [marshmallow](https://github.com/marshmallow-code/marshmallow) - A :star:4664
...
* [cornice](https://github.com/Cornices/cornice) - provides helpers to :star:360
...
* [cliquet](https://github.com/mozilla-services/cliquet) - Cliquet is a toolkit :star:67
  ...
  APIs.
* [webargs](https://github.com/sloria/webargs) - A friendly library for parsing :star:1009
  HTTP request arguments, with built-in support for popular web frameworks.
* [ramses](https://github.com/ramses-tech/ramses) - Generate a RESTful API using :star:305
...
* [pyramid_swagger](https://github.com/striglia/pyramid_swagger) - Convenient :star:64
  tools for using Swagger to define and validate your interfaces in a Pyramid webapp. (Swagger 2.0 document)
* [pyramid-openapi3](https://github.com/niteoweb/pyramid_openapi3) - Validate Pyramid views against an OpenAPI 3.0 document. Similar to pyramid_swagger but for OpenAPI 3.0. :star:47
* [pyramid_jsonapi](https://github.com/colinhiggs/pyramid-jsonapi) - Automatically  :star:25
...
* [pyramid_services](https://github.com/mmerickel/pyramid_services) - defines a :star:74
  pattern and helper methods for accessing a pluggable service layer from
  within your Pyramid apps.
* [hupper](https://github.com/Pylons/hupper) - A process monitor/reloader for developers :star:130
...
* [pyramid_tm](https://github.com/Pylons/pyramid_tm) - Centralized transaction :star:32
...
* [pyramid_celery](https://github.com/sontek/pyramid_celery) - Pyramid :star:97
...
* [pyramid_jinja2](https://github.com/Pylons/pyramid_jinja2) - Jinja2 :star:72
...
* [Kajiki](https://github.com/nandoflorestan/kajiki) - provides fast well-formed XML templates, with [Pyramid integration](https://github.com/nandoflorestan/kajiki/blob/master/kajiki/integration/pyramid.py) :star:29

## Testing

*Packages that help test code or generate test data.*

* [webtest](https://github.com/Pylons/webtest) - Wraps any WSGI application and :star:278
...
* [PyramidVue](https://github.com/eddyekofo94/pyramidVue) - Pyramid and VueJs (JavaScript) template with Hot-Module-Replacement starter template. :star:27
...
* [pyramid_layout](https://github.com/Pylons/pyramid_layout) - Pyramid add-on :star:25
  for managing UI layouts.
* [pyramid_skins](https://github.com/Pylons/pyramid_skins) - This package :star:1
  provides a simple framework to integrate code with templates and resources.
* [waitress](https://github.com/Pylons/waitress) - Waitress is meant to be a :star:751
...
* [pyramid_rpc](https://github.com/Pylons/pyramid_rpc) - RPC service add-on for :star:26
...
* [pyramid_pages](https://github.com/uralbash/pyramid_pages) - Provides a :star:11
  ...
  in URL dispath.
* [paginate](https://github.com/Pylons/paginate) - Python pagination module. :star:48
...
* [substanced](https://github.com/Pylons/substanced) - An application server :star:141
  ...
  create applications.
* [Kotti](https://github.com/Kotti/Kotti) - A user-friendly, light-weight and :star:348
...
* [cluegun](https://github.com/Pylons/cluegun) - A simple pastebin application :star:26
...
* [Khufu Project](http://khufuproject.github.io/) - Khufu is an application
  ...
  SQLAlchemy.
* [Ptah](https://github.com/ptahproject/ptah) - Ptah is a fast, fun, open :star:71
  source high-level Python web development environment.
* [warehouse](https://github.com/pypa/warehouse) - Warehouse is a next :star:2403
  generation Python Package Repository designed to replace the legacy code base
  that currently powers PyPI.
* [travelcrm](https://github.com/mazvv/travelcrm) - TravelCRM is effective free and open source application for the automation of customer relationships for travel agencies at all levels, from small to large networks. :star:21
