# Info come from [webpro/awesome-dotfiles](https://github.com/webpro/awesome-dotfiles)
# Awesome dotfiles
...
* [Bork](https://github.com/mattly/bork) - Bash DSL for config management. :star:198
* [dotbot](https://github.com/anishathalye/dotbot) - Tool that bootstraps your dotfiles. :star:1428
* [dotdrop](https://github.com/deadc0de6/dotdrop) - Save your dotfiles once, deploy them everywhere. :star:92
* [dotfiles](https://github.com/jbernard/dotfiles) - Tool to make managing your dotfile symlinks in $HOME easy. :star:345
* [Ellipsis](https://github.com/ellipsis/ellipsis) - A package manager for dotfiles. :star:203
...
* [homesick](https://github.com/technicalpickles/homesick) - Your home directory is your castle. Don't leave your dotfiles behind ([article](https://technicalpickles.com/posts/never-leave-your-dotfiles-behind-again-with-homesick)). :star:1959
* [mackup](https://github.com/lra/mackup) - Keep your application settings in sync (OS X/Linux). :star:6682
* [rcm](https://github.com/thoughtbot/rcm) - rc file (dotfile) management :star:1713
...
* [themer](https://github.com/mjswensen/themer) - Manage and generate themes across your development tools from within your dotfiles. :star:1302
* [vcsh](https://github.com/RichiH/vcsh) - Version Control System for $HOME, multiple Git repositories in $HOME. :star:1335
* [yadm](https://github.com/TheLocehiliosan/yadm) - Tool for managing a collection of files across multiple computers, using a shared Git repository and some additional features. :star:547

### macOS

* [Cider](https://github.com/msanders/cider) - Hassle-free bootstrapping with Homebrew. :star:782
* [dockutil](https://github.com/kcrawford/dockutil) - Command line tool for managing dock items :star:521
* [mas](https://github.com/mas-cli/mas) - Mac App Store command line interface :star:3902
...
* [OS X Defaults](https://github.com/kevinSuttle/macOS-Defaults) - Centralized place for the awesome work started by [@mathiasbynens on .osx](https://github.com/mathiasbynens/dotfiles#sensible-os-x-defaults). :star:439

## Related Lists

* [Awesome Shell](https://github.com/alebcay/awesome-shell) - Curated list of awesome command-line frameworks, toolkits, guides and gizmos. :star:11244
* [Awesome Zsh Plugins](https://github.com/unixorn/awesome-zsh-plugins) - List of Zsh plugins suitable for use with oh-my-zsh, antigen & Prezto. :star:3622
* [Awesome Dev Env](https://github.com/jondot/awesome-devenv) - Curated list of awesome tools, resources and workflow tips making an awesome development environment. :star:990

## Archive/abandoned projects

* [Bashstrap](https://github.com/barryclark/bashstrap) :star:1464
...
* [Kevin's dotfiles](https://github.com/kdeldycke/dotfiles) :star:50
