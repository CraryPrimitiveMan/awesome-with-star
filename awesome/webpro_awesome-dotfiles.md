...
* [Bork](https://github.com/mattly/bork) - Bash DSL for config management. :star:218
* [dotbot](https://github.com/anishathalye/dotbot) - Tool that bootstraps your dotfiles. :star:1672
...
* [mackup](https://github.com/lra/mackup) - Keep your application settings in sync (OS X/Linux). :star:7154
* [rcm](https://github.com/thoughtbot/rcm) - rc file (dotfile) management :star:1825
...
* [themer](https://github.com/mjswensen/themer) - Manage and generate themes across your development tools from within your dotfiles. :star:1599
* [vcsh](https://github.com/RichiH/vcsh) - Version Control System for $HOME, multiple Git repositories in $HOME. :star:1383
* [yadm](https://github.com/TheLocehiliosan/yadm) - Tool for managing a collection of files across multiple computers, using a shared Git repository and some additional features. :star:696

### macOS

* [Cider](https://github.com/msanders/cider) - Hassle-free bootstrapping with Homebrew. :star:801
* [dockutil](https://github.com/kcrawford/dockutil) - Command line tool for managing dock items :star:572
* [mas](https://github.com/mas-cli/mas) - Mac App Store command line interface :star:4449
...
* [OS X Defaults](https://github.com/kevinSuttle/macOS-Defaults) - Centralized place for the awesome work started by [@mathiasbynens on .osx](https://github.com/mathiasbynens/dotfiles#sensible-os-x-defaults). :star:505

## Related Lists

* [Awesome Shell](https://github.com/alebcay/awesome-shell) - Curated list of awesome command-line frameworks, toolkits, guides and gizmos. :star:12413
* [Awesome Zsh Plugins](https://github.com/unixorn/awesome-zsh-plugins) - List of Zsh plugins suitable for use with oh-my-zsh, antigen & Prezto. :star:4310
