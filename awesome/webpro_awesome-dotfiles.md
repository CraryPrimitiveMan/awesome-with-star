...
* [Bork](https://github.com/mattly/bork) - Bash DSL for config management. :star:216
* [dotbot](https://github.com/anishathalye/dotbot) - Tool that bootstraps your dotfiles. :star:1637
* [dotdrop](https://github.com/deadc0de6/dotdrop) - Save your dotfiles once, deploy them everywhere. :star:173
* [dotfiles](https://github.com/jbernard/dotfiles) - Tool to make managing your dotfile symlinks in $HOME easy. :star:363
* [Ellipsis](https://github.com/ellipsis/ellipsis) - A package manager for dotfiles. :star:232
...
* [homesick](https://github.com/technicalpickles/homesick) - Your home directory is your castle. Don't leave your dotfiles behind ([article](https://technicalpickles.com/posts/never-leave-your-dotfiles-behind-again-with-homesick)). :star:2011
* [mackup](https://github.com/lra/mackup) - Keep your application settings in sync (OS X/Linux). :star:7110
* [rcm](https://github.com/thoughtbot/rcm) - rc file (dotfile) management :star:1805
...
* [themer](https://github.com/mjswensen/themer) - Manage and generate themes across your development tools from within your dotfiles. :star:1585
* [vcsh](https://github.com/RichiH/vcsh) - Version Control System for $HOME, multiple Git repositories in $HOME. :star:1376
* [yadm](https://github.com/TheLocehiliosan/yadm) - Tool for managing a collection of files across multiple computers, using a shared Git repository and some additional features. :star:672

### macOS

* [Cider](https://github.com/msanders/cider) - Hassle-free bootstrapping with Homebrew. :star:799
* [dockutil](https://github.com/kcrawford/dockutil) - Command line tool for managing dock items :star:564
* [mas](https://github.com/mas-cli/mas) - Mac App Store command line interface :star:4398
...
* [OS X Defaults](https://github.com/kevinSuttle/macOS-Defaults) - Centralized place for the awesome work started by [@mathiasbynens on .osx](https://github.com/mathiasbynens/dotfiles#sensible-os-x-defaults). :star:493

## Related Lists

* [Awesome Shell](https://github.com/alebcay/awesome-shell) - Curated list of awesome command-line frameworks, toolkits, guides and gizmos. :star:12249
* [Awesome Zsh Plugins](https://github.com/unixorn/awesome-zsh-plugins) - List of Zsh plugins suitable for use with oh-my-zsh, antigen & Prezto. :star:4191
* [Awesome Dev Env](https://github.com/jondot/awesome-devenv) - Curated list of awesome tools, resources and workflow tips making an awesome development environment. :star:1132

## Archive/abandoned projects

* [Bashstrap](https://github.com/barryclark/bashstrap) :star:1483
* [battleschool](https://github.com/spencergibb/battleschool) :star:423
* [Eduardo's dotfiles](https://github.com/eduardolundgren/dotfiles) :star:421
* [Kevin's dotfiles](https://github.com/kdeldycke/dotfiles) :star:57
* [kody](https://github.com/jh3y/kody) :star:74
