...
* [bspwm](https://github.com/baskerville/bspwm) - Tiling window manager that represents windows as the leaves of a full binary tree. :star:2094
...
* [Spice-Up](https://github.com/Philip-Scott/Spice-up) - Desktop presentation app. :star:286
...
* [ramme](https://github.com/terkelg/ramme) - Instagram client. :star:2736
* [ScudCloud](https://github.com/raelgc/scudcloud/) - Slack client with additional features (compared to the original Slack client).
* [Whatever](https://github.com/CellarD0-0r/whatever) - Evernote client based on the web version. :star:292
...
* [AppImageKit](https://github.com/probonopd/AppImageKit) - Using AppImageKit you can package applications in the [AppImage](http://appimage.org/) format that runs on common Linux-based operating systems, such as RHEL, CentOS, Ubuntu, Fedora, debian and derivatives; one app = one file. :star:2966
...
* [fuck](https://github.com/nvbn/thefuck) - Command line tool which corrects your previously mistyped command. :star:35083
...
* [ranger](https://github.com/ranger/ranger) - Vim-inspired file manager for the console. :star:3541
* [screenFetch](https://github.com/KittyKatt/screenFetch) - Fetches system/theme information in terminal. :star:2060
* [shellcheck](https://github.com/koalaman/shellcheck) - Static analysis tool for shell scripts. :star:10726
* [speed-test](https://github.com/sindresorhus/speed-test) - Test your Internet connection speed and ping using [speedtest.net](http://www.speedtest.net/). :star:2948
...
* [wavemon](https://github.com/uoaerg/wavemon) - Monitoring application for wireless network devices. :star:187
* [youtube-dl](https://github.com/rg3/youtube-dl) - A tool to download videos from YouTube and other video sites. :star:36495
