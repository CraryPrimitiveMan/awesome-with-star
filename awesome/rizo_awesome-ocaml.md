...
- [Base](https://github.com/janestreet/base) - Jane Street Capital's dependency-free, quick-compiling, fully-portable across any environment that can run OCaml code standard library. :star:181
...
- [infer](https://github.com/facebook/infer) - infer is a static analyzer for Java, C and Objective-C :star:8269
- [flow](https://github.com/facebook/flow) - flow is a static type checker for JavaScript :star:16032
...
- [BAP](https://github.com/BinaryAnalysisPlatform/bap) - BAP is a reverse engineering and program analysis platform that targets binary programs. :star:617
...
- **Editor Integration**:
  ...
  - [vscode-ocaml](https://github.com/hackwaly/vscode-ocaml/) – extension that provides OCaml language support for [VSCode](https://github.com/microsoft/vscode) :star:47367
...
- **Tools**:
  ...
  - [BuckleScript](https://github.com/bloomberg/bucklescript) - BuckleScript is backend for OCaml to generate debuggable Javascript. It enables OCaml to integrate Javascript platform in a seamless way. :star:3534
