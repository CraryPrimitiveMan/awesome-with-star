...
- [infer](https://github.com/facebook/infer) - infer is a static analyzer for Java, C and Objective-C :star:8193
- [flow](https://github.com/facebook/flow) - flow is a static type checker for JavaScript :star:15694
...
- **Editor Integration**:
  ...
  - [vscode-ocaml](https://github.com/hackwaly/vscode-ocaml/) – extension that provides OCaml language support for [VSCode](https://github.com/microsoft/vscode) :star:45734
...
- **Tools**:
  ...
  - [BuckleScript](https://github.com/bloomberg/bucklescript) - BuckleScript is backend for OCaml to generate debuggable Javascript. It enables OCaml to integrate Javascript platform in a seamless way. :star:3464
