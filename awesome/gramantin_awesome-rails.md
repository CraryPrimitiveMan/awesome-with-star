...
- [whitehall](https://github.com/alphagov/whitehall) - A content management app used by UK government - **using Rails 5.1** :star:573
...
- [Nanobox](https://github.com/nanobox-io/nanobox) - A micro-PaaS (μPaaS) for creating consistent, isolated, development environments deployable anywhere [:earth_africa:](https://nanobox.io). :star:1427
...
- [rails-dashboard](https://github.com/y-takey/rails-dashboard) - A dev-tool to improve your rails log. :star:94
