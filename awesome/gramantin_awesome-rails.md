...
- [Rails Source Code](https://github.com/rails/rails) :star:44869
...
- [Protecting your users data from Rails application using cryptography](https://github.com/cossacklabs/acra/wiki/Using-Acra-to-Protect-Your-Rails-App) :star:526
...
- [activeWorkflow](https://github.com/automaticmode/active_workflow) - An intelligent process and workflow automation platform based on software agents - **using Rails 5.2** :star:209
- [adopt-a-hydrant](https://github.com/codeforamerica/adopt-a-hydrant) - A civic infrastructure detection app - **using Rails 4.2** :star:493
...
- [blackCandy](https://github.com/aidewoode/black_candy) - A music streaming app - **using Rails 6.0** :star:495
...
- [canvas-lms](https://github.com/instructure/canvas-lms) - A learning management app - **using Rails 5.2** :star:3057
...
- [ciao](https://github.com/brotandgames/ciao) - A URL status checking app - **using Rails 6.0** :star:1027
- [coRM](https://github.com/SIGIRE/CoRM) - A customer relationship management app - **using Rails 3.2** - [:earth_africa:](http://www.corm.fr)
- [coderwall (legacy)](https://github.com/coderwall/coderwall-legacy) - A social network app for software engineers - **using Rails 3.2** :star:864
- [coderwall (next)](https://github.com/coderwall/coderwall-next) - A social network app for software engineers - **using Rails 5.0** :star:167
...
- [coursemology2](https://github.com/Coursemology/coursemology2) - Learning platform app - **using Rails 5.2** :star:82
- [covoiturage-libre](https://github.com/covoiturage-libre/covoiturage-libre) - A carpooling app - **using Rails 5.0** - **archived** :star:103
...
- [crowdtiltOpen](https://github.com/Crowdtilt/CrowdtiltOpen) - A crowdfunding platform - **using Rails 3.2** :star:593
- [danbooru](https://github.com/danbooru/danbooru) - A taggable image board app - **using Rails 6.0** :star:788
...
- [dgi-db](https://github.com/griffithlab/dgi-db) - A drug gene interaction platform - **using Rails 5.1** :star:58
...
- [ekylibre](https://github.com/ekylibre/ekylibre) - A farm management app - **using Rails 4.2** :star:211
- [postal](https://github.com/postalhq/postal) - A mail delivery platform - **using Rails 5.2** :star:9431
...
- [expertiza](https://github.com/expertiza/expertiza) - A learning material sharing app - **using Rails 4.2** :star:151
...
- [gitlabhq](https://github.com/gitlabhq/gitlabhq) -  A code collaboration app - **using Rails 5.2** :star:22129
...
- [intercityup.com](https://github.com/intercity/intercity-next) - A control panel app for app deployment - **using Rails 4.1** :star:80
...
- [lavish](https://github.com/mquan/lavish) - A color scheme generator - **using Rails 4.2** :star:700
...
- [obtvse2](https://github.com/natew/obtvse2) - A blogging app - **using Rails 4.0** :star:266
...
- [openFarm](https://github.com/openfarmcc/OpenFarm) -  A database for information about farming and gardening - **using Rails 5.2** - :star:682
...
- [popHealth](https://github.com/pophealth/popHealth) -  A population health reporting app - **using Rails 4.1** :star:122
...
- [rentmybikes-rails](https://github.com/balanced/rentmybikes-rails) - A marketplace app - - **using Rails 4.0** :star:60
...
- [scholarsphere](https://github.com/psu-stewardship/scholarsphere) - A digital assets management app - **using Rails 5.1** :star:75
...
- [socify](https://github.com/scaffeinate/socify) - A social networking platform - **using Rails 5.0** :star:337
...
- [whitehall](https://github.com/alphagov/whitehall) - A content management app used by UK government - **using Rails 5.1** :star:568
...
- [Nanobox](https://github.com/nanobox-io/nanobox) - A micro-PaaS (μPaaS) for creating consistent, isolated, development environments deployable anywhere [:earth_africa:](https://nanobox.io). :star:1400
...
- [rails-dashboard](https://github.com/y-takey/rails-dashboard) - A dev-tool to improve your rails log. :star:87

[Back to top](#table-of-contents)

### Notable Awesome Stuffs

- [jnv/lists](https://github.com/jnv/lists) - List of (awesome) lists curated on GitHub :star:6268
- [awesome-ruby](https://github.com/sdogruyol/awesome-ruby) :star:1119
- [awesome-rails-gem](https://github.com/hothero/awesome-rails-gem) :star:2648
