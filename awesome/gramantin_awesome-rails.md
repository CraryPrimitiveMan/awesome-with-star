...
- [Rails Source Code](https://github.com/rails/rails) :star:45149
...
- [Protecting your users data from Rails application using cryptography](https://github.com/cossacklabs/acra/wiki/Using-Acra-to-Protect-Your-Rails-App) :star:537
...
- [activeWorkflow](https://github.com/automaticmode/active_workflow) - An intelligent process and workflow automation platform based on software agents - **using Rails 5.2** :star:224
- [adopt-a-hydrant](https://github.com/codeforamerica/adopt-a-hydrant) - A civic infrastructure detection app - **using Rails 4.2** :star:500
...
- [askaway](https://github.com/askaway/askaway) - Question & answer app specialized in politics - **using Rails 4.1** :star:36
...
- [blackCandy](https://github.com/aidewoode/black_candy) - A music streaming app - **using Rails 6.0** :star:514
- [brimir](https://github.com/ivaldi/brimir) - An email helpdesk app - **using Rails 5.2** - **archived** :star:1433
- [calagator](https://github.com/calagator/calagator) - A community calendaring app - **using Rails 4.2** :star:382
...
- [canvas-lms](https://github.com/instructure/canvas-lms) - A learning management app - **using Rails 5.2** :star:3135
...
- [chatwoot](https://github.com/chatwoot/chatwoot) - A simple and elegant live chat software - **using Rails 6.0** :star:3660
- [ciao](https://github.com/brotandgames/ciao) - A URL status checking app - **using Rails 6.0** :star:1043
- [coRM](https://github.com/SIGIRE/CoRM) - A customer relationship management app - **using Rails 3.2** - [:earth_africa:](http://www.corm.fr)
- [coderwall (legacy)](https://github.com/coderwall/coderwall-legacy) - A social network app for software engineers - **using Rails 3.2** :star:866
- [coderwall (next)](https://github.com/coderwall/coderwall-next) - A social network app for software engineers - **using Rails 5.0** :star:170
...
- [commudle](https://github.com/gdgnewdelhi/commudle) - A community management app - **using Rails 5.2** :star:242
- [contribulator](https://github.com/24pullrequests/contribulator) - An open source project finder app - **using Rails 5.1** :star:86
- [coursemology2](https://github.com/Coursemology/coursemology2) - Learning platform app - **using Rails 5.2** :star:83
- [covoiturage-libre](https://github.com/covoiturage-libre/covoiturage-libre) - A carpooling app - **using Rails 5.0** - **archived** :star:105
...
- [crowdtiltOpen](https://github.com/Crowdtilt/CrowdtiltOpen) - A crowdfunding platform - **using Rails 3.2** :star:594
- [danbooru](https://github.com/danbooru/danbooru) - A taggable image board app - **using Rails 6.0** :star:815
- [dcaf_case_management](https://github.com/DCAFEngineering/dcaf_case_management) - A case management app - **using Rails 5.2** :star:66
...
- [dgi-db](https://github.com/griffithlab/dgi-db) - A drug gene interaction platform - **using Rails 5.1** :star:57
...
- [ekylibre](https://github.com/ekylibre/ekylibre) - A farm management app - **using Rails 4.2** :star:214
- [postal](https://github.com/postalhq/postal) - A mail delivery platform - **using Rails 5.2** :star:9531
...
- [expertiza](https://github.com/expertiza/expertiza) - A learning material sharing app - **using Rails 4.2** :star:154
...
- [feedi](https://github.com/davidesantangelo/feedi) - A RSS feed conversion (to API) app - **using Rails 5.2** :star:273
...
- [gitlabhq](https://github.com/gitlabhq/gitlabhq) -  A code collaboration app - **using Rails 6.0** :star:22184
...
- [intercityup.com](https://github.com/intercity/intercity-next) - A control panel app for app deployment - **using Rails 4.1** :star:87
- [kanban](https://github.com/seanomlor/kanban) - A Trello clone - **using Rails 4.2** - [:earth_africa:](http://kanban.seanomlor.com)
- [kitsu-tools](https://github.com/hummingbird-me/kitsu-tools) - An anime discovery platform - **using Rails 4.1** :star:2013
...
- [obtvse2](https://github.com/natew/obtvse2) - A blogging app - **using Rails 4.0** :star:267
...
- [openFarm](https://github.com/openfarmcc/OpenFarm) -  A database for information about farming and gardening - **using Rails 5.2** - :star:690
...
- [popHealth](https://github.com/pophealth/popHealth) -  A population health reporting app - **using Rails 4.1** :star:124
- [publify](https://github.com/publify/publify) - A blogging app - **using Rails 5.2** :star:1755
...
- [rentmybikes-rails](https://github.com/balanced/rentmybikes-rails) - A marketplace app - - **using Rails 4.0** :star:59
...
- [scholarsphere](https://github.com/psu-stewardship/scholarsphere) - A digital assets management app - **using Rails 5.1** :star:76
- [selfstarter](https://github.com/apigy/selfstarter) - A crowdfunding app - **using Rails 4.0** :star:3140
...
- [socify](https://github.com/scaffeinate/socify) - A social networking platform - **using Rails 5.0** :star:344
...
- [trado](https://github.com/Jellyfishboy/trado) - An e-commerce platform - **using Rails 4.2** :star:148
...
- [whitehall](https://github.com/alphagov/whitehall) - A content management app used by UK government - **using Rails 5.1** :star:571
...
- [Nanobox](https://github.com/nanobox-io/nanobox) - A micro-PaaS (μPaaS) for creating consistent, isolated, development environments deployable anywhere [:earth_africa:](https://nanobox.io). :star:1416
...
- [rails-dashboard](https://github.com/y-takey/rails-dashboard) - A dev-tool to improve your rails log. :star:89

[Back to top](#table-of-contents)

### Notable Awesome Stuffs

- [jnv/lists](https://github.com/jnv/lists) - List of (awesome) lists curated on GitHub :star:6371
- [awesome-ruby](https://github.com/sdogruyol/awesome-ruby) :star:1119
- [awesome-rails-gem](https://github.com/hothero/awesome-rails-gem) :star:2652
