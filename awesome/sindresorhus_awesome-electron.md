...
- [Beaker](https://github.com/beakerbrowser/beaker) - Browser with peer-to-peer web protocols. :star:2962
- [Hyper](https://github.com/zeit/hyper) - Terminal. :star:21449
- [WebTorrent](https://github.com/feross/webtorrent-app) - Streaming torrent client. :star:4662
- [Kap](https://github.com/wulkano/kap) - Screen recorder with GIF support. :star:8180
- [Min](https://github.com/minbrowser/min) - Minimal web browser. :star:2358
- [Mancy](https://github.com/princejwesley/Mancy) - JavaScript REPL. :star:2477
...
- [Atom](https://github.com/atom/atom) - Code editor. :star:43626
- [Visual Studio Code](https://github.com/Microsoft/vscode) - Cross-platform IDE. :star:44940
- [Brave](https://github.com/brave/browser-laptop) - Privacy-focused web browser. :star:6919

###### Other

- [Git-it](https://github.com/jlord/git-it-electron) - Teaches you Git and GitHub. :star:1933
- [Caprine](https://github.com/sindresorhus/caprine) - Unofficial Facebook Messenger app. :star:2931
- [Simplenote](https://github.com/Automattic/simplenote-electron) - Note keeper. :star:1551
...
- [Medis](https://github.com/luin/medis) - Redis database management. :star:5426
...
- [KeeWeb](https://github.com/keeweb/keeweb) - Unofficial KeePass app. :star:6067
- [Gitify](https://github.com/ekonstantinidis/gitify) - GitHub notifications in your menubar. :star:2257
- [Friends](https://github.com/moose-team/friends) - P2P chat. :star:2874
- [Cumulus](https://github.com/gillesdemey/Cumulus) - SoundCloud player in your menubar. :star:1001
...
- [Leanote](https://github.com/leanote/desktop-app) - Cloud notepad. :star:1097
...
- [DevDocs](https://github.com/egoist/devdocs-app) - Unofficial DevDocs.io app. :star:1063
...
- [Sqlectron](https://github.com/sqlectron/sqlectron-gui) - SQL client. :star:2138
- [docker-indicator](https://github.com/khornberg/docker-indicator) - Unofficial Docker menubar app. :star:33
- [Light Table](https://github.com/LightTable/LightTable) - Code editor with instant feedback. :star:10056
- [Tubehead](https://github.com/makotot/Tubehead) - YouTube music player in your menubar. :star:26
- [Google Play Music Desktop Player](https://github.com/MarshallOfSound/Google-Play-Music-Desktop-Player-UNOFFICIAL-) - Unofficial Google Play Music app. :star:6083
...
- [James](https://github.com/uxebu/james) - HTTP proxy to view and intercept browser requests. :star:644
...
- [Electronic WeChat](https://github.com/geeeeeeeeek/electronic-wechat) - Unofficial WeChat app. :star:9572
- [dida](https://github.com/xwartz/dida) - Add tasks to TickTick (滴答清单). :star:25
- [FromScratch](https://github.com/kilian/fromscratch) - Autosaving scratchpad. :star:401
- [Hawkpass](https://github.com/kalpetros/hawkpass-desktop) - Password generator. :star:35
- [Gokotta](https://github.com/Zhangdroid/Gokotta) - Music player. :star:450
...
- [Boostnote](https://github.com/BoostIO/Boostnote) - Markdown note & code snippet app for developers. :star:6607
...
- [Hain](https://github.com/appetizermonster/hain) - Launcher for Windows. :star:2657
...
- [YakYak](https://github.com/yakyak/yakyak) - Unofficial Google Hangouts app. :star:3247
...
- [Toshocat](https://github.com/tofuness/Toshocat) - Anime/Manga Progress Tracker. :star:136
...
- [Ramme](https://github.com/terkelg/ramme) - Unofficial Instagram app. :star:2611
...
- [Rambox](https://github.com/saenzramiro/rambox) - Chat and email app that combines multiple services like Discord, Hangouts, Gmail and Outlook. :star:3330
...
- [ndm](https://github.com/720kb/ndm) - npm desktop manager. :star:1303
- [GIFBar](https://github.com/dcrousso/GIFBar) - Search GIFs in your menubar. :star:44
- [Stacer](https://github.com/oguzhaninan/Stacer) - Ubuntu system optimizer. :star:2977
- [Zazu](https://github.com/tinytacoteam/zazu) - Launcher. :star:1565
- [Inpad](https://github.com/sarah-seo/Inpad) - Notes app with GitHub-flavored Markdown. :star:155
- [Cerebro](https://github.com/KELiON/cerebro) - Launcher with inline previews. :star:4420
- [Desktop Dimmer](https://github.com/sidneys/desktop-dimmer) - Control the brightness of any display. :star:121
- [LosslessCut](https://github.com/mifi/lossless-cut) - Lossless video trimming & cutting. :star:1325
- [Wexond](https://github.com/sential/wexond) - Web browser with material UI and extensions API. :star:71
- [Buka](https://github.com/oguzhaninan/Buka) - E-book management. :star:361
- [Insomnia](https://github.com/getinsomnia/insomnia) - Create and manage HTTP requests. :star:6401
- [Tusk](https://github.com/champloohq/tusk) - Unofficial Evernote app. :star:517
...
- [Buttercup Desktop](https://github.com/buttercup/buttercup-desktop) - Password manager. :star:2025
...
- [Headset](https://github.com/headsetapp/headset-electron) - Discover, collect, and listen to music from YouTube. :star:479
...
- [Electron API usage](https://github.com/hokein/electron-sample-apps) - Sample apps illustrating usage of Electron APIs. :star:2061
...
- [electron-react-boilerplate](https://github.com/chentsulin/electron-react-boilerplate) - Boilerplate based on React and webpack. :star:8120
- [descjop](https://github.com/karad/lein_template_descjop) - ClojureScript boilerplate for creating an app. :star:342
- [electron-quick-start](https://github.com/electron/electron-quick-start) - Clone the repo to try a simple app. :star:3628
- [bozon](https://github.com/railsware/bozon) - Scaffold, run, test, and package your app. :star:540
- [electron-vue](https://github.com/SimulatedGREG/electron-vue) - Easily build your app with Vue and common plugins. :star:4978
...
- [angular-electron](https://github.com/maximegris/angular-electron) - Angular 5, Electron, TypeScript, SASS, Hot Reload. :star:948
...
- [electron-builder](https://github.com/electron-userland/electron-builder) - Create installers. :star:4411
- [devtron](https://github.com/electron/devtron) - Official DevTools extension. :star:1242
- [electron-packager](https://github.com/electron-userland/electron-packager) - Package and distribute your app. :star:4874
...
- [nuts](https://github.com/GitbookIO/nuts) - Releases server with auto-updater and GitHub as a backend. :star:758
- [electron-dl](https://github.com/sindresorhus/electron-dl) - Simplified file downloads. :star:364
- [electron-release-server](https://github.com/ArekSredzki/electron-release-server) - Self-hosted release server with front-end & auto-updater support. :star:782
- [electron-rebuild](https://github.com/electron/electron-rebuild) - Rebuild native Node.js modules against the currently installed Electron version. :star:359
...
- [electron-window-state](https://github.com/mawie81/electron-window-state) - Persist window sizes and positions. :star:257
...
- [spectron](https://github.com/electron/spectron) - Test Electron apps using ChromeDriver. :star:900
...
- [electron-store](https://github.com/sindresorhus/electron-store) - Save and load data like user preferences, app state, cache, etc. :star:775
...
- [NeDB](https://github.com/louischatriot/nedb) - Embedded persistent or in-memory database. :star:7876
- [electron-devtools-installer](https://github.com/GPMDP/electron-devtools-installer) - Install DevTools extensions from the Chrome Web Store. :star:321
- [electron-log](https://github.com/megahertz/electron-log) - Simple logging. :star:216
...
- [electron-pdf-window](https://github.com/gerhardberger/electron-pdf-window) - View PDF files in browser windows. :star:93
...
- [got](https://github.com/sindresorhus/got) - Simplified HTTP requests. :star:2414
...
- [electron-util](https://github.com/sindresorhus/electron-util) - Useful utilities for developing apps and modules. :star:207
...
- [nativefier](https://github.com/jiahaog/nativefier) - Create an app of any website. :star:13787
...
- [Reactotron](https://github.com/reactotron/reactotron) - Inspect your React and React Native apps. :star:7606
...
- [menubar](https://github.com/maxogden/menubar) - Menubar app framework. :star:4434
...
- [React Desktop](https://github.com/gabrielbull/react-desktop) - UI toolkit for macOS and Windows built with React. :star:7139
- [electron-input-menu](https://github.com/parro-it/electron-input-menu) - Context menu for input elements. :star:71
- [chrome-tabs](https://github.com/adamschwartz/chrome-tabs) - Chrome like tabs. :star:742
- [titlebar](https://github.com/kapetan/titlebar) - Emulate the macOS window titlebar. :star:379
