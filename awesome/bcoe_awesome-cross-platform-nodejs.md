...
- [systeminformation](https://github.com/sebhildebrandt/systeminformation) - Hardware/software system information. :star:878
...
- [which](https://github.com/npm/node-which) - Cross-platform implementation of Unix's `which`. :star:180
...
- [process-exists](https://github.com/sindresorhus/process-exists) - Check if a process exists. :star:24
...
- [node-winreg](https://github.com/fresc81/node-winreg) - Access the Windows registry. :star:167
