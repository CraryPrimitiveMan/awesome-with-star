...
* [Elm Example App](https://github.com/sporto/elm-example-app) - A small SPA example in Elm to learn the basics :star:440
...
* [Kanban Board in Elm](https://github.com/huytd/kanelm) - A kanban board (trello-alike) built with Elm and HTML5 Drag & Drop API :star:259
...
* [Elm Flatris](https://github.com/w0rm/elm-flatris) - A Flatris clone in Elm language v0.18. :star:399
...
* [core](https://github.com/elm/core) - Elm Core Libraries. :star:2276
* [html](https://github.com/elm/html) - Use HTML in Elm, based on the idea of a "virtual DOM". :star:321
...
* [elm-ui](https://github.com/mdgriffith/elm-ui) - UI Library in Elm. :star:561
* [elm-css](https://github.com/rtfeldman/elm-css) - CSS in Elm. :star:993
* [dillonkearns/elm-graphql](https://github.com/dillonkearns/elm-graphql) - Generate code to build guaranteed correct, type-safe API requests to your GraphQL API. :star:434
...
* [Elm Program test](https://github.com/avh4/elm-program-test/tree/3.0.0) - Test complete Elm programs :star:22
...
* [Elm Format](https://github.com/avh4/elm-format) - Automatic Elm code formatter adhering to [Elm Style Guide](http://elm-lang.org/docs/style-guide). :star:1140
...
* [Elm Analyse](https://github.com/stil4m/elm-analyse) - Linter for the Elm programming language. :star:373
...
* [OpenApi Generator](https://github.com/OpenAPITools/openapi-generator) - Generate OpenApi types for Elm. :star:3417
* [Elm Typescript Interop](https://github.com/dillonkearns/elm-typescript-interop) - Generate Typescript definitions from Elm. :star:119
* [Quicktype](https://github.com/quicktype/quicktype) - Generate JSON decoders and encoders from JSON :star:3486
...
* [elm-compiler](https://github.com/elm/compiler) - Compiler for the Elm programming language. :star:5450
* [elm-webpack-loader](https://github.com/elm-community/elm-webpack-loader) - Webpack loader for the Elm programming language. :star:493
...
* [Elm Language Server](https://github.com/elm-tooling/elm-language-server#sublime) - Language server implementation for Elm :star:143
...
* [emmet-vim](https://github.com/mattn/emmet-vim) - Markup expansion with elm support. :star:4827
...
* [create-elm-app](https://github.com/halfzebra/create-elm-app) - Create Elm apps with no build configuration. :star:1338
* [elm-live](https://github.com/wking-io/elm-live) - A flexible dev server for Elm. Live reload included. :star:761
...
* [Elm Batteries](https://github.com/cedricss/elm-batteries) - A project template and generator for Elm, Parcel, Cypress and Netlify   :star:71

### Outdated Boilerplates

* [elm-webpack-starter](https://github.com/moarwick/elm-webpack-starter) - A simple Webpack setup for writing Elm apps. :star:887
...
* [Elchemy](https://github.com/wende/elchemy) - Write Elixir code using statically-typed Elm-like syntax :star:941
* [Elmish](https://github.com/elmish/elmish) - Elm-like abstractions for F# apps :star:443
* [Fabulous](https://github.com/fsprojects/Fabulous) - F# Functional App Development, using declarative dynamic UI :star:468
