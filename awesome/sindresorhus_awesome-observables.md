...
- [Overview](https://github.com/zenparsing/es-observable) :star:1763
- [Specification](https://zenparsing.github.io/es-observable/)


## Implementations

- [zen-observable](https://github.com/zenparsing/zen-observable) :star:374
- [RxJS](https://github.com/ReactiveX/RxJS) :star:12131
...
- [stream-to-observable](https://github.com/jamestalmage/stream-to-observable) - Convert a Node.js stream into an Observable. :star:58
- [symbol-observable](https://github.com/blesh/symbol-observable) - `Symbol.observable` ponyfill. :star:86
