...
- [Overview](https://github.com/zenparsing/es-observable) :star:1631
- [Specification](https://zenparsing.github.io/es-observable/)


## Implementations

- [zen-observable](https://github.com/zenparsing/zen-observable) :star:323
- [RxJS](https://github.com/ReactiveX/RxJS) :star:10394
...
- [stream-to-observable](https://github.com/jamestalmage/stream-to-observable) - Convert a Node.js stream into an Observable. :star:54
- [symbol-observable](https://github.com/blesh/symbol-observable) - `Symbol.observable` ponyfill. :star:71
