...
* [frontend-boilerplate - webpack-react-redux-babel-autoprefixer-hmr-postcss-css-modules-rucksack-boilerplate](https://github.com/tj/frontend-boilerplate) :star:3040
...
* [React-iCheck - iCheck components built with React. Highly customizable checkboxes and radio buttons](https://github.com/luqin/react-icheck) :star:175
...
* [react-inlinesvg - An SVG loader component for React](https://github.com/gilbarbara/react-inlinesvg) :star:543
...
* [react-tokeninput - Tokeninput component for React](https://github.com/instructure/react-tokeninput) :star:129
...
* [react.animate - State animation plugin for react.js](https://github.com/pleasetrythisathome/react.animate) :star:171
...
* [react-resizable-box - Resizable component for React](https://github.com/bokuweb/react-resizable-box) :star:480
...
* [react-virtualized-sticky-tree - Render virtualized tree structures with support for position: sticky ](https://github.com/marchaos/react-virtualized-sticky-tree) :star:59
...
* [Backbone React Component](https://github.com/magalhas/backbone-react-component) :star:825
...
* [react-three - React bindings to create and control a 3D scene using three.js](https://github.com/Izzimach/react-three) :star:1392
...
* [freezer-js - Lightweight and reactive immutable data structure for React](https://github.com/arqex/freezer) :star:1210
...
* [Docz - An incredible environment to build components and generate beautiful and highly customizable documentation using MDX](https://github.com/pedronauck/docz) :star:11217
...
* [react-native-google-signin - Google Signin for React Native](https://github.com/apptailor/react-native-google-signin) :star:1112
...
* [redux-state-validator - A simple redux middleware to validate redux state values and object types using JSON Schema](https://github.com/suyesh/redux-state-validator) :star:1
...
* [graphql-bookshelf - Some help defining GraphQL schema around BookshelfJS models](https://github.com/brysgo/graphql-bookshelf) :star:169
* [GraphpostgresQL - GraphQL for **PostgreSQL**](https://github.com/solidsnack/GraphpostgresQL) :star:1000
* [graffiti - Node.js GraphQL ORM](https://github.com/RisingStack/graffiti) :star:1042
* [sql-to-graphql - Generate a GraphQL API based on your SQL database structure](https://github.com/vaffel/sql-to-graphql) :star:474
* [graphql-sequelize - GraphQL & Relay for MySQL & Postgres via Sequelize](https://github.com/mickhansen/graphql-sequelize) :star:1310
...
* [Relay GitHub](https://github.com/facebook/relay) :star:11581
...
#### Relay Tools
* [graphql-relay-js - A library to help construct a graphql-js server supporting react-relay](https://github.com/graphql/graphql-relay-js) :star:1051
* [react-router-relay - Relay integration for React Router](https://github.com/relay-tools/react-router-relay) :star:564
* [relay-local-schema - Use Relay without a GraphQL server](https://github.com/relay-tools/relay-local-schema) :star:216
* [relay-codemod -  Codemod scripts based for on jsodeshift to update Relay APIs](https://github.com/facebook/jscodeshift) :star:3658
...
#### Apollo Tools
* [react-apollo-redux -  A small wrapper to automatically dispatch actions in response to apollo mutations](https://github.com/Drawbotics/react-apollo-redux) :star:50
...
* [Flow GitHub](https://github.com/facebook/flow) :star:18127
...
* [react-hn - A React & react-router-powered implementation of Hacker News](https://github.com/insin/react-hn) :star:1965
...
* [react-mvc - A sample chat application written with React and pure MVC](https://github.com/ustun/react-mvc) :star:40
...
* [lifequote - React port of a life insurance quick quoting application](https://github.com/insin/lifequote) :star:28
* [reactor-demo - Isomorphic Javascript app with React](https://github.com/natew/reactor-demo) :star:17
* [imgsible - React-based Imgur-like isomorphic demo app](https://github.com/BinaryMuse/imgsible) :star:137
* [wow-realm-status-react - WoW Realm Status: React Edition](https://github.com/BinaryMuse/wow-realm-status-react) :star:2
* [react-json-editor - A generic JSON editor](https://github.com/dustingetz/react-json-editor) :star:112
...
* [Hapi+React+Flux user management system](https://github.com/jedireza/aqua) :star:1345
* [Redux TodoMVC](https://github.com/gaearon/redux/tree/master/examples/todomvc) :star:44735
...
* [React/Redux CRUD with persistent state in Local Storage](https://github.com/cristianszwarc/react_crud_localStorage/) :star:24
* [React Slack clone - comprehensive Slack clone built with React and Chatkit](https://github.com/pusher/react-slack-clone/) :star:873
* [react-color-wander - Generative art with React](https://github.com/sonaye/react-color-wander) :star:6

---
### Example Apps
* [isomorphic500 - Isomorphic JS app built with React and Fluxible](https://github.com/gpbl/isomorphic500) :star:1352
* [fil -  A playground for in-browser interpreters (Redux)](https://github.com/fatiherikli/fil) :star:856
* [sound-redux - A Soundcloud client built with React / Redux](https://github.com/andrewngu/sound-redux) :star:4439
* [react-pomodoro - A Pomodoro timer for developers](https://github.com/afonsopacifer/react-pomodoro) :star:298
* [Do - Notes management application built with React and Redux](https://github.com/1ven/do) :star:271
* [soundcloud-react-redux - A SoundCloud Client built with React / Redux](https://github.com/rwieruch/favesound-redux) :star:1307
* [soundcloud-react-mobx - A SoundCloud Client built with React / MobX](https://github.com/rwieruch/favesound-mobx) :star:452
* [A Reimplementation of Winamp 2.9 with React and Redux](https://github.com/captbaritone/winamp2-js) :star:6350
* [ComingOrNot - Event Planner built with react, react-router, redux, graphQL & serverless](https://github.com/lakshmantgld/comingOrNot#reactjs-redux-serverless-graphql-event-planner) :star:48
* [React Reduction - Admin Dashboard built with React + Bootstrap4](https://github.com/reduction-admin/react-reduction) :star:514
* [React Code Splitting Sample - React + React Router + Flux](https://github.com/tiarebalbi/flux-main-sample) :star:3
* [Responsive React 'The Movie Database' (TMDb) App](https://github.com/SKempin/reactjs-tmdb-app) :star:478
* [CoreUI - Free Admin Panel built with React and Bootstrap 4](https://github.com/coreui/coreui-free-react-admin-template) :star:1382

---
### Real Apps
* [khan/perseus](https://github.com/khan/perseus) :star:1007
* [webbylab/itsquiz-wall](https://github.com/webbylab/itsquiz-wall) :star:495
* [devtools-html/debugger](https://github.com/devtools-html/debugger.html) :star:4033
* [brainfock/brainfock](https://github.com/brainfock/brainfock) :star:428
* [HVF/franchise](https://github.com/HVF/franchise) :star:3280
* [KELiON/cerebro](https://github.com/KELiON/cerebro) :star:5529
* [stride-nyc/remote_retro](https://github.com/stride-nyc/remote_retro) :star:207
* [Sqlectron - SQL client](https://sqlectron.github.io/)
* [ALM - A cloud ready IDE for React + TypeScript](https://alm-tools.github.io)
* [Spectrum – Simple, powerful online communities](https://github.com/withspectrum/spectrum) :star:4791
* [Mattermost – Open source Slack-alternative](https://github.com/mattermost/mattermost-webapp) :star:266
* [SaaS Boilerplate – Open source web app to quickly build your own SaaS product](https://github.com/async-labs/saas) :star:504
* [WOYE – Insert plain-text, get listed information from Youtube and Wikipedia](https://github.com/alxpez/woye) :star:45
