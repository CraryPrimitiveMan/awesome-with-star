...
* [Album O'Rama](https://github.com/phalcon/album-o-rama) - Sample modular application for the Phalcon Framework :star:89
* [Base App](https://github.com/mruz/base-app) - The base application in Phalcon Framework :star:68
* [INVO Application](https://github.com/phalcon/invo) - Sample application for the Phalcon Framework :star:325
* [Lightning](https://github.com/zxz054321/lightning/) - Lightning is a high performance framework with elegant syntax that sits on top of Phalcon. :star:29
* [MVC](https://github.com/phalcon/mvc) - Examples of Phalcon MVC file structures :star:662
...
* [Phalcon Boilerplate](https://github.com/mikegioia/phalcon-boilerplate) - Template for building large-scale Phalcon Applications :star:76
* [Phalcon Composer](https://github.com/xxtime/phalcon) - Phalcon with Composer support MySql MongoDb Redis, clean + beauty :star:14
...
* [Phalcon Module Skeleton](https://github.com/ovr/phalcon-module-skeleton) - Application template for building beauty applications on Phalcon Framework :star:133
...
* [Solid Layer](https://github.com/solid-layer/solid-layer) - A framework/large wrapper built under Phalcon Framework :star:75
* [Vökuró](https://github.com/phalcon/vokuro) - Sample application for Phalcon Framework (Acl, Auth, Security) :star:326
* [Webird](https://github.com/perchlayer/webird) - Webird was created to merge the latest PHP and Node.js innovations into a single application stack :star:95
...
* [Padlock](https://github.com/tegaphilip/padlock) - A docker-based phalcon authentication server built on top of the PHP OAuth 2.0 Server :star:4
* [phalcon-authmiddleware](https://github.com/SidRoberts/phalcon-authmiddleware) - Add middleware events to the dispatcher. Generic design that's compatible with ACL or a custom auth library. :star:16
* [phalcon-oauth2-server](https://github.com/nueko/phalcon-oauth2-server) - Phalcon wrapper for oAuth2 [thephpleague/oauth2-server](https://github.com/thephpleague/oauth2-server) :star:4183
...
* [PhalconEye](https://github.com/PhalconEye/phalconeye) - PhalconEye CMS :star:436
...
* [Yona CMS](https://github.com/oleksandr-torosh/yona-cms) - CMS based on Phalcon Framework with modular structure :star:352
* [PhalconCMS](https://github.com/KevinJay/PhalconCMS) - A blog built on Phalcon Framework :star:106
...
* [phalcon-cron](https://github.com/SidRoberts/phalcon-cron) - Cron component for Phalcon :star:68
...
* [dasshy](https://github.com/phalcon/dasshy) - Statistics dashboard with Mongo/Phalcon :star:28
...
* [dd](https://github.com/phalcon/dd) - This package will add the `dd` and `dump` helpers to your Phalcon application :star:11
...
* [Phalcon Debugbar](https://github.com/snowair/phalcon-debugbar) - Integrates [PHP Debug Bar](http://phpdebugbar.com) with Phalcon Framework :star:139
* [Phalcon Whoops](https://github.com/whoops-php/phalcon) - Integrating [Whoops](https://filp.github.io/whoops/) with Phalcon :star:10
* [Prophiler](https://github.com/fabfuel/prophiler) - PHP Profiler & Developer Toolbar (built for Phalcon) :star:441
...
* [pidic](https://github.com/phalette/pidic) - Nette Dependency Injection/Container for Phalcon :star:3
...
* [Phact](https://github.com/wandersonwhcr/phact) -  A Simple Event Propagation with Phalcon Framework :star:8
...
* [Phalcon Translate Service](https://github.com/stanislav-web/phalcon-translate) - Phalcon Translate Service. Simple way to translate your custom part of templates :star:9
* [xgettext-template](https://github.com/gmarty/xgettext) - Extract gettext messages from Volt templates using a command line program that is identical to the [xgettext invocation](http://www.gnu.org/software/gettext/manual/gettext.html#xgettext-Invocation). :star:72
...
* [phalcon-logentries](https://github.com/phalcon/phalcon-logentries) - Sends log messages to the [Logentries](https://logentries.com/) log management service :star:10

## Mail

*Mail services.*

* [Phalcon Mailer](https://github.com/vanchelo/phalcon-mailer) - Phalcon Mailer Service :star:42
...
* [nova](https://github.com/nohatssir/nova) - A media manager project in PHP and Phalcon Framework :star:7
* [Phalcon File Uploader](https://github.com/stanislav-web/phalcon-uploader) - Handling and downloading files for Phalcon projects. Allowed multiple files, filters etc :star:64
...
* [Breadcrumbs](https://github.com/phalcon/breadcrumbs) - Powerful and flexible component for building site breadcrumbs in Phalcon 2+. :star:36
...
* [Incubator](https://github.com/phalcon/incubator) - Repository to publish/share/experiment with new adapters, prototypes or functionality that can potentially be incorporated into the Phalcon Framework :star:693
...
* [Phalcony](https://github.com/ovr/phalcony) - Library for expansion the base functional of Phalcon Framework :star:19
* [yarak](https://github.com/zachleigh/yarak) - Laravel inspired Phalcon devtools :star:17
...
* [phalcon-boundmodels](https://github.com/SidRoberts/phalcon-boundmodels) - Automatically get models based on dispatcher parameters within the Phalcon framework :star:1
* [phalcon-mssql](https://github.com/fishjerky/phalcon-mssql) - A Phalcon Framework MSSQL PDO db adapter :star:19
* [phalcon-repositories](https://github.com/micheleangioni/phalcon-repositories) - Easy Repository pattern for Phalcon :star:11
...
* [Phalcon API](https://github.com/phalcon/phalcon-api) - Implementation of an API application using the Phalcon :star:15
...
* [Phalcon REST](https://github.com/redound/phalcon-rest) - Phalcon REST Library :star:106
* [Phalcon Rest JWT](https://github.com/nerfe/phalconphp-rest-jwt-acl) - This project uses Phalcon Micro Framework for REST API with JWT and ACL :star:30
...
* [phalcon-api-oauth2](https://github.com/goors/phalcon-api-oauth2) - Full Phalcon REST API example with is own OAuth2 server :star:36
* [phalcon-rest-boilerplate](https://github.com/redound/phalcon-rest-boilerplate) - Phalcon REST Boilerplate :star:93
* [phalcon-json-api](https://github.com/gte451f/phalcon-json-api) - A reference application combining Phalcon + JSON:API + Composer :star:19
...
* [PhalconRest](https://github.com/cmoore4/phalcon-rest) - A Base project for APIs using the Phalcon Framework :star:214
* [phest](https://github.com/ovide/phest) - REST API library for Phalcon :star:24
...
* [PhREST API](https://github.com/phrest/api) - Phalcon Framework REST API Package :star:28
...
* [generator-phalcon](https://github.com/michaelkrone/generator-phalcon) - Yeoman generator for Phalcon Multi-Module Applications :star:44
* [phalcon-bootstrap](https://github.com/JimmDiGrizli/phalcon-bootstrap) - Bootstrap component for a quick start developing applications on Phalcon Framework :star:19
...
* [ElasticsearchIndexer](https://github.com/SidRoberts/phalcon-elasticsearchindexer) - Elasticsearch indexer component for Phalcon :star:7
...
* [Searcher](https://github.com/stanislav-web/Searcher) - Database searcher for Phalcon Framework :star:25
...
* [phalcon_cart](https://github.com/uno-de-piera/phalcon_cart) - Complete cart system for Phalcon Framework :star:18
* [phasty](https://github.com/chaban/phasty) - Shopping Cart on Phalcon Framework :star:16
* [Cashier](https://github.com/duythien/cashier) - Phalcon cashier :star:15
* [Yona E-commerce](https://github.com/oleksandr-torosh/yona-ecommerce) - E-commerce CMF based on Phalcon Framework :star:13
...
* [Multiple SMS Sender factory](https://github.com/stanislav-web/phalcon-sms-factory) - Phalcon SMS Factory :star:30
...
* [Phosphorum](https://github.com/phalcon/forum) - The source for official Phalcon Forum :star:330
...
* [phalcon-demo](https://github.com/Codeception/phalcon-demo) - A modified Phalcon INVO Application to demonstrate basics of Codeception testing. :star:32
...
* [PHP Request Validator](https://github.com/progsmile/request-validator) - Easy PHP validation with the Phalcon support :star:26
...
* [URL-Shortener](https://github.com/blackbunny/Url-Shortener) - Simple Fast Url-Shortener application :star:25
...
* [packagecloud](https://github.com/phalcongelist/packagecloud) - Phalcon distribution hosted on PackageCloud :star:22
...
* [phalcon-compose](https://github.com/phalcon/phalcon-compose) - Open-source and community-driven boilerplate for Phalcon projects that run on Docker :star:92
* [phalcon-docker-nginx](https://github.com/viebig/phalcon-docker-nginx) - Phalcon 3, PHP7, Docker sample starter application :star:19
