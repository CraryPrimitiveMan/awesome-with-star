...
### EHR
  ...
  * [EHRServer](https://github.com/ppazos/cabolabs-ehrserver) - CaboLabs EHRServer :star:107
  ...
  * [EHRServer](https://github.com/ppazos/cabolabs-ehrserver) - Generic, minimal, standards-based, service-oriented, openEHR clinical data storage. :star:107
  ...
  * [Odoo Medical](https://github.com/OCA/vertical-medical) - Universal Health and Hospital Information System. :star:201
  ...
  * [openMAXIMS](https://github.com/IMS-MAXIMS/openMAXIMS) - Full Patient Administration System designed for the NHS. :star:51
...
### Prescribing
  * [OpenEP](https://github.com/ehrscape/examples/tree/master/openep) - Suite of medicines management apps that improve the safety and efficiency of prescribing and medicines management. :star:16
...
### Imaging
  ...
  * [Cornerstone](https://github.com/cornerstonejs/cornerstone) - An open source project with a goal to deliver a complete web based medical imaging platform. :star:1297
  ...
  * [DICOMcloud](https://github.com/DICOMcloud/DICOMcloud) - a standalone DICOMweb server with RESTful implementation of the DICOMweb/WADO services :star:110
  ...
  * [OHIF](https://github.com/OHIF/Viewers) - OHIF zero-footprint DICOM viewer and oncology specific Lesion Tracker :star:1152
  ...
  * [Papaya](https://github.com/rii-mango/Papaya) - Pure JavaScript medical research image viewer. :star:360
...
### Frameworks
  * [API Server](https://github.com/smart-on-fhir/api-server) - FHIR Server to support patient and clinician-facing apps. :star:92
  * [C3-PRO-Server](https://github.com/chb/c3-pro-server) - Highly reliable and scalable FHIR compliant web server. :star:5
  * [CareKit](https://github.com/carekit-apple/CareKit/) - CareKit is an open source software framework for creating apps that help people better understand and manage their health. :star:1862
  ...
  * [FHIR Server for Azure](https://github.com/Microsoft/fhir-server) - A .NET Core implementation of the FHIR standard. :star:449
  * [Intervention Engine FHIR Server](https://github.com/intervention-engine/fhir) - Generic FHIR server implementation in GoLang. :star:84
  * [Opal](http://opal.openhealthcare.org.uk/) - Framework for building clinical applications.
  * [ResearchKit](https://github.com/ResearchKit/ResearchKit) - Software framework that makes it easy to create apps for medical research or for other research projects. :star:5337
  * [Spark](https://github.com/furore-fhir/spark) - FHIR server. :star:155
  * [Swift-SMART](https://github.com/smart-on-fhir/Swift-SMART) - Swift SMART on FHIR framework for iOS and OS X. :star:93

### Libraries
  * [Archie](https://github.com/openehr/archie) - OpenEHR Library written in Java :star:21
  * [Asymmetrik FHIR API Server](https://github.com/Asymmetrik/node-fhir-server-core) - A Secure Rest implementation for the HL7 FHIR Specification :star:197
  * [DCMTK](https://dicom.offis.de/dcmtk.php.en) - DICOM Toolkit
  * [dicom](https://github.com/suyashkumar/dicom) - High Performance DICOM Medical Image Parser in Go :star:406
  * [Evil-DICOM](https://github.com/rexcardan/Evil-DICOM) - A C# DICOM Library :star:108
  * [Fellow Oak DICOM](https://github.com/fo-dicom/fo-dicom) - DICOM for .NET, .NET Core, Universal Windows, Android, iOS, Mono and Unity :star:566
  * [FHIR .NET API](https://github.com/FirelyTeam/fhir-net-api) - The official .NET API for HL7 FHIR. :star:468
  * [fhir.js](https://github.com/FHIR/fhir.js) - JavaScript client for FHIR. :star:267
  * [FHIR protocol buffers](https://github.com/google/fhir) - a Google implementation of protocol buffers for FHIR. :star:427
  * [HAPI FHIR](https://github.com/jamesagnew/hapi-fhir) - Java API for HL7 FHIR Clients and Servers. :star:987
  * [Hearth](https://github.com/jembi/hearth) - A fast FHIR-compliant server focused on longitudinal data stores. :star:21
  * [Health data standards](https://github.com/projectcypress/health-data-standards) - Ruby library for generating and consuming various healthcare related formats. These include HITSP C32, QRDA Category I, and QRDA Category III. :star:97
  * [MITK](http://mitk.org/wiki/MITK) - The Medical Imaging Interaction Toolkit.
  * [Node HL7](https://github.com/MatthewVita/node-hl7-complete) - Node module that is bridged with the Java Hapi HL7 library. :star:30
  * [Node-hl7-parser](https://github.com/RedoxEngine/redox-hl7-v2) - Open source version of Redox's HL7 v2 to schema-fied JSON parser. :star:6
  * [php-fhir](https://github.com/dcarbone/php-fhir) - Tools for creating PHP classes from the HL7 FHIR Specification :star:47
  * [pynetdicom](https://github.com/pydicom/pynetdicom) - A Python implementation of the DICOM networking protocol :star:217
  * [Python HL7](https://github.com/johnpaulett/python-hl7) - Simple library for parsing messages of HL7 version 2.x into Python objects. :star:132
  * [Python SMART on FHIR client](https://github.com/smart-on-fhir/client-py) - Flexible Python client for FHIR servers supporting the SMART on FHIR protocol :star:251
  * [Ruby FHIR](https://github.com/fhir-crucible/fhir_client) - FHIR client implementation in Ruby. :star:88
  * [Ruby HL7](https://github.com/segfault/ruby-hl7) - Ruby HL7 library. :star:93

### Applications
  * [Intervention Engine](https://github.com/intervention-engine/ie) - The Intervention Engine project provides a web-application for data-driven team huddles. :star:25
  * [SMART Pediatric Growth Chart](https://github.com/smart-on-fhir/growth-chart-app) - Pediatric growth charts. :star:43

### PHR
  * [Tidepool](https://github.com/tidepool-org) - Data platform to reduce the burden of Type 1 Diabetes.
  * [HealthLocker](https://github.com/healthlocker/healthlocker) - Elixir-based personal health record. :star:60
...
### Integration
  ...
  * [Open Source Mirth Transforms](https://github.com/daticahealth/Mirth-Transforms) - Open source transforms to make Mirthconnect-based integrations easier. :star:61

### Hardware
  * [echOpen](http://echopen.org/) - Low-cost (affordable) echo-stethoscope.
  * [Gluco](https://github.com/nebulabio/gluco) - Glucometer. :star:16
  * [MobilECG II](https://github.com/xdever/MobilECG-II) - Clinical grade Holter ECG. :star:357
...
### Bioinformatics
  * [ADAM](https://github.com/bigdatagenomics/adam) - Genomics analysis platform. :star:853
  * [Bcbio](https://github.com/chapmanb/bcbio-nextgen) - Validated, scalable, community developed variant calling, RNA-seq and small RNA analysis. :star:738
...
### Data
  ...
  * [Synthea Patient Generator](https://github.com/synthetichealth/synthea) - Synthetic patient generator that models the medical history of synthetic patients. :star:679

### Datasets
  * [Medical Data for Machine Learning](https://github.com/beamandrew/medical-data) - A curated list of medical data for machine learning. :star:4215

### EMPI
  * [MEDIC Client Registry RI](https://github.com/MohawkMEDIC/client-registry) - The Mohawk College MARC-HI/MEDIC Client Registry EMPI Implementation. :star:10
...
### Compliance
* [HIPAA Compliance Policies](https://github.com/catalyzeio/policies) - Make compliance as easy as possible for companies working with protected health information. :star:638

### Asset Management
* [Tapirx](https://github.com/virtalabs/tapirx) - Networked medical device discovery and identification. :star:17
