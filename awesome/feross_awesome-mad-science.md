# Info come from [feross/awesome-mad-science](https://github.com/feross/awesome-mad-science)
...
## sound
- [doppler](https://github.com/DanielRapp/doppler) - detect motion with the doppler effect using only the microphone and speakers :star:2215
- [speak.js](https://github.com/mattytemple/speak-js) - text-to-speech on the web :star:233
...
- [vantage.js](https://github.com/dthree/vantage) - CLI + SSH + REPL for Node :star:3373
- [cash](https://github.com/dthree/cash) - Cross-platform Linux commands in pure ES6 :star:7394

## virtual machines
- [jsemu](https://github.com/fcambus/jsemu) - A list of emulators written in the JavaScript :star:866
...
- [doppio](https://github.com/plasma-umass/doppio) - actively updated jvm in node.js, written in TypeScript :star:1709
