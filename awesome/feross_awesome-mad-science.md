...
- [glslify](https://github.com/stackgl/glslify) - npm modules compiled into WebGL shaders :star:965
...
## sound
- [doppler](https://github.com/DanielRapp/doppler) - detect motion with the doppler effect using only the microphone and speakers :star:2244
- [speak.js](https://github.com/mattytemple/speak-js) - text-to-speech on the web :star:239
...
- [vantage.js](https://github.com/dthree/vantage) - CLI + SSH + REPL for Node :star:3429
- [cash](https://github.com/dthree/cash) - Cross-platform Linux commands in pure ES6 :star:7530

## virtual machines
- [jsemu](https://github.com/fcambus/jsemu) - A list of emulators written in the JavaScript :star:957
...
- [doppio](https://github.com/plasma-umass/doppio) - actively updated jvm in node.js, written in TypeScript :star:1758
