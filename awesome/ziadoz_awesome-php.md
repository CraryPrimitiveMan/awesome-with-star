...
* [Composer Installers](https://github.com/composer/installers) - A  multi framework Composer library installer. :star:888
* [Composer](https://getcomposer.org/) - A package and dependency manager.
* [Melody](http://melody.sensiolabs.org/) - A tool to build one file Composer scripts.
* [Pickle](https://github.com/FriendsOfPHP/pickle) - A PHP extension installer. :star:1045
...
* [Composer Merge Plugin](https://github.com/wikimedia/composer-merge-plugin) - A composer plugin to merge several composer.json files. :star:396
* [Prestissimo](https://github.com/hirak/prestissimo) - A composer plugin which enables parallel install process. :star:3571
* [Satis](https://github.com/composer/satis) - A static Composer repository generator. :star:1691
...
* [Slim Skeleton](https://github.com/slimphp/Slim-Skeleton) - A skeleton for Slim. :star:791
...
* [Fast Route](https://github.com/nikic/FastRoute) - A fast routing library. :star:2819
...
* [Mustache](https://github.com/bobthecow/mustache.php) - A PHP implementation of the Mustache template language. :star:2657
...
* [Buzz](https://github.com/kriswallsmith/Buzz) - Another HTTP client. :star:1442
...
* [Requests](https://github.com/rmccue/Requests) - A simple HTTP library. :star:2888
* [Retrofit](https://github.com/tebru/retrofit-php) - A library to ease creation of REST API clients. :star:113
* [zend-diactoros](https://github.com/zendframework/zend-diactoros) - PSR-7 HTTP Message implementation. :star:751

### Scraping
*Libraries for scraping websites.*

* [Embed](https://github.com/oscarotero/Embed) - An information extractor from any web service or page. :star:1189
* [Goutte](https://github.com/FriendsOfPHP/Goutte) - A simple web scraper. :star:6228
* [PHP Spider](https://github.com/mvdbos/php-spider) - A configurable and extensible PHP web spider. :star:972
...
* [PHP Domain Parser](https://github.com/jeremykendall/php-domain-parser) - A domain suffix parser library. :star:521
...
* [Uri](https://github.com/thephpleague/uri) - Another URL manipulation library. :star:300

### Email
*Libraries for sending and parsing email.*

* [CssToInlineStyles](https://github.com/tijsverkoyen/CssToInlineStyles) - A library to inline CSS in email templates. :star:2990
...
* [Mautic](https://github.com/mautic/mautic) - Email marketing automation :star:2309
* [PHPMailer](https://github.com/PHPMailer/PHPMailer) - Another mailer solution. :star:10752
...
* [CSV](https://github.com/thephpleague/csv) - A CSV data manipulation library. :star:1499
* [Flysystem](https://github.com/thephpleague/Flysystem) - Another filesystem abstraction layer. :star:5865
* [Gaufrette](https://github.com/KnpLabs/Gaufrette) - A filesystem abstraction layer. :star:1934
...
* [Auryn](https://github.com/rdlowrey/Auryn) - A recursive dependency injector. :star:550
...
* [Symfony DI](https://github.com/symfony/dependency-injection) - A dependency injection container component (SF). :star:756
...
* [Glide](https://github.com/thephpleague/glide) - An on-demand image manipulation library. :star:1312
...
* [Intervention Image](https://github.com/Intervention/image) - Another image manipulation library. :star:6831
* [PHP Image Workshop](https://github.com/Sybio/ImageWorkshop) - Another image manipulation library. :star:781

### Testing
*Libraries for testing codebases and generating test data.*

* [Alice](https://github.com/nelmio/alice) - An expressive fixture generation library. :star:1571
* [AspectMock](https://github.com/Codeception/AspectMock) - A mocking framework for PHPUnit/Codeception. :star:615
* [Atoum](https://github.com/atoum/atoum) - A simple testing library. :star:1204
* [Behat](http://docs.behat.org/en/v2.5/) - A behaviour driven development (BDD) testing framework.
* [Codeception](https://github.com/Codeception/Codeception) - A full stack testing framework. :star:3260
* [DBUnit](https://github.com/sebastianbergmann/dbunit) - A database testing library for PHPUnit. :star:185
* [Faker](https://github.com/fzaninotto/Faker) - A fake data generator library. :star:14999
...
* [Mockery](https://github.com/mockery/mockery) - A mock object library for testing. :star:4678
...
* [PHPUnit](https://github.com/sebastianbergmann/phpunit) - A unit testing framework. :star:9386
* [Prophecy](https://github.com/phpspec/prophecy) - A highly opinionated mocking framework. :star:3373
...
* [APIGen](https://github.com/apigen/apigen) - Another API documentation generator. :star:1712
* [daux.io](https://github.com/justinwalsh/daux.io) - A documentation generator which uses Markdown files. :star:4686
* [PHP Documentor 2](https://github.com/phpDocumentor/phpDocumentor2) - A documentation generator. :star:2135
* [phpDox](http://phpdox.de/) - A documentation generator for PHP projects (that is not limited to API documentation).
* [Sami](https://github.com/FriendsOfPHP/Sami) - An API documentation generator. :star:1798
...
* [IniScan](https://github.com/psecio/iniscan) - A tool that scans PHP INI files for security. :star:1290
* [Optimus](https://github.com/jenssegers/optimus) - Id obfuscation based on Knuth's multiplicative hashing method. :star:763
* [PHP Encryption](https://github.com/defuse/php-encryption) - Secure PHP Encryption Library. :star:1682
* [PHP SSH](https://github.com/Herzult/php-ssh) - An experimental object orientated SSH wrapper library. :star:306
* [PHPSecLib](http://phpseclib.sourceforge.net/) - A pure PHP secure communications library.
* [random_compat](https://github.com/paragonie/random_compat) - PHP 5.x support for `random_bytes()` and `random_int()` :star:2995
...
* [Password Compat](https://github.com/ircmaxell/password_compat) - A compatibility library for the new PHP 5.5 password functions. :star:1995
* [Password Policy](https://github.com/ircmaxell/password-policy) - A password policy library for PHP and JavaScript. :star:58
...
* [PHP Parser](https://github.com/nikic/PHP-Parser) - A PHP parser written in PHP. :star:5695
...
* [PHP CodeSniffer](https://github.com/squizlabs/PHP_CodeSniffer) - A library that detects PHP, CSS and JS coding standard violations. :star:4698
* [PHP CS Fixer](https://github.com/FriendsOfPHP/PHP-CS-Fixer) - A coding standards fixer library. :star:5714
...
* [phan](https://github.com/phan/phan) - A static analyzer based on PHP 7+ and the php-ast extension. :star:2784
* [PHPCompatibility](https://github.com/wimg/PHPCompatibility) - A PHP compatibility checker for PHP CodeSniffer. :star:802
* [PhpDependencyAnalysis](https://github.com/mamuz/PhpDependencyAnalysis) - A tool to create customisable dependency graphs. :star:315
* [PHP Metrics](https://github.com/phpmetrics/PhpMetrics) - A static metric library. :star:1428
* [PHP Migration](https://github.com/monque/PHP-Migration) - A static analyzer for PHP version migration. :star:127
* [PHPStan](https://github.com/phpstan/phpstan) - A PHP Static Analysis Tool. :star:3439
* [Pslam](https://github.com/vimeo/psalm) - A static analysis tool for finding errors in PHP applications. :star:764

### Architectural
*Libraries related to design patterns, programming approaches and ways to organize code.*

* [Design Patterns PHP](https://github.com/domnikl/DesignPatternsPHP) - A repository of software patterns implemented in PHP. :star:14628
* [Finite](http://yohan.giarel.li/Finite/) - A simple PHP finite state machine.
* [Functional PHP](https://github.com/lstrojny/functional-php) - A functional programming library. :star:1186
...
* [Kint](https://github.com/kint-php/kint) - A debugging and profiling tool. :star:2077
* [PHP Console](https://github.com/Seldaek/php-console) - A web debugging console. :star:449
* [PHP Debug Bar](http://phpdebugbar.com/) - A debugging toolbar.
* [PHPBench](https://github.com/phpbench/phpbench) - A benchmarking Framework. :star:680
...
* [xDebug](https://github.com/xdebug/xdebug) - A debug and profile tool for PHP. :star:1368
* [XHProf](https://github.com/phacility/xhprof) - A profiling tool originally developed by Facebook. :star:2118
...
* [Robo](https://github.com/consolidation/Robo) - A PHP Task runner with object-orientated configurations. :star:1996
* [Task](http://taskphp.github.io/) - A pure PHP task runner inspired by Grunt and Gulp.

### Navigation
*Tools for building navigation structures.*

* [KnpMenu](https://github.com/KnpLabs/KnpMenu) - A menu library. :star:593
...
* [Carbon](https://github.com/briannesbitt/Carbon) - A simple DateTime API extension. :star:8540
* [Chronos](https://github.com/cakephp/chronos) - A DateTime API extension supporting both mutable and immutable date/time. :star:547
...
* [Amp](https://github.com/amphp/amp) - An event driven non-blocking I/O library. :star:1326
* [Broadway](https://github.com/broadway/broadway) - An event source and CQRS library. :star:1061
...
* [Event](https://github.com/thephpleague/event) - An event library with a focus on domain events. :star:475
...
* [Prooph Event Store](https://github.com/prooph/event-store) - An event source component to persist event messages :star:317
* [Ratchet](https://github.com/ratchetphp/Ratchet) - A web socket library. :star:4063
* [React](https://github.com/reactphp/react) - An event driven non-blocking I/O library. :star:5972
* [RxPHP](https://github.com/ReactiveX/RxPHP) - A reactive extension library. :star:1007
* [Workerman](https://github.com/walkor/Workerman) - An event driven non-blocking I/O library. :star:6019

### Logging
*Libraries for generating and working with log files.*

* [Monolog](https://github.com/Seldaek/monolog) - A comprehensive logger. :star:9483

### E-commerce
*Libraries and applications for taking payments and building online e-commerce stores.*

* [Money](https://github.com/moneyphp/money) - A PHP implementation of Fowler's money pattern. :star:1826
* [OmniPay](https://github.com/thephpleague/omnipay) - A framework agnostic multi-gateway payment processing library. :star:4014
* [Payum](https://github.com/payum/payum) - A payment abstraction library. :star:1163
...
* [Dompdf](https://github.com/dompdf/dompdf) - A HTML to PDF converter. :star:4596
* [PHPPdf](https://github.com/psliwa/PHPPdf) - A library for generating PDFs and images from XML. :star:309
* [Snappy](https://github.com/KnpLabs/snappy) - A PDF and image generation library. :star:2683
* [WKHTMLToPDF](https://github.com/wkhtmltopdf/wkhtmltopdf) - A tool to convert HTML to PDF. :star:6486
...
* [PHPWord](https://github.com/PHPOffice/PHPWord) - A library for working with Microsoft Word documents. :star:3137
...
* [Baum](https://github.com/etrepat/baum) - A nested set implementation for Eloquent. :star:1705
...
* [Eloquent](https://github.com/illuminate/database) - A simple ORM (L5). :star:1395
...
* [ProxyManager](https://github.com/Ocramius/ProxyManager) - A set of utilities to generate proxy objects for data mappers. :star:1268
...
* [Phinx](https://github.com/cakephp/phinx) - Another database migration library. :star:3349
...
* [Predis](https://github.com/nrk/predis) - A feature complete Redis library. :star:4366
...
* [Pheanstalk](https://github.com/pda/pheanstalk) - A Beanstalkd client library. :star:1330
* [PHP AMQP](https://github.com/php-amqplib/php-amqplib) - A pure PHP AMQP library. :star:2100
...
* [ElasticSearch PHP](https://github.com/elastic/elasticsearch-php) - The official client library for [ElasticSearch](https://www.elastic.co/). :star:2269
...
* [CLI Menu](https://github.com/php-school/cli-menu) - A library for building CLI menus. :star:1300
...
* [Cron Expression](https://github.com/mtdowling/cron-expression) - A library to calculate cron run dates. :star:2524
...
* [PsySH](https://github.com/bobthecow/psysh) - Another PHP REPL. :star:4500
...
* [SocialConnect Auth](https://github.com/socialConnect/auth) - An open source social sign (OAuth1\OAuth2\OpenID\OpenIDConnect). :star:279
* [Json Web Token](https://github.com/lcobucci/jwt) - Json Tokens to authenticate and transmit information. :star:2282
* [OAuth 1.0 Client](https://github.com/thephpleague/oauth1-client) - An OAuth 1.0 client library. :star:283
* [OAuth 2.0 Client](https://github.com/thephpleague/oauth2-client) - An OAuth 2.0 client library. :star:1936
...
* [Opauth](https://github.com/opauth/opauth) - A multi-provider authentication framework. :star:1620
...
* [TwitterOAuth](https://github.com/abraham/twitteroauth) - A Twitter OAuth library. :star:3585

### Markup
*Libraries for working with markup.*

* [Cebe Markdown](https://github.com/cebe/markdown) - An fast and extensible Markdown parser. :star:736
* [CommonMark PHP](https://github.com/thephpleague/commonmark) - A Markdown parser which supports the full [CommonMark spec](http://spec.commonmark.org/). :star:945
...
* [HTML to Markdown](https://github.com/thephpleague/html-to-markdown) - Converts HTML into Markdown. :star:735
* [HTML5 PHP](https://github.com/Masterminds/html5-php) - An HTML5 parser and serializer library. :star:577
* [Parsedown](https://github.com/erusev/parsedown) - Another Markdown parser. :star:7182
* [PHP Markdown](https://github.com/michelf/php-markdown) - A Markdown parser. :star:2653
...
* [Device Detector](https://github.com/matomo-org/device-detector) - Another library for parsing user agent strings. :star:1024
...
* [Mobile-Detect](https://github.com/serbanghita/Mobile-Detect) - A lightweight PHP class for detecting mobile devices (including tablets). :star:7736
* [Patchwork UTF-8](https://github.com/nicolas-grekas/Patchwork-UTF8) - A portable library for working with UTF-8 strings. :star:64
* [Slugify](https://github.com/cocur/slugify) - A library to convert strings to slugs. :star:1426
...
* [UUID](https://github.com/ramsey/uuid) - A library for generating UUIDs. :star:5140
...
* [LibPhoneNumber for PHP](https://github.com/giggsey/libphonenumber-for-php) - A PHP implementation of Google's phone number handling library. :star:2252
...
* [Respect Validation](https://github.com/Respect/Validation) - A simple validation library. :star:4454
...
* [Negotiation](https://github.com/willdurand/Negotiation) - A content negotiation library. :star:592
...
* [Doctrine Cache](https://github.com/doctrine/cache) - A caching library. :star:1544
...
* [JsonMapper](https://github.com/cweiske/jsonmapper) - A library that maps nested JSON structures onto PHP classes. :star:762
* [Knapsack](https://github.com/DusanKasan/Knapsack) - Collection library inspired by Clojure's sequences. :star:388
...
* [Serializer](https://github.com/schmittjoh/serializer) - A library for serialising and de-serialising data. :star:863
...
* [Deployer](https://github.com/deployphp/deployer) - A deployment tool. :star:5522
* [Envoy](https://github.com/laravel/envoy) - A tool to run SSH tasks with PHP. :star:1041
...
* [Amazon Web Service SDK](https://github.com/aws/aws-sdk-php) - The official PHP AWS SDK library. :star:3023
...
* [Stripe](https://github.com/stripe/stripe-php) - The official Stripe PHP library. :star:1511
* [Twilio](https://github.com/twilio/twilio-php) - The official Twilio PHP REST API. :star:917
...
* [Annotations](https://github.com/doctrine/annotations) - An annotations library (part of Doctrine). :star:1518
* [BotMan](https://github.com/botman/botman) - A framework agnostic PHP library to build cross-platform chat bots. :star:3611
...
* [ClassPreloader](https://github.com/ClassPreloader/ClassPreloader) - A library for optimising autoloading. :star:258
* [Country List](https://github.com/umpirsky/country-list) - A list of all countries with names and ISO 3166-1 codes. :star:3284
...
* [Hprose-PHP](https://github.com/hprose/hprose-php) - A very newbility RPC Library, support 25+ languages now. :star:1146
* [JSON Lint](https://github.com/Seldaek/jsonlint) - A JSON lint utility. :star:382
* [JSONPCallbackValidator](https://github.com/willdurand/JsonpCallbackValidator) - A library for validating JSONP callbacks. :star:202
...
* [Pagerfanta](https://github.com/whiteoctober/Pagerfanta) - A pagination library. :star:896
* [PHP PassBook](https://github.com/eymengunay/php-passbook) - A PHP library for iOS PassBook. :star:204
* [PHP-ML](https://github.com/php-ai/php-ml) - A library for Machine Learning in PHP. :star:5512
* [PHPCR](https://github.com/phpcr/phpcr) - A PHP port of the Java Content Repository (JCR). :star:390
* [PHPStack](http://dunkels.com/adam/phpstack/) - A TCP/IP stack proof of concept written in PHP.
* [print_o](https://github.com/koriym/print_o) - An object graph visualizer. :star:104
...
* [RMT](https://github.com/liip/RMT) - A library for versioning and releasing software. :star:367
...
* [SuperClosure](https://github.com/jeremeamia/super_closure) - A library that allows Closures to be serialized. :star:915
...
* [Whoops](https://github.com/filp/whoops) - A pretty error handling library. :star:6799
...
* [HomeBrew PHP](https://github.com/Homebrew/homebrew-php) - A PHP tap for HomeBrew. :star:2732
* [HomeBrew](https://brew.sh/) - A package manager for OSX.
* [PHP Brew](https://github.com/phpbrew/phpbrew) - A PHP version manager and installer. :star:3377
...
* [HHVM](https://github.com/facebook/hhvm) - A Virtual Machine, Runtime and JIT for PHP by Facebook. :star:15197
...
* [Cachet](https://github.com/cachethq/cachet) - The open source status page system. :star:7867
* [phpRedisAdmin](https://github.com/ErikDubbelboer/phpRedisAdmin) - A simple web interface to manage [Redis](https://redis.io/) databases. :star:1795
* [phpMyAdmin](https://github.com/phpmyadmin/phpmyadmin) - A web interface for MySQL/MariaDB. :star:2961
* [Adminer](https://www.adminer.org/) - Database management in a single PHP file.
* [Grav](https://github.com/getgrav/grav) - A modern flat-file CMS. :star:8730
* [Lychee](https://github.com/electerious/Lychee) - An easy to use and great looking photo-management-system. :star:4263

### Infrastructure
*Infrastructure for providing PHP applications and services.*

* [appserver.io](https://appserver.io/) - A multithreaded application server for PHP, written in PHP.
* [php-pm](https://github.com/php-pm/php-pm) - A process manager, supercharger and load balancer for PHP applications. :star:4884
