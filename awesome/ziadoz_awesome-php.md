...
* [Prestissimo](https://github.com/hirak/prestissimo) - A composer plugin which enables parallel install process. :star:3757
...
* [Aura.Router](https://github.com/auraphp/Aura.Router) - A full-featured routing library. :star:373
* [Fast Route](https://github.com/nikic/FastRoute) - A fast routing library. :star:2992
...
* [zend-diactoros](https://github.com/zendframework/zend-diactoros) - PSR-7 HTTP Message implementation. :star:860

### Scraping
*Libraries for scraping websites.*

* [Embed](https://github.com/oscarotero/Embed) - An information extractor from any web service or page. :star:1225
* [Goutte](https://github.com/FriendsOfPHP/Goutte) - A simple web scraper. :star:6457
* [PHP Spider](https://github.com/mvdbos/php-spider) - A configurable and extensible PHP web spider. :star:1006
...
* [CssToInlineStyles](https://github.com/tijsverkoyen/CssToInlineStyles) - A library to inline CSS in email templates. :star:3490
...
* [Mautic](https://github.com/mautic/mautic) - Email marketing automation :star:2471
* [PHPMailer](https://github.com/PHPMailer/PHPMailer) - Another mailer solution. :star:11294
...
* [Flysystem](https://github.com/thephpleague/Flysystem) - Another filesystem abstraction layer. :star:6659
...
* [Symfony DI](https://github.com/symfony/dependency-injection) - A dependency injection container component (SF). :star:1082
...
* [Glide](https://github.com/thephpleague/glide) - An on-demand image manipulation library. :star:1398
...
* [Intervention Image](https://github.com/Intervention/image) - Another image manipulation library. :star:7359
* [PHP Image Workshop](https://github.com/Sybio/ImageWorkshop) - Another image manipulation library. :star:793

### Testing
*Libraries for testing codebases and generating test data.*

* [Alice](https://github.com/nelmio/alice) - An expressive fixture generation library. :star:1647
...
* [Codeception](https://github.com/Codeception/Codeception) - A full stack testing framework. :star:3368
* [DBUnit](https://github.com/sebastianbergmann/dbunit) - A database testing library for PHPUnit. :star:194
* [Faker](https://github.com/fzaninotto/Faker) - A fake data generator library. :star:16253
...
* [Mockery](https://github.com/mockery/mockery) - A mock object library for testing. :star:5370
...
* [PHPSpec](https://github.com/phpspec/phpspec) - A design by specification unit testing library. :star:1411
* [PHPT](https://qa.php.net/write-test.php) - A test tool used by PHP itself.
* [PHPUnit](https://github.com/sebastianbergmann/phpunit) - A unit testing framework. :star:10419
* [Prophecy](https://github.com/phpspec/prophecy) - A highly opinionated mocking framework. :star:4064
* [VFS Stream](https://github.com/mikey179/vfsStream) - A virtual filesystem stream wrapper for testing. :star:1005
...
* [APIGen](https://github.com/apigen/apigen) - Another API documentation generator. :star:1758
...
* [Sami](https://github.com/FriendsOfPHP/Sami) - An API documentation generator. :star:1862
...
* [PHP Encryption](https://github.com/defuse/php-encryption) - Secure PHP Encryption Library. :star:1890
* [PHP SSH](https://github.com/Herzult/php-ssh) - An experimental object orientated SSH wrapper library. :star:307
* [PHPSecLib](http://phpseclib.sourceforge.net/) - A pure PHP secure communications library.
* [random_compat](https://github.com/paragonie/random_compat) - PHP 5.x support for `random_bytes()` and `random_int()` :star:3777
...
* [Password-Generator](https://github.com/hackzilla/password-generator) - PHP library to generate random passwords. :star:117
...
* [PHP Parser](https://github.com/nikic/PHP-Parser) - A PHP parser written in PHP. :star:6743
...
* [PHPQA](https://github.com/EdgedesignCZ/phpqa) - A tool for running QA tools (phploc, phpcpd, phpcs, pdepend, phpmd, phpmetrics). :star:263
...
* [PHP CodeSniffer](https://github.com/squizlabs/PHP_CodeSniffer) - A library that detects PHP, CSS and JS coding standard violations. :star:5036
* [PHP CS Fixer](https://github.com/FriendsOfPHP/PHP-CS-Fixer) - A coding standards fixer library. :star:6109
* [PHP Mess Detector](https://phpmd.org/) - A library that scans code for bugs, sub-optimal code, unused parameters and more.
* [PHPCheckstyle](https://github.com/PHPCheckstyle/phpcheckstyle) - A tool to help adhere to certain coding conventions. :star:120
* [PHPCPD](https://github.com/sebastianbergmann/phpcpd) - A library that detects copied and pasted code. :star:1514

### Static Analysis
*Libraries for performing static analysis of PHP code.*

* [Exakat](https://github.com/exakat/exakat) - A static analysis engine for PHP. :star:162
* [Mondrian](https://github.com/Trismegiste/Mondrian) - A code analysis tool using Graph Theory. :star:349
* [phan](https://github.com/phan/phan) - A static analyzer based on PHP 7+ and the php-ast extension. :star:3358
* [PHPCompatibility](https://github.com/wimg/PHPCompatibility) - A PHP compatibility checker for PHP CodeSniffer. :star:853
...
* [PHPStan](https://github.com/phpstan/phpstan) - A PHP Static Analysis Tool. :star:3935
...
* [Design Patterns PHP](https://github.com/domnikl/DesignPatternsPHP) - A repository of software patterns implemented in PHP. :star:15344
...
* [Tracy](https://github.com/nette/tracy) - A simple error detection, logging and time measuring library. :star:938
...
* [Robo](https://github.com/consolidation/Robo) - A PHP Task runner with object-orientated configurations. :star:2059
* [Task](http://taskphp.github.io/) - A pure PHP task runner inspired by Grunt and Gulp.

### Navigation
*Tools for building navigation structures.*

* [KnpMenu](https://github.com/KnpLabs/KnpMenu) - A menu library. :star:690
...
* [Carbon](https://github.com/briannesbitt/Carbon) - A simple DateTime API extension. :star:9446
...
* [Event](https://github.com/thephpleague/event) - An event library with a focus on domain events. :star:577
...
* [Prooph Event Store](https://github.com/prooph/event-store) - An event source component to persist event messages :star:342
* [Ratchet](https://github.com/ratchetphp/Ratchet) - A web socket library. :star:4216
* [React](https://github.com/reactphp/react) - An event driven non-blocking I/O library. :star:6188
* [RxPHP](https://github.com/ReactiveX/RxPHP) - A reactive extension library. :star:1083
* [Workerman](https://github.com/walkor/Workerman) - An event driven non-blocking I/O library. :star:6399

### Logging
*Libraries for generating and working with log files.*

* [Monolog](https://github.com/Seldaek/monolog) - A comprehensive logger. :star:10700

### E-commerce
*Libraries and applications for taking payments and building online e-commerce stores.*

* [Money](https://github.com/moneyphp/money) - A PHP implementation of Fowler's money pattern. :star:1965
* [OmniPay](https://github.com/thephpleague/omnipay) - A framework agnostic multi-gateway payment processing library. :star:4152
...
* [Swap](https://github.com/florianv/swap) - An exchange rates library. :star:931
* [Sylius](https://sylius.com/) - An open source e-commerce solution.

### PDF
*Libraries and software for working with PDF files.*

* [Dompdf](https://github.com/dompdf/dompdf) - A HTML to PDF converter. :star:4854
* [PHPPdf](https://github.com/psliwa/PHPPdf) - A library for generating PDFs and images from XML. :star:314
* [Snappy](https://github.com/KnpLabs/snappy) - A PDF and image generation library. :star:2804
* [WKHTMLToPDF](https://github.com/wkhtmltopdf/wkhtmltopdf) - A tool to convert HTML to PDF. :star:6821
...
* [PHPWord](https://github.com/PHPOffice/PHPWord) - A library for working with Microsoft Word documents. :star:3371
...
* [Baum](https://github.com/etrepat/baum) - A nested set implementation for Eloquent. :star:1778
* [Cake ORM](https://github.com/cakephp/orm) - Object-Relational Mapper, implemented using the DataMapper pattern (CP). :star:126
* [Doctrine Extensions](https://github.com/Atlantic18/DoctrineExtensions) - A collection of Doctrine behavioural extensions. :star:2221
* [Doctrine](https://www.doctrine-project.org/) - A comprehensive DBAL and ORM.
* [Eloquent](https://github.com/illuminate/database) - A simple ORM (L5). :star:1495
...
* [ProxyManager](https://github.com/Ocramius/ProxyManager) - A set of utilities to generate proxy objects for data mappers. :star:1586
...
* [Phinx](https://github.com/cakephp/phinx) - Another database migration library. :star:3439
...
* [Predis](https://github.com/nrk/predis) - A feature complete Redis library. :star:4665

### Queue
*Libraries for working with event and task queues.*

* [Bernard](https://github.com/bernardphp/bernard) - A multibackend abstraction library. :star:943
* [BunnyPHP](https://github.com/jakubkulhan/bunny) - A performant pure-PHP AMQP (RabbitMQ) sync and also async (ReactPHP) library. :star:386
* [Pheanstalk](https://github.com/pda/pheanstalk) - A Beanstalkd client library. :star:1393
* [PHP AMQP](https://github.com/php-amqplib/php-amqplib) - A pure PHP AMQP library. :star:2255
...
* [CLI Menu](https://github.com/php-school/cli-menu) - A library for building CLI menus. :star:1372
...
* [Cron Expression](https://github.com/mtdowling/cron-expression) - A library to calculate cron run dates. :star:2883
...
* [PsySH](https://github.com/bobthecow/psysh) - Another PHP REPL. :star:5226
* [ShellWrap](https://github.com/MrRio/shellwrap) - A simple command line wrapper library. :star:702
...
* [SocialConnect Auth](https://github.com/socialConnect/auth) - An open source social sign (OAuth1\OAuth2\OpenID\OpenIDConnect). :star:329
* [Json Web Token](https://github.com/lcobucci/jwt) - Json Tokens to authenticate and transmit information. :star:2583
* [OAuth 1.0 Client](https://github.com/thephpleague/oauth1-client) - An OAuth 1.0 client library. :star:365
* [OAuth 2.0 Client](https://github.com/thephpleague/oauth2-client) - An OAuth 2.0 client library. :star:2038
...
* [HTML to Markdown](https://github.com/thephpleague/html-to-markdown) - Converts HTML into Markdown. :star:786
* [HTML5 PHP](https://github.com/Masterminds/html5-php) - An HTML5 parser and serializer library. :star:598
* [Parsedown](https://github.com/erusev/parsedown) - Another Markdown parser. :star:8004
* [PHP Markdown](https://github.com/michelf/php-markdown) - A Markdown parser. :star:2724

### Strings
*Libraries for parsing and manipulating strings.*

* [Agent](https://github.com/jenssegers/agent) - A PHP desktop/mobile user agent parser, based on Mobiledetect. :star:2118
...
* [Jieba-PHP](https://github.com/fukuball/jieba-php) - A PHP port of Python's jieba. Chinese text segmentation for natural language processing. :star:605
...
* [Slugify](https://github.com/cocur/slugify) - A library to convert strings to slugs. :star:1543
* [SQL Formatter](https://github.com/jdorn/sql-formatter/) - A library for formatting SQL statements.
* [Stringy](https://github.com/danielstjules/Stringy) - A string manipulation library with multibyte support. :star:2136
* [UA Parser](https://github.com/tobie/ua-parser/tree/master/php) - A library for parsing user agent strings.
* [URLify](https://github.com/jbroadway/urlify) - A PHP port of Django's URLify.js. :star:548
* [UUID](https://github.com/ramsey/uuid) - A library for generating UUIDs. :star:6005
...
* [Respect Validation](https://github.com/Respect/Validation) - A simple validation library. :star:4608
...
* [Restler](https://github.com/Luracast/Restler) - A lightweight framework to expose PHP methods as RESTful web API. :star:1244
...
* [Doctrine Cache](https://github.com/doctrine/cache) - A caching library. :star:2133
...
* [Fractal](https://github.com/thephpleague/fractal) - A library for converting complex data structures to JSON output. :star:2506
...
* [Serializer](https://github.com/schmittjoh/serializer) - A library for serialising and de-serialising data. :star:992
...
* [Deployer](https://github.com/deployphp/deployer) - A deployment tool. :star:5834
* [Envoy](https://github.com/laravel/envoy) - A tool to run SSH tasks with PHP. :star:1070
* [Rocketeer](https://github.com/rocketeers/rocketeer) - A fast and easy deployer for the PHP world. :star:2617
...
* [Stripe](https://github.com/stripe/stripe-php) - The official Stripe PHP library. :star:1622
...
* [Zephir](https://github.com/phalcon/zephir) - A compiled language between PHP and C++ for developing PHP extensions. :star:2331

### Miscellaneous
*Useful libraries or tools that don't fit in the categories above.*

* [Annotations](https://github.com/doctrine/annotations) - An annotations library (part of Doctrine). :star:2138
* [BotMan](https://github.com/botman/botman) - A framework agnostic PHP library to build cross-platform chat bots. :star:3838
...
* [Country List](https://github.com/umpirsky/country-list) - A list of all countries with names and ISO 3166-1 codes. :star:3441
...
* [Hprose-PHP](https://github.com/hprose/hprose-php) - A very newbility RPC Library, support 25+ languages now. :star:1249
...
* [PHP-ML](https://github.com/php-ai/php-ml) - A library for Machine Learning in PHP. :star:5889
...
* [Slimdump](https://github.com/webfactory/slimdump) - An easy dumper tool for MySQL. :star:72
...
* [Whoops](https://github.com/filp/whoops) - A pretty error handling library. :star:7529
...
* [PHP Brew](https://github.com/phpbrew/phpbrew) - A PHP version manager and installer. :star:3540
...
* [HHVM](https://github.com/facebook/hhvm) - A Virtual Machine, Runtime and JIT for PHP by Facebook. :star:15385
...
* [MailCatcher](https://github.com/sj26/mailcatcher) - A web tool for capturing and viewing emails. :star:4339
* [Cachet](https://github.com/cachethq/cachet) - The open source status page system. :star:8285
...
* [phpMyAdmin](https://github.com/phpmyadmin/phpmyadmin) - A web interface for MySQL/MariaDB. :star:3153
* [Adminer](https://www.adminer.org/) - Database management in a single PHP file.
* [Grav](https://github.com/getgrav/grav) - A modern flat-file CMS. :star:9212
...
* [php-pm](https://github.com/php-pm/php-pm) - A process manager, supercharger and load balancer for PHP applications. :star:5058
