...
* [Composer Installers](https://github.com/composer/installers) - A  multi framework Composer library installer. :star:853
...
* [Composer Merge Plugin](https://github.com/wikimedia/composer-merge-plugin) - A composer plugin to merge several composer.json files. :star:380
...
* [Prestissimo](https://github.com/hirak/prestissimo) - A composer plugin which enables parallel install process. :star:3459
...
* [Fast Route](https://github.com/nikic/FastRoute) - A fast routing library. :star:2736
...
* [Mustache](https://github.com/bobthecow/mustache.php) - A PHP implementation of the Mustache template language. :star:2642
...
* [zend-diactoros](https://github.com/zendframework/zend-diactoros) - PSR-7 HTTP Message implementation. :star:639

### Scraping
*Libraries for scraping websites.*

* [Embed](https://github.com/oscarotero/Embed) - An information extractor from any web service or page. :star:1174
* [Goutte](https://github.com/FriendsOfPHP/Goutte) - A simple web scraper. :star:6132
...
* [CssToInlineStyles](https://github.com/tijsverkoyen/CssToInlineStyles) - A library to inline CSS in email templates. :star:2257
...
* [Flysystem](https://github.com/thephpleague/Flysystem) - Another filesystem abstraction layer. :star:5052
* [Gaufrette](https://github.com/KnpLabs/Gaufrette) - A filesystem abstraction layer. :star:1916
...
* [Container](https://github.com/thephpleague/container) - Another flexible dependency injection container. :star:364
...
* [Symfony DI](https://github.com/symfony/dependency-injection) - A dependency injection container component (SF). :star:606

### Imagery
*Libraries for manipulating images.*

* [Color Extractor](https://github.com/thephpleague/color-extractor) - A library for extracting colours from images. :star:809
...
* [Glide](https://github.com/thephpleague/glide) - An on-demand image manipulation library. :star:1274
* [Image Hash](https://github.com/jenssegers/imagehash) - A library for generating perceptual image hashes. :star:998
...
* [Intervention Image](https://github.com/Intervention/image) - Another image manipulation library. :star:6489
...
* [Codeception](https://github.com/Codeception/Codeception) - A full stack testing framework. :star:3192
* [DBUnit](https://github.com/sebastianbergmann/dbunit) - A database testing library for PHPUnit. :star:184
* [Faker](https://github.com/fzaninotto/Faker) - A fake data generator library. :star:13977
* [HTTP Mock](https://github.com/InterNations/http-mock) - A library for mocking HTTP requests in unit tests. :star:305
* [Kahlan](https://github.com/kahlan/kahlan) - Full stack Unit/BDD testing framework with built-in stub, mock and code-coverage support. :star:840
* [Mink](http://mink.behat.org/en/latest/) - Web acceptance testing.
* [Mockery](https://github.com/mockery/mockery) - A mock object library for testing. :star:3905
* [ParaTest](https://github.com/brianium/paratest) - A parallel testing library for PHPUnit. :star:626
...
* [PHPUnit](https://github.com/sebastianbergmann/phpunit) - A unit testing framework. :star:8454
* [Prophecy](https://github.com/phpspec/prophecy) - A highly opinionated mocking framework. :star:2572
* [Samsui](https://github.com/mauris/samsui) - Another fake data generator library. :star:30
* [VFS Stream](https://github.com/mikey179/vfsStream) - A virtual filesystem stream wrapper for testing. :star:938
...
* [Sami](https://github.com/FriendsOfPHP/Sami) - An API documentation generator. :star:1776

### Security
*Libraries for generating secure random numbers, encrypting data and scanning for vulnerabilities.*

* [Halite](https://paragonie.com/project/halite) - A simple library for encryption using [libsodium](https://github.com/jedisct1/libsodium).
* [HTML Purifier](https://github.com/ezyang/htmlpurifier) - A standards compliant HTML filter. :star:1153
* [IniScan](https://github.com/psecio/iniscan) - A tool that scans PHP INI files for security. :star:1271
* [Optimus](https://github.com/jenssegers/optimus) - Id obfuscation based on Knuth's multiplicative hashing method. :star:748
* [PHP Encryption](https://github.com/defuse/php-encryption) - Secure PHP Encryption Library. :star:1564
...
* [random_compat](https://github.com/paragonie/random_compat) - PHP 5.x support for `random_bytes()` and `random_int()` :star:2190
...
* [Password Compat](https://github.com/ircmaxell/password_compat) - A compatibility library for the new PHP 5.5 password functions. :star:1986
...
* [PHP Parser](https://github.com/nikic/PHP-Parser) - A PHP parser written in PHP. :star:4744
...
* [PHPLOC](https://github.com/sebastianbergmann/phploc) - A tool for quickly measuring the size of a PHP project. :star:1432
...
* [PHP CodeSniffer](https://github.com/squizlabs/PHP_CodeSniffer) - A library that detects PHP, CSS and JS coding standard violations. :star:4539
* [PHP CS Fixer](https://github.com/FriendsOfPHP/PHP-CS-Fixer) - A coding standards fixer library. :star:5531
...
* [PHPCPD](https://github.com/sebastianbergmann/phpcpd) - A library that detects copied and pasted code. :star:1419

### Static Analysis
*Libraries for performing static analysis of PHP code.*

* [Exakat](https://github.com/exakat/exakat) - A static analysis engine for PHP. :star:114
* [Mondrian](https://github.com/Trismegiste/Mondrian) - A code analysis tool using Graph Theory. :star:344
* [phan](https://github.com/phan/phan) - A static analyzer based on PHP 7+ and the php-ast extension. :star:2653
...
* [PHPStan](https://github.com/phpstan/phpstan) - A PHP Static Analysis Tool. :star:3253
...
* [Design Patterns PHP](https://github.com/domnikl/DesignPatternsPHP) - A repository of software patterns implemented in PHP. :star:14344
* [Finite](http://yohan.giarel.li/Finite/) - A simple PHP finite state machine.
* [Functional PHP](https://github.com/lstrojny/functional-php) - A functional programming library. :star:1155
...
* [PHP Option](https://github.com/schmittjoh/php-option) - An option type library. :star:690
...
* [RulerZ](https://github.com/K-Phoen/rulerz) - A powerful rule engine and implementation of the Specification pattern. :star:594
...
* [xDebug](https://github.com/xdebug/xdebug) - A debug and profile tool for PHP. :star:1341
...
* [Robo](https://github.com/consolidation/Robo) - A PHP Task runner with object-orientated configurations. :star:1939
...
* [GeoTools](https://github.com/thephpleague/geotools) - A library of geo-related tools. :star:869
...
* [Carbon](https://github.com/briannesbitt/Carbon) - A simple DateTime API extension. :star:7629
...
* [Yasumi](https://github.com/azuyalabs/yasumi) - An library to help you calculate the dates and names of holidays. :star:409

### Event
*Libraries that are event-driven or implement non-blocking event loops.*

* [Amp](https://github.com/amphp/amp) - An event driven non-blocking I/O library. :star:1250
* [Broadway](https://github.com/broadway/broadway) - An event source and CQRS library. :star:1025
...
* [Event](https://github.com/thephpleague/event) - An event library with a focus on domain events. :star:389
...
* [React](https://github.com/reactphp/react) - An event driven non-blocking I/O library. :star:5861
* [Rx.PHP](https://github.com/asm89/Rx.PHP) - A reactive extension library. :star:214
* [Workerman](https://github.com/walkor/Workerman) - An event driven non-blocking I/O library. :star:5801

### Logging
*Libraries for generating and working with log files.*

* [Monolog](https://github.com/Seldaek/monolog) - A comprehensive logger. :star:8554

### E-commerce
*Libraries and applications for taking payments and building online e-commerce stores.*

* [Money](https://github.com/moneyphp/money) - A PHP implementation of Fowler's money pattern. :star:1777
* [OmniPay](https://github.com/thephpleague/omnipay) - A framework agnostic multi-gateway payment processing library. :star:3958
* [Payum](https://github.com/payum/payum) - A payment abstraction library. :star:1131
* [Shopware](https://github.com/shopware/shopware) - Highly customizable e-commerce software :star:802
...
* [Dompdf](https://github.com/dompdf/dompdf) - A HTML to PDF converter. :star:4434
...
* [WKHTMLToPDF](https://github.com/wkhtmltopdf/wkhtmltopdf) - A tool to convert HTML to PDF. :star:6342

### Office
*Libraries for working with office suite documents.*

* [ExcelAnt](https://github.com/Wisembly/ExcelAnt) - A library for manipulating Microsoft Excel documents. :star:58
* [PHPPowerPoint](https://github.com/PHPOffice/PHPPresentation) - A library for working with Microsoft PowerPoint Presentations. :star:672
* [PHPWord](https://github.com/PHPOffice/PHPWord) - A library for working with Microsoft Word documents. :star:3031
...
* [Doctrine Extensions](https://github.com/Atlantic18/DoctrineExtensions) - A collection of Doctrine behavioural extensions. :star:2026
...
* [ProxyManager](https://github.com/Ocramius/ProxyManager) - A set of utilities to generate proxy objects for data mappers. :star:1158
...
* [Phinx](https://github.com/cakephp/phinx) - Another database migration library. :star:3307
...
* [Predis](https://github.com/nrk/predis) - A feature complete Redis library. :star:4155

### Queue
*Libraries for working with event and task queues.*

* [Bernard](https://github.com/bernardphp/bernard) - A multibackend abstraction library. :star:891
...
* [Pheanstalk](https://github.com/pda/pheanstalk) - A Beanstalkd client library. :star:1302
* [PHP AMQP](https://github.com/php-amqplib/php-amqplib) - A pure PHP AMQP library. :star:2018
...
* [CLI Menu](https://github.com/php-school/cli-menu) - A library for building CLI menus. :star:903
...
* [Cron Expression](https://github.com/mtdowling/cron-expression) - A library to calculate cron run dates. :star:2229
...
* [PsySH](https://github.com/bobthecow/psysh) - Another PHP REPL. :star:3672
...
* [Json Web Token](https://github.com/lcobucci/jwt) - Json Tokens to authenticate and transmit information. :star:2068
* [OAuth 1.0 Client](https://github.com/thephpleague/oauth1-client) - An OAuth 1.0 client library. :star:229
* [OAuth 2.0 Client](https://github.com/thephpleague/oauth2-client) - An OAuth 2.0 client library. :star:1890
...
* [TwitterOAuth](https://github.com/abraham/twitteroauth) - A Twitter OAuth library. :star:3559
* [TwitterSDK](https://github.com/lyrixx/twitter-sdk) - A fully tested Twitter SDK. :star:37

### Markup
*Libraries for working with markup.*

* [Cebe Markdown](https://github.com/cebe/markdown) - An fast and extensible Markdown parser. :star:720
...
* [HTML to Markdown](https://github.com/thephpleague/html-to-markdown) - Converts HTML into Markdown. :star:707
* [HTML5 PHP](https://github.com/Masterminds/html5-php) - An HTML5 parser and serializer library. :star:560
* [Parsedown](https://github.com/erusev/parsedown) - Another Markdown parser. :star:6259
* [PHP Markdown](https://github.com/michelf/php-markdown) - A Markdown parser. :star:2627

### Strings
*Libraries for parsing and manipulating strings.*

* [Agent](https://github.com/jenssegers/agent) - A PHP desktop/mobile user agent parser, based on Mobiledetect. :star:1883
...
* [Mobile-Detect](https://github.com/serbanghita/Mobile-Detect) - A lightweight PHP class for detecting mobile devices (including tablets). :star:7630
* [Patchwork UTF-8](https://github.com/nicolas-grekas/Patchwork-UTF8) - A portable library for working with UTF-8 strings. :star:62
* [Slugify](https://github.com/cocur/slugify) - A library to convert strings to slugs. :star:1365
* [SQL Formatter](https://github.com/jdorn/sql-formatter/) - A library for formatting SQL statements.
* [Stringy](https://github.com/danielstjules/Stringy) - A string manipulation library with multibyte support. :star:2065
...
* [UUID](https://github.com/ramsey/uuid) - A library for generating UUIDs. :star:4302
...
* [LibPhoneNumber for PHP](https://github.com/giggsey/libphonenumber-for-php) - A PHP implementation of Google's phone number handling library. :star:2196
...
* [Respect Validation](https://github.com/Respect/Validation) - A simple validation library. :star:4382
* [Upload](https://github.com/brandonsavage/Upload) - A library for handling file uploads and validation. :star:1462
* [Valitron](https://github.com/vlucas/valitron) - Another validation library. :star:946
...
* [CacheTool](https://github.com/gordalina/cachetool) - A tool to clear APC/opcode caches from the command line. :star:536
* [Cake Cache](https://github.com/cakephp/cache) - A caching library (CP). :star:14
* [Doctrine Cache](https://github.com/doctrine/cache) - A caching library. :star:1215
...
* [Fractal](https://github.com/thephpleague/fractal) - A library for converting complex data structures to JSON output. :star:2300
...
* [PHP Collections](https://github.com/schmittjoh/php-collection) - A simple collections library. :star:414
* [PINQ](https://github.com/TimeToogo/Pinq) - A PHP library based on .NET's LINQ (Language Integrated Query). :star:407
* [Porter](https://github.com/ScriptFUSION/Porter) - Data import abstraction framework. :star:363
* [Serializer](https://github.com/schmittjoh/serializer) - A library for serialising and de-serialising data. :star:838
...
* [Deployer](https://github.com/deployphp/deployer) - A deployment tool. :star:5326
...
* [Amazon Web Service SDK](https://github.com/aws/aws-sdk-php) - The official PHP AWS SDK library. :star:2949
...
* [Stripe](https://github.com/stripe/stripe-php) - The official Stripe PHP library. :star:1426
...
* [Annotations](https://github.com/doctrine/annotations) - An annotations library (part of Doctrine). :star:1158
* [BotMan](https://github.com/botman/botman) - A framework agnostic PHP library to build cross-platform chat bots. :star:3441
...
* [Country List](https://github.com/umpirsky/country-list) - A list of all countries with names and ISO 3166-1 codes. :star:3220
...
* [Hprose-PHP](https://github.com/hprose/hprose-php) - A very newbility RPC Library, support 25+ languages now. :star:1095
* [JSON Lint](https://github.com/Seldaek/jsonlint) - A JSON lint utility. :star:351
...
* [PHP-ML](https://github.com/php-ai/php-ml) - A library for Machine Learning in PHP. :star:5346
...
* [SuperClosure](https://github.com/jeremeamia/super_closure) - A library that allows Closures to be serialized. :star:838
...
* [Whoops](https://github.com/filp/whoops) - A pretty error handling library. :star:5987
...
* [HomeBrew PHP](https://github.com/Homebrew/homebrew-php) - A PHP tap for HomeBrew. :star:2669
* [HomeBrew](https://brew.sh/) - A package manager for OSX.
* [PHP Brew](https://github.com/phpbrew/phpbrew) - A PHP version manager and installer. :star:3335
...
* [HHVM](https://github.com/facebook/hhvm) - A Virtual Machine, Runtime and JIT for PHP by Facebook. :star:15128
...
* [Cachet](https://github.com/cachethq/cachet) - The open source status page system. :star:7667
...
* [Grav](https://github.com/getgrav/grav) - A modern flat-file CMS. :star:8518
* [Lychee](https://github.com/electerious/Lychee) - An easy to use and great looking photo-management-system. :star:4176

### Infrastructure
*Infrastructure for providing PHP applications and services.*

* [appserver.io](https://appserver.io/) - A multithreaded application server for PHP, written in PHP.
* [php-pm](https://github.com/php-pm/php-pm) - A process manager, supercharger and load balancer for PHP applications. :star:4779
