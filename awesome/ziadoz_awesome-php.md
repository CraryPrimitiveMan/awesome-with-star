...
* [Composer Merge Plugin](https://github.com/wikimedia/composer-merge-plugin) - A composer plugin to merge several composer.json files. :star:429
...
* [Fast Route](https://github.com/nikic/FastRoute) - A fast routing library. :star:2995
...
* [Embed](https://github.com/oscarotero/Embed) - An information extractor from any web service or page. :star:1227
* [Goutte](https://github.com/FriendsOfPHP/Goutte) - A simple web scraper. :star:6463
* [PHP Spider](https://github.com/mvdbos/php-spider) - A configurable and extensible PHP web spider. :star:1010
...
* [CssToInlineStyles](https://github.com/tijsverkoyen/CssToInlineStyles) - A library to inline CSS in email templates. :star:3502
...
* [Mautic](https://github.com/mautic/mautic) - Email marketing automation :star:2474
* [PHPMailer](https://github.com/PHPMailer/PHPMailer) - Another mailer solution. :star:11309
...
* [Flysystem](https://github.com/thephpleague/Flysystem) - Another filesystem abstraction layer. :star:6681
...
* [Symfony DI](https://github.com/symfony/dependency-injection) - A dependency injection container component (SF). :star:1090
...
* [Intervention Image](https://github.com/Intervention/image) - Another image manipulation library. :star:7370
...
* [Codeception](https://github.com/Codeception/Codeception) - A full stack testing framework. :star:3373
* [DBUnit](https://github.com/sebastianbergmann/dbunit) - A database testing library for PHPUnit. :star:194
* [Faker](https://github.com/fzaninotto/Faker) - A fake data generator library. :star:16288
...
* [Mockery](https://github.com/mockery/mockery) - A mock object library for testing. :star:5390
...
* [PHPUnit](https://github.com/sebastianbergmann/phpunit) - A unit testing framework. :star:10454
* [Prophecy](https://github.com/phpspec/prophecy) - A highly opinionated mocking framework. :star:4088
...
* [APIGen](https://github.com/apigen/apigen) - Another API documentation generator. :star:1763
...
* [random_compat](https://github.com/paragonie/random_compat) - PHP 5.x support for `random_bytes()` and `random_int()` :star:3800
...
* [PHP Parser](https://github.com/nikic/PHP-Parser) - A PHP parser written in PHP. :star:6774
...
* [PHPLOC](https://github.com/sebastianbergmann/phploc) - A tool for quickly measuring the size of a PHP project. :star:1505
* [PHPQA](https://github.com/EdgedesignCZ/phpqa) - A tool for running QA tools (phploc, phpcpd, phpcs, pdepend, phpmd, phpmetrics). :star:264
...
* [PHP CodeSniffer](https://github.com/squizlabs/PHP_CodeSniffer) - A library that detects PHP, CSS and JS coding standard violations. :star:5046
* [PHP CS Fixer](https://github.com/FriendsOfPHP/PHP-CS-Fixer) - A coding standards fixer library. :star:6123
...
* [phan](https://github.com/phan/phan) - A static analyzer based on PHP 7+ and the php-ast extension. :star:3377
...
* [PHP Metrics](https://github.com/phpmetrics/PhpMetrics) - A static metric library. :star:1529
* [PHP Migration](https://github.com/monque/PHP-Migration) - A static analyzer for PHP version migration. :star:137
* [PHPStan](https://github.com/phpstan/phpstan) - A PHP Static Analysis Tool. :star:3994
* [Psalm](https://github.com/vimeo/psalm) - A static analysis tool for finding errors in PHP applications. :star:989

### Architectural
*Libraries related to design patterns, programming approaches and ways to organize code.*

* [Design Patterns PHP](https://github.com/domnikl/DesignPatternsPHP) - A repository of software patterns implemented in PHP. :star:15370
* [Finite](http://yohan.giarel.li/Finite/) - A simple PHP finite state machine.
* [Functional PHP](https://github.com/lstrojny/functional-php) - A functional programming library. :star:1243
...
* [xDebug](https://github.com/xdebug/xdebug) - A debug and profile tool for PHP. :star:1423
* [XHProf](https://github.com/phacility/xhprof) - A profiling tool originally developed by Facebook. :star:2152
...
* [Robo](https://github.com/consolidation/Robo) - A PHP Task runner with object-orientated configurations. :star:2062
* [Task](http://taskphp.github.io/) - A pure PHP task runner inspired by Grunt and Gulp.

### Navigation
*Tools for building navigation structures.*

* [KnpMenu](https://github.com/KnpLabs/KnpMenu) - A menu library. :star:691
...
* [Carbon](https://github.com/briannesbitt/Carbon) - A simple DateTime API extension. :star:9474
...
* [Amp](https://github.com/amphp/amp) - An event driven non-blocking I/O library. :star:1538
...
* [Ratchet](https://github.com/ratchetphp/Ratchet) - A web socket library. :star:4215
* [React](https://github.com/reactphp/react) - An event driven non-blocking I/O library. :star:6195
* [RxPHP](https://github.com/ReactiveX/RxPHP) - A reactive extension library. :star:1084
* [Workerman](https://github.com/walkor/Workerman) - An event driven non-blocking I/O library. :star:6407

### Logging
*Libraries for generating and working with log files.*

* [Monolog](https://github.com/Seldaek/monolog) - A comprehensive logger. :star:10735

### E-commerce
*Libraries and applications for taking payments and building online e-commerce stores.*

* [Money](https://github.com/moneyphp/money) - A PHP implementation of Fowler's money pattern. :star:1969
...
* [Dompdf](https://github.com/dompdf/dompdf) - A HTML to PDF converter. :star:4864
* [PHPPdf](https://github.com/psliwa/PHPPdf) - A library for generating PDFs and images from XML. :star:314
* [Snappy](https://github.com/KnpLabs/snappy) - A PDF and image generation library. :star:2807
* [WKHTMLToPDF](https://github.com/wkhtmltopdf/wkhtmltopdf) - A tool to convert HTML to PDF. :star:6824
...
* [PHPWord](https://github.com/PHPOffice/PHPWord) - A library for working with Microsoft Word documents. :star:3378
...
* [Doctrine Extensions](https://github.com/Atlantic18/DoctrineExtensions) - A collection of Doctrine behavioural extensions. :star:2223
...
* [ProxyManager](https://github.com/Ocramius/ProxyManager) - A set of utilities to generate proxy objects for data mappers. :star:1595
...
* [Bernard](https://github.com/bernardphp/bernard) - A multibackend abstraction library. :star:945
...
* [Pheanstalk](https://github.com/pda/pheanstalk) - A Beanstalkd client library. :star:1394
* [PHP AMQP](https://github.com/php-amqplib/php-amqplib) - A pure PHP AMQP library. :star:2263
...
* [ElasticSearch PHP](https://github.com/elastic/elasticsearch-php) - The official client library for [ElasticSearch](https://www.elastic.co/). :star:2458
...
* [Cron Expression](https://github.com/mtdowling/cron-expression) - A library to calculate cron run dates. :star:2895
...
* [PsySH](https://github.com/bobthecow/psysh) - Another PHP REPL. :star:5245
...
* [Json Web Token](https://github.com/lcobucci/jwt) - Json Tokens to authenticate and transmit information. :star:2592
* [OAuth 1.0 Client](https://github.com/thephpleague/oauth1-client) - An OAuth 1.0 client library. :star:366
* [OAuth 2.0 Client](https://github.com/thephpleague/oauth2-client) - An OAuth 2.0 client library. :star:2042
...
* [Parsedown](https://github.com/erusev/parsedown) - Another Markdown parser. :star:8025
* [PHP Markdown](https://github.com/michelf/php-markdown) - A Markdown parser. :star:2728

### Strings
*Libraries for parsing and manipulating strings.*

* [Agent](https://github.com/jenssegers/agent) - A PHP desktop/mobile user agent parser, based on Mobiledetect. :star:2122
...
* [Device Detector](https://github.com/matomo-org/device-detector) - Another library for parsing user agent strings. :star:1112
* [Hoa String](https://github.com/hoaproject/Ustring) - Another UTF-8 string library. :star:123
* [Jieba-PHP](https://github.com/fukuball/jieba-php) - A PHP port of Python's jieba. Chinese text segmentation for natural language processing. :star:610
* [Mobile-Detect](https://github.com/serbanghita/Mobile-Detect) - A lightweight PHP class for detecting mobile devices (including tablets). :star:7952
* [Patchwork UTF-8](https://github.com/nicolas-grekas/Patchwork-UTF8) - A portable library for working with UTF-8 strings. :star:63
* [Slugify](https://github.com/cocur/slugify) - A library to convert strings to slugs. :star:1545
...
* [UUID](https://github.com/ramsey/uuid) - A library for generating UUIDs. :star:6024
...
* [Doctrine Cache](https://github.com/doctrine/cache) - A caching library. :star:2149
...
* [Serializer](https://github.com/schmittjoh/serializer) - A library for serialising and de-serialising data. :star:996
...
* [Deployer](https://github.com/deployphp/deployer) - A deployment tool. :star:5852
* [Envoy](https://github.com/laravel/envoy) - A tool to run SSH tasks with PHP. :star:1072
...
* [Amazon Web Service SDK](https://github.com/aws/aws-sdk-php) - The official PHP AWS SDK library. :star:3209
...
* [Github](https://github.com/KnpLabs/php-github-api) - A library to interface with the Github API. :star:1343
* [Mailgun](https://github.com/mailgun/mailgun-php) The official Mailgun PHP API.
* [Stripe](https://github.com/stripe/stripe-php) - The official Stripe PHP library. :star:1625
...
* [Annotations](https://github.com/doctrine/annotations) - An annotations library (part of Doctrine). :star:2156
* [BotMan](https://github.com/botman/botman) - A framework agnostic PHP library to build cross-platform chat bots. :star:3845
...
* [Country List](https://github.com/umpirsky/country-list) - A list of all countries with names and ISO 3166-1 codes. :star:3442
...
* [Hprose-PHP](https://github.com/hprose/hprose-php) - A very newbility RPC Library, support 25+ languages now. :star:1251
...
* [PHP-ML](https://github.com/php-ai/php-ml) - A library for Machine Learning in PHP. :star:5898
...
* [SuperClosure](https://github.com/jeremeamia/super_closure) - A library that allows Closures to be serialized. :star:1033
...
* [Whoops](https://github.com/filp/whoops) - A pretty error handling library. :star:7548
...
* [PHP Brew](https://github.com/phpbrew/phpbrew) - A PHP version manager and installer. :star:3548
...
* [HHVM](https://github.com/facebook/hhvm) - A Virtual Machine, Runtime and JIT for PHP by Facebook. :star:15388
...
* [MailCatcher](https://github.com/sj26/mailcatcher) - A web tool for capturing and viewing emails. :star:4346
* [Cachet](https://github.com/cachethq/cachet) - The open source status page system. :star:8308
* [phpRedisAdmin](https://github.com/ErikDubbelboer/phpRedisAdmin) - A simple web interface to manage [Redis](https://redis.io/) databases. :star:1879
* [phpMyAdmin](https://github.com/phpmyadmin/phpmyadmin) - A web interface for MySQL/MariaDB. :star:3162
* [Adminer](https://www.adminer.org/) - Database management in a single PHP file.
* [Grav](https://github.com/getgrav/grav) - A modern flat-file CMS. :star:9227
...
* [php-pm](https://github.com/php-pm/php-pm) - A process manager, supercharger and load balancer for PHP applications. :star:5062
