...
- [How to _evolve_ neural networks in Ruby using the Machine Learning Workbench](https://github.com/giuse/machine_learning_workbench/blob/master/examples/neuroevolution.rb) :star:7
...
- [shogun](https://github.com/shogun-toolbox/shogun) - Polyfunctional and mature :star:2640
...
- [eps](https://github.com/ankane/eps) - Bayesian Classification and Linear Regression with exports :star:501
...
- [tensorflow](https://github.com/somaticio/tensorflow.rb) - Ruby bindings for [TensorFlow](https://www.tensorflow.org/). :star:813
- [ruby-dnn](https://github.com/unagiootoro/ruby-dnn) - Simple deep learning for Ruby. :star:25
- [torch-rb](https://github.com/ankane/torch-rb) - Ruby bindings for [LibTorch](https://github.com/pytorch/pytorch) :star:37835
...
- [GSL and Ruby buildpack](https://github.com/tomwolfe/heroku-buildpack-gsl-ruby) :star:3
- [OpenCV and Ruby buildpack](https://github.com/lilibethdlc/heroku-buildpack-ruby-opencv) :star:2
- [ImageMagick buildpack](https://github.com/mcollina/heroku-buildpack-imagemagick) :star:43
...
- [iRuby](https://github.com/SciRuby/iruby) - IRuby kernel for Jupyter (formelly IPython). :star:534
