...
- [How to _evolve_ neural networks in Ruby using the Machine Learning Workbench](https://github.com/giuse/machine_learning_workbench/blob/master/examples/neuroevolution.rb) :star:6
...
- [shogun](https://github.com/shogun-toolbox/shogun) - Polyfunctional and mature :star:2554
...
- [eps](https://github.com/ankane/eps) - Bayesian Classification and Linear Regression with exports :star:483
...
- [tensorflow](https://github.com/somaticio/tensorflow.rb) - Ruby bindings for [TensorFlow](https://www.tensorflow.org/). :star:811
- [ruby-dnn](https://github.com/unagiootoro/ruby-dnn) - Simple deep learning for Ruby. :star:15
...
- [iRuby](https://github.com/SciRuby/iruby) - IRuby kernel for Jupyter (formelly IPython). :star:507
