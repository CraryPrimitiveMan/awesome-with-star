...
* [asynchbase](https://github.com/OpenTSDB/asynchbase) - Fully asynchronous, non-blocking HBase client. :star:484
* [gohbase](https://github.com/tsuna/gohbase) - Pure Go client for HBase. :star:203
* [happybase](https://github.com/wbolster/happybase) - Python client for HBase. :star:375
...
* [Kundera](https://github.com/impetus-opensource/Kundera) - JPA client with support for HBase. :star:781
...
#### Graph
* [Gradoop](https://github.com/dbs-leipzig/gradoop) - Research framework for scalable graph analytics built on Flink and HBase. :star:100
...
* [Spark](https://github.com/hortonworks-spark/shc) - Spark-HBase connector. :star:201
