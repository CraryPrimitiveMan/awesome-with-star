...
* [Vegeta](https://github.com/tsenart/vegeta) :star:7001
* [wrk](https://github.com/wg/wrk) :star:14671
...
* [glances](https://github.com/nicolargo/glances) :star:9207
* [nmon](http://nmon.sourceforge.net/pmwiki.php)
* [gtop](https://github.com/aksakalli/gtop) :star:6555
...
* [Zach Holman's](https://github.com/holman/dotfiles) - oh-my-zsh, osx, Zsh, vi, Ruby, Git, and more :star:4833
* [Mathias Bynens's](https://github.com/mathiasbynens/dotfiles) - .files, including ~/.osx — sensible hacker defaults for OS X :star:18295
* [Thoughtbot's](https://github.com/thoughtbot/dotfiles) - A set of vim, zsh, git, and tmux configuration files :star:4691
...
* [atom-beautify](https://github.com/Glavin001/atom-beautify) - Beautify HTML (including Handlebars), CSS (including Sass and Less), JavaScript, and much more in Atom. :star:1172
...
* [Completor](https://github.com/maralla/completor.vim) - async autocomplete with support for omni and semantic completion. :star:657
* [Powerline](https://github.com/Lokaltog/powerline) - improved status bar for your buffers. :star:8551
...
* [AdvancedNewFile](https://github.com/skuroda/Sublime-AdvancedNewFile) - File creation plugin. :star:738
* [Emmet](https://github.com/sergeche/emmet-sublime) :star:5101
* [Git Gutter](https://github.com/jisaacks/GitGutter) - display changed/added lines in the margin of the editor window. :star:3656
...
* [MarkdownEditing](https://github.com/SublimeText-Markdown/MarkdownEditing) - Markdown syntax understanding and good color schemes. :star:2272
...
* [Sublime Linter](https://github.com/SublimeLinter/SublimeLinter3/) - Interactive code linting. :star:1440
...
* [git-extras](https://github.com/visionmedia/git-extras) - GIT utilities -- repo summary, repl, changelog population, author commit percentages and more :star:11011
...
* [impress.js](https://github.com/impress/impress.js) - presentation framework based on the power of CSS3 transforms and transitions :star:33008
* [remark](https://github.com/gnab/remark) - markdown based presentation on your browser :star:7260
...
* [awesome-zsh-plugins](https://github.com/unixorn/awesome-zsh-plugins) - List of zsh plugins usable with [zgen](https://github.com/tarjoilija/zgen) and other [oh-my-zsh](https://github.com/robbyrussell/oh-my-zsh/) compatible zsh frameworks :star:3741
* [fish-shell](https://github.com/fish-shell/fish-shell) - The user-friendly command line shell :star:9017
* [oh-my-fish](https://github.com/oh-my-fish/oh-my-fish) - Framework for managing your fish shell configuration inspired by oh-my-zsh. :star:3054
...
* [shellcheck](https://github.com/koalaman/shellcheck) - Lint for shell. Will find deprecated and/or dangerous usage in shell scripts :star:9935
...
* [ag](https://github.com/ggreer/the_silver_searcher) - A C based code-searching tool similar to ack, but faster :star:14319
* [peco](https://github.com/peco/peco) - interactive filtering, like interactive Grep :star:4353


## Terminal
*Tools and addons for terminal and terminal work*

* [autojump](https://github.com/joelthelion/autojump) - remembers your :star:6363
...
* [oh-my-zsh](https://github.com/robbyrussell/oh-my-zsh) - the :star:65224
...
* [fswatch](https://github.com/alandipert/fswatch) - a watch tool which :star:2004
...
* [watchman](https://github.com/facebook/watchman) - Facebook's better :star:6250
