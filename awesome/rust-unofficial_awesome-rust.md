...
* [linkerd/linkerd2-proxy](https://github.com/linkerd/linkerd2-proxy) - Ultralight service mesh for Kubernetes. :star:158
...
* [Sandstorm Collections App](https://github.com/sandstorm-io/collections-app) :star:14
...
* [ParityDB](https://github.com/paritytech/paritydb) - Fast and reliable database, optimised for read operation :star:37
...
* [rsaarelm/magog](https://github.com/rsaarelm/magog) - A roguelike game in Rust :star:174
...
* [Thinkofname/rust-quake](https://github.com/Thinkofname/rust-quake) - Quake map renderer in Rust :star:16
...
* [locka99/opcua](https://github.com/locka99/opcua) - A pure rust [OPC UA](https://opcfoundation.org/about/opc-technologies/opc-ua/) library. :star:46
...
* [whitfin/runiq](https://github.com/whitfin/runiq) - an efficient way to filter duplicate lines from unsorted input. :star:35

### Utilities

* [brycx/checkpwn](https://github.com/brycx/checkpwn) - A Have I Been Pwned (HIBP) command-line utility tool that lets you easily check for compromised accounts and passwords. :star:10
...
* [whitfin/s3-meta](https://github.com/whitfin/s3-meta) - A command line tool to gather metadata about your Amazon S3 buckets. :star:37
* [amar-laksh/workstation](https://github.com/amar-laksh/workstation) - A commandline tool to help you manage your workstation by distancing you from your screen, locking your screen when you aren't there among other things with OPENCV! :star:7
...
- [TheWaWaR/simple-http-server](https://github.com/TheWaWaR/simple-http-server) - simple static http server :star:121
...
* Webpack
  * [Ralvke/rust-loader](https://github.com/Ralvke/rust-loader) — Webpack Rust loader (wasm) :star:29

### Debugging

* GDB
  * [rust-gdb](https://github.com/rust-lang/rust/blob/master/src/etc/rust-gdb) :star:31282
...
* Python
  * [getsentry/milksnake](https://github.com/getsentry/milksnake) - extension for python setuptools that allows you to distribute dynamic linked libraries in Python wheels in the most portable way imaginable. :star:444
...
See also [Are we (I)DE yet?](https://areweideyet.com/) and [Rust and IDEs](https://www.rust-lang.org/ides.html).
  ...
  * [Atom](https://atom.io/)
    * [zargony/atom-language-rust](https://github.com/zargony/atom-language-rust) :star:117
  ...
  * [Emacs](https://www.gnu.org/software/emacs/)
    ...
    * [flycheck-rust](https://github.com/flycheck/flycheck-rust) — Rust support for [Flycheck](https://github.com/flycheck/flycheck) :star:1641
    * [emacs-racer](https://github.com/racer-rust/emacs-racer) — Autocompletion (see also [company](https://company-mode.github.io) and [auto-complete](https://github.com/auto-complete/auto-complete)) :star:1486
    * [lsp-rust](https://github.com/emacs-lsp/lsp-rust) - Add rls support to [lsp-mode](https://github.com/emacs-lsp/lsp-mode) :star:923
  ...
  * [NetBeans](https://netbeans.org/)
    * [drrb/rust-netbeans](https://github.com/drrb/rust-netbeans) :star:40
  ...
  * [SolidOak](https://github.com/oakes/SolidOak) — a simple IDE for Rust, based on GTK+ and [Neovim](https://github.com/neovim/neovim) :star:28822
  * [Sublime Text](https://www.sublimetext.com/)
    * [rust-lang/rust-enhanced](https://github.com/rust-lang/rust-enhanced) — official Rust package
    * [sublimehq/packages](https://github.com/sublimehq/Packages/tree/master/Rust) — native Sublime support (already installed) :star:2710
...
* [trust](https://github.com/japaric/trust) - A Travis CI and AppVeyor template to test your Rust crate on 5 architectures and publish binary releases of it for Linux, macOS and Windows :star:620
...
* [jameysharp/corrode](https://github.com/jameysharp/corrode) - A C to Rust translator written in Haskell. :star:1869
...
* [pop-os/bus-writer](https://github.com/pop-os/bus-writer) - Generic single-reader, multi-writer :star:16
...
* [sfackler/rust-security-framework](https://github.com/sfackler/rust-security-framework) — Bindings for Security Framework (OSX native crypto) :star:28
* [steffengy/schannel-rs](https://github.com/steffengy/schannel-rs) — Bindings for Schannel (Windows native TLS) :star:9
* [zebradil/rustotpony](https://github.com/zebradil/rustotpony) — CLI manager of one-time password generators aka Google Authenticator (TOTP) :star:4
...
* [weld-project/weld](https://github.com/weld-project/weld) - High-performance runtime for data analytics applications :star:975
...
* Apache Hadoop
  * [whitfin/efflux](https://github.com/whitfin/efflux) - Easy Hadoop Streaming and MapReduce interfaces in Rust. :star:3
* Apache Kafka
...
* Operations
  ...
  * [pop-os/sys-mount](https://github.com/pop-os/sys-mount) - High level abstraction for the `mount` / `umount2` system calls. :star:2
...
* Game Engines
  ...
  * [Unrust](https://github.com/unrust/unrust) - unrust - A pure rust based (webgl 2.0 / native) game engine :star:195
  * [Vulkust](https://github.com/Hossein-Noroozpour/vulkust) - Vulkust - A safe, highly multithreaded, Vulkan based game engine written with Rust. :star:10
...
* [autopilot-rs/autopilot-rs](https://github.com/autopilot-rs/autopilot-rs) - A simple, cross-platform GUI automation library for Rust. :star:40
...
* [ImGui](https://github.com/ocornut/imgui) :star:12349
...
* [libui](https://github.com/andlabs/libui) :star:7849
...
* [Nuklear](https://github.com/vurtun/nuklear) :star:11028
...
* hado
  * [ludat/hado-rs](https://github.com/ludat/hado-rs) - A little macro for writing haskell-like do expressions without too much ceremony :star:25
...
### Parser
  ...
  * [ptal/oak](https://github.com/ptal/oak) — a typed PEG parser generator (compiler plugin) :star:109
...
* Linux
  * [pop-os/dbus-udisks2](https://github.com/pop-os/dbus-udisks2) - UDisks2 DBus API :star:2
  * [pop-os/distinst](https://github.com/pop-os/distinst/) - Linux distribution installer library :star:93
...
* [Rust Design Patterns](https://github.com/rust-unofficial/patterns) :star:1872
