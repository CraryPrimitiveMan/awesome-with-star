...
* [runconduit/conduit](https://github.com/runconduit/conduit) - Ultralight service mesh for Kubernetes. :star:1027
...
* [Sandstorm Collections App](https://github.com/sandstorm-io/collections-app) :star:13
...
* **Games**, see also [Games Made With Piston](https://github.com/PistonDevelopers/piston/wiki/Games-Made-With-Piston).
  ...
  * [rsaarelm/magog](https://github.com/rsaarelm/magog) - A roguelike game in Rust :star:112
  ...
  * [Thinkofname/rust-quake](https://github.com/Thinkofname/rust-quake) - Quake map renderer in Rust :star:7
* **Graphics**
...
* Perl
  * [vickenty/mi-rust](https://github.com/vickenty/mi-rust) - Adds support to M::I for building modules with Cargo :star:1
...
* Python
  * [getsentry/milksnake](https://github.com/getsentry/milksnake) - extension for python setuptools that allows you to distribute dynamic linked libraries in Python wheels in the most portable way imaginable. :star:303
...
See also [Are we (I)DE yet?](https://areweideyet.com/) and [Rust and IDEs](https://www.rust-lang.org/ides.html).
  ...
  * [Emacs](https://www.gnu.org/software/emacs/)
    ...
    * [flycheck-rust](https://github.com/flycheck/flycheck-rust) — Rust support for [Flycheck](https://github.com/flycheck/flycheck) :star:1497
  ...
  * [SolidOak](https://github.com/oakes/SolidOak) — a simple IDE for Rust, based on GTK+ and [Neovim](https://github.com/neovim/neovim) :star:25942
...
* [trust](https://github.com/japaric/trust) - A Travis CI and AppVeyor template to test your Rust crate on 5 architectures and publish binary releases of it for Linux, macOS and Windows :star:455
...
* [germangb/minimp3-rs](https://github.com/germangb/minimp3-rs) - Lightweight mp3 decoding library [![Build Status](https://api.travis-ci.org/germangb/minimp3-rs.svg?branch=master)](https://travis-ci.org/germangb/minimp3-rs)
...
* [TeXitoi/structopt](https://github.com/TeXitoi/structopt) — parse command line argument by defining a struct. It combines clap with custom derive. [![Build status](https://api.travis-ci.org/TeXitoi/structopt.svg?branch=master)](https://travis-ci.org/TeXitoi/structopt)
...
* [weld-project/weld](https://github.com/weld-project/weld) - High-performance runtime for data analytics applications :star:774
...
* Cocoa
  ...
  * [servo/cocoa-rs](https://github.com/servo/cocoa-rs) :star:290
...
* [ImGui](https://github.com/ocornut/imgui) :star:9705
...
* [libui](https://github.com/andlabs/libui) :star:4893
...
* [Nuklear](https://github.com/vurtun/nuklear) :star:9431
...
* [Termbox](https://github.com/nsf/termbox) :star:1202
...
* hado
  * [ludat/hado-rs](https://github.com/ludat/hado-rs) - A little macro for writing haskell-like do expressions without too much ceremony :star:9
...
* HTTP Server
  ...
  * [daniel-Q6wUOI/zap](https://github.com/oltdaniel/zap) - A lightning fast http framework for Rust [<img src="https://api.travis-ci.org/daniel-Q6wUOI/zap.svg?branch=master">](https://travis-ci.org/daniel-Q6wUOI/zap)
...
* [Rust Design Patterns](https://github.com/rust-unofficial/patterns) :star:1307
