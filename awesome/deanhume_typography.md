...
- [A simple plugin to keep font-size in proportion with it's containers size](https://github.com/jkroso/flowtype) :star:35
...
- [Normalize-Opentype.css - Adds OpenType features—ligatures, kerning, and more—to Normalize.css.](https://github.com/kennethormandy/normalize-opentype.css) :star:806
- [Type­set.js - A typographic pre-processor for your html which uses zero client-side JavaScript](https://blot.im/typeset/)
- [brick.im](https://github.com/alfredxing/brick) :star:2879
...
- [Using Custom Fonts in Emails](https://github.com/ladjs/custom-fonts-in-emails) :star:65
