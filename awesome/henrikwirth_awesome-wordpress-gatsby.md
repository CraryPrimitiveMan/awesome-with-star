...
- [WPGraphQL for Advanced Custom Fields](https://github.com/wp-graphql/wp-graphql-acf) :star:133
- [WPGraphiQL](https://github.com/wp-graphql/wp-graphiql) :star:132
- [WPGraphQL Polylang Extension](https://github.com/valu-digital/wp-graphql-polylang) :star:14
- [WPGraphQL Gutenberg](https://github.com/pristas-peter/wp-graphql-gutenberg) :star:45
- [WPGraphQL Gutenberg ACF](https://github.com/pristas-peter/wp-graphql-gutenberg-acf) :star:7
- [WP API Menus](https://wordpress.org/plugins/wp-api-menus/)
- [WP JAMstack Deployments](https://github.com/crgeary/wp-jamstack-deployments) :star:102
...
- [Gatsby + WPGraphQL Blog Example](https://github.com/wp-graphql/gatsby-wpgraphql-blog-example) - Demo showing how to use WPGraphQL as the source for Gatsby Sites. :star:83
- [Gatsby + Headless WordPress + Netlify Starter](https://github.com/justinwhall/gatsby-wordpress-netlify-starter) - A Gatsby + WordPress starter for continuous deployment to Netlify. :star:157


## Themes
List of gatsby-themes that work with WordPre as a source, which you can use in your Gatsby setup.

- [Twenty Nineteen Gatsby Theme](https://github.com/zgordon/twentynineteen-gatsby-theme) - A port of the Twenty Nineteen WordPress Theme over to Gatsby. :star:55
