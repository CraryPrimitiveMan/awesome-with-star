...
- [Snap.svg](https://github.com/adobe-webplatform/Snap.svg) - The JavaScript library for modern SVG graphics. :star:12742
- [Svg.js](https://github.com/svgdotjs/svg.js) - The lightweight library for manipulating and animating SVG. :star:7969
- [Vivus](https://github.com/maxwellito/vivus) - Library to make drawing animation on SVG. :star:13029
- [Walkway](https://github.com/ConnorAtherton/walkway) - An easy way to animate SVG elements. :star:4345
- [Raphael](https://github.com/DmitryBaranovskiy/raphael) - JavaScript Vector Library. :star:10615
- [Bonsai](https://github.com/uxebu/bonsai) - BonsaiJS is a graphics library and renderer. :star:1972

## Common

- [GSAP](https://github.com/greensock/GSAP) - JavaScript animation library. :star:10724
- [TweenJS](https://github.com/CreateJS/TweenJS) - A simple but powerful tweening / animation library for JavaScript. Part of the CreateJS suite of libraries. :star:3170
- [Anime.js](https://github.com/juliangarnier/anime) - JavaScript animation engine. :star:35390
- [Mojs](https://github.com/mojs/mojs) - The motion graphics toolbelt for the web. :star:15736
- [Animo.js](https://github.com/ThrivingKings/animo.js) - A powerful little tool for managing CSS animations. :star:2167
- [Move.js](https://github.com/visionmedia/move.js) - CSS3 backed JavaScript animation framework. :star:4551
- [Velocity](https://github.com/julianshapiro/velocity) - Accelerated JavaScript animation. :star:16606
- [Animateplus](https://github.com/bendc/animateplus) - A+ animation module for the modern web. :star:5463
- [Animatic](https://github.com/lvivski/animatic) - CSS animations engine. :star:1403
- [Just Animate](https://github.com/just-animate/just-animate) - Making Animation Simple. :star:236
- [Haiku Core](https://github.com/HaikuTeam/core) - Interactive UI animation engine for the Web. Core renderer for Haiku Animator. :star:718
- [Between.js](https://github.com/sasha240100/between.js) - Lightweight JavaScript (ES6) tweening engine. :star:690
- [Progressbar.js](https://github.com/kimmobrunfeldt/progressbar.js) - Responsive and slick progress bars. :star:7204
- [Bezier easing](https://github.com/gre/bezier-easing) - Cubic-bezier implementation for your JavaScript animation easings. :star:1178
- [Glsl easings](https://github.com/glslify/glsl-easings) - Easing functions in GLSL. :star:250
- [ES6-tween](https://github.com/tweenjs/es6-tween) - ES6 version of tween.js. :star:159

## CSS

- [Animate.css](https://github.com/daneden/animate.css) -  A cross-browser library of CSS animations. As easy to use as an easy thing. :star:66660
- [Motion-ui](https://github.com/foundation/motion-ui) - The powerful Sass library for creating CSS transitions and animations. :star:953
- [Magic](https://github.com/miniMAC/magic) - CSS3 Animations with special effects. :star:6481
- [Css-loaders](https://github.com/lukehaas/css-loaders) - A collection of loading spinners animated with CSS. :star:6316
- [SpinKit](https://github.com/tobiasahlin/SpinKit) - A collection of loading indicators animated with CSS. :star:16952
- [Bounce.js](https://github.com/tictail/bounce.js) - Create beautiful CSS3 powered animations in no time. :star:6057

## Canvas

- [EaselJS](https://github.com/CreateJS/EaselJS) - EaselJS is a library for building high-performance interactive 2D content in HTML5. :star:7556
- [Fabric.js](https://github.com/fabricjs/fabric.js) - JavaScript canvas library with animation support. :star:15836
- [Paper.js](https://github.com/paperjs/paper.js) - The Swiss Army Knife of Vector Graphics Scripting – Scriptographer ported to JavaScript and the browser, using HTML5 Canvas. :star:11548
- [Konva](https://github.com/konvajs/konva) - Konva.js is an HTML5 Canvas JavaScript framework that extends the 2d context by enabling canvas interactivity for desktop and mobile applications. :star:4946
- [Two.js](https://github.com/jonobr1/two.js) - A renderer agnostic two-dimensional drawing api for the web with animation support. :star:6661
- [Ocanvas](https://github.com/koggdal/ocanvas) - JavaScript library for object-based canvas drawing. :star:470
- [Curtainsjs](https://github.com/martinlaxenaire/curtainsjs) - Lightweight vanilla WebGL JavaScript library that turns HTML DOM elements into interactive textured planes. :star:748
- [Hover-effect](https://github.com/robin-dela/hover-effect) - JavaScript library to draw and animate images on hover. :star:769

## Animate on scroll

- [AOS](https://github.com/michalsnik/aos) - Animate on scroll library. :star:12668
- [Laxxx](https://github.com/alexfoxy/laxxx) - Simple & light weight (3kb minified & zipped) vanilla JavaScript plugin to create smooth & beautiful animations when you scrolllll! :star:6932
- [Wow](https://github.com/matthieua/WOW) - Reveal CSS animation as you scroll down a page. :star:9227
- [Scrollreveal](https://github.com/scrollreveal/scrollreveal) - Animate elements as they scroll into view. :star:18712
- [ScrollMagic](https://github.com/janpaepke/ScrollMagic) - The JavaScript library for magical scroll interactions. :star:12216
- [Motus](https://github.com/alexcambose/motus) - Animation library that mimics CSS keyframes when scrolling. :star:410
- [Sal](https://github.com/mciastek/sal) - Performance focused, lightweight scroll animation library. :star:2488

## Text

- [Malarkey](https://github.com/yuanqing/malarkey) - Simulate a typewriter effect in vanilla JavaScript. :star:236
- [Typed.js](https://github.com/mattboldt/typed.js) - A JavaScript Typing Animation Library. :star:9516
- [Shuffle-text](https://github.com/ics-ikeda/shuffle-text) - Shuffle-text is JavaScript text effect library such as cool legacy of Flash. :star:50
- [Typebot](https://github.com/akzhy/typebot) - JavaScript library for typing animation. :star:13
- [Blotter](https://github.com/bradley/Blotter) - A JavaScript API for drawing unconventional text effects on the web. :star:2622

## React

- [Motion](https://github.com/framer/motion) - Open source, production-ready animation and gesture library for React. :star:4973
- [SVGR](https://github.com/gregberge/svgr) - Transform SVGs into React components. :star:6212
