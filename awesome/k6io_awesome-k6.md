# Information comes from [k6io/awesome-k6](https://github.com/k6io/awesome-k6)
<div align="center">
  <a href="https://k6.io/">
...
- [k6-github-actions-example](https://github.com/loadimpact/k6-github-actions-example) - Running k6 load tests as part of a GitHub Actions build. :star:1
...
- [k6-typescript-framework](https://github.com/go-automate/k6-typescript-framework) - Example of a k6 load testing framework written in TypeScript. :star:5
...
- [example-data-generation](https://github.com/k6io/example-data-generation) - Generate realistic data for k6 using faker. :star:1
...
- [har-to-k6](https://github.com/loadimpact/har-to-k6) - Tool for converting HAR recordings to k6 test scripts. :star:5
- [postman-to-k6](https://github.com/loadimpact/postman-to-k6) - Tool for converting Postman collections to k6 test scripts. :star:88
- [k6 generator](https://github.com/OpenAPITools/openapi-generator) - Tool for converting Swagger/OpenAPI specifications to k6 test scripts. :star:5025
- [jmeter-to-k6](https://github.com/loadimpact/jmeter-to-k6) - Tool for converting JMeter test cases to k6 test scripts. :star:23
- [jslib.k6.io](https://jslib.k6.io/) - Useful utility libs for k6 scripts.

## Stacks

- [CloudPosse's Load Testing Stack](https://github.com/cloudposse/load-testing) - Load testing stack using k6, Grafana and InfluxDB. :star:8
- [Load Impact's OSS Load Testing Stack](https://github.com/loadimpact/open-source-load-testing-stack) - Open-source stack that works well for running load tests, storing results and visualizing those results in dashboards. :star:4
