...
- [GTimeLog](https://github.com/gtimelog/gtimelog) - Simple app for keeping track of time. :star:109
...
- [UberWriter](https://github.com/UberWriter/uberwriter) - Distraction-free Markdown editor for GNU/Linux made with GTK+ :star:183
...
- [Bookworm](https://github.com/babluboy/bookworm) - Simple, focused eBook reader that looks good in GNOME. :star:843
- [Foliate](https://github.com/johnfactotum/foliate) - Simple and modern GTK eBook reader :star:886
...
- [Pulseeffect](https://github.com/wwmm/pulseeffects) - Provides limiter, compressor, reverberation, equalizer and auto volume effects for PulseAudio applications. :star:1070
...
- [Lutris](https://github.com/lutris/lutris) - Open Source gaming platform for GNU/Linux :star:2314
...
- [Dynamic Wallpaper Editor](https://github.com/maoschanz/dynamic-wallpaper-editor) - Utility for editing GNOME's XML wallpapers :star:46

### Tools

- [Catfish](https://launchpad.net/catfish-search) - Search application, created for XFCE but follows the GNOME HIG.
- [Tilix](https://github.com/gnunn1/terminix/) - Tiling terminal emulator for GNOME. :star:3428
- [GPaste](https://github.com/Keruspe/GPaste) - Clipboard manager for GNOME (composed of an applicaiton and an extension). :star:345
- [Peek](https://github.com/phw/peek) - Simple screen recorder that saves your recording as a GIF. :star:4747
- [Sequeler](https://github.com/Alecaddd/sequeler) - SQL Client built in Vala :star:402
...
- [Firefox GNOME Theme](https://github.com/rafaelmardojai/firefox-gnome-theme) - Integrate Firefox into GNOME-based desktop using Adwaita. :star:201
...
- [GSConnect](https://github.com/andyholmes/gnome-shell-extension-gsconnect) - KDE Connect implementation for Gnome Shell 3.24+ :star:1127
...
### Windows
- [Window Corner Preview](https://github.com/medenagan/window-corner-preview) - Create and anchor preview of a window to a corener of the screen. :star:106
...
- [PaperWM](https://github.com/paperwm/PaperWM) - Tiled scrollable window management for GNOME Shell. :star:380
...
- [Materia](https://github.com/nana-4/materia-theme) - Material Design-like theme for GNOME/GTK+ based desktop environments. (GTK, Shell) :star:2348
- [Adapta](https://github.com/adapta-project/adapta-gtk-theme) - Adaptive GTK+ theme based on Material Design Guidelines. (GTK, Shell) :star:3293
- [Vimix](https://github.com/vinceliuice/vimix-gtk-themes) - A flat Material Design theme for GTK 3, GTK 2 and Gnome-Shell. :star:1029

### Flat

- [Arc](https://github.com/NicoHood/arc-theme) - Flat theme with transparent elements. (GTK, Shell) :star:574
...
- [Numix](https://github.com/numixproject/numix-gtk-theme) - Popular flat semi-dark theme with an orange touch. (GTK) :star:1061
- [Zukitre](https://github.com/lassekongo83/zuki-themes) - Flat grey theme, part of the zuki-theme suite. (GTK, works with Zuki-Shell for the shell theme) :star:492
- [Yaru](https://github.com/ubuntu/yaru) - Ubuntu community theme (GTK, Shell) :star:472
...
- [Zukitwo](https://github.com/lassekongo83/zuki-themes) - Skeumorphic grey theme, part of the zuki-theme suite. (GTK, works with Zuki-Shell for the shell theme). :star:492

## Icons

### Adwaita-based

- [GNOME++](https://github.com/Bonandry/gnome-plus) - Third-party icons theme, based on GNOME 3.32's Adwaita :star:22

### Material Icons

- [Paper](https://snwh.org/paper) - Material icon theme.
- [Papirus](https://github.com/PapirusDevelopmentTeam/papirus-icon-theme) - Material icon theme, initially based on Paper. :star:2775
...
- [Numix Circle](https://github.com/numixproject/numix-icon-theme-circle) - Flat rounded icon theme. :star:525
