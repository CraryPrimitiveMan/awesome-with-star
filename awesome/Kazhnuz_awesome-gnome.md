...
- [Tangram](https://github.com/sonnyp/Tangram) - Group your webapps into a single application. :star:35

### Office

- [NFO Viewer](https://github.com/otsaloma/nfoview) - Simple viewer for NFO files, beating text editors with preset font and encoding settings and clickable hyperlink support. :star:67
...
- [Bookworm](https://github.com/babluboy/bookworm) - Simple, focused eBook reader that looks good in GNOME. :star:902
- [Foliate](https://github.com/johnfactotum/foliate) - Simple and modern eBook reader. :star:1106
...
- [UberWriter](https://github.com/UberWriter/uberwriter) - Distraction-free Markdown editor. :star:204
- [Marker](https://github.com/fabiocolacio/Marker) - Markdown editor with an integrated previewer. :star:465

### Productivity and Time

- [GNOME Todo](https://wiki.gnome.org/Apps/Todo) - Minimal task manager. ![GNOME Core][GNOME Core]
- [GTimeLog](https://github.com/gtimelog/gtimelog) - Simple app for keeping track of time. :star:115
...
- [Celluloid](https://github.com/celluloid-player/celluloid) - Simple frontend for mpv. :star:334
...
- [Pulseeffect](https://github.com/wwmm/pulseeffects) - Provides limiter, compressor, reverberation, equalizer and auto volume effects for PulseAudio applications. :star:1191
...
- [Drawing](https://github.com/maoschanz/drawing) - Responsive drawing application. :star:169

### Gaming

- [Lutris](https://github.com/lutris/lutris) - Open Source gaming platform. :star:2671
...
- [Tilix](https://github.com/gnunn1/terminix/) - Tiling terminal emulator. :star:3590
...
- [Dynamic Wallpaper Editor](https://github.com/maoschanz/dynamic-wallpaper-editor) - Utility for editing GNOME's XML wallpapers :star:60
- [Unifydmin](https://gitlab.com/gabmus/unifydmin) - Unified administration panel for heterogeneous Linux servers.

### Utilities

- [GPaste](https://github.com/Keruspe/GPaste) - Clipboard manager (composed of an applicaiton and a gnome-shell extension). :star:368
- [Peek](https://github.com/phw/peek) - Simple screen recorder that saves your recording as a GIF. :star:5177
...
- [Sequeler](https://github.com/Alecaddd/sequeler) - SQL Client built in Vala. :star:481
...
- [razerCommander](https://github.com/GabMus/razerCommander) - Control center for managing Razer peripherals. :star:121

## Third-party Apps Plugins

- [Firefox GNOME Theme](https://github.com/rafaelmardojai/firefox-gnome-theme) - Integrate Firefox into GNOME-based desktop using Adwaita. :star:277
...
- [Clipboard Indicator](https://github.com/Tudmotu/gnome-shell-extension-clipboard-indicator) - Simple clipboard applet. :star:212
- [Desk Changer](https://github.com/BigE/desk-changer/) - Wallpaper slideshow applet. :star:48
- [Emoji Selector](https://github.com/maoschanz/emoji-selector-for-gnome) - Emoji picker applet. :star:112
...
- [GSConnect](https://github.com/andyholmes/gnome-shell-extension-gsconnect) - KDE Connect implementation. :star:1231
- [Docker Integration](https://github.com/gpouilloux/gnome-shell-extension-docker) - An extension for managing docker containers :star:95
...
### Windows
- [Window Corner Preview](https://github.com/medenagan/window-corner-preview) - Create and anchor preview of a window to a corener of the screen. :star:117
...
- [PaperWM](https://github.com/paperwm/PaperWM) - Tiled scrollable window management. :star:467
...
- [Oomox](https://github.com/themix-project/oomox) - Generates different color variations of Numix and Materia themes. :star:974
...
- [Yaru](https://github.com/ubuntu/yaru) - Ubuntu's official community-made style. (GTK, Shell) :star:557
...
- [Materia](https://github.com/nana-4/materia-theme) - Material Design-like theme. (GTK, Shell) :star:2475
- [Adapta](https://github.com/adapta-project/adapta-gtk-theme) - Adaptive theme based on Material Design Guidelines. (GTK, Shell) :star:3337
- [Vimix](https://github.com/vinceliuice/vimix-gtk-themes) - A flat Material Design theme. (GTK, Shell) :star:1106
- [Plata](https://gitlab.com/tista500/plata-theme) - A Gtk theme based on Material Design Refresh. (GTK, Shell)

#### Flat

- [Arc](https://github.com/NicoHood/arc-theme) - Flat theme with transparent elements. (GTK, Shell) :star:627
- [Pop](https://github.com/pop-os/gtk-theme/) - Official theme of Pop!\_OS by System76. (GTK, Shell) :star:366
- [Numix](https://github.com/numixproject/numix-gtk-theme) - Popular flat semi-dark theme with an orange touch. (GTK) :star:1074
- [Zukitre](https://github.com/lassekongo83/zuki-themes) - Flat grey theme, part of the zuki-theme suite. (GTK, works with Zuki-Shell for the shell theme) :star:505
...
- [Zukitwo](https://github.com/lassekongo83/zuki-themes) - Skeumorphic grey theme, part of the zuki-theme suite. (GTK, works with Zuki-Shell for the shell theme). :star:505

### Icons

#### Upstream Style

- [GNOME++](https://github.com/Bonandry/gnome-plus) - Third-party application icons compatible with GNOME's current guidelines. :star:41
- [Pop!](https://github.com/pop-os/icon-theme) - Official icon theme of Pop!\_OS by System76. :star:32

#### Material Icons

- [Paper](https://snwh.org/paper) - Material icon theme.
- [Papirus](https://github.com/PapirusDevelopmentTeam/papirus-icon-theme) - Material icon theme, initially based on Paper. :star:2958

#### Flat Icons

- [La Capitaine](https://github.com/keeferrourke/la-capitaine-icon-theme) - Icon inspired by macOS and Material Design guidelines. :star:1469
...
- [Numix Circle](https://github.com/numixproject/numix-icon-theme-circle) - Flat rounded icon theme. :star:551
...
### Cursors
 ...
 - [Bibata](https://github.com/KaizIqbal/Bibata_Cursor) - Silm material-based cursor theme. :star:195
 - [Capitaine Cursors](https://github.com/keeferrourke/capitaine-cursors) - An x-cursor theme inspired by macOS and based on KDE Breeze. Designed to be paired with La Capitaine icons. :star:533
