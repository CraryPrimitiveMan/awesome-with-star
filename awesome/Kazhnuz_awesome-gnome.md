...
- [NFO Viewer](https://github.com/otsaloma/nfoview) - Simple viewer for NFO files, beating text editors with preset font and encoding settings and clickable hyperlink support. :star:68
...
- [Bookworm](https://github.com/babluboy/bookworm) - Simple, focused eBook reader that looks good in GNOME. :star:906
- [Foliate](https://github.com/johnfactotum/foliate) - Simple and modern eBook reader. :star:1120
...
- [UberWriter](https://github.com/UberWriter/uberwriter) - Distraction-free Markdown editor. :star:206
- [Marker](https://github.com/fabiocolacio/Marker) - Markdown editor with an integrated previewer. :star:468

### Productivity and Time

- [GNOME Todo](https://wiki.gnome.org/Apps/Todo) - Minimal task manager. ![GNOME Core][GNOME Core]
- [GTimeLog](https://github.com/gtimelog/gtimelog) - Simple app for keeping track of time. :star:116
...
- [Celluloid](https://github.com/celluloid-player/celluloid) - Simple frontend for mpv. :star:342
...
- [Pulseeffect](https://github.com/wwmm/pulseeffects) - Provides limiter, compressor, reverberation, equalizer and auto volume effects for PulseAudio applications. :star:1199
...
- [Drawing](https://github.com/maoschanz/drawing) - Responsive drawing application. :star:171

### Gaming

- [Lutris](https://github.com/lutris/lutris) - Open Source gaming platform. :star:2692
...
- [Tilix](https://github.com/gnunn1/terminix/) - Tiling terminal emulator. :star:3596
...
- [Peek](https://github.com/phw/peek) - Simple screen recorder that saves your recording as a GIF. :star:5200
...
- [Sequeler](https://github.com/Alecaddd/sequeler) - SQL Client built in Vala. :star:488
...
- [razerCommander](https://github.com/GabMus/razerCommander) - Control center for managing Razer peripherals. :star:122

## Third-party Apps Plugins

- [Firefox GNOME Theme](https://github.com/rafaelmardojai/firefox-gnome-theme) - Integrate Firefox into GNOME-based desktop using Adwaita. :star:280
...
- [Clipboard Indicator](https://github.com/Tudmotu/gnome-shell-extension-clipboard-indicator) - Simple clipboard applet. :star:215
...
- [GSConnect](https://github.com/andyholmes/gnome-shell-extension-gsconnect) - KDE Connect implementation. :star:1239
...
- [PaperWM](https://github.com/paperwm/PaperWM) - Tiled scrollable window management. :star:475
...
- [Oomox](https://github.com/themix-project/oomox) - Generates different color variations of Numix and Materia themes. :star:979
...
- [Yaru](https://github.com/ubuntu/yaru) - Ubuntu's official community-made style. (GTK, Shell) :star:563
...
- [Materia](https://github.com/nana-4/materia-theme) - Material Design-like theme. (GTK, Shell) :star:2485
- [Adapta](https://github.com/adapta-project/adapta-gtk-theme) - Adaptive theme based on Material Design Guidelines. (GTK, Shell) :star:3340
- [Vimix](https://github.com/vinceliuice/vimix-gtk-themes) - A flat Material Design theme. (GTK, Shell) :star:1115
- [Plata](https://gitlab.com/tista500/plata-theme) - A Gtk theme based on Material Design Refresh. (GTK, Shell)

#### Flat

- [Arc](https://github.com/NicoHood/arc-theme) - Flat theme with transparent elements. (GTK, Shell) :star:633
- [Pop](https://github.com/pop-os/gtk-theme/) - Official theme of Pop!\_OS by System76. (GTK, Shell) :star:369
- [Numix](https://github.com/numixproject/numix-gtk-theme) - Popular flat semi-dark theme with an orange touch. (GTK) :star:1076
...
- [GNOME++](https://github.com/Bonandry/gnome-plus) - Third-party application icons compatible with GNOME's current guidelines. :star:43
...
- [Papirus](https://github.com/PapirusDevelopmentTeam/papirus-icon-theme) - Material icon theme, initially based on Paper. :star:2974

#### Flat Icons

- [La Capitaine](https://github.com/keeferrourke/la-capitaine-icon-theme) - Icon inspired by macOS and Material Design guidelines. :star:1477
...
- [Numix Circle](https://github.com/numixproject/numix-icon-theme-circle) - Flat rounded icon theme. :star:553
...
### Cursors
 ...
 - [Bibata](https://github.com/KaizIqbal/Bibata_Cursor) - Silm material-based cursor theme. :star:198
 - [Capitaine Cursors](https://github.com/keeferrourke/capitaine-cursors) - An x-cursor theme inspired by macOS and based on KDE Breeze. Designed to be paired with La Capitaine icons. :star:536
