...
- [Gifify](https://github.com/vvo/gifify) - Convert any video file to an optimized animated GIF :star:5087
- [Gifify (not the same)](https://github.com/jclem/gifify) - convert screen recording into GIF :star:996
- [Gifsicle](https://github.com/kornelski/giflossy) - lossy GIF compressor :star:903
- [Gifs](https://github.com/jglovier/gifs) - storage place for GIFs :star:1592
- [Gifshot](https://github.com/yahoo/gifshot) - create animated GIFs from media by Yahoo. ([demo](http://yahoo.github.io/gifshot/))
- [Gifsockets](https://github.com/videlalvaro/gifsockets) - Real Time communication library using Animated GIFs as a transport :star:1677
- [X-gif](https://github.com/geelen/x-gif) - a web component for flexible GIF playback :star:1953
- [GifW00t](https://github.com/yaronn/GifW00t) - javascript web recorder :star:784
- [gif-machine](https://github.com/lelandbatey/gif-machine) - GIF creation from Youtube videos :star:53
- [gifstreaming](https://github.com/jbochi/gifstreaming) - Live video streaming server :star:142
- [Screengif](https://github.com/dergachev/screengif) - Create animated GIF screencasts :star:1128
- [vnc-over-gif](https://github.com/sidorares/vnc-over-gif) - Serves screen updates as animated GIF over http :star:515
...
- [Gifline](https://github.com/zehfernandes/gifline) - Chrome extension to put GIFs in your emails :star:60
...
- [Tty2gif](https://github.com/z24/tty2gif) - record scripts and their outputs into both binary and GIF formats :star:144
- [Giftoppr](https://github.com/desktoppr/giftoppr) - Sync your favourite GIFs with Dropbox :star:35
- [Gifit](https://github.com/Fauntleroy/GIFit) - Chrome extension to make a GIF from a YouTube video :star:110
- [Ccapture.js](https://github.com/spite/ccapture.js) - Capture animations created with HTML5 canvas :star:1786
...
- [gifski](https://github.com/ImageOptim/gifski) - High-quality GIF encoder based on libimagequant. :star:1369
...
- [Node-gif](https://github.com/pkrumins/node-gif) - C++ library to make GIF :star:185
- [Gif-h](https://github.com/ginsweater/gif-h) - C++ one-header library for the creation of animated GIFs :star:239
- [OfxGifEncoder](https://github.com/jesusgollonet/ofxGifEncoder) - C++ openframeworks addon to export animated GIFs :star:93

<h3 id="c-sharp">C#</h2>

- [dot-screencap](https://github.com/Speiser/dot-screencap) - A simple libary to record your screen and save it as animated GIF :star:22
- [WpfAnimatedGif](https://github.com/thomaslevesque/WpfAnimatedGif) - A simple library to display animated GIF images in WPF :star:16
...
- [AnimatedGif](https://github.com/mrousavy/AnimatedGif) - A high performance .NET library for reading and creating animated GIFs :star:33
...
- [Android-gif-drawable](https://github.com/koral--/android-gif-drawable) - Views and Drawable for displaying animated GIFs on Android :star:7615
...
- [Gif Movie View](https://github.com/sbakhtiarov/gif-movie-view) - Android View widget for displaying GIF animations :star:454
- [GifImageView](https://github.com/felipecsl/GifImageView) - Android ImageView that handles animated GIF images :star:1063
- [Gif-animation](https://github.com/extrapixel/gif-animation) - Processing library to play and export GIF :star:139
- [Android-gif-encoder](https://github.com/nbadal/android-gif-encoder) - animated GIF encoder for Android :star:255
- [GIFDroid](https://github.com/quackware/GIFDroid) - Android video to GIF converter :star:95
- [Android-GifStitch](https://github.com/CaptPhunkosis/Android-GifStitch) - create and share animated GIFs :star:39

#### JavaScript

- [Gif.js](https://github.com/jnordberg/gif.js) - Javascript - create GIF from the DOM :star:3246
- [Omggif](https://github.com/deanm/omggif) - Javascript - GIF 89a encoder and decoder :star:447
- [Animated_GIF](https://github.com/sole/Animated_GIF) - Javascript library for creating animated GIFs :star:178
- [Gifffer](https://github.com/krasimir/gifffer) JavaScript library that prevents the autoplaying of the animated GIFs
- [Gifplayer](https://github.com/rubentd/gifplayer) - jquery plugin to play and stop animated GIFs :star:433
- [Jsgif](https://github.com/shachaf/jsgif) - JavaScript GIF parser and player :star:446
- [node-gify](https://github.com/tj/node-gify) - Javascript convert videos to GIFs using ffmpeg and gifsicle :star:244
- [Gifencoder](https://github.com/eugeneware/gifencoder) - Server side animated GIF generation for node.js :star:317
- [Gif-video](https://github.com/hughsk/gif-video) - Javascript Convert a GIF image into an HTML5-ready video :star:63
...
- [node-youtube](https://github.com/javascipt/node-youtube) - Youtube to snapshots and GIFs. :star:159

#### PHP

- [GifCreator](https://github.com/Sybio/GifCreator) - PHP class that creates animated GIF from multiple images :star:282
- [Spacer.gif](https://github.com/msng/spacer.gif) - PHP script offering spacer.gif 1x1 :star:16
- [GifFrameExtractor](https://github.com/Sybio/GifFrameExtractor) - PHP class that separates all the frames of an animated GIF :star:139

#### Objective-C

- [AnimatedGIFImageSerialization](https://github.com/mattt/AnimatedGIFImageSerialization) - decodes an UIImage from Animated GIFs image data :star:1078
- [UIimage from GIF](https://github.com/mayoff/uiimage-from-animated-gif) - UIImage category that loads animated GIFs :star:849
- [GIFRefreshControl](https://github.com/cyndibaby905/GIFRefreshControl) - "Twitter music" and "Yahoo! Weather" like pull-to-refresh control :star:297
- [UIImageView-PlayGIF](https://github.com/yfme/UIImageView-PlayGIF) - UIImageView category/subclass for playing GIF :star:433
- [FLAnimatedImage](https://github.com/Flipboard/FLAnimatedImage) - Gif engine for iOS by FlipBoard :star:7275
- [Animated-GIF-iPhone](https://github.com/arturogutierrez/Animated-GIF-iPhone) - Support for Animated GIF on iOS :star:131
- [UzysAnimatedGifPullToRefresh](https://github.com/uzysjung/UzysAnimatedGifPullToRefresh) - PullToRefresh using animated GIF to any scrollView :star:1431
- [SvGifView](https://github.com/smileEvday/SvGifView) - iOS load and display GIF :star:83
- [GifHUD](https://github.com/cemolcay/GiFHUD) - iOS progress hud for displaying only animated GIF images :star:157
...
- [Gifu](https://github.com/kaishin/gifu) - animated GIF support for iOS in Swift :star:2276
- [SwiftGif](https://github.com/swiftgif/SwiftGif) - UIImage extension with GIF support :star:1057
...
- [GIFs](https://github.com/orta/GIFs) - Mac App for finding GIFs :star:605
- [VineGifR](https://github.com/caraesten/VineGifR ) - Mac app to turn Vine videos into GIFs :star:85
- [GifPro](https://github.com/unixpickle/GifPro) - GIF encoder for Mac :star:42
- [AnimatedGif](https://github.com/Waitsnake/AnimatedGif) - Mac Screensaver for playing GIFs :star:133
...
- [Starwars-dot-gif](https://github.com/LindseyB/starwars-dot-gif) - Python script to generate GIFs from star wars :star:483
