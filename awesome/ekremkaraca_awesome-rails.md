...
- [Rails Source Code](https://github.com/rails/rails) :star:41228
...
- [adopt-a-hydrant](https://github.com/codeforamerica/adopt-a-hydrant) - A Ruby on Rails application that allows citizens to "adopt" civic infrastructure, such as fire hydrants :star:453
...
- [brimir](https://github.com/ivaldi/brimir) -  Email helpdesk built using Ruby on Rails and Zurb Foundation :star:1443
- [calagator](https://github.com/calagator/calagator) - An event aggregator based in Portland, OR :star:364
...
- [canvas-lms](https://github.com/instructure/canvas-lms) -  A new, open-source learning management system by Instructure Inc   :star:2587
...
- [coursemology2](https://github.com/Coursemology/coursemology2) - Rails 4 re-write of Coursemology   :star:60
- [covoiturage-libre](https://github.com/covoiturage-libre/covoiturage-libre) - a Carpooling Open Source platform in Rails 5 :star:98
...
- [dgi-db](https://github.com/griffithlab/dgi-db) -  Rails frontend to The Genome Institute's drug gene interaction database :star:43
...
- [expertiza](https://github.com/expertiza/expertiza) - web application where students can submit and peer-review learning objects (articles, code, web sites, etc). :star:144
...
- [gitlabhq](https://github.com/gitlabhq/gitlabhq) -  Open source software to collaborate on code  [Live](https://gitlab.com/gitlab-org/gitlab-ce) - :star:21282
...
- [hummingbird](https://github.com/hummingbird-me/hummingbird) - A modern anime discovery platform that helps you track the anime you're watching, discover new anime and socialize with other fans :star:1973
...
- [intercityup.com](https://github.com/intercity/intercity-next) -  Control Panel for hosting Ruby on Rails :star:45
- [kanban](https://github.com/somlor/kanban) - A Trello clone in Rails and Backbone.js  [Live](http://kanban.seanomlor.com)
- [lavish](https://github.com/mquan/lavish) - a rails app that generates Bootstrap color scheme from an image  :star:703
- [leihs](https://github.com/leihs/leihs) - An easy inventory handling system   :star:72
...
- [lobsters](https://github.com/jcs/lobsters) -  Rails code running the lobste.rs link aggregation site   :star:1971
...
- [obtvse2](https://github.com/natew/obtvse2) - A clean and simple markdown blogging platform on Rails :star:260
...
- [OpenFarm](https://github.com/openfarmcc/OpenFarm) -  A free and open database for farming and gardening knowledge   :star:597
...
- [ossfriday](https://github.com/ossfriday/ossfriday) - a movement to encourage companies, people and maintainers to contribute to open source every Friday :star:649
...
- [people](https://github.com/netguru/people) - Manage people within the projects :star:58
- [planningalerts-app](https://github.com/openaustralia/planningalerts) - Find out and have your say about what's being built and knocked down in your area :star:50
- [popHealth](https://github.com/pophealth/popHealth) -  An Open Source Population Health Reporting Prototype   :star:123
...
- [RapidFTR](https://github.com/rapidftr/RapidFTR) -  An Android-based mobile application that lets aid workers collect, sort and share information about children in emergency situations :star:286
...
- [selfstarter](https://github.com/lockitron/selfstarter) - Roll your own crowdfunding :star:3128
...
- [socify](https://github.com/scaffeinate/socify) - an open source social networking platform written in Ruby on Rails :star:312
...
- [trado](https://github.com/Jellyfishboy/trado) - lightweight, easy to use e-commerce platform designed for sole traders and SME businesses   :star:134
...
- [whitehall](https://github.com/alphagov/whitehall) - Inside Government: how the UK Government works, what it's doing, and how you can get involved   :star:500
...
- [Nanobox](https://github.com/nanobox-io/nanobox) - A micro-PaaS (μPaaS) for creating consistent, isolated, development environments deployable anywhere [Live](https://nanobox.io). :star:1273
...
- [rails-dashboard](https://github.com/y-takey/rails-dashboard) - A dev-tool to improve your rails log. :star:64


### Notable Awesome Stuffs

- [jnv/lists](https://github.com/jnv/lists) - List of (awesome) lists curated on GitHub :star:5331
- [awesome-ruby](https://github.com/sdogruyol/awesome-ruby) :star:1065
- [awesome-rails-gem](https://github.com/hothero/awesome-rails-gem) :star:2508
