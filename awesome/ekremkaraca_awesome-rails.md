...
- [Rails Source Code](https://github.com/rails/rails) :star:44473
...
- [Protecting your users data from Rails application using cryptography](https://github.com/cossacklabs/acra/wiki/Using-Acra-to-Protect-Your-Rails-App) :star:483
...
- [activeWorkflow](https://github.com/automaticmode/active_workflow) - An intelligent process and workflow automation platform based on software agents :star:107
- [adopt-a-hydrant](https://github.com/codeforamerica/adopt-a-hydrant) - A Ruby on Rails application that allows citizens to "adopt" civic infrastructure, such as fire hydrants :star:487
...
- [blackCandy](https://github.com/aidewoode/black_candy) - A self hosted music streaming server - **using Rails 6.0** :star:455
- [brimir](https://github.com/ivaldi/brimir) -  Email helpdesk built using Ruby on Rails and Zurb Foundation :star:1434
- [calagator](https://github.com/calagator/calagator) - An event aggregator based in Portland, OR :star:379
...
- [canvas-lms](https://github.com/instructure/canvas-lms) -  A new, open-source learning management system by Instructure Inc :star:2977
...
- [ciao](https://github.com/brotandgames/ciao) - URL status checking app - **using Rails 6.0** :star:1005
...
- [commudle](https://github.com/gdgnewdelhi/commudle) - Community management app - **using Rails 5.2** :star:242
- [contribulator](https://github.com/24pullrequests/contribulator) - Open source project finder app - **using Rails 5.1** :star:87
- [coursemology2](https://github.com/Coursemology/coursemology2) - Learning platform app - **using Rails 5.2** :star:80
...
- [danbooru](https://github.com/r888888888/danbooru) - A taggable image board written in Rails 3 :star:756
- [dcaf_case_management](https://github.com/DCAFEngineering/dcaf_case_management) - Case management app - **using Rails 5.2** :star:65
...
- [ekylibre](https://github.com/ekylibre/ekylibre) - Simple agricultural ERP :star:207
- [postal](https://github.com/atech/postal) - Mail delivery platform app - **using Rails 5.2** :star:9301
...
- [gitlabhq](https://github.com/gitlabhq/gitlabhq) -  Open source software to collaborate on code  [:earth_africa:](https://gitlab.com/gitlab-org/gitlab-ce) - :star:22042
...
- [hummingbird](https://github.com/hummingbird-me/hummingbird) - A modern anime discovery platform that helps you track the anime you're watching, discover new anime and socialize with other fans :star:2009
...
- [intercityup.com](https://github.com/intercity/intercity-next) -  Control Panel for hosting Ruby on Rails :star:74
...
- [lobsters](https://github.com/jcs/lobsters) -  Rails code running the lobste.rs link aggregation site :star:2414
...
- [obtvse2](https://github.com/natew/obtvse2) - A clean and simple markdown blogging platform on Rails :star:263
...
- [openFarm](https://github.com/openfarmcc/OpenFarm) -  A free and open database for farming and gardening knowledge :star:673
...
- [ossfriday](https://github.com/ossfriday/ossfriday) - a movement to encourage companies, people and maintainers to contribute to open source every Friday :star:748
...
- [selfstarter](https://github.com/lockitron/selfstarter) - Roll your own crowdfunding :star:3138
...
- [socify](https://github.com/scaffeinate/socify) - an open source social networking platform written in Ruby on Rails :star:337
...
- [trado](https://github.com/Jellyfishboy/trado) - lightweight, easy to use e-commerce platform designed for sole traders and SME businesses :star:144
...
- [whitehall](https://github.com/alphagov/whitehall) - Inside Government: how the UK Government works, what it's doing, and how you can get involved :star:561
...
- [Nanobox](https://github.com/nanobox-io/nanobox) - A micro-PaaS (μPaaS) for creating consistent, isolated, development environments deployable anywhere [:earth_africa:](https://nanobox.io). :star:1382
...
- [rails-dashboard](https://github.com/y-takey/rails-dashboard) - A dev-tool to improve your rails log. :star:83

[^top](#table-of-contents)

### Notable Awesome Stuffs

- [jnv/lists](https://github.com/jnv/lists) - List of (awesome) lists curated on GitHub :star:6102
- [awesome-ruby](https://github.com/sdogruyol/awesome-ruby) :star:1109
- [awesome-rails-gem](https://github.com/hothero/awesome-rails-gem) :star:2640
