# Information comes from [ekremkaraca/awesome-rails](https://github.com/ekremkaraca/awesome-rails)
...
- [Rails Source Code](https://github.com/rails/rails) :star:44672
...
- [Protecting your users data from Rails application using cryptography](https://github.com/cossacklabs/acra/wiki/Using-Acra-to-Protect-Your-Rails-App) :star:506
...
- [activeWorkflow](https://github.com/automaticmode/active_workflow) - An intelligent process and workflow automation platform based on software agents :star:188
- [adopt-a-hydrant](https://github.com/codeforamerica/adopt-a-hydrant) - A Ruby on Rails application that allows citizens to "adopt" civic infrastructure, such as fire hydrants :star:491
...
- [askaway](https://github.com/askaway/askaway) - Question & answer app specialized in politics - **using Rails 4.1** :star:35
- [autolab](https://github.com/autolab/Autolab) - A course management service - [:earth_africa:](http://www.autolabproject.com)
- [beatstream](https://github.com/Darep/Beatstream) -  App for streaming music from any computer running Ruby on Rails to anywhere :star:120
- [bike_index](https://github.com/bikeindex/bike_index) -  An online bike registry [:earth_africa:](https://bikeindex.org)
- [blackCandy](https://github.com/aidewoode/black_candy) - A self hosted music streaming server - **using Rails 6.0** :star:467
- [brimir](https://github.com/ivaldi/brimir) -  Email helpdesk built using Ruby on Rails and Zurb Foundation :star:1434
- [calagator](https://github.com/calagator/calagator) - An event aggregator based in Portland, OR :star:382
...
- [canvas-lms](https://github.com/instructure/canvas-lms) -  A new, open-source learning management system by Instructure Inc :star:3010
...
- [ciao](https://github.com/brotandgames/ciao) - URL status checking app - **using Rails 6.0** :star:1010
...
- [commudle](https://github.com/gdgnewdelhi/commudle) - Community management app - **using Rails 5.2** :star:243
- [contribulator](https://github.com/24pullrequests/contribulator) - Open source project finder app - **using Rails 5.1** :star:86
- [coursemology2](https://github.com/Coursemology/coursemology2) - Learning platform app - **using Rails 5.2** :star:81
- [covoiturage-libre](https://github.com/covoiturage-libre/covoiturage-libre) - a Carpooling Open Source platform in Rails 5 :star:103
...
- [crowdtiltOpen](https://github.com/Crowdtilt/CrowdtiltOpen) - Open source crowdfunding platform :star:593
- [cyberdojo](https://github.com/cyber-dojo/cyber-dojo) -  Free in-browser coding-dojo [:earth_africa:](http://cyber-dojo.org)
- [danbooru](https://github.com/r888888888/danbooru) - A taggable image board written in Rails 3 :star:769
- [dcaf_case_management](https://github.com/DCAFEngineering/dcaf_case_management) - Case management app - **using Rails 5.2** :star:66
...
- [dgi-db](https://github.com/griffithlab/dgi-db) -  Rails frontend to The Genome Institute's drug gene interaction database :star:58
...
- [ekylibre](https://github.com/ekylibre/ekylibre) - Simple agricultural ERP :star:208
- [postal](https://github.com/atech/postal) - Mail delivery platform app - **using Rails 5.2** :star:9366
- [encrypt.to](https://github.com/encrypt-to/encrypt.to) - Send encrypted messages by one click :star:114
- [eol](https://github.com/EOL/eol) - Encyclopedia of Life  [:earth_africa:](http://eol.org)
- [expertiza](https://github.com/expertiza/expertiza) - web application where students can submit and peer-review learning objects (articles, code, web sites, etc).  :star:151
...
- [gitlabhq](https://github.com/gitlabhq/gitlabhq) -  Open source software to collaborate on code  [:earth_africa:](https://gitlab.com/gitlab-org/gitlab-ce) - :star:22082
...
- [hummingbird](https://github.com/hummingbird-me/hummingbird) - A modern anime discovery platform that helps you track the anime you're watching, discover new anime and socialize with other fans :star:2012
...
- [intercityup.com](https://github.com/intercity/intercity-next) -  Control Panel for hosting Ruby on Rails :star:75
...
- [leihs](https://github.com/leihs/leihs) - An easy inventory handling system :star:90
...
- [lobsters](https://github.com/jcs/lobsters) -  Rails code running the lobste.rs link aggregation site :star:2443
...
- [obtvse2](https://github.com/natew/obtvse2) - A clean and simple markdown blogging platform on Rails :star:264
...
- [openFarm](https://github.com/openfarmcc/OpenFarm) -  A free and open database for farming and gardening knowledge :star:681
- [opencongress](https://github.com/sunlightlabs/opencongress) - An open website for opening Congress :star:47
...
- [ossfriday](https://github.com/ossfriday/ossfriday) - a movement to encourage companies, people and maintainers to contribute to open source every Friday :star:754
...
- [rapidFTR](https://github.com/rapidftr/RapidFTR) -  An Android-based mobile application that lets aid workers collect, sort and share information about children in emergency situations :star:288
...
- [rentmybikes-rails](https://github.com/balanced/rentmybikes-rails) - A fully functional, deployable marketplace implementation using Balanced API for Rails :star:60
...
- [selfstarter](https://github.com/lockitron/selfstarter) - Roll your own crowdfunding :star:3140
...
- [socify](https://github.com/scaffeinate/socify) - an open source social networking platform written in Ruby on Rails :star:338
...
- [trado](https://github.com/Jellyfishboy/trado) - lightweight, easy to use e-commerce platform designed for sole traders and SME businesses :star:146
...
- [whitehall](https://github.com/alphagov/whitehall) - Inside Government: how the UK Government works, what it's doing, and how you can get involved :star:563
...
- [Nanobox](https://github.com/nanobox-io/nanobox) - A micro-PaaS (μPaaS) for creating consistent, isolated, development environments deployable anywhere [:earth_africa:](https://nanobox.io). :star:1393
...
- [rails-dashboard](https://github.com/y-takey/rails-dashboard) - A dev-tool to improve your rails log. :star:84

[^top](#table-of-contents)

### Notable Awesome Stuffs

- [jnv/lists](https://github.com/jnv/lists) - List of (awesome) lists curated on GitHub :star:6200
- [awesome-ruby](https://github.com/sdogruyol/awesome-ruby) :star:1114
- [awesome-rails-gem](https://github.com/hothero/awesome-rails-gem) :star:2644
