...
- [Rails Source Code](https://github.com/rails/rails) :star:44505
...
- [Protecting your users data from Rails application using cryptography](https://github.com/cossacklabs/acra/wiki/Using-Acra-to-Protect-Your-Rails-App) :star:484
...
- [activeWorkflow](https://github.com/automaticmode/active_workflow) - An intelligent process and workflow automation platform based on software agents :star:111
- [adopt-a-hydrant](https://github.com/codeforamerica/adopt-a-hydrant) - A Ruby on Rails application that allows citizens to "adopt" civic infrastructure, such as fire hydrants :star:486
...
- [blackCandy](https://github.com/aidewoode/black_candy) - A self hosted music streaming server - **using Rails 6.0** :star:456
- [brimir](https://github.com/ivaldi/brimir) -  Email helpdesk built using Ruby on Rails and Zurb Foundation :star:1433
- [calagator](https://github.com/calagator/calagator) - An event aggregator based in Portland, OR :star:380
...
- [canvas-lms](https://github.com/instructure/canvas-lms) -  A new, open-source learning management system by Instructure Inc :star:2983
...
- [danbooru](https://github.com/r888888888/danbooru) - A taggable image board written in Rails 3 :star:759
...
- [postal](https://github.com/atech/postal) - Mail delivery platform app - **using Rails 5.2** :star:9320
...
- [gitlabhq](https://github.com/gitlabhq/gitlabhq) -  Open source software to collaborate on code  [:earth_africa:](https://gitlab.com/gitlab-org/gitlab-ce) - :star:22046
...
- [lobsters](https://github.com/jcs/lobsters) -  Rails code running the lobste.rs link aggregation site :star:2420
...
- [openFarm](https://github.com/openfarmcc/OpenFarm) -  A free and open database for farming and gardening knowledge :star:674
...
- [trado](https://github.com/Jellyfishboy/trado) - lightweight, easy to use e-commerce platform designed for sole traders and SME businesses :star:145
...
- [Nanobox](https://github.com/nanobox-io/nanobox) - A micro-PaaS (μPaaS) for creating consistent, isolated, development environments deployable anywhere [:earth_africa:](https://nanobox.io). :star:1384
...
- [jnv/lists](https://github.com/jnv/lists) - List of (awesome) lists curated on GitHub :star:6123
- [awesome-ruby](https://github.com/sdogruyol/awesome-ruby) :star:1110
