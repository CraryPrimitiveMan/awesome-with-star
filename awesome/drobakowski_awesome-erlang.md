# Info come from [drobakowski/awesome-erlang](https://github.com/drobakowski/awesome-erlang)
...
* [stillir](https://github.com/heroku/stillir) - Cache environment variables as Erlang app variables. :star:34

## Codebase Maintenance
*Libraries and tools to maintain a clean codebase.*

* [elvis](https://github.com/inaka/elvis) - Erlang Style Reviewer. :star:286
...
* [ChicagoBoss](https://github.com/ChicagoBoss/ChicagoBoss) - A server framework inspired by Rails and written in Erlang. :star:1689
* [cowboy](https://github.com/ninenines/cowboy) - A simple HTTP server. :star:4627
...
* [MochiWeb](https://github.com/mochi/mochiweb) - An Erlang library for building lightweight HTTP servers. :star:1567
* [N2O](https://github.com/synrc/n2o) - WebSocket Application Server. :star:1067
* [Nitrogen](https://github.com/nitrogen/nitrogen) - Framework to build web applications (including front-end) in pure Erlang. :star:835
* [Zotonic](https://github.com/zotonic/zotonic) - High speed, real-time web framework and content management system. :star:539

## Web Framework Components
*Standalone component from web development frameworks.*

* [cb_admin](https://github.com/ChicagoBoss/cb_admin) - An admin interface for Chicago Boss. :star:74
...
* [bullet](https://github.com/ninenines/bullet) - Simple, reliable, efficient streaming for Cowboy. :star:284
* [gun](https://github.com/ninenines/gun) - Erlang HTTP client with support for HTTP/1.1, SPDY and Websocket. :star:378
* [hackney](https://github.com/benoitc/hackney) - Simple HTTP client in Erlang. :star:766
* [ibrowse](https://github.com/cmullaparthi/ibrowse) - Erlang HTTP client. :star:466
* [lhttpc](https://github.com/esl/lhttpc) - A lightweight HTTP/1.1 client implemented in Erlang. :star:119
* [shotgun](https://github.com/inaka/shotgun) - For the times you need more than just a gun. :star:116

## Testing
*Libraries for testing codebases and generating test data.*

* [PropEr](https://github.com/manopapad/proper) - A QuickCheck-inspired property-based testing tool for Erlang. :star:556
...
* [logplex](https://github.com/heroku/logplex) - Heroku log router. :star:814

## Monitoring
*Libraries for gathering metrics and monitoring.*

* [entop](https://github.com/mazenharake/entop) - A top-like Erlang node monitoring tool. :star:236
* [eper](https://github.com/massemanet/eper) - A loose collection of Erlang Performance related tools. :star:407
* [Exometer](https://github.com/Feuerlabs/exometer) - An Erlang instrumentation package. :star:417
* [folsom](https://github.com/boundary/folsom) - An Erlang based metrics system inspired by Coda Hale's [metrics](https://github.com/codahale/metrics). :star:546
* [statsderl](https://github.com/lpgauth/statsderl) - A statsd Erlang client. :star:81
* [vmstats](https://github.com/ferd/vmstats) - Tiny Erlang app that works in conjunction with statsderl in order to generate information on the Erlang VM for graphite logs. :star:157
...
* [Concuerror](https://github.com/parapluu/Concuerror) - Concuerror is a systematic testing tool for concurrent Erlang programs. :star:133
* [eflame](https://github.com/proger/eflame) - A Flame Graph profiler for Erlang. :star:249

## Build Tools
*Project build and automation tools.*

* [rebar](https://github.com/rebar/rebar) - Erlang build tool that makes it easy to compile and test Erlang applications, port drivers and releases. :star:919
...
* [sync](https://github.com/rustyio/sync) - On-the-fly recompiling for Erlang. :star:616

## Geolocation
*Libraries for geocoding addresses and working with latitudes and longitudes.*

* [erl-rstar](https://github.com/armon/erl-rstar) - An Erlang implementation of the R*-tree spacial data structure. :star:37
...
* [tx](https://github.com/kvakvs/tx) - An HTML Erlang term viewer, starts own webserver and displays any term you give it from your Erlang node. :star:61
...
* [erlang_localtime](https://github.com/dmitryme/erlang_localtime) - Erlang library for conversion from one local time to another. :star:39
* [qdate](https://github.com/choptastic/qdate) - Erlang date, time, and timezone management: formatting, conversion, and date arithmetic. :star:189

## ORM and Datamapping
*Libraries that implement object-relational mapping or datamapping techniques.*

* [boss_db](https://github.com/ErlyORM/boss_db) - A sharded, caching, pooling, evented ORM for Erlang. :star:244
* [epgsql](https://github.com/epgsql/epgsql) - PostgreSQL Driver for Erlang. :star:217
* [mysql-otp](https://github.com/mysql-otp/mysql-otp) - MySQL/OTP – MySQL driver for Erlang/OTP. :star:219
* [pgsql_migration](https://github.com/artemeff/pgsql_migration) – PostgreSQL migrations for Erlang.

## Queue
*Libraries for working with event and task queues.*

* [dq](https://github.com/darach/dq) - Distributed Fault Tolerant Queue library. :star:25
* [ebqueue](https://github.com/rgrinberg/ebqueue) - Tiny simple blocking queue in erlang. :star:5
* [pqueue](https://github.com/okeuday/pqueue) - Erlang Priority Queues. :star:95
* [tinymq](https://github.com/ChicagoBoss/tinymq) - A diminutive, in-memory message queue for Erlang. :star:97

## Authentication
*Libraries for implementing authentications schemes.*

* [oauth2](https://github.com/kivra/oauth2) - Erlang Oauth2 implementation. :star:193

## Text and Numbers
*Libraries for parsing and manipulating text and numbers.*

* [eql](https://github.com/artemeff/eql) - Erlang with SQL or not. :star:66
* [jiffy](https://github.com/davisp/jiffy) - JSON NIFs for Erlang. :star:628
...
* [qsp](https://github.com/artemeff/qsp) - Enhanced query string parser for Erlang. :star:14
...
* [cache](https://github.com/fogfish/cache) - In-memory Segmented Cache :star:86

## Third Party APIs
*Libraries for accessing third party APIs.*

* [restc](https://github.com/kivra/restclient) - An Erlang REST client :star:68
* [oauth2c](https://github.com/kivra/oauth2_client) - An Erlang oAuth 2 client (uses restc)

## Networking
*Libraries and tools for using network related stuff.*

* [barrel_tcp](https://github.com/benoitc-attic/barrel_tcp) - barrel_tcp is a generic TCP acceptor pool with low latency in Erlang. :star:83
* [gen_rpc](https://github.com/priestjim/gen_rpc) - A scalable RPC library for Erlang-VM based languages. :star:133
...
* [nat_upnp](https://github.com/benoitc/nat_upnp) - Erlang library to map your internal port to an external using UNP IGD. :star:35
* [ranch](https://github.com/ninenines/ranch) - Socket acceptor pool for TCP protocols. :star:742

## Internet of Things
*Libraries and tools for interacting with the physical world.*
* [lemma_erlang](https://github.com/noam-io/lemma_erlang) - A lemma for IDEO's Noam internet-of-things prototyping platform. :star:2
...
* [riak_dt](https://github.com/basho/riak_dt) - Erlang library of state based CRDTs. :star:230
