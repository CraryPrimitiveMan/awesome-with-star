...
* [cowboy](https://github.com/ninenines/cowboy) - A simple HTTP server. :star:4731
...
* [MochiWeb](https://github.com/mochi/mochiweb) - An Erlang library for building lightweight HTTP servers. :star:1581
...
* [Zotonic](https://github.com/zotonic/zotonic) - High speed, real-time web framework and content management system. :star:549
...
* [hackney](https://github.com/benoitc/hackney) - Simple HTTP client in Erlang. :star:787
...
* [PropEr](https://github.com/manopapad/proper) - A QuickCheck-inspired property-based testing tool for Erlang. :star:563
...
* [eper](https://github.com/massemanet/eper) - A loose collection of Erlang Performance related tools. :star:413
...
* [vmstats](https://github.com/ferd/vmstats) - Tiny Erlang app that works in conjunction with statsderl in order to generate information on the Erlang VM for graphite logs. :star:172
...
* [tx](https://github.com/kvakvs/tx) - An HTML Erlang term viewer, starts own webserver and displays any term you give it from your Erlang node. :star:63
...
* [mysql-otp](https://github.com/mysql-otp/mysql-otp) - MySQL/OTP – MySQL driver for Erlang/OTP. :star:226
...
* [pqueue](https://github.com/okeuday/pqueue) - Erlang Priority Queues. :star:97
* [tinymq](https://github.com/ChicagoBoss/tinymq) - A diminutive, in-memory message queue for Erlang. :star:99

## Authentication
*Libraries for implementing authentications schemes.*

* [oauth2](https://github.com/kivra/oauth2) - Erlang Oauth2 implementation. :star:194

## Text and Numbers
*Libraries for parsing and manipulating text and numbers.*

* [eql](https://github.com/artemeff/eql) - Erlang with SQL or not. :star:73
* [jiffy](https://github.com/davisp/jiffy) - JSON NIFs for Erlang. :star:643
...
* [cache](https://github.com/fogfish/cache) - In-memory Segmented Cache :star:91
...
* [gen_rpc](https://github.com/priestjim/gen_rpc) - A scalable RPC library for Erlang-VM based languages. :star:143
...
* [ranch](https://github.com/ninenines/ranch) - Socket acceptor pool for TCP protocols. :star:758
...
* [Erlang Bookmarks](https://github.com/0xAX/erlang-bookmarks/wiki/Erlang-bookmarks) - All about erlang programming language [powerd by community]. :star:1004
