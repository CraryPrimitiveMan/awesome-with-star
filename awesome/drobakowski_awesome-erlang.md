...
* [ChicagoBoss](https://github.com/ChicagoBoss/ChicagoBoss) - A server framework inspired by Rails and written in Erlang. :star:1729
* [cowboy](https://github.com/ninenines/cowboy) - A simple HTTP server. :star:5048
...
* [Zotonic](https://github.com/zotonic/zotonic) - High speed, real-time web framework and content management system. :star:560
...
* [bullet](https://github.com/ninenines/bullet) - Simple, reliable, efficient streaming for Cowboy. :star:297
* [gun](https://github.com/ninenines/gun) - Erlang HTTP client with support for HTTP/1.1, SPDY and Websocket. :star:442
* [hackney](https://github.com/benoitc/hackney) - Simple HTTP client in Erlang. :star:839
...
* [shotgun](https://github.com/inaka/shotgun) - For the times you need more than just a gun. :star:122

## Testing
*Libraries for testing codebases and generating test data.*

* [PropEr](https://github.com/manopapad/proper) - A QuickCheck-inspired property-based testing tool for Erlang. :star:589
...
* [entop](https://github.com/mazenharake/entop) - A top-like Erlang node monitoring tool. :star:246
...
* [vmstats](https://github.com/ferd/vmstats) - Tiny Erlang app that works in conjunction with statsderl in order to generate information on the Erlang VM for graphite logs. :star:188
...
* [Concuerror](https://github.com/parapluu/Concuerror) - Concuerror is a systematic testing tool for concurrent Erlang programs. :star:164
* [eflame](https://github.com/proger/eflame) - A Flame Graph profiler for Erlang. :star:269

## Build Tools
*Project build and automation tools.*

* [rebar](https://github.com/rebar/rebar) - Erlang build tool that makes it easy to compile and test Erlang applications, port drivers and releases. :star:930
...
* [sync](https://github.com/rustyio/sync) - On-the-fly recompiling for Erlang. :star:640

## Geolocation
*Libraries for geocoding addresses and working with latitudes and longitudes.*

* [erl-rstar](https://github.com/armon/erl-rstar) - An Erlang implementation of the R*-tree spacial data structure. :star:41
...
* [tx](https://github.com/kvakvs/tx) - An HTML Erlang term viewer, starts own webserver and displays any term you give it from your Erlang node. :star:65
...
* [qdate](https://github.com/choptastic/qdate) - Erlang date, time, and timezone management: formatting, conversion, and date arithmetic. :star:202

## ORM and Datamapping
*Libraries that implement object-relational mapping or datamapping techniques.*

* [boss_db](https://github.com/ErlyORM/boss_db) - A sharded, caching, pooling, evented ORM for Erlang. :star:256
* [epgsql](https://github.com/epgsql/epgsql) - PostgreSQL Driver for Erlang. :star:239
* [mysql-otp](https://github.com/mysql-otp/mysql-otp) - MySQL/OTP – MySQL driver for Erlang/OTP. :star:240
...
* [pqueue](https://github.com/okeuday/pqueue) - Erlang Priority Queues. :star:105
* [tinymq](https://github.com/ChicagoBoss/tinymq) - A diminutive, in-memory message queue for Erlang. :star:102

## Authentication
*Libraries for implementing authentications schemes.*

* [oauth2](https://github.com/kivra/oauth2) - Erlang Oauth2 implementation. :star:196

## Text and Numbers
*Libraries for parsing and manipulating text and numbers.*

* [eql](https://github.com/artemeff/eql) - Erlang with SQL or not. :star:75
* [jiffy](https://github.com/davisp/jiffy) - JSON NIFs for Erlang. :star:665
...
* [gen_rpc](https://github.com/priestjim/gen_rpc) - A scalable RPC library for Erlang-VM based languages. :star:165
...
* [ranch](https://github.com/ninenines/ranch) - Socket acceptor pool for TCP protocols. :star:816

## Internet of Things
*Libraries and tools for interacting with the physical world.*
* [lemma_erlang](https://github.com/noam-io/lemma_erlang) - A lemma for IDEO's Noam internet-of-things prototyping platform. :star:4
...
* [riak_dt](https://github.com/basho/riak_dt) - Erlang library of state based CRDTs. :star:242
...
* [Erlang Bookmarks](https://github.com/0xAX/erlang-bookmarks/wiki/Erlang-bookmarks) - All about erlang programming language [powerd by community]. :star:1020
