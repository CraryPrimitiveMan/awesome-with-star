...
* [lz4](https://github.com/lz4/lz4) - Fast Compression algorithm. :star:2833
* [snappy](https://github.com/google/snappy) - Fast compression library (implementation in C++, native bindings to C). :star:2689
...
* [Spearmint](https://github.com/zturtleman/spearmint) - Engine designed for FPS games. [`GNU GPL3 or later`](http://www.gnu.org/licenses/gpl.html)
...
* [kore](https://github.com/jorisvink/kore) - Easy to use, scalable and secure web application framework for writing web APIs in C. :star:2740
