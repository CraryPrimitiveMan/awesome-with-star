...
* [lz4](https://github.com/lz4/lz4) - Fast Compression algorithm. :star:2800
* [snappy](https://github.com/google/snappy) - Fast compression library (implementation in C++, native bindings to C). :star:2653
...
* [kore](https://github.com/jorisvink/kore) - Easy to use, scalable and secure web application framework for writing web APIs in C. :star:2723
