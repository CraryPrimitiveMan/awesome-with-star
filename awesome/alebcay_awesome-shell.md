...
* [ag](https://github.com/ggreer/the_silver_searcher) - Super fast string search through a directory hierarchy :star:14470
...
* [autoenv](https://github.com/kennethreitz/autoenv) - Directory-based environments :star:3877
* [autojump](https://github.com/wting/autojump) - A cd command that learns - easily navigate directories from the command line :star:6407
...
* [boilr](https://github.com/tmrts/boilr) - A blazingly fast CLI tool for creating projects from boilerplate templates. :star:625
...
* [direnv](https://github.com/direnv/direnv) - An environment switcher for the shell, compare with autoenv :star:3175
* [enhancd](https://github.com/b4b4r07/enhancd) - :rocket: A next-generation cd command with an interactive filter :star:806
* [fasd](https://github.com/clvv/fasd) - Command-line productivity booster, offers quick access to files and directories :star:3497
...
* [fzf](https://github.com/junegunn/fzf) - A command-line fuzzy finder :star:13197
...
* [jump](https://github.com/gsamokovarov/jump) - Jump helps you navigate your file system faster by learning your habits. :star:378
...
* [rg](https://github.com/BurntSushi/ripgrep) - ripgrep is a line oriented search tool that combines the usability of The Silver Searcher with the raw speed of GNU grep :star:7898
...
* [thefuck](https://github.com/nvbn/thefuck) - Fix common shell mistakes by using an easy to remember command :star:33774
...
* [bash-git-prompt](https://github.com/magicmonty/bash-git-prompt) - An informative and fancy Bash prompt for Git users :star:3713
...
* [Gogh - Color Scheme](https://github.com/Mayccoll/Gogh) - Color Scheme for Gnome Terminal :star:1821
...
* [cloc](https://github.com/AlDanial/cloc) - Count Lines of Code :star:4212
* [doclt](https://github.com/omgimanerd/doclt) - A command line interface to Digital Ocean :star:16
* [dokku](https://github.com/dokku/dokku) - Docker powered mini-Heroku. The smallest PaaS implementation you've ever seen. :star:15087
...
* [git-extras](https://github.com/tj/git-extras) - Git utilities -- repo summary, repl, changelog population, author commit percentages and more :star:11089
...
* [hub](https://github.com/github/hub) - hub helps you win at git. :star:12256
...
* [repren](https://github.com/jlevy/repren) - Command-line search-and-replace and file-renaming swiss army knife :star:151
...
* [progress](https://github.com/Xfennec/progress) - Linux tool to show progress for cp, rm, dd, ... :star:3622
* [glances](https://github.com/nicolargo/glances) - Glances an Eye on your system :star:9328
* [goaccess](https://github.com/allinurl/goaccess) - GoAccess is a real-time web log analyzer and interactive viewer that runs in a terminal in \*nix systems. :star:6478
* [histstat](https://github.com/vesche/histstat) - History for netstat :star:37
* [htop](https://github.com/hishamhm/htop) - A ncurses based interactive process viewer which aims to be a better `top` :star:2938
...
* [aria2](https://github.com/aria2/aria2) - aria2 is a lightweight multi-protocol & multi-source, cross platform download utility operated in command-line. It supports HTTP/HTTPS, FTP, BitTorrent and Metalink :star:8471
...
* [httpie](https://github.com/jakubroztocil/httpie) - HTTPie is a command line HTTP client, a user-friendly cURL replacement :star:34028
* [ngincat](https://github.com/jaburns/ngincat) - Tiny Bash HTTP server using netcat :star:129
* [resty](https://github.com/micha/resty) - Little command line REST client that you can use in pipelines :star:2275
* [youtube-dl](https://github.com/rg3/youtube-dl) - Small command-line program to download videos from YouTube.com and other video sites :star:33967
...
* [Beets](https://github.com/beetbox/beets) - Music library manager and MusicBrainz tagger :star:7002
* [cmus](https://github.com/cmus/cmus) - Cross-platform cli audio player. :star:2539
...
* [jq](https://github.com/stedolan/jq) - Sed for json data. You can use it to slice and filter and map and transform structured data :star:10730
...
* [ledger](https://github.com/ledger/ledger) - Command line accounting :star:2293
...
* [wego](https://github.com/schachmat/wego) - Weather app for the terminal :star:5145
...
* [bash-it](https://github.com/Bash-it/bash-it) - A community Bash framework :star:7480
...
* [shellcheck](https://github.com/koalaman/shellcheck) - Static analysis tool for shell scripts :star:10104
...
* [The Art of Command Line](https://github.com/jlevy/the-art-of-command-line) :star:33697
* [Learn Enough Command Line to Be Dangerous](https://www.learnenough.com/command-line-tutorial)
* [A guide to learn bash](https://github.com/Idnan/bash-guide) :star:8251
