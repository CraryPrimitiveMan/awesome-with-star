...
* [ag](https://github.com/ggreer/the_silver_searcher) - Super fast string search through a directory hierarchy :star:15436
* [aliases](https://github.com/sebglazebrook/aliases) - Contextual, dynamic, organized aliases for bash :star:157
* [aliasme](https://github.com/Jintin/aliasme) - alias helper to change directory quickly :star:42
* [autoenv](https://github.com/kennethreitz/autoenv) - Directory-based environments :star:4038
* [autojump](https://github.com/wting/autojump) - A cd command that learns - easily navigate directories from the command line :star:7701
...
* [boilr](https://github.com/tmrts/boilr) - A blazingly fast CLI tool for creating projects from boilerplate templates. :star:731
...
* [direnv](https://github.com/direnv/direnv) - An environment switcher for the shell, compare with autoenv :star:3663
* [enhancd](https://github.com/b4b4r07/enhancd) - :rocket: A next-generation cd command with an interactive filter :star:878
* [fasd](https://github.com/clvv/fasd) - Command-line productivity booster, offers quick access to files and directories :star:3816
...
* [fzf](https://github.com/junegunn/fzf) - A command-line fuzzy finder :star:15130
* [googler](https://github.com/jarun/googler) - Google Search, Google Site Search, Google News from the terminal :star:2489
* [goto](https://github.com/iridakos/goto) - A shell utility for navigation to aliased directories supporting auto-completion :star:396
...
* [marker](https://github.com/pindexis/marker) - Bookmark your shell commands :star:732
...
* [percol](https://github.com/mooz/percol) - Adds flavor of interactive filtering to the traditional pipe concept of UNIX shell :star:2559
...
* [rg](https://github.com/BurntSushi/ripgrep) - ripgrep is a line oriented search tool that combines the usability of The Silver Searcher with the raw speed of GNU grep :star:9354
...
* [spark](https://github.com/holman/spark) - ▁▂▃▅▂▇ in your shell :star:5071
...
* [sshfs](https://github.com/osxfuse/sshfs) - A tool for mounting remote file systems over SSH :star:580
...
* [thefuck](https://github.com/nvbn/thefuck) - Fix common shell mistakes by using an easy to remember command :star:36041
...
* [bash-git-prompt](https://github.com/magicmonty/bash-git-prompt) - An informative and fancy Bash prompt for Git users :star:4106
...
* [bullet-train-oh-my-zsh-theme](https://github.com/caiogondim/bullet-train.zsh) - :bullettrain_side: An oh-my-zsh shell theme based on the Powerline Vim plugin :star:1838
...
* [Gogh - Color Scheme](https://github.com/Mayccoll/Gogh) - Color Scheme for Gnome Terminal :star:2269
...
* [bocker](https://github.com/p8952/bocker) - Docker implemented in 100 lines of bash :star:5047
* [cloc](https://github.com/AlDanial/cloc) - Count Lines of Code :star:5015
* [doclt](https://github.com/omgimanerd/doclt) - A command line interface to Digital Ocean :star:20
* [dokku](https://github.com/dokku/dokku) - Docker powered mini-Heroku. The smallest PaaS implementation you've ever seen. :star:15818
...
* [git-extras](https://github.com/tj/git-extras) - Git utilities -- repo summary, repl, changelog population, author commit percentages and more :star:11607
...
* [hub](https://github.com/github/hub) - hub helps you win at git. :star:13137
...
* [rebound](https://github.com/shobrook/rebound) - Instantly browse Stack Overflow results in your terminal when you get a compiler error :star:2120
...
* [shipit](https://github.com/sapegin/shipit) - Minimalistic SSH deployment :star:413
...
* [progress](https://github.com/Xfennec/progress) - Linux tool to show progress for `cp`, `rm`, `dd`, and more... :star:4111
* [stronghold](https://github.com/alichtman/stronghold) - Easily configure MacOS security settings from the terminal. :star:168
* [glances](https://github.com/nicolargo/glances) - Glances an Eye on your system :star:10126
* [goaccess](https://github.com/allinurl/goaccess) - GoAccess is a real-time web log analyzer and interactive viewer that runs in a terminal in \*nix systems. :star:7051
* [histstat](https://github.com/vesche/histstat) - History for netstat :star:44
* [htop](https://github.com/hishamhm/htop) - A ncurses based interactive process viewer which aims to be a better `top` :star:3272
...
* [mtr](https://github.com/traviscross/mtr) - The functionality of the 'traceroute' and 'ping' programs in a single network diagnostic tool. :star:931
...
* [xiringuito](https://github.com/ivanilves/xiringuito) - SSH-based "VPN for poors" :star:826

## Downloading and Serving

*Self-hosted, lightweight servers and networking tools written in shell scripts.*

* [aria2](https://github.com/aria2/aria2) - aria2 is a lightweight multi-protocol & multi-source, cross platform download utility operated in command-line. It supports HTTP/HTTPS, FTP, BitTorrent and Metalink :star:10316
...
* [httpie](https://github.com/jakubroztocil/httpie) - HTTPie is a command line HTTP client, a user-friendly cURL replacement :star:35901
...
* [resty](https://github.com/micha/resty) - Little command line REST client that you can use in pipelines :star:2314
* [youtube-dl](https://github.com/rg3/youtube-dl) - Small command-line program to download videos from YouTube.com and other video sites :star:38257
...
* [Beets](https://github.com/beetbox/beets) - Music library manager and MusicBrainz tagger :star:8160
...
* [jq](https://github.com/stedolan/jq) - Sed for json data. You can use it to slice and filter and map and transform structured data :star:11756
...
* [awless](https://github.com/wallix/awless) - A powerful, innovative and small surface CLI to manage AWS. :star:3812
...
* [jrnl](https://github.com/maebert/jrnl) - A simple command line journal application that stores your journal in a plain text file :star:3035
* [ledger](https://github.com/ledger/ledger) - Command line accounting :star:2471
...
* [wego](https://github.com/schachmat/wego) - Weather app for the terminal :star:5332
...
* [bash-it](https://github.com/Bash-it/bash-it) - A community Bash framework :star:8156
...
* [shallow-backup](https://github.com/alichtman/shallow-backup) - Easily create lightweight documentation of installed packages, dotfiles, and more :star:85
...
* [shellcheck](https://github.com/koalaman/shellcheck) - Static analysis tool for shell scripts :star:11537
...
* [shunit2](https://github.com/kward/shunit2) - A unit test framework for Bash scripts with a flavour of JUnit/PyUnit. :star:507
...
* [The Art of Command Line](https://github.com/jlevy/the-art-of-command-line) :star:35581
...
* [awesome-cli-apps](https://github.com/agarrharr/awesome-cli-apps) :star:2432
