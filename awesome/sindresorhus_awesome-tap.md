...
- [tap-dot](https://github.com/scottcorgan/tap-dot) - Dotted output. :star:28
- [tap-spec](https://github.com/scottcorgan/tap-spec) - Mocha-like spec reporter. :star:249
- [tap-nyan](https://github.com/calvinmetcalf/tap-nyan) - Nyan cat. :star:131
- [tap-min](https://github.com/gummesson/tap-min) - Minimal output. :star:29
- [tap-difflet](https://github.com/namuol/tap-difflet) - Minimal output with diffing. :star:41
- [tap-diff](https://github.com/axross/tap-diff) - Human-friendly output with diffing. :star:75
- [tap-simple](https://github.com/joeybaker/tap-simple) - Simple output. :star:6
- [faucet](https://github.com/substack/faucet) - Human-readable summarizer. :star:504
...
- [tap-summary](https://github.com/zoubin/tap-summary) - Summarized output. :star:33
...
- [tap-notify](https://github.com/axross/tap-notify) - Notifier for macOS, Linux and Windows. :star:57
- [tap-json](https://github.com/gummesson/tap-json) - JSON output. :star:20
...
- [AVA](https://github.com/sindresorhus/ava) - Futuristic test runner (`$ ava --tap`). :star:14925
- [tap](https://github.com/isaacs/node-tap) - TAP test framework for Node.js. :star:1273
- [tape](https://github.com/substack/tape) - TAP-producing test harness for Node.js and browsers. :star:4781
...
- [jasmine-reporters](https://github.com/larrymyers/jasmine-reporters) - TAP output for Jasmine. :star:392
- [karma-tap-reporter](https://github.com/fumiakiy/karma-tap-reporter) - TAP output for Karma. :star:7
- [mos](https://github.com/zkochan/mos) - Markdown file generator and tester (`$ mos test --tap`). :star:94
...
- [bats](https://github.com/sstephenson/bats) - Bash Automated Testing System. :star:5130
...
- [tap-parser](https://github.com/substack/tap-parser) - TAP parser. :star:88
...
- [tap-dev-tool](https://github.com/Jam3/tap-dev-tool) - Prettify TAP in the browser console. :star:27
- [tap-merge](https://github.com/anko/tap-merge) - Merge multiple TAP streams. :star:8
- [smokestack](https://github.com/hughsk/smokestack) - Run TAP tests in a browser and write the output to `stdout`. :star:237
...
- [tappy](https://github.com/mblayman/tappy) - Tools for working with TAP. :star:59
...
- [test-anything](https://github.com/finnp/test-anything) - Learn to test anything with TAP through an interactive workshop. :star:126
...
- [Discuss](https://github.com/TestAnything/Specification/issues) :star:44
