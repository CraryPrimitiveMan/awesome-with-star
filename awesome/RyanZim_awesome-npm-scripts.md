...
- [npm-run-all](https://github.com/mysticatea/npm-run-all) - Fully featured task runner. :star:1862
...
- [onchange](https://github.com/Qard/onchange) - `onchange <glob> -- <command>`. :star:380
- [watch](https://github.com/mikeal/watch) - `watch <command> <directory>`. :star:1048

## Dev Servers

- [http-server](https://github.com/indexzero/http-server) - Simple zero-configuration command-line http server. :star:6911
- [live-server](https://github.com/tapio/live-server) - Simple development http server with live reload capability. :star:2163

## Cross-platform Utilities

Utilities to perform common command-line tasks without worrying about cross-platform compatibility.

- [rimraf](https://github.com/isaacs/rimraf) - Delete files or directories; like `rm -rf`. :star:2488
- [del-cli](https://github.com/sindresorhus/del-cli) - Safer file and folder deletion. :star:92
...
- [cross-env](https://github.com/kentcdodds/cross-env) - Set environment variables for scripts, unix-style. :star:2597
...
- [cli-error-notifier](https://github.com/micromata/cli-error-notifier) - Send native desktop notifications when npm scripts fail. :star:34

## Miscellaneous

- [screwy](https://github.com/samueleaton/screwy) - The npm scripts GUI. :star:95
- [Forrest](https://github.com/stefanjudis/forrest) - npm scripts desktop client. :star:268
...
- [ntl](https://github.com/ruyadorno/ntl) - Interactive cli menu to list and run npm scripts. :star:494
