...
* [Telegraf](https://github.com/influxdata/telegraf) - (Official) plugin-driven server agent for reporting metrics into InfluxDB :star:4300
...
* [vsphere-influxdb-go](https://github.com/Oxalide/vsphere-influxdb-go) - Collect VMware vSphere, vCenter and ESXi performance metrics and send them to InfluxDB :star:85

#### Non-dedicated

Tools that generate data that feed into multiple backends, InfluxDB included.

* [cAdvisor](https://github.com/google/cadvisor) - Analyzes resource usage and performance characteristics of running containers :star:6722
...
* [gatling](https://github.com/gatling/gatling) - Async Scala-Akka-Netty based Stress Tool :star:3404
...
* [heapster](https://github.com/kubernetes/heapster) - Monitor container resource usage of a [Kubernetes](https://kubernetes.io/) cluster :star:1745
...
* [logrus_influxdb](https://github.com/Abramovic/logrus_influxdb) - InfluxDB Hook for [Logrus](https://github.com/Sirupsen/logrus) :star:6417
...
* [metrics-influxdb](https://github.com/davidB/metrics-influxdb) - A reporter for [dropwizard](http://www.dropwizard.io/0.9.1/docs/) metrics which announces measurements to an InfluxDB server :star:204
...
* [Chronograf](https://github.com/influxdata/chronograf) - Official InfluxDB data visualization tool :star:492
* [facette](https://github.com/facette/facette) - Time series data visualization and graphing software :star:953
* [FluxDash](https://github.com/vrecan/FluxDash) - Terminal based InfluxDB dashboard :star:22
* [grafana](https://github.com/grafana/grafana) - Gorgeous metric viz, dashboards & editors for Graphite, InfluxDB & OpenTSDB :star:19823
...
* [awesome-bigdata](https://github.com/onurakpolat/awesome-bigdata) :star:5666
* [awesome-dashboard](https://github.com/obazoud/awesome-dashboard) :star:536
* [awesome-data-engineering](https://github.com/igorbarinov/awesome-data-engineering) :star:1271
* [awesome-db](https://github.com/numetriclabz/awesome-db) :star:554
* [awesome-go](https://github.com/avelino/awesome-go) :star:26963
* [awesome-sysadmin](https://github.com/kahun/awesome-sysadmin) :star:16510

### Lists of awesome lists that include awesome-influxdb

* [awesome](https://github.com/sindresorhus/awesome) :star:76178
