...
* [C#](https://github.com/influxdata/influxdb-csharp) - A .NET library for efficiently sending points to InfluxDB :star:152
* [Go](https://github.com/influxdata/influxdb1-client) - Go client for InfluxDB 1.x :star:72
* [Java](https://github.com/influxdata/influxdb-java) - Java client for InfluxDB :star:753
* [PHP](https://github.com/influxdata/influxdb-php) - PHP client for InfluxDB :star:318
* [Python](https://github.com/influxdata/influxdb-python) - Python client for InfluxDB :star:1182
...
* [node-influx](https://github.com/node-influx/node-influx) - InfluxDB Node.js Client :star:682
...
* [k6](https://github.com/loadimpact/k6) - A modern load testing tool, using Go and JavaScript :star:5445
...
* [node-opcua-logger](https://github.com/coussej/node-opcua-logger) - Collect industrial data from OPC UA Servers  :star:65
...
* [snmpcollector](https://github.com/toni-moreno/snmpcollector) - A full featured Generic SNMP data collector with Web Administration Interface for InfluxDB :star:154
* [Telegraf](https://github.com/influxdata/telegraf) - (Official) plugin-driven server agent for reporting metrics into InfluxDB :star:7353
...
* [cAdvisor](https://github.com/google/cadvisor) - Analyzes resource usage and performance characteristics of running containers :star:9620
...
* [gatling](https://github.com/gatling/gatling) - Async Scala-Akka-Netty based Stress Tool :star:4381
...
* [heapster](https://github.com/kubernetes-retired/heapster) - Monitor container resource usage of a [Kubernetes](https://kubernetes.io/) cluster :star:2516
...
* [jmxtrans](https://github.com/jmxtrans/jmxtrans) - Effectively the missing connector between speaking to a JVM via JMX on one end and whatever logging / monitoring / graphing package that you can dream up on the other end. :star:1540
...
* [logary](https://github.com/logary/logary) - High performance, multi-target logging, metric and health-check library for mono and .Net :star:439
...
* [Riemann](https://github.com/riemann/riemann) - A network event stream processing system, in Clojure :star:3808
* [statsd-jvm-profiler](https://github.com/etsy/statsd-jvm-profiler) - Simple JVM Profiler Using StatsD :star:314
* [statsite](https://github.com/statsite/statsite) - C implementation of statsd :star:1744
...
* [go-runtime-metrics](https://github.com/tevjef/go-runtime-metrics) - Collect golang runtime Metrics, outputting to InfluxDB or through Telegraf :star:210
...
* [logrus_influxdb](https://github.com/Abramovic/logrus_influxdb) - InfluxDB Hook for [Logrus](https://github.com/Sirupsen/logrus) :star:12377

### Plugins

Plugins to allow other standalone tools to send their data into InfluxDB.

* [embulk-output-influxdb](https://github.com/joker1007/embulk-output-influxdb) - InfluxDB output plugin for [Embulk](https://github.com/embulk/embulk) :star:1325
...
* [Chronograf](https://github.com/influxdata/chronograf) - Official InfluxDB data visualization tool :star:978
...
* [grafana](https://github.com/grafana/grafana) - Gorgeous metric viz, dashboards & editors for Graphite, InfluxDB & OpenTSDB :star:30941
...
* [InfluxDB Studio](https://github.com/CymaticLabs/InfluxDBStudio) - InfluxDB Studio is a UI management tool, its inspiration comes from other similar SQL database management tools (use InfluxData.Net run on MS Windows) :star:304
...
* [awesome-bigdata](https://github.com/onurakpolat/awesome-bigdata) :star:7914
* [awesome-dashboard](https://github.com/obazoud/awesome-dashboard) :star:740
* [awesome-data-engineering](https://github.com/igorbarinov/awesome-data-engineering) :star:2459
* [awesome-db](https://github.com/numetriclabz/awesome-db) :star:756
* [awesome-go](https://github.com/avelino/awesome-go) :star:47806
* [awesome-home-assistant](https://github.com/frenck/awesome-home-assistant) :star:1549
* [awesome-microservices](https://github.com/mfornos/awesome-microservices) :star:8091
* [awesome-sysadmin](https://github.com/kahun/awesome-sysadmin) :star:19173

### Lists of awesome lists that include awesome-influxdb

* [awesome](https://github.com/sindresorhus/awesome) :star:115733
* [lists](https://github.com/jnv/lists) :star:5960
