...
* [C#](https://github.com/influxdata/influxdb-csharp) - A .NET library for efficiently sending points to InfluxDB :star:74
...
* [Java](https://github.com/influxdata/influxdb-java) - Java client for InfluxDB :star:415
* [PHP](https://github.com/influxdata/influxdb-php) - PHP client for InfluxDB :star:171
* [Python](https://github.com/influxdata/influxdb-python) - Python client for InfluxDB :star:712
...
* [k6](https://github.com/loadimpact/k6) - A modern load testing tool, using Go and JavaScript :star:3331
...
* [Telegraf](https://github.com/influxdata/telegraf) - (Official) plugin-driven server agent for reporting metrics into InfluxDB :star:4320
...
* [cAdvisor](https://github.com/google/cadvisor) - Analyzes resource usage and performance characteristics of running containers :star:6768
...
* [gatling](https://github.com/gatling/gatling) - Async Scala-Akka-Netty based Stress Tool :star:3416
...
* [heapster](https://github.com/kubernetes/heapster) - Monitor container resource usage of a [Kubernetes](https://kubernetes.io/) cluster :star:1754
...
* [jmxtrans](https://github.com/jmxtrans/jmxtrans) - Effectively the missing connector between speaking to a JVM via JMX on one end and whatever logging / monitoring / graphing package that you can dream up on the other end. :star:1300
...
* [Riemann](https://github.com/riemann/riemann) - A network event stream processing system, in Clojure :star:3488
* [statsd-jvm-profiler](https://github.com/etsy/statsd-jvm-profiler) - Simple JVM Profiler Using StatsD :star:262
* [statsite](https://github.com/statsite/statsite) - C implementation of statsd :star:1582
...
* [metrics](https://github.com/beberlei/metrics) - (PHP) Simple library that abstracts different metrics collectors. "I find this necessary to have a consistent and simple metrics (functional) API that doesn't cause vendor lock-in" :star:228
...
* [logrus_influxdb](https://github.com/Abramovic/logrus_influxdb) - InfluxDB Hook for [Logrus](https://github.com/Sirupsen/logrus) :star:6464
...
* [grafana](https://github.com/grafana/grafana) - Gorgeous metric viz, dashboards & editors for Graphite, InfluxDB & OpenTSDB :star:19870
...
* [Morgoth](https://github.com/nathanielc/morgoth) - Metric anomaly detection :star:213
...
* [awesome-bigdata](https://github.com/onurakpolat/awesome-bigdata) :star:5685
* [awesome-dashboard](https://github.com/obazoud/awesome-dashboard) :star:539
* [awesome-data-engineering](https://github.com/igorbarinov/awesome-data-engineering) :star:1281
* [awesome-db](https://github.com/numetriclabz/awesome-db) :star:555
* [awesome-go](https://github.com/avelino/awesome-go) :star:27083
* [awesome-sysadmin](https://github.com/kahun/awesome-sysadmin) :star:16538

### Lists of awesome lists that include awesome-influxdb

* [awesome](https://github.com/sindresorhus/awesome) :star:76679
