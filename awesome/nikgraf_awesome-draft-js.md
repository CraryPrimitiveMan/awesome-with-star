...
- [Community](https://github.com/nikgraf/awesome-draft-js#community) :star:1935
- [Presentations](https://github.com/nikgraf/awesome-draft-js#presentations) :star:1935
- [Projects on Top of Draft.js](https://github.com/nikgraf/awesome-draft-js#standalone-editors-built-on-draftjs) :star:1935
- [Common Utilities](https://github.com/nikgraf/awesome-draft-js#common-utilities) :star:1935
- [Blog Posts & Articles](https://github.com/nikgraf/awesome-draft-js#blog-posts--articles) :star:1935
- [Live Demos](https://github.com/nikgraf/awesome-draft-js#live-demos) :star:1935
- [Usage in Production](https://github.com/nikgraf/awesome-draft-js#usage-in-production) :star:1935
- [License](https://github.com/nikgraf/awesome-draft-js#license) :star:1935
...
* [React-RTE](https://github.com/sstur/react-rte/) - A full-featured textarea replacement similar to CKEditor or TinyMCE. :star:2120
...
* [Megadraft](https://github.com/globocom/megadraft) - A rich text editor with a nice default base of plugins and extensibility. :star:796
* [Medium Draft](https://github.com/brijeshb42/medium-draft) - Medium-like rich text editor with a focus on keyboard shortcuts. :star:1409
* [React-Draft-Wyiswyg](https://github.com/jpuri/react-draft-wysiwyg) - A WYISWYG editor, with various text editing options and corresponding HTML generation. :star:3613
* [Dante 2](https://github.com/michelson/dante2) - Just another Medium clone built on top of DraftJs. :star:634
...
* [Draftail](https://github.com/springload/draftail/) -  A configurable rich text editor based on Draft.js, built for Wagtail. :star:239
* [Braft](https://github.com/margox/braft-editor) - Extensible Draft JS Editor :star:2415

## Plugins and Decorators Built for Draft.js

* [Draft.js Plugins](https://github.com/draft-js-plugins/draft-js-plugins) - A Plugin architecture on top of Draft.js :star:3254
...
* [Draft.js: Export ContentState to HTML](https://github.com/sstur/draft-js-utils/tree/master/packages/draft-js-export-html) - Export ContentState to HTML. :star:670
...
* [DraftJS Utils](https://github.com/jpuri/draftjs-utils) - Set of utility functions for DraftJS. :star:181
...
* [HTML to DraftJS](https://github.com/jpuri/html-to-draftjs) - Convert plain HTML to DraftJS Editor content. :star:85
* [Draft.js Exporter (Go)](https://github.com/ejilay/draftjs) - Export Draft.js content state into HTML. :star:17
* [React Native Draft.js Render](https://github.com/globocom/react-native-draftjs-render) - A React Native render for Draft.js model. :star:306
