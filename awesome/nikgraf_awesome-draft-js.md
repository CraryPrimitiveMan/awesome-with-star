...
- [Community](https://github.com/nikgraf/awesome-draft-js#community) :star:1946
- [Presentations](https://github.com/nikgraf/awesome-draft-js#presentations) :star:1946
- [Projects on Top of Draft.js](https://github.com/nikgraf/awesome-draft-js#standalone-editors-built-on-draftjs) :star:1946
- [Common Utilities](https://github.com/nikgraf/awesome-draft-js#common-utilities) :star:1946
- [Blog Posts & Articles](https://github.com/nikgraf/awesome-draft-js#blog-posts--articles) :star:1946
- [Live Demos](https://github.com/nikgraf/awesome-draft-js#live-demos) :star:1946
- [Usage in Production](https://github.com/nikgraf/awesome-draft-js#usage-in-production) :star:1946
- [License](https://github.com/nikgraf/awesome-draft-js#license) :star:1946
...
* [Draft WYSIWYG](https://github.com/bkniffler/draft-wysiwyg) - WYSIWYG editor that with drag&drop, resizing & tooltips. :star:424
...
* [React-RTE](https://github.com/sstur/react-rte/) - A full-featured textarea replacement similar to CKEditor or TinyMCE. :star:2128
...
* [Megadraft](https://github.com/globocom/megadraft) - A rich text editor with a nice default base of plugins and extensibility. :star:811
* [Medium Draft](https://github.com/brijeshb42/medium-draft) - Medium-like rich text editor with a focus on keyboard shortcuts. :star:1417
* [React-Draft-Wyiswyg](https://github.com/jpuri/react-draft-wysiwyg) - A WYISWYG editor, with various text editing options and corresponding HTML generation. :star:3655
* [Dante 2](https://github.com/michelson/dante2) - Just another Medium clone built on top of DraftJs. :star:640
* [Last Draft](https://github.com/vacenz/last-draft) - A Draft editor built with Draft.js plugins. :star:208
* [Z-Editor](https://github.com/Z-Editor/Z-Editor) - Online Z-notations editor. :star:74
* [Draftail](https://github.com/springload/draftail/) -  A configurable rich text editor based on Draft.js, built for Wagtail. :star:242
* [Braft](https://github.com/margox/braft-editor) - Extensible Draft JS Editor :star:2483

## Plugins and Decorators Built for Draft.js

* [Draft.js Plugins](https://github.com/draft-js-plugins/draft-js-plugins) - A Plugin architecture on top of Draft.js :star:3273
...
* [DraftJs to HTML](https://github.com/jpuri/draftjs-to-html) - Library for generating HTML for DraftJS editor content. :star:177
...
* [React Native Draft.js Render](https://github.com/globocom/react-native-draftjs-render) - A React Native render for Draft.js model. :star:310
