...
- [Color Thief](https://github.com/lokesh/color-thief) - Grab color palette from an image. :star:7801
...
- [Color Name List](https://github.com/meodai/color-names/) - Huge curated list of unique color names. :star:752
