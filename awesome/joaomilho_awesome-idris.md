...
* [Official repo](https://github.com/idris-lang/Idris-dev) :star:3166
...
* [iridium](https://github.com/puffnfresh/iridium) - xmonad with the X11 abstracted and configured with Idris. :star:193
* [lightyear](https://github.com/ziman/lightyear) - Parser combinators for Idris. :star:211
* [quantities](https://github.com/timjb/quantities) Type-safe physical computations and unit conversions in Idris.
* [idris-type-providers](https://github.com/david-christiansen/idris-type-providers) - Type provider library for Idris. :star:75
* [IdrisScript](https://github.com/idris-hackers/IdrisScript) - FFI Bindings to interact with the unsafe world of JavaScript. :star:83
* [idris-containers](https://github.com/jfdm/idris-containers) - Various data structures for use in the Idris Language. :star:85
* [IdrisSqlite](https://github.com/david-christiansen/IdrisSqlite) - Effectful bindings for SQLite. :star:33
* [idris-http](https://github.com/uwap/idris-http) - HTTP library for Idris. :star:33
* [RingIdris](https://github.com/FranckS/RingIdris) - Ring solver for Idris. :star:18
* [specdris](https://github.com/pheymann/specdris) - Test framework for Idris. :star:49
* [idris-config](https://github.com/jfdm/idris-config) - Parsers for various configuration files written in Idris. :star:18
* [probability](https://github.com/BlackBrane/probability) - Probabilistic computation in Idris. :star:29
* [idris-protobuf](https://github.com/google/idris-protobuf) - Partial implementation of Protocol Buffers in Idris. :star:25
* [idris-free](https://github.com/idris-hackers/idris-free) - Free Monads and useful constructions to work with them. :star:18
* [idris-ct](https://github.com/statebox/idris-ct) - Formally verified category theory library :star:161
* [typedefs](https://github.com/typedefs/typedefs) - Programming language-agnostic, algebraic data type definition language :star:251

### Backends

* [idris-jvm](https://github.com/mmhelloworld/idris-jvm) - JVM bytecode backend for Idris. :star:304
* [idris-llvm](https://github.com/idris-hackers/idris-llvm) - LLVM backend. :star:71
* [idris-erlang](https://github.com/lenary/idris-erlang) - Erlang backend. :star:183
* [idris-malfunction](https://github.com/stedolan/idris-malfunction) - Experimental Malfunction (OCaml internal representation) backend. :star:74

### Build tools | Package managers

- [Idris Rules](http://idris.build) - Idris rules for Bazel
- [Ikan](https://github.com/idris-industry/ikan) - A package manager for idris, in idris :star:24
- [Elba](https://github.com/elba/elba) - A package manager for Idris :star:145
- [idream](https://github.com/idream-build/idream) - A simple build system for Idris :star:18
