...
* [Official repo](https://github.com/idris-lang/Idris-dev) :star:2198
...
* [GitHub's trending Idris repos](https://github.com/trending/idris) :star:
* [iridium](https://github.com/puffnfresh/iridium) - xmonad with the X11 abstracted and configured with Idris. :star:169
* [lightyear](https://github.com/ziman/lightyear) - Parser combinators for Idris. :star:157
* [quantities](https://github.com/timjb/quantities) Type-safe physical computations and unit conversions in Idris.
* [idris-type-providers](https://github.com/david-christiansen/idris-type-providers) - Type provider library for Idris. :star:59
* [IdrisScript](https://github.com/idris-hackers/IdrisScript) - FFI Bindings to interact with the unsafe world of JavaScript. :star:61
* [idris-containers](https://github.com/jfdm/idris-containers) - Various data structures for use in the Idris Language. :star:55
* [IdrisSqlite](https://github.com/david-christiansen/IdrisSqlite) - Effectful bindings for SQLite. :star:29
* [idris-http](https://github.com/uwap/idris-http) - HTTP library for Idris. :star:24
* [RingIdris](https://github.com/FranckS/RingIdris) - Ring solver for Idris. :star:17
* [specdris](https://github.com/pheymann/specdris) - Test framework for Idris. :star:28
...
* [idris-jvm](https://github.com/mmhelloworld/idris-jvm) - JVM bytecode backend for Idris. :star:217
* [idris-llvm](https://github.com/idris-hackers/idris-llvm) - LLVM backend. :star:46
* [idris-erlang](https://github.com/lenary/idris-erlang) - Erlang backend. :star:160
* [idris-malfunction](https://github.com/stedolan/idris-malfunction) - Experimental Malfunction (OCaml internal representation) backend. :star:60
