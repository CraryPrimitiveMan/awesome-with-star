...
* [Official repo](https://github.com/idris-lang/Idris-dev) :star:2594
...
* [iridium](https://github.com/puffnfresh/iridium) - xmonad with the X11 abstracted and configured with Idris. :star:182
* [lightyear](https://github.com/ziman/lightyear) - Parser combinators for Idris. :star:190
* [quantities](https://github.com/timjb/quantities) Type-safe physical computations and unit conversions in Idris.
* [idris-type-providers](https://github.com/david-christiansen/idris-type-providers) - Type provider library for Idris. :star:69
* [IdrisScript](https://github.com/idris-hackers/IdrisScript) - FFI Bindings to interact with the unsafe world of JavaScript. :star:74
* [idris-containers](https://github.com/jfdm/idris-containers) - Various data structures for use in the Idris Language. :star:74
* [IdrisSqlite](https://github.com/david-christiansen/IdrisSqlite) - Effectful bindings for SQLite. :star:31
* [idris-http](https://github.com/uwap/idris-http) - HTTP library for Idris. :star:28
* [RingIdris](https://github.com/FranckS/RingIdris) - Ring solver for Idris. :star:16
* [specdris](https://github.com/pheymann/specdris) - Test framework for Idris. :star:37
* [idris-config](https://github.com/jfdm/idris-config) - Parsers for various configuration files written in Idris. :star:17
* [probability](https://github.com/BlackBrane/probability) - Probabilistic computation in Idris. :star:18
* [idris-protobuf](https://github.com/google/idris-protobuf) - Partial implementation of Protocol Buffers in Idris. :star:19
* [idris-free](https://github.com/idris-hackers/idris-free) - Free Monads and useful constructions to work with them. :star:15

### Backends

* [idris-jvm](https://github.com/mmhelloworld/idris-jvm) - JVM bytecode backend for Idris. :star:265
* [idris-llvm](https://github.com/idris-hackers/idris-llvm) - LLVM backend. :star:63
* [idris-erlang](https://github.com/lenary/idris-erlang) - Erlang backend. :star:169
