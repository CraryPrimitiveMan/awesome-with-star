...
* [Breeze](https://github.com/wise2c-devops/breeze) - CentOS - Cloud Agnostique :star:749
* [Conjure-up](https://github.com/conjure-up/conjure-up) - Ubuntu - Cloud Agnostique :star:419
...
* [k3s](https://github.com/rancher/k3s) - Lightweight Kubernetes. Easy to install, half the memory, all in a binary less than 40mb :star:8942
* [kind](https://kind.sigs.k8s.io) -  A tool for running local Kubernetes clusters using Docker container “nodes”
* [Kops](https://github.com/kubernetes/kops) - OS Agnostique - AWS :star:9877
* [Kube-ansible](https://github.com/kairen/kube-ansible) - OS Agnostique - Cloud Agnostique :star:265
* [Kube-aws](https://github.com/coreos/kube-aws) - CoreOS - AWS :star:1056
...
* [Kubernetes-Saltstack](https://github.com/valentin2105/Kubernetes-Saltstack) - `systemd` OS - Cloud Agnostique :star:153
* [Kubespray](https://github.com/kubernetes-incubator/kubespray) - OS Agnostique - Cloud Agnostique :star:7254
* [Kubicorn](https://github.com/kubicorn/kubicorn) - OS Agnostique - Cloud Agnostique :star:1550
...
* [matchbox](https://github.com/coreos/matchbox) - CoreOS - Network boot and provision Container Linux clusters (e.g. etcd3, Kubernetes, more). :star:773
* [MetalK8s](https://github.com/scality/metalk8s) - CentOS - On-Prem - Cloud Agnostique - [Apache-2.0](https://github.com/scality/metalk8s/blob/development/1.1/LICENSE) :star:129
* [MicroK8s](https://github.com/ubuntu/microk8s) - A single package of k8s that installs on 42 flavours of Linux :star:1882
* [Minikube](https://github.com/kubernetes/minikube) - Run Kubernetes locally :star:15864
* [RKE](https://github.com/rancher/rke) - OS Agnostique - Cloud Agnostique :star:1493
* [sealos](https://github.com/fanux/sealos) - Simple kubernetes HA installer :star:638
...
* [aks-engine](https://github.com/Azure/aks-engine) - AKS Engine is the easiest way to provision a self-managed Kubernetes cluster on Azure. :star:497
...
* [Kubernetes Source](https://github.com/kubernetes/kubernetes/) :star:58308
...
* [Kubernetes-1.16](https://github.com/kubernetes/kubernetes/blob/master/CHANGELOG-1.16.md) :star:58308
* [Kubernetes-1.15](https://github.com/kubernetes/kubernetes/blob/master/CHANGELOG-1.15.md) :star:58308
* [Kubernetes-1.14](https://github.com/kubernetes/kubernetes/blob/master/CHANGELOG-1.14.md) :star:58308
* [Kubernetes-1.13](https://github.com/kubernetes/kubernetes/blob/master/CHANGELOG-1.13.md) :star:58308
* [Kubernetes-1.12](https://github.com/kubernetes/kubernetes/blob/master/CHANGELOG-1.12.md) :star:58308
* [Kubernetes-1.11](https://github.com/kubernetes/kubernetes/blob/master/CHANGELOG-1.11.md) :star:58308
* [Kubernetes-1.10](https://github.com/kubernetes/kubernetes/blob/master/CHANGELOG-1.10.md) :star:58308
* [Kubernetes-1.9](https://github.com/kubernetes/kubernetes/blob/master/CHANGELOG-1.9.md) :star:58308
* [Kubernetes-1.8](https://github.com/kubernetes/kubernetes/blob/master/CHANGELOG-1.8.md) :star:58308
* [Kubernetes-1.7](https://github.com/kubernetes/kubernetes/blob/master/CHANGELOG-1.7.md) :star:58308
* [Kubernetes-1.6](https://github.com/kubernetes/kubernetes/blob/master/CHANGELOG-1.6.md) :star:58308
* [Kubernetes-1.5](https://github.com/kubernetes/kubernetes/blob/master/CHANGELOG-1.5.md) :star:58308
* [Kubernetes-1.4](https://github.com/kubernetes/kubernetes/blob/master/CHANGELOG-1.4.md) :star:58308
* [Kubernetes-1.3](https://github.com/kubernetes/kubernetes/blob/master/CHANGELOG-1.3.md) :star:58308
* [Kubernetes-1.2](https://github.com/kubernetes/kubernetes/blob/master/CHANGELOG-1.2.md) :star:58308
...
- [Automate deep learning training with Kubernetes GPU-cluster](https://github.com/Langhalsdino/Kubernetes-GPU-Guide) :star:664
...
* [Kubernetes Production Patterns (and Anti-Patterns)](https://github.com/gravitational/workshop/blob/master/k8sprod.md) :star:1762
...
=======================================================================
  ...
  - [Gardener](https://github.com/gardener/gardener) - Alibaba, AWS, Azure, GCP, and OpenStack cluster manager :star:1165
  ...
  - [DevSpace](https://github.com/covexo/devspace) - Build, test and run code directly inside any Kubernetes cluster :star:683
  - [Draft](https://draft.sh) - a tool for developers to create cloud native applications with Kubernetes
  - [Eclipse Che](https://github.com/eclipse/che) - cloud development workspaces with SSH and multi-user support :star:5710
  ...
  - [Okteto](https://github.com/okteto/okteto) - Develop directly in any Kubernetes cluster. No commit, build or push required. :star:381
  ...
  - [VAMP](http://vamp.io)
  - [Tilt](https://github.com/windmilleng/tilt) :star:2824
  ...
  - [teresa](https://github.com/luizalabs/teresa) - Simple PAAS that runs on top of Kubernetes. :star:403
  - [WSO2](http://wso2.com)
...
*List of available free online courses([MOOC](https://en.wikipedia.org/wiki/Massive_open_online_course)) and tutorials*
  ...
  - [Learning Kubernetes, The Chinese Taoist Way](https://github.com/caicloud/kube-ladder) :star:963
...
* [Kubernetes the hard way (installation from scratch)](http://github.com/kelseyhightower/kubernetes-the-hard-way/) :star:17663
* [Kubernetes Failure Stories](https://github.com/hjacobs/kubernetes-failure-stories) :star:5201
...
* [NetApp Trident](https://github.com/NetApp/trident) :star:318
* [OpenEBS](http://github.com/openebs/openebs/) :star:5801
...
* [Rancher Longhorn](https://github.com/rancher/longhorn) :star:741
* [Rook](http://rook.io/)
* [StorageOS](http://storageos.com)
* [Stork](https://github.com/libopenstorage/stork) :star:182
...
* [AWS EBS](https://github.com/kubernetes-sigs/aws-ebs-csi-driver) :star:71
* [AWS EFS](https://github.com/kubernetes-sigs/aws-efs-csi-driver) :star:64
* [AWS FSx for Lustre](https://github.com/kubernetes-sigs/aws-fsx-csi-driver) :star:26
* [Ceph](https://github.com/ceph/ceph-csi) :star:253
* [Cloudscale](https://github.com/cloudscale-ch/csi-cloudscale) :star:4
...
* [Gluster](https://github.com/gluster/gluster-csi-driver) :star:28
* [Google Compute Engine Persistent Disk](https://github.com/kubernetes-sigs/gcp-compute-persistent-disk-csi-driver) :star:32
* [Hostpath](https://github.com/kubernetes-csi/drivers/tree/master/pkg/hostpath) :star:96
* [Inmemory](https://github.com/kubernetes-csi/csi-test/tree/master/mock/service) :star:53
* [Intel PMEM-CSI](https://github.com/intel/pmem-CSI) :star:47
...
* [MooseFs](https://github.com/moosefs/moosefs-csi) :star:16
* [NetApp Trident](https://github.com/NetApp/trident) :star:318
...
*List of some libraries & scripts for executions and good referrals*
  ...
  ### [Python](#python)
   ...
   - [Pykube](https://github.com/hjacobs/pykube) :star:53

  ### [Jenkins](#jenkins)

   - [Jenkinsfile with Helm, Go, Docker, Kubectl, JNLP](https://github.com/lachie83/croc-hunter/blob/master/Jenkinsfile) :star:259
...
* [Argo](https://github.com/argoproj/argo) - The Workflow Engine for Kubernetes :star:3787
* [Bitnami Kubernetes Production Runtime](https://kubeprod.io)
* [Client Libraries](https://github.com/kubernetes/website/blob/master/content/en/docs/reference/using-api/client-libraries.md) :star:1578
* [Fission Workflows](https://github.com/fission/fission-workflows) - Workflow-based serverless function composition :star:246
* [Forecastle](https://github.com/stakater/Forecastle) - A dashboard which dynamically discovers and provides a launchpad to access applications deployed on Kubernetes :star:76
* [Git Webhook Proxy](https://github.com/stakater/GitWebhookProxy) - A proxy to let webhooks reach running services behind a firewall :star:52
* [Hypernetes](https://github.com/hyperhq/hypernetes) :star:549
* [Ingress Monitor Controller](https://github.com/stakater/IngressMonitorController) - Watches ingress endpoints and automatically registers liveness alerts on the configured uptime checker :star:182
* [kmachine](https://github.com/skippbox/kmachine) :star:179
* [KEDA](https://github.com/kedacore/keda) - Kubernetes-based Event Driven Autoscaling :star:1238
...
* [kube-openvpn](https://github.com/pieterlange/kube-openvpn) :star:284
* [Kubeform](http://capgemini.github.io/kubeform/)
* [Kubefuse](http://opencredo.com/introducing-kubefuse-file-system-kubernetes/)
* [Kubefwd](https://github.com/txn2/kubefwd) - Bulk port forwarding Kubernetes services for local development. :star:1443
* [Kubernetes Cluster Federation (previously Ubernetes)](https://kubernetes.io/docs/concepts/cluster-administration/federation/)
* [Kubernetes Ec2 Autoscaler](https://github.com/openai/kubernetes-ec2-autoscaler) :star:826
* [Kubic-Project](https://github.com/kubic-project)
* [Reloader](https://github.com/stakater/Reloader) - Auto-load updates of ConfigMaps and Secrets into pods for Deployments, StatefulSets and DaemonSets :star:623
* [Telepresence](http://www.telepresence.io) - Locally develop/debug services against a remote Kubernetes cluster
* [kubernetes-deploy](https://github.com/Shopify/kubernetes-deploy) - A command-line tool that helps you ship changes to a Kubernetes namespace and understand the result :star:836
...
* [Console](http://github.com/kubernetes/dashboard) :star:6044
* [BotKube](https://github.com/infracloudio/botkube) - App that helps you monitor your Kubernetes cluster, debug critical deployments & gives recommendations for the standard practices :star:206
* [Datadog](http://www.datadoghq.com/)
* [eventrouter](https://github.com/heptiolabs/eventrouter) - simple introspective kubernetes service that forwards events to a specified sink. :star:303
* [Goldpinger](https://github.com/bloomberg/goldpinger) display, monitor and alert on inter-cluster connectivity
* [Grafana Kubernetes App](https://github.com/grafana/kubernetes-app) :star:293
* [Heapster](https://github.com/kubernetes/heapster) :star:2528
* [Instana](https://instana.com)
* [kail](https://github.com/boz/kail) - Kubernetes Log Viewer. Streams logs from all containers of all matching pods. :star:854
* [Kubebox](https://github.com/astefanutti/kubebox) - Terminal console for Kubernetes :star:975
* [Kubedash](https://github.com/kubernetes/kubedash) - **Deprecated** repository is archived and read-only :star:218
* [Kubernetes Operational View](https://github.com/hjacobs/kube-ops-view) - read-only system dashboard for multiple K8s clusters :star:1147
* [K8Dash](https://github.com/herbrandson/k8dash) - Realtime K8S alternative dashboard :star:409
...
* [Kubespy](https://github.com/pulumi/kubespy) - Tools for observing Kubernetes resources in real time, powered by Pulumi. :star:1832
* [Kubetail](https://github.com/johanhaleby/kubetail) :star:1597
* [Kubewatch](https://github.com/skippbox/kubewatch) :star:1009
...
* [NexClipper](https://github.com/NexClipper/NexClipper) - An open source software for monitoring Kubernetes and containers. :star:374
...
* [kube-state-metrics](https://github.com/kubernetes/kube-state-metrics) - Simple service that listens to the Kubernetes API server and generates metrics about the state of the objects. :star:1635
* [loki](https://github.com/grafana/loki) - Loki is a horizontally-scalable, highly-available, multi-tenant log aggregation system inspired by Prometheus. :star:7273
* [Loghouse](https://github.com/flant/loghouse) - Efficiently store big amounts of your logs (in ClickHouse database), process them using a simple query language and monitor them online through web UI. :star:524

## Testing

*Test your applications running on Kubernetes*

* [chaoskube](https://github.com/linki/chaoskube) - periodically kills random pods in your Kubernetes cluster :star:657
* [k8s-testsuite](https://github.com/mrahbar/k8s-testsuite) - Helm chart for network and loadtesting of a Kubernetes cluster :star:108
* [kboom](https://github.com/mhausenblas/kboom) - The Kubernetes scale & soak load tester :star:200
* [kind](https://github.com/bsycorp/kind) - A single node cluster to run your CI tests against thats ready in 30 seconds :star:300
* [kube-monkey](https://github.com/asobti/kube-monkey) - Chaos Monkey for Kubernetes clusters :star:1432
...
* [Litmus](https://github.com/openebs/litmus) - Chaos engineering for stateful workloads on Kubernetes :star:260
* [PowerfulSeal](https://github.com/bloomberg/powerfulseal) - kills targeted pods and machines to test your software reliability :star:1093
* [Sonobuoy](https://github.com/heptio/sonobuoy) - Diagnostic tool that runs Kubernetes conformance tests :star:1586
* [Test-Infra](https://github.com/kubernetes/test-infra) :star:1601
* [KubeInvaders](https://github.com/lucky-sideburn/KubeInvaders) - Gamified Chaos engineering tool for Kubernetes Clusters. It is like Space Invaders but alien ships are pods. :star:198
...
* [Jenkins](https://jenkins.io)
   ...
   * [Lab: Build a Continuous Deployment Pipeline with Jenkins and Kubernetes](https://github.com/GoogleCloudPlatform/continuous-deployment-on-kubernetes) :star:1131
   * [Jenkins Operator - Kubernetes native Jenkins operator](https://github.com/jenkinsci/kubernetes-operator) :star:121
...
* [Apollo](https://github.com/logzio/apollo) - Open Source application providing teams with self service UI for creating and deploying their services to Kubernetes. :star:266
* [Argo CD](https://github.com/argoproj/argo-cd) - Declarative continuous deployment for Kubernetes. :star:1746
* [autoapply](https://github.com/autoapply/autoapply) - Automatically apply changes from a Git repository to a Kubernetes cluster :star:66
...
* [Kontinuous](https://github.com/AcalephStorage/kontinuous) :star:112
* [KubeCI](https://www.kubeci.io/)
* [Razee](https://github.com/razee-io/Razee) :star:282
* [Shippable](http://blog.shippable.com/topic/kubernetes)
* [Shipper](https://github.com/bookingcom/shipper) - Kubernetes native multi-cluster canary or blue-green rollouts using Helm. :star:443
* [Spinnaker](http://www.spinnaker.io/blog/deploy-to-kubernetes-using-spinnaker)
* [Vili](https://github.com/airware/vili) :star:56
* [Weave Flux – GitOps reconcoliation operator](https://github.com/weaveworks/flux) :star:2949
* [Wercker](http://blog.wercker.com/topic/kubernetes)
* [Werf](https://github.com/flant/werf) - Werf simplifies development of build scripts, reduces commit build time and automates deployment. :star:1245

## Serverless Implementations

* [FaaS-netes](https://github.com/alexellis/faas-netes) :star:1418
* [Fission](https://github.com/platform9/fission) :star:4633
* [Funktion](https://github.com/fabric8io/funktion) :star:276
* [Iron.io](http://iron.io)
* [Kubeless](https://github.com/skippbox/kubeless) :star:5076
* [Nuclio](https://github.com/nuclio/nuclio) :star:2989
* [OpenFaaS](https://github.com/alexellis/faas) :star:15626
* [OpenWhisk](https://github.com/openwhisk)
* [Virtual Kubelet](https://github.com/virtual-kubelet/virtual-kubelet) - Allows nodes to be backed by other services and providers. :star:2220

## Operators

* [Cert manager](https://github.com/kelseyhightower/kube-cert-manager) :star:984
* [Cert Operator](https://github.com/giantswarm/cert-operator) :star:30
* [cert-manager](https://github.com/jetstack/cert-manager) :star:4232
...
* [DB Operator](https://github.com/k8sdb/operator) :star:229
* [Elasticsearch](https://github.com/upmc-enterprises/elasticsearch-operator) :star:620
* [etcd](https://github.com/coreos/etcd-operator) :star:1235
* [Istio](https://github.com/banzaicloud/istio-operator) :star:349
...
* [kooper](https://github.com/spotahome/kooper) - Simple Go library to create Kubernetes operators and controllers :star:336
* [Kubernetes Operators](https://github.com/sapcc/kubernetes-operators) :star:112
* [KubeVirt](https://github.com/kubevirt)
* [Kured](https://github.com/weaveworks/kured) - Kured (Kubernetes Reboot Daemon) is a Kubernetes daemonset that performs safe automatic node reboots :star:617
* [Memcached](https://github.com/kbst/memcached) :star:15
* [MongoDB](https://github.com/kbst/mongodb) :star:37
* [MySQL](https://github.com/oracle/mysql-operator) :star:565
* [Operator Kit](https://github.com/rook/operator-kit) :star:250
* [Operator SDK](https://github.com/operator-framework/operator-sdk) :star:2453
* [OperatorHub.io](https://www.operatorhub.io) - A new home for the Kubernetes community to share Operators
* [PostgreSQL](https://github.com/CrunchyData/postgres-operator) :star:778
* [PostgreSQL](https://github.com/zalando-incubator/postgres-operator) - manage PostgreSQL clusters using StatefulSets and [Patroni](https://github.com/zalando/patroni). :star:690
* [Prometheus](https://github.com/coreos/prometheus-operator) :star:3411
* [Addon-operator](https://github.com/flant/addon-operator) - adds hooks and values to helm charts in order to enhance the capabilities of helm and transform charts into smart modules that configure themselves and respond to changes in the cluster. :star:172
* [Shell-operator](https://github.com/flant/shell-operator) - a tool for running event-driven scripts in a Kubernetes cluster. :star:447

## Custom Schedulers

* [bashScheduler](https://github.com/rothgar/bashScheduler) - Written in bash :star:52
* [escheduler](https://github.com/agonzalezro/escheduler) - Written in elixir :star:19
* [firmament](https://github.com/camsas/firmament) :star:354
...
* [containerd](https://github.com/containerd/containerd) :star:4651
* [cri-containerd](https://github.com/kubernetes-incubator/cri-containerd) - Containerd-based implementation of Kubernetes Container Runtime Interface :star:586
* [CRI-O](https://github.com/kubernetes-incubator/cri-o) :star:1996
* [Hyper.sh/frakti](https://github.com/kubernetes/frakti) - Hypervisor-based container runtime :star:500
* [virtlet](https://github.com/Mirantis/virtlet) - Kubernetes CRI implementation for running VM workloads :star:509
...
* [AWS VPC CNI](https://github.com/aws/amazon-vpc-cni-k8s) - Networking plugin using Elastic Network Interfaces :star:908
* [Calico](http://www.projectcalico.org/)
* [Canal](https://github.com/tigera/canal) by [Tigera](https://github.com/tigera)
* [Cilium](https://github.com/cilium/cilium) :star:4500
...
* [CNI-Genie](https://github.com/Huawei-PaaS/CNI-Genie) :star:26
* [cni-ipvlan-vpc-k8s](https://github.com/lyft/cni-ipvlan-vpc-k8s) :star:260
* [Contiv](http://contiv.github.io/)
* [External DNS](https://github.com/kubernetes-incubator/external-dns) - To control DNS records dynamically via Kube resources :star:2308
* [Goldpinger](https://github.com/bloomberg/goldpinger) display, monitor and alert on inter-cluster connectivity
* [Infoblox](https://github.com/infobloxopen/cni-infoblox) :star:4
* [Kube-router](http://github.com/cloudnativelabs/kube-router) :star:1259
* [kubernetes-network-policy-recipes](https://github.com/ahmetb/kubernetes-network-policy-recipes) :star:1592
* [Kuryr](https://github.com/openstack/kuryr-kubernetes) :star:116
* [Linen](https://github.com/John-Lin/linen-cni) :star:42
* [Multus-cni](https://github.com/Intel-Corp/multus-cni) - Multi-homed pod cni :star:562
...
* [Weave Mesh](https://github.com/weaveworks/mesh) :star:552
...
* [k8sec](https://github.com/dtan4/k8sec) :star:205
* [Kamus](https://github.com/Soluto/kamus) - A GitOps, zero-trust solution for secrets encryption/decryption solution. :star:414
* [kube-lego](https://github.com/jetstack/kube-lego) :star:2116
* [kubernetes-vault](https://github.com/Boostport/kubernetes-vault) :star:903
* [kubesec](https://github.com/shyiko/kubesec) - Secure Secret management :star:425
* [Sealed Secrets](https://github.com/bitnami-labs/sealed-secrets) :star:1398
...
* [Kubernator](https://github.com/smpio/kubernator) :star:421
* [Kubernetes Resource Report](https://github.com/hjacobs/kube-resource-report) - report Kubernetes cluster and pod resource requests vs usage and generate static HTML :star:323
* [Kubeapps](https://github.com/kubeapps/kubeapps) - A web-based UI for deploying and managing applications in Kubernetes clusters :star:1591
* [Polaris](https://github.com/reactiveops/polaris) - An open source dashboard for Kubernetes best practices :star:941
* [Octant](https://github.com/vmware/octant) - A web-based, highly extensible platform for developers to better understand the complexity of Kubernetes clusters. :star:2727
...
* [Cabin](https://github.com/bitnami/cabin) :star:555
* [Cockpit](http://cockpit-project.org/guide/latest/feature-kubernetes.html)

## API/CLI adaptors

* [click](https://github.com/databricks/click) - A CLI focused REPL for quickly interacting with Kubernetes objects. :star:1054
* [Ksql](https://github.com/brendandburns/ksql) :star:117
* [kube-prompt](https://github.com/c-bata/kube-prompt) - Interactive kubernetes client built using go-prompt. :star:1069
* [kube-ps1](https://github.com/jonmosco/kube-ps1) - Kubernetes prompt helper for bash and zsh. :star:1257
* [Kube-shell](https://github.com/cloudnativelabs/kube-shell) - Integrated shell for working with the Kubernetes CLI :star:1388
* [kube-tmux](https://github.com/jonmosco/kube-tmux) - Kubernetes tmux plugin to display the current context and namespace :star:157
* [Kubectl Aliases](https://github.com/ahmetb/kubectl-aliases) - Aliases for Kubectl :star:896
* [kubectl-plugins](https://github.com/jordanwilson230/kubectl-plugins) - A collection of kubectl plugins handling everything from easy context switches to connecting to a container as any user (root included) via exec. Slightly tailored towards GKE users. :star:167
* [kubectl-trace](https://github.com/iovisor/kubectl-trace) - Schedule bpftrace programs on your kubernetes cluster using this kubectl plugin :star:684
* [kubectld](https://github.com/rancher/kubectld) :star:12
* [kubectx](https://github.com/ahmetb/kubectx) - switch between clusters on kubectl :star:5259
* [Kubefuse](http://opencredo.com/introducing-kubefuse-file-system-kubernetes/)
* [kubens](https://github.com/ahmetb/kubectx) - switch between namespaces on kubectl :star:5259
...
* [StackStorm](https://github.com/StackStorm/st2) :star:3460
* [stern](https://github.com/wercker/stern) - Multi pod and container log tailing :star:2649
* [Vikube](https://github.com/c9s/vikube.vim) - Kubernetes operations from Vim, in Vim :star:173
* [K9s](https://github.com/derailed/k9s) - Kubernetes CLI To Manage Your Clusters In Style! :star:3146
...
* [Brigade](https://github.com/Azure/brigade) - Event Based Scripting using JavaScript :star:1742
...
* [Skaffold](https://github.com/GoogleCloudPlatform/skaffold) - Command line tool that facilitates continuous development for Kubernetes applications. :star:7643
* [kubedog](https://github.com/flant/kubedog) - Kubedog is a library and cli utility that allows watching and following kubernetes resources in CI/CD deploy pipelines. :star:208
...
* [Jsonnet](https://github.com/google/jsonnet/tree/master/case_studies/kubernetes) :star:3381
* [K8comp](https://github.com/cststack/k8comp) :star:23
* [kapitan](https://github.com/deepmind/kapitan) - Manage complex deployments using jsonnet and jinja2 :star:966
* [kenv](https://github.com/thisendout/kenv) :star:142
* [Kompose](https://github.com/kubernetes/kompose) :star:4361
* [Konfd](https://github.com/kelseyhightower/konfd) :star:478
* [Ktmpl](https://github.com/jimmycuadra/ktmpl) :star:69
* [kubecfg](https://github.com/bitnami/kubecfg) - Combines jsonnet and kubectl to let you declare systems in an easy to override way :star:498
* [kubediff](https://github.com/weaveworks/kubediff) :star:649
* [kubegen](https://github.com/errordeveloper/kubegen) :star:124
* [kustomize](https://github.com/kubernetes-sigs/kustomize) - Customization using partial specs :star:3831
...
* [ytt](https://github.com/k14s/ytt) - YAML templating tool that works on YAML structure allowing you to focus on your data instead of how to properly escape it. :star:262

## Security

* [Aquasec](http://blog.aquasec.com/topic/kubernetes)
* [Authenticator](https://github.com/heptio/authenticator) - A tool for using AWS IAM credentials to authenticate to a Kubernetes cluster :star:1205
...
* [Dex](https://github.com/coreos/dex) - OpenID and OAuth for Kubernetes :star:3741
* [Guard](https://github.com/appscode/guard) - Authenticaton webhook server with support for Github, Gitlab, Google, Azure and LDAP (AD) as identity providers. :star:299
* [kiam](https://github.com/uswitch/kiam) -  Allows cluster users to associate AWS IAM roles to Pods. :star:664
* [kube-bench](https://github.com/aquasecurity/kube-bench) - The Kubernetes Bench for Security is a Go application that checks whether Kubernetes is deployed according to security best practices. :star:2024
* [kube-hunter](https://github.com/aquasecurity/kube-hunter) - Hunt for security weaknesses in Kubernetes clusters. :star:1683
* [kube-psp-advisor](https://github.com/sysdiglabs/kube-psp-advisor) - Help building an adaptive and fine-grained pod security policy. :star:100
* [kube2iam](https://github.com/jtblin/kube2iam) - Provides different AWS IAM roles for pods running on Kubernetes :star:1265
* [Kubesec.io](http://kubesec.io/)
* [Pomerium](http://www.pomerium.io/) - a zero-trust identity-aware access proxy inspired by BeyondCorp.
* [Rakkess](https://github.com/corneliusweig/rakkess) - Kubectl plugin to show an access matrix for all available resources. :star:384
...
* [Trireme](http://github.com/aporeto-inc/trireme-kubernetes) :star:117
...
* [AWS ALB Ingress Controller](https://github.com/kubernetes-sigs/aws-alb-ingress-controller) :star:1162
* [Cloudflare Warp Ingress](https://github.com/cloudflare/cloudflare-ingress-controller) :star:203
* [Contour](https://github.com/heptio/contour) - Kubernetes ingress controller for Lyft's Envoy proxy :star:1887
...
* [Gloo - Envoy-based API gateway and ingress controller](https://github.com/solo-io/gloo) :star:1709
* [HAProxy Ingress](https://github.com/jcmoraisjr/haproxy-ingress) :star:495
* [Linode NodeBalancer Ingress](https://github.com/linode/linode-cloud-controller-manager) :star:19
...
* [NGINX Ingress Controller](https://github.com/kubernetes/ingress-nginx) :star:5742
* [Nginx Plus](http://www.nginx.com/blog/load-balancing-kubernetes-services-nginx-plus/)
* [Skipper](https://github.com/zalando/skipper) - HTTP router and reverse proxy for service composition, including use cases like Kubernetes Ingress :star:1861
* [Traefik](http://traefik.io/)
* [Voyager - Secure HAProxy based Ingress Controller](https://github.com/appscode/voyager) :star:1106
* [Yggdrasil - Envoy Control Plane for Kubernetes Multi-cluster Ingress](https://github.com/uswitch/yggdrasil) :star:92

## Big Data

* [Kube-Yarn](https://github.com/Comcast/kube-yarn) :star:120
* [Spark](https://github.com/kubernetes/examples/tree/master/staging/spark) :star:2466

## Machine Learning

* [FfDL](https://github.com/IBM/FfDL) - Deep Learning Platform offering TensorFlow, Caffe, PyTorch etc. as a Service on Kubernetes :star:562
* [kubeflow](https://github.com/google/kubeflow) - Machine Learning Toolkit for Kubernetes. :star:7533
* [mxnet-operator](https://github.com/deepinsight/mxnet-operator) - Tools for ML/MXNet on Kubernetes. :star:40
* [Polyaxon](https://github.com/polyaxon/polyaxon) - An open source platform for reproducible machine learning and deep learning on kubernetes :star:2154
* [seldon-core](https://github.com/SeldonIO/seldon-core) - Open source framework for deploying machine learning models on Kubernetes :star:1156
* [TensorFlow k8s](https://github.com/tensorflow/k8s) :star:719

## Service Discovery

* [Consul](http://consul.io)
  * [Kelsey Hightower Consul](https://github.com/kelseyhightower/consul-on-kubernetes) :star:526
...
* [k3OS](https://github.com/rancher/k3os) :star:1285
* [LinuxKit](https://github.com/linuxkit/kubernetes) :star:299
* [Talos](https://github.com/talos-systems/talos) :star:1495

## YAML/JSON Config

* [kompose](https://github.com/kubernetes/kompose) :star:4361
* [ksonnet-lib](https://github.com/ksonnet/ksonnet-lib) :star:388
* [kube-libsonnet](https://github.com/bitnami-labs/kube-libsonnet/blob/master/kube.libsonnet) - Generic library of Kubernetes objects for Jsonnet/Kubecfg with object to array mapping for painless overrides. :star:60
* [kubegen](https://github.com/errordeveloper/kubegen) :star:124
* [kubeval](https://github.com/garethr/kubeval) :star:1377

## Static Analysis

* [kube-score](https://github.com/zegl/kube-score) - Kubernetes object analysis with recommendations for improved reliability and security :star:478
* [popeye](https://github.com/derailed/popeye) - Kubernetes cluster resource sanitzer :star:1289
...
* [Velero](https://github.com/heptio/velero) - Utility for managing backup and restore of Kubernetes clusters. Formerly Heptio Ark. :star:3118
...
* [kube-backup](https://github.com/pieterlange/kube-backup) - Sync kubernetes state to git. :star:326

## Policy Management

* [Kyverno](https://github.com/nirmata/kyverno) - Kubernetes Native Policy Management :star:107

## Plugins

* [Krew - Plugin Manager](https://github.com/kubernetes-sigs/krew/) :star:1415
* [Kboom](https://github.com/mhausenblas/kboom) :star:200
* [View-utilization](https://github.com/etopeter/kubectl-view-utilization) :star:59

## Debug

* [Kubectl-Debug](https://github.com/aylei/kubectl-debug) :star:794
...
* [Community Q&A – The Office Hours](https://github.com/kubernetes/community/blob/master/events/office-hours.md) :star:5046
* [Community](https://github.com/kubernetes/community) :star:5046
