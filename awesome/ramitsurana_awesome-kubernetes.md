...
* [Minikube](https://github.com/kubernetes/minikube) - Run Kubernetes locally :star:11256
* [Kops](https://github.com/kubernetes/kops) - OS Agnostique - AWS :star:6991
* [Kube-deploy](https://github.com/kubernetes/kube-deploy) :star:517
* [Kubeadm](http://kubernetes.io/docs/admin/kubeadm/) - OS Agnostique - Cloud Agnostique
* [Kubespray](https://github.com/kubernetes-incubator/kubespray) - OS Agnostique - Cloud Agnostique :star:4310
* [Bootkube](https://github.com/kubernetes-incubator/bootkube) - CoreOS - Cloud Agnostique :star:846
* [Kube-aws](https://github.com/coreos/kube-aws) - CoreOS - AWS :star:851
* [Kismatic](https://github.com/apprenda/kismatic) - CentOS - Cloud Agnostique :star:777
* [Juju](https://jujucharms.com/canonical-kubernetes) - Ubuntu - Cloud Agnostique
* [Terraform](https://github.com/kz8s/tack) - CoreOS - AWS :star:716
* [Supergiant](http://supergiant.io/) - CoreOS - Cloud Agnostique
* [Archon](https://github.com/kubeup/archon) - OS Agnostique - Cloud Agnostique :star:179
* [KubeNow](https://github.com/kubenow/KubeNow) - Ubuntu - Cloud Agnostique :star:206
* [Kubicorn](https://github.com/kubicorn/kubicorn) - OS Agnostique - Cloud Agnostique :star:1328
* [Simplekube](https://github.com/valentin2105/Simplekube) - `systemd` OS - Cloud Agnostique :star:80
* [Conjure-up](https://github.com/conjure-up/conjure-up) - Ubuntu - Cloud Agnostique :star:342
* [Kube-ansible](https://github.com/kairen/kube-ansible) - OS Agnostique - Cloud Agnostique :star:163
* [Kubernetes-Saltstack](https://github.com/valentin2105/Kubernetes-Saltstack) - `systemD` OS - Cloud Agnostique :star:118
* [matchbox](https://github.com/coreos/matchbox) - CoreOS - Network boot and provision Container Linux clusters (e.g. etcd3, Kubernetes, more). :star:637
* [RKE](https://github.com/rancher/rke) - OS Agnostique - Cloud Agnostique :star:854
...
* [MetalK8s](https://github.com/scality/metalk8s) - CentOS - On-Prem - Cloud Agnostique - [Apache-2.0](https://github.com/scality/metalk8s/blob/development/1.1/LICENSE) :star:51
...
* [Kubernetes Source](https://github.com/kubernetes/kubernetes/) :star:42956
...
* [Kubernetes-1.12](https://github.com/kubernetes/kubernetes/blob/master/CHANGELOG-1.12.md) :star:42956
* [Kubernetes-1.11](https://github.com/kubernetes/kubernetes/blob/master/CHANGELOG-1.11.md) :star:42956
* [Kubernetes-1.10](https://github.com/kubernetes/kubernetes/blob/master/CHANGELOG-1.10.md) :star:42956
* [Kubernetes-1.9](https://github.com/kubernetes/kubernetes/blob/master/CHANGELOG-1.9.md) :star:42956
* [Kubernetes-1.8](https://github.com/kubernetes/kubernetes/blob/master/CHANGELOG-1.8.md) :star:42956
* [Kubernetes-1.7](https://github.com/kubernetes/kubernetes/blob/master/CHANGELOG-1.7.md) :star:42956
* [Kubernetes-1.6](https://github.com/kubernetes/kubernetes/blob/master/CHANGELOG-1.6.md) :star:42956
* [Kubernetes-1.5](https://github.com/kubernetes/kubernetes/blob/master/CHANGELOG-1.5.md) :star:42956
* [Kubernetes-1.4](https://github.com/kubernetes/kubernetes/blob/master/CHANGELOG-1.4.md) :star:42956
* [Kubernetes-1.3](https://github.com/kubernetes/kubernetes/blob/master/CHANGELOG-1.3.md) :star:42956
* [Kubernetes-1.2](https://github.com/kubernetes/kubernetes/blob/master/CHANGELOG-1.2.md) :star:42956
...
* [Automate deep learning training with Kubernetes GPU-cluster](https://github.com/Langhalsdino/Kubernetes-GPU-Guide) :star:574
* [Kubernetes Production Patterns (and Anti-Patterns)](https://github.com/gravitational/workshop/blob/master/k8sprod.md) :star:1662
...
=======================================================================
  ...
  - [Gardener](https://github.com/gardener/gardener) - AWS, Azure, GCP, and OpenStack cluster manager :star:689
  ...
  - [Kqueen](https://github.com/Mirantis/kqueen) :star:80

  ### [Developer Platform](#developer-platform)

  - [Fabric8](http://fabric8.io)
  - [Spring Cloud integration](https://github.com/fabric8io/spring-cloud-kubernetes) :star:539
  - [Mantl](https://github.com/mantl/mantl) :star:3061
  ...
  - [DevSpace](https://github.com/covexo/devspace) - Build, test and run code directly inside any Kubernetes cluster :star:259
  ...
  - [teresa](https://github.com/luizalabs/teresa) - Simple PAAS that runs on top of Kubernetes. :star:309
...
* [Using Kubernetes on AWS](https://github.com/hjacobs/kubernetes-on-aws-users) :star:92
* [Kubernetes at Github](http://githubengineering.com/kubernetes-at-github/)
* [Kubernetes the hard way (installation from scratch)](http://github.com/kelseyhightower/kubernetes-the-hard-way/) :star:12119
...
* [Kube-Aliyun](https://github.com/kubeup/kube-aliyun) :star:79
* [Portworx](http://portworx.com/)
* [Rancher Longhorn](https://github.com/rancher/longhorn) :star:399
* [Stork](https://github.com/libopenstorage/stork) :star:96
* [OpenEBS](http://github.com/openebs/openebs/) :star:5433
...
*List of some libraries & scripts for executions and good referrals*
  ...
  ### [Python](#python)
   ...
   - [Pykube](https://github.com/kelproject/pykube) :star:330

  ### [Jenkins](#jenkins)

   - [Jenkinsfile with Helm, Go, Docker, Kubectl, JNLP](https://github.com/lachie83/croc-hunter/blob/master/Jenkinsfile) :star:210
...
* [Hypernetes](https://github.com/hyperhq/hypernetes) :star:522
...
* [Kubernetes Ec2 Autoscaler](https://github.com/openai/kubernetes-ec2-autoscaler) :star:767
* [Kubeform](http://capgemini.github.io/kubeform/)
* [kube-openvpn](https://github.com/pieterlange/kube-openvpn) :star:215
* [Archon](https://github.com/kubeup/archon) :star:179
* [Client Libraries](https://github.com/kubernetes/community/blob/master/contributors/devel/client-libraries.md) :star:2646
...
* [Fission Workflows](https://github.com/fission/fission-workflows) - Workflow-based serverless function composition :star:175
...
* [Console](http://github.com/kubernetes/dashboard) :star:3496
* [Datadog](http://www.datadoghq.com/)
* [eventrouter](https://github.com/heptiolabs/eventrouter) - simple introspective kubernetes service that forwards events to a specified sink. :star:139
* [Grafana Kubernetes App](https://github.com/grafana/kubernetes-app) :star:114
* [Heapster](https://github.com/kubernetes/heapster) :star:2353
* [Instana](https://instana.com)
* [Kubebox](https://github.com/astefanutti/kubebox) - Terminal console for Kubernetes :star:339
* [Kubedash](https://github.com/kubernetes/kubedash) :star:208
* [Kubernetes Operational View](https://github.com/hjacobs/kube-ops-view) - read-only system dashboard for multiple K8s clusters :star:622
* [Kubetail](https://github.com/johanhaleby/kubetail) :star:915
* [Kubewatch](https://github.com/skippbox/kubewatch) :star:473
...
* [Searchlight](https://github.com/appscode/searchlight) :star:150
* [Ingress Monitor Controller](https://github.com/stakater/IngressMonitorController) - A Kubernetes Controller to watch your ingresses and create liveness alerts for your endpoints :star:89
* [Kubespy](https://github.com/pulumi/kubespy) - Tools for observing Kubernetes resources in real time, powered by Pulumi. :star:1337

## Testing

*Test your applications running on Kubernetes*

* [kube-monkey](https://github.com/asobti/kube-monkey) - Chaos Monkey for Kubernetes clusters :star:913
* [k8s-testsuite](https://github.com/mrahbar/k8s-testsuite) - Helm chart for network and loadtesting of a Kubernetes cluster :star:67
* [Test-Infra](https://github.com/kubernetes/test-infra) :star:670
* [Sonobuoy](https://github.com/heptio/sonobuoy) - Diagnostic tool that runs Kubernetes conformance tests :star:986
* [PowerfulSeal](https://github.com/bloomberg/powerfulseal) - kills targeted pods and machines to test your software reliability :star:746
* [Litmus](https://github.com/openebs/litmus) - Chaos engineering for stateful workloads on Kubernetes :star:113
* [Kubeadm-dind-cluster](https://github.com/kubernetes-sigs/kubeadm-dind-cluster) - multi-node test cluster based on kubeadm :star:714
* [kind](https://github.com/bsycorp/kind) - A single node cluster to run your CI tests against thats ready in 30 seconds :star:112
...
* [Jenkins](https://jenkins.io)
   ...
   * [Lab: Build a Continuous Deployment Pipeline with Jenkins and Kubernetes](https://github.com/GoogleCloudPlatform/continuous-deployment-on-kubernetes) :star:892
...
* [Kontinuous](https://github.com/AcalephStorage/kontinuous) :star:107
...
* [Vili](https://github.com/airware/vili) :star:53
* [Keel](https://keel.sh/)
* [Apollo](https://github.com/logzio/apollo) - Open Source application providing teams with self service UI for creating and deploying their services to Kubernetes. :star:154
* [Weave Flux – GitOps reconcoliation operator](https://github.com/weaveworks/flux) :star:1006
* [Codefresh](https://codefresh.io/) - Kubernetes CI/CD platform (with private Docker and Helm Chart repositories)

## Serverless Implementations

* [Funktion](https://github.com/fabric8io/funktion) :star:256
* [Fission](https://github.com/platform9/fission) :star:3669
* [Kubeapps](https://github.com/kubeapps/kubeapps) - set of tools (application dashboard, Serverless framework, and Secret generator) to build FaaS apps on top of Kubernetes :star:587
* [Kubeless](https://github.com/skippbox/kubeless) :star:3700
* [OpenWhisk](https://github.com/openwhisk)
* [Iron.io](http://iron.io)
* [OpenFaaS](https://github.com/alexellis/faas) :star:11843
* [FaaS-netes](https://github.com/alexellis/faas-netes) :star:1165
* [Nuclio](https://github.com/nuclio/nuclio) :star:2305
* [Virtual Kubelet](https://github.com/virtual-kubelet/virtual-kubelet) - Allows nodes to be backed by other services and providers. :star:1243

## Operators

* [Prometheus](https://github.com/coreos/prometheus-operator) :star:1879
* [Kong API](https://github.com/upmc-enterprises/kong-operator) :star:73
* [Kubernetes Operators](https://github.com/sapcc/kubernetes-operators) :star:87
* [K8s Operator Workshop](https://github.com/lukebond/cc-au-k8s-operators-workshop) :star:15
* [Cert Operator](https://github.com/giantswarm/cert-operator) :star:27
...
* [Operator Kit](https://github.com/rook/operator-kit) :star:213
* [Container Linux Update Operator](https://github.com/coreos/container-linux-update-operator) :star:152
* [DB Operator](https://github.com/k8sdb/operator) :star:78
* [etcd](https://github.com/coreos/etcd-operator) :star:824
* [Elasticsearch](https://github.com/upmc-enterprises/elasticsearch-operator) :star:434
* [Memcached](https://github.com/kbst/memcached) :star:13
* [MySQL](https://github.com/oracle/mysql-operator) :star:302
* [MongoDB](https://github.com/kbst/mongodb) :star:32
* [PostgreSQL](https://github.com/CrunchyData/postgres-operator) :star:451
* [PostgreSQL](https://github.com/zalando-incubator/postgres-operator) - manage PostgreSQL clusters using StatefulSets and [Patroni](https://github.com/zalando/patroni). :star:303
* [Couchbase](https://blog.couchbase.com/introducing-couchbase-operator/)
* [Kafka](https://github.com/krallistic/kafka-operator) :star:229
* [KubeVirt](https://github.com/kubevirt)
* [Operator SDK](https://github.com/operator-framework/operator-sdk) :star:897
* [kooper](https://github.com/spotahome/kooper) - Simple Go library to create Kubernetes operators and controllers :star:256

## Custom Schedulers

* [Scheduler](https://github.com/kelseyhightower/scheduler) - Cost based scheduler :star:100
* [Sticky Node Scheduler](https://github.com/philipn/kubernetes-sticky-node-scheduler) :star:13
* [ksched](https://github.com/coreos/ksched) - Experimental flow based scheduler :star:29
* [escheduler](https://github.com/agonzalezro/escheduler) - Written in elixir :star:17
* [bashScheduler](https://github.com/rothgar/bashScheduler) - Written in bash :star:50
...
* [Rkt](http://coreos.com/rkt)
  ...
  * [rktlet](https://github.com/kubernetes-incubator/rktlet) - Rkt implementation of a Kubernetes :star:106
* [containerd](https://github.com/containerd/containerd) :star:3007
* [cri-containerd](https://github.com/kubernetes-incubator/cri-containerd) - Containerd-based implementation of Kubernetes Container Runtime Interface :star:394
* [CRI-O (OCI)](https://github.com/kubernetes-incubator/cri-o) :star:1345
* [Hyper.sh/frakti](https://github.com/kubernetes/frakti) - Hypervisor-based container runtime :star:365
* [virtlet](https://github.com/Mirantis/virtlet) - Kubernetes CRI implementation for running VM workloads :star:351
* [infranetes](https://github.com/apporbit/infranetes) :star:21
...
* [RDS](https://github.com/sorenmat/k8s-rds) - Provision RDS databases via CRD from Kubernetes :star:67
...
* [Nuage](https://github.com/nuagenetworks/nuage-kubernetes) :star:39
* [Kuryr](https://github.com/openstack/kuryr-kubernetes) :star:88
* [Contiv](http://contiv.github.io/)
* [Calico](http://www.projectcalico.org/)
* [OpenVSwitch](http://openvswitch.org/)
* [Kube-router](http://github.com/cloudnativelabs/kube-router) :star:887
* [Cilium](https://github.com/cilium/cilium) :star:2950
* [Linen](https://github.com/John-Lin/linen-cni) :star:36
* [CNI-Genie](https://github.com/Huawei-PaaS/CNI-Genie) :star:180
* [Romana](http://romana.io/)
* [Infoblox](https://github.com/infobloxopen/cni-infoblox) :star:4
* [External DNS](https://github.com/kubernetes-incubator/external-dns) - To control DNS records dynamically via Kube resources :star:1337
* [cni-ipvlan-vpc-k8s](https://github.com/lyft/cni-ipvlan-vpc-k8s) :star:202
* [kubernetes-network-policy-recipes](https://github.com/ahmetb/kubernetes-network-policy-recipes) :star:749
* [Multus-cni](https://github.com/Intel-Corp/multus-cni) - Multi-homed pod cni :star:286
* [Network-Controller](https://github.com/linkernetworks/network-controller) - Open vSwitch, Multiple network interfaces that associate with Kubernetes pods :star:12
* [AWS VPC CNI](https://github.com/aws/amazon-vpc-cni-k8s) - Networking plugin using Elastic Network Interfaces :star:519
...
* [Weave Mesh](https://github.com/weaveworks/mesh) :star:428
* [Conduit](http://conduit.io/)

## RPC

* [gRPC](http://grpc.io)
* [Micro](https://github.com/micro/kubernetes) :star:158
...
* [Vault controller](https://github.com/kelseyhightower/vault-controller) :star:397
* [kube-lego](https://github.com/jetstack/kube-lego) :star:1921
* [k8sec](https://github.com/dtan4/k8sec) :star:138
* [kubernetes-vault](https://github.com/Boostport/kubernetes-vault) :star:726
* [kubesec](https://github.com/shyiko/kubesec) - Secure Secret management :star:232
* [Sealed Secrets](https://github.com/bitnami-labs/sealed-secrets) :star:644
...
* [Kubernator](https://github.com/smpio/kubernator) :star:314
...
* [Cabin](https://github.com/bitnami/cabin) :star:406
* [Cockpit](http://cockpit-project.org/guide/latest/feature-kubernetes.html)

## API/CLI adaptors

* [click](https://github.com/databricks/click) - A CLI focused REPL for quickly interacting with Kubernetes objects. :star:751
* [kube-prompt](https://github.com/c-bata/kube-prompt) - Interactive kubernetes client built using go-prompt. :star:720
* [Kube-shell](https://github.com/cloudnativelabs/kube-shell) - Integrated shell for working with the Kubernetes CLI :star:938
* [Kubebot](https://github.com/harbur/kubebot) :star:96
* [kubectx](https://github.com/ahmetb/kubectx) - switch between clusters on kubectl :star:2345
* [kubens](https://github.com/ahmetb/kubectx) - switch between namespaces on kubectl :star:2345
* [StackStorm](https://github.com/StackStorm/st2) :star:2841
* [Kubefuse](http://opencredo.com/introducing-kubefuse-file-system-kubernetes/)
* [Ksql](https://github.com/brendandburns/ksql) :star:101
...
* [Kubectl Aliases](https://github.com/ahmetb/kubectl-aliases) - Aliases for Kubectl :star:354
* [Vikube](https://github.com/c9s/vikube.vim) - Kubernetes operations from Vim, in Vim :star:136
* [kube-ps1](https://github.com/jonmosco/kube-ps1) - Kubernetes prompt helper for bash and zsh. :star:554
* [kube-tmux](https://github.com/jonmosco/kube-tmux) - Kubernetes tmux plugin to display the current context and namespace :star:82
* [kubensx](https://github.com/shyiko/kubensx) - Simpler Cluster/User/Namespace switching for Kubernetes (featuring interactive mode and wildcard/fuzzy matching). :star:24
* [stern](https://github.com/wercker/stern) - Multi pod and container log tailing :star:1248
* [kubeplay](https://github.com/errordeveloper/kubeplay) :star:76
* [kubectl-plugins](https://github.com/jordanwilson230/kubectl-plugins) - A collection of kubectl plugins handling everything from easy context switches to connecting to a container as any user (root included) via exec. Slightly tailored towards GKE users. :star:28

## Application deployment orchestration

* [ElasticKube](https://elasticbox.com/kubernetes)
* [AppController](https://github.com/Mirantis/k8s-AppController) :star:185
* [Kb8or](https://github.com/UKHomeOffice/kb8or) :star:47
* [IBM UrbanCode](https://developer.ibm.com/urbancode/plugin/kubernetes/)
* [Nulecule](https://github.com/projectatomic/nulecule) :star:220
* [Deployment manager](https://cloud.google.com/deployment-manager/)
* [Psykube](https://github.com/commercialtribe/psykube) :star:85
* [Brigade](https://github.com/Azure/brigade) - Event Based Scripting using JavaScript :star:1357
* [Skaffold](https://github.com/GoogleCloudPlatform/skaffold) - Command line tool that facilitates continuous development for Kubernetes applications. :star:4909
* [Gitkube](https://gitkube.sh/) - Build and deploy docker images on Kubernetes using `git push`.

## Configuration

* [Kompose](https://github.com/kubernetes/kompose) :star:3073
* [Jsonnet](https://github.com/google/jsonnet/tree/master/case_studies/kubernetes) :star:1752
* [K8comp](https://github.com/cststack/k8comp) :star:20
* [Ktmpl](https://github.com/InQuicker/ktmpl) :star:148
* [Konfd](https://github.com/kelseyhightower/konfd) :star:466
* [kenv](https://github.com/thisendout/kenv) :star:137
* [kubediff](https://github.com/weaveworks/kubediff) :star:387
* [thesus](https://github.com/heptiolabs/theseus) - A command-line utility and importable package for comparing sets of Kubernetes objects :star:22
...
* [kubegen](https://github.com/errordeveloper/kubegen) :star:104
* [kustomize](https://github.com/kubernetes-sigs/kustomize) - Customization using partial specs :star:1231
* [kapitan](https://github.com/deepmind/kapitan) - Manage complex deployments using jsonnet and jinja2 :star:424

## Security

* [Aquasec](http://blog.aquasec.com/topic/kubernetes)
* [Authenticator](https://github.com/heptio/authenticator) - A tool for using AWS IAM credentials to authenticate to a Kubernetes cluster :star:747
* [Dex](https://github.com/coreos/dex) - OpenID and OAuth for Kubernetes :star:2601
* [Guard](https://github.com/appscode/guard) - Authenticaton webhook server with support for Github, Gitlab, Google, Azure and LDAP (AD) as identity providers. :star:178
* [kiam](https://github.com/uswitch/kiam) -  Allows cluster users to associate AWS IAM roles to Pods. :star:279
* [kube-bench](https://github.com/aquasecurity/kube-bench) - The Kubernetes Bench for Security is a Go application that checks whether Kubernetes is deployed according to security best practices. :star:958
* [kube-hunter](https://github.com/aquasecurity/kube-hunter) - Hunt for security weaknesses in Kubernetes clusters. :star:697
* [kube2iam](https://github.com/jtblin/kube2iam) - Provides different AWS IAM roles for pods running on Kubernetes :star:839
* [Kubesec.io](http://kubesec.io/)
* [Sysdig Falco](http://www.sysdig.org/falco/)
* [Sysdig Secure](http://www.sysdig.com/product/secure)
* [Trireme](http://github.com/aporeto-inc/trireme-kubernetes) :star:99
...
* [AWS ALB Ingress Controller](https://github.com/kubernetes-sigs/aws-alb-ingress-controller) :star:687
* [Cloudflare Warp Ingress](https://github.com/cloudflare/cloudflare-ingress-controller) :star:127
* [Contour](https://github.com/heptio/contour) - Kubernetes ingress controller for Lyft's Envoy proxy :star:1145
* [F5 Big IP Controller](https://github.com/F5Networks/k8s-bigip-ctlr) :star:82
* [Gimbal](https://github.com/heptio/gimbal) - Platform capable of routing traffic to multiple Kubernetes and OpenStack clusters :star:429
* [Gloo - Envoy-based API gateway and ingress controller](https://github.com/solo-io/gloo) :star:930
* [HAProxy Ingress](https://github.com/jcmoraisjr/haproxy-ingress) :star:297
...
* [NGINX Ingress Controller](https://github.com/kubernetes/ingress-nginx) :star:3075
* [Nginx Plus](http://www.nginx.com/blog/load-balancing-kubernetes-services-nginx-plus/)
* [Skipper](https://github.com/zalando/skipper) - HTTP router and reverse proxy for service composition, including use cases like Kubernetes Ingress :star:1248
* [Traefik](http://traefik.io/)
* [Voyager - Secure HAProxy based Ingress Controller](https://github.com/appscode/voyager) :star:907

## Big Data

* [Kube-Yarn](https://github.com/Comcast/kube-yarn) :star:95
* [Spark](https://github.com/kubernetes/examples/tree/master/staging/spark) :star:1341

## Machine Learning

* [TensorFlow k8s](https://github.com/tensorflow/k8s) :star:564
* [mxnet-operator](https://github.com/deepinsight/mxnet-operator) - Tools for ML/MXNet on Kubernetes. :star:33
* [kubeflow](https://github.com/google/kubeflow) - Machine Learning Toolkit for Kubernetes. :star:4842
* [seldon-core](https://github.com/SeldonIO/seldon-core) - Open source framework for deploying machine learning models on Kubernetes :star:498
* [FfDL](https://github.com/IBM/FfDL) - Deep Learning Platform offering TensorFlow, Caffe, PyTorch etc. as a Service on Kubernetes :star:373
* [Polyaxon](https://github.com/polyaxon/polyaxon) - An open source platform for reproducible machine learning and deep learning on kubernetes :star:1572
* [MLT](https://github.com/IntelAI/mlt) - Machine Learning Container Templates: easy to use container and kubernetes object templates. :star:69

## Service Discovery

* [Consul](http://consul.io)
  * [Kelsey Hightower Consul](https://github.com/kelseyhightower/consul-on-kubernetes) :star:407
  * [Bridge between Kubernetes and Consul](https://github.com/Beldur/kube2consul) :star:53
...
* [LinuxKit](https://github.com/linuxkit/kubernetes) :star:228

## YAML/JSON Config

* [Kube.libsonnet](https://github.com/heptio/kube.libsonnet) :star:330
* [kompose](https://github.com/kubernetes/kompose) :star:3073
* [kubeval](https://github.com/garethr/kubeval) :star:767
* [kubegen](https://github.com/errordeveloper/kubegen) :star:104
...
* [Ark](https://github.com/heptio/ark) - Utility for managing backup and restore of Kubernetes clusters. :star:1612
* [burry.sh](https://github.com/mhausenblas/burry.sh) - Cloud Native backup and recovery for etcd, zookeeper and consul :star:182
* [kube-backup](https://github.com/pieterlange/kube-backup) - Sync kubernetes state to git. :star:165
...
* [Community](https://github.com/kubernetes/community) :star:2646
* [Community Q&A – The Office Hours](https://github.com/kubernetes/community/blob/master/events/office-hours.md) :star:2646
