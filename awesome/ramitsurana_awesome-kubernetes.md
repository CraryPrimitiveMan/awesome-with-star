...
* [k3s](https://github.com/rancher/k3s) - Lightweight Kubernetes. Easy to install, half the memory, all in a binary less than 40mb :star:8224
* [kind](https://kind.sigs.k8s.io) -  A tool for running local Kubernetes clusters using Docker container “nodes”
* [Kops](https://github.com/kubernetes/kops) - OS Agnostique - AWS :star:9555
* [Kube-ansible](https://github.com/kairen/kube-ansible) - OS Agnostique - Cloud Agnostique :star:256
* [Kube-aws](https://github.com/coreos/kube-aws) - CoreOS - AWS :star:1027
...
* [Kubespray](https://github.com/kubernetes-incubator/kubespray) - OS Agnostique - Cloud Agnostique :star:6902
* [Kubicorn](https://github.com/kubicorn/kubicorn) - OS Agnostique - Cloud Agnostique :star:1522
...
* [MicroK8s](https://github.com/ubuntu/microk8s) - A single package of k8s that installs on 42 flavours of Linux :star:1582
* [Minikube](https://github.com/kubernetes/minikube) - Run Kubernetes locally :star:15236
* [RKE](https://github.com/rancher/rke) - OS Agnostique - Cloud Agnostique :star:1413
* [sealos](https://github.com/fanux/sealos) - Simple kubernetes HA installer :star:424
...
* [aks-engine](https://github.com/Azure/aks-engine) - AKS Engine is the easiest way to provision a self-managed Kubernetes cluster on Azure. :star:455
...
* [Kubernetes Source](https://github.com/kubernetes/kubernetes/) :star:56468
...
* [Kubernetes-1.15](https://github.com/kubernetes/kubernetes/blob/master/CHANGELOG-1.15.md) :star:56468
* [Kubernetes-1.14](https://github.com/kubernetes/kubernetes/blob/master/CHANGELOG-1.14.md) :star:56468
* [Kubernetes-1.13](https://github.com/kubernetes/kubernetes/blob/master/CHANGELOG-1.13.md) :star:56468
* [Kubernetes-1.12](https://github.com/kubernetes/kubernetes/blob/master/CHANGELOG-1.12.md) :star:56468
* [Kubernetes-1.11](https://github.com/kubernetes/kubernetes/blob/master/CHANGELOG-1.11.md) :star:56468
* [Kubernetes-1.10](https://github.com/kubernetes/kubernetes/blob/master/CHANGELOG-1.10.md) :star:56468
* [Kubernetes-1.9](https://github.com/kubernetes/kubernetes/blob/master/CHANGELOG-1.9.md) :star:56468
* [Kubernetes-1.8](https://github.com/kubernetes/kubernetes/blob/master/CHANGELOG-1.8.md) :star:56468
* [Kubernetes-1.7](https://github.com/kubernetes/kubernetes/blob/master/CHANGELOG-1.7.md) :star:56468
* [Kubernetes-1.6](https://github.com/kubernetes/kubernetes/blob/master/CHANGELOG-1.6.md) :star:56468
* [Kubernetes-1.5](https://github.com/kubernetes/kubernetes/blob/master/CHANGELOG-1.5.md) :star:56468
* [Kubernetes-1.4](https://github.com/kubernetes/kubernetes/blob/master/CHANGELOG-1.4.md) :star:56468
* [Kubernetes-1.3](https://github.com/kubernetes/kubernetes/blob/master/CHANGELOG-1.3.md) :star:56468
* [Kubernetes-1.2](https://github.com/kubernetes/kubernetes/blob/master/CHANGELOG-1.2.md) :star:56468
...
* [Kubernetes Production Patterns (and Anti-Patterns)](https://github.com/gravitational/workshop/blob/master/k8sprod.md) :star:1748
...
=======================================================================
  ...
  - [Gardener](https://github.com/gardener/gardener) - Alibaba, AWS, Azure, GCP, and OpenStack cluster manager :star:1121
  ...
  - [DevSpace](https://github.com/covexo/devspace) - Build, test and run code directly inside any Kubernetes cluster :star:620
  - [Draft](https://draft.sh) - a tool for developers to create cloud native applications with Kubernetes
  - [Eclipse Che](https://github.com/eclipse/che) - cloud development workspaces with SSH and multi-user support :star:5640
  ...
  - [Okteto](https://github.com/okteto/okteto) - Develop directly in any Kubernetes cluster. No commit, build or push required. :star:302
  - [Mantl](https://github.com/mantl/mantl) :star:3084
  - [Spring Cloud integration](https://github.com/fabric8io/spring-cloud-kubernetes) :star:623
  - [VAMP](http://vamp.io)
  - [Tilt](https://github.com/windmilleng/tilt) :star:2627
  ...
  - [teresa](https://github.com/luizalabs/teresa) - Simple PAAS that runs on top of Kubernetes. :star:392
  - [WSO2](http://wso2.com)
...
*List of available free online courses([MOOC](https://en.wikipedia.org/wiki/Massive_open_online_course)) and tutorials*
  ...
  - [Learning Kubernetes, The Chinese Taoist Way](https://github.com/caicloud/kube-ladder) :star:820
...
* [Kubernetes the hard way (installation from scratch)](http://github.com/kelseyhightower/kubernetes-the-hard-way/) :star:16867
* [Kubernetes Failure Stories](https://github.com/hjacobs/kubernetes-failure-stories) :star:4962
...
* [OpenEBS](http://github.com/openebs/openebs/) :star:5771
...
* [Rancher Longhorn](https://github.com/rancher/longhorn) :star:687
* [Rook](http://rook.io/)
...
* [Argo](https://github.com/argoproj/argo) - The Workflow Engine for Kubernetes :star:3504
* [Bitnami Kubernetes Production Runtime](https://kubeprod.io)
* [Client Libraries](https://github.com/kubernetes/website/blob/master/content/en/docs/reference/using-api/client-libraries.md) :star:1518
...
* [Git Webhook Proxy](https://github.com/stakater/GitWebhookProxy) - A proxy to let webhooks reach running services behind a firewall :star:44
* [Hypernetes](https://github.com/hyperhq/hypernetes) :star:546
...
* [KEDA](https://github.com/kedacore/keda) - Kubernetes-based Event Driven Autoscaling :star:1129
...
* [Kubefwd](https://github.com/txn2/kubefwd) - Bulk port forwarding Kubernetes services for local development. :star:1368
...
* [Reloader](https://github.com/stakater/Reloader) - Auto-load updates of ConfigMaps and Secrets into pods for Deployments, StatefulSets and DaemonSets :star:525
...
* [Console](http://github.com/kubernetes/dashboard) :star:5640
* [BotKube](https://github.com/infracloudio/botkube) - App that helps you monitor your Kubernetes cluster, debug critical deployments & gives recommendations for the standard practices :star:171
...
* [Heapster](https://github.com/kubernetes/heapster) :star:2502
* [Instana](https://instana.com)
* [kail](https://github.com/boz/kail) - Kubernetes Log Viewer. Streams logs from all containers of all matching pods. :star:824
* [Kubebox](https://github.com/astefanutti/kubebox) - Terminal console for Kubernetes :star:802
* [Kubedash](https://github.com/kubernetes/kubedash) - **Deprecated** repository is archived and read-only :star:218
* [Kubernetes Operational View](https://github.com/hjacobs/kube-ops-view) - read-only system dashboard for multiple K8s clusters :star:1082
* [Kubespy](https://github.com/pulumi/kubespy) - Tools for observing Kubernetes resources in real time, powered by Pulumi. :star:1743
* [Kubetail](https://github.com/johanhaleby/kubetail) :star:1532
* [Kubewatch](https://github.com/skippbox/kubewatch) :star:946
...
* [kube-state-metrics](https://github.com/kubernetes/kube-state-metrics) - Simple service that listens to the Kubernetes API server and generates metrics about the state of the objects. :star:1531
* [loki](https://github.com/grafana/loki) - Loki is a horizontally-scalable, highly-available, multi-tenant log aggregation system inspired by Prometheus. :star:6840
...
* [chaoskube](https://github.com/linki/chaoskube) - periodically kills random pods in your Kubernetes cluster :star:622
...
* [kboom](https://github.com/mhausenblas/kboom) - The Kubernetes scale & soak load tester :star:186
* [kind](https://github.com/bsycorp/kind) - A single node cluster to run your CI tests against thats ready in 30 seconds :star:267
* [kube-monkey](https://github.com/asobti/kube-monkey) - Chaos Monkey for Kubernetes clusters :star:1350
...
* [Litmus](https://github.com/openebs/litmus) - Chaos engineering for stateful workloads on Kubernetes :star:230
...
* [Sonobuoy](https://github.com/heptio/sonobuoy) - Diagnostic tool that runs Kubernetes conformance tests :star:1506
* [Test-Infra](https://github.com/kubernetes/test-infra) :star:1477
...
* [Jenkins](https://jenkins.io)
   ...
   * [Lab: Build a Continuous Deployment Pipeline with Jenkins and Kubernetes](https://github.com/GoogleCloudPlatform/continuous-deployment-on-kubernetes) :star:1096
...
* [Argo CD](https://github.com/argoproj/argo-cd) - Declarative continuous deployment for Kubernetes. :star:1526
...
* [Weave Flux – GitOps reconcoliation operator](https://github.com/weaveworks/flux) :star:2587
* [Wercker](http://blog.wercker.com/topic/kubernetes)
* [Werf](https://github.com/flant/werf) - Werf simplifies development of build scripts, reduces commit build time and automates deployment. :star:1097

## Serverless Implementations

* [FaaS-netes](https://github.com/alexellis/faas-netes) :star:1375
* [Fission](https://github.com/platform9/fission) :star:4530
* [Funktion](https://github.com/fabric8io/funktion) :star:273
* [Iron.io](http://iron.io)
* [Kubeless](https://github.com/skippbox/kubeless) :star:4948
* [Nuclio](https://github.com/nuclio/nuclio) :star:2892
* [OpenFaaS](https://github.com/alexellis/faas) :star:15172
* [OpenWhisk](https://github.com/openwhisk)
* [Virtual Kubelet](https://github.com/virtual-kubelet/virtual-kubelet) - Allows nodes to be backed by other services and providers. :star:2120

## Operators

* [Cert manager](https://github.com/kelseyhightower/kube-cert-manager) :star:979
* [Cert Operator](https://github.com/giantswarm/cert-operator) :star:30
* [cert-manager](https://github.com/jetstack/cert-manager) :star:3977
...
* [etcd](https://github.com/coreos/etcd-operator) :star:1181
* [Istio](https://github.com/banzaicloud/istio-operator) :star:320
...
* [Kured](https://github.com/weaveworks/kured) - Kured (Kubernetes Reboot Daemon) is a Kubernetes daemonset that performs safe automatic node reboots :star:591
* [Memcached](https://github.com/kbst/memcached) :star:14
* [MongoDB](https://github.com/kbst/mongodb) :star:36
* [MySQL](https://github.com/oracle/mysql-operator) :star:526
* [Operator Kit](https://github.com/rook/operator-kit) :star:248
* [Operator SDK](https://github.com/operator-framework/operator-sdk) :star:2217
* [OperatorHub.io](https://www.operatorhub.io) - A new home for the Kubernetes community to share Operators
* [PostgreSQL](https://github.com/CrunchyData/postgres-operator) :star:740
* [PostgreSQL](https://github.com/zalando-incubator/postgres-operator) - manage PostgreSQL clusters using StatefulSets and [Patroni](https://github.com/zalando/patroni). :star:628
* [Prometheus](https://github.com/coreos/prometheus-operator) :star:3228
* [Addon-operator](https://github.com/flant/addon-operator) - adds hooks and values to helm charts in order to enhance the capabilities of helm and transform charts into smart modules that configure themselves and respond to changes in the cluster. :star:159
* [Shell-operator](https://github.com/flant/shell-operator) - a tool for running event-driven scripts in a Kubernetes cluster. :star:401
...
* [containerd](https://github.com/containerd/containerd) :star:4462
* [cri-containerd](https://github.com/kubernetes-incubator/cri-containerd) - Containerd-based implementation of Kubernetes Container Runtime Interface :star:551
* [CRI-O](https://github.com/kubernetes-incubator/cri-o) :star:1881
...
* [Cilium](https://github.com/cilium/cilium) :star:4237
...
* [External DNS](https://github.com/kubernetes-incubator/external-dns) - To control DNS records dynamically via Kube resources :star:2152
* [Goldpinger](https://github.com/bloomberg/goldpinger) display, monitor and alert on inter-cluster connectivity
...
* [kubernetes-network-policy-recipes](https://github.com/ahmetb/kubernetes-network-policy-recipes) :star:1490
* [Kuryr](https://github.com/openstack/kuryr-kubernetes) :star:113
* [Linen](https://github.com/John-Lin/linen-cni) :star:41
* [Multus-cni](https://github.com/Intel-Corp/multus-cni) - Multi-homed pod cni :star:528
...
* [k8sec](https://github.com/dtan4/k8sec) :star:198
* [Kamus](https://github.com/Soluto/kamus) - A GitOps, zero-trust solution for secrets encryption/decryption solution. :star:383
* [kube-lego](https://github.com/jetstack/kube-lego) :star:2101
* [kubernetes-vault](https://github.com/Boostport/kubernetes-vault) :star:888
* [kubesec](https://github.com/shyiko/kubesec) - Secure Secret management :star:399
* [Sealed Secrets](https://github.com/bitnami-labs/sealed-secrets) :star:1237
...
* [Kubeapps](https://github.com/kubeapps/kubeapps) - A web-based UI for deploying and managing applications in Kubernetes clusters :star:1496
* [Polaris](https://github.com/reactiveops/polaris) - An open source dashboard for Kubernetes best practices :star:885
...
* [Cabin](https://github.com/bitnami/cabin) :star:546
* [Cockpit](http://cockpit-project.org/guide/latest/feature-kubernetes.html)

## API/CLI adaptors

* [click](https://github.com/databricks/click) - A CLI focused REPL for quickly interacting with Kubernetes objects. :star:1023
...
* [kube-ps1](https://github.com/jonmosco/kube-ps1) - Kubernetes prompt helper for bash and zsh. :star:1155
...
* [Kubectl Aliases](https://github.com/ahmetb/kubectl-aliases) - Aliases for Kubectl :star:788
* [kubectl-plugins](https://github.com/jordanwilson230/kubectl-plugins) - A collection of kubectl plugins handling everything from easy context switches to connecting to a container as any user (root included) via exec. Slightly tailored towards GKE users. :star:148
...
* [kubectx](https://github.com/ahmetb/kubectx) - switch between clusters on kubectl :star:4818
* [Kubefuse](http://opencredo.com/introducing-kubefuse-file-system-kubernetes/)
* [kubens](https://github.com/ahmetb/kubectx) - switch between namespaces on kubectl :star:4818
...
* [StackStorm](https://github.com/StackStorm/st2) :star:3364
* [stern](https://github.com/wercker/stern) - Multi pod and container log tailing :star:2438
* [Vikube](https://github.com/c9s/vikube.vim) - Kubernetes operations from Vim, in Vim :star:167
* [K9s](https://github.com/derailed/k9s) - Kubernetes CLI To Manage Your Clusters In Style! :star:2767

## Application deployment orchestration

* [AppController](https://github.com/Mirantis/k8s-AppController) :star:200
* [Brigade](https://github.com/Azure/brigade) - Event Based Scripting using JavaScript :star:1695
...
* [Skaffold](https://github.com/GoogleCloudPlatform/skaffold) - Command line tool that facilitates continuous development for Kubernetes applications. :star:7364
* [kubedog](https://github.com/flant/kubedog) - Kubedog is a library and cli utility that allows watching and following kubernetes resources in CI/CD deploy pipelines. :star:191
...
* [Jsonnet](https://github.com/google/jsonnet/tree/master/case_studies/kubernetes) :star:3251
...
* [Kompose](https://github.com/kubernetes/kompose) :star:4226
* [Konfd](https://github.com/kelseyhightower/konfd) :star:476
* [Ktmpl](https://github.com/jimmycuadra/ktmpl) :star:64
* [kubecfg](https://github.com/bitnami/kubecfg) - Combines jsonnet and kubectl to let you declare systems in an easy to override way :star:479
* [kubediff](https://github.com/weaveworks/kubediff) :star:611
* [kubegen](https://github.com/errordeveloper/kubegen) :star:121
* [kustomize](https://github.com/kubernetes-sigs/kustomize) - Customization using partial specs :star:3468
...
* [ytt](https://github.com/k14s/ytt) - YAML templating tool that works on YAML structure allowing you to focus on your data instead of how to properly escape it. :star:239
...
* [Dex](https://github.com/coreos/dex) - OpenID and OAuth for Kubernetes :star:3577
* [Guard](https://github.com/appscode/guard) - Authenticaton webhook server with support for Github, Gitlab, Google, Azure and LDAP (AD) as identity providers. :star:281
* [kiam](https://github.com/uswitch/kiam) -  Allows cluster users to associate AWS IAM roles to Pods. :star:625
* [kube-bench](https://github.com/aquasecurity/kube-bench) - The Kubernetes Bench for Security is a Go application that checks whether Kubernetes is deployed according to security best practices. :star:1905
* [kube-hunter](https://github.com/aquasecurity/kube-hunter) - Hunt for security weaknesses in Kubernetes clusters. :star:1518
...
* [Rakkess](https://github.com/corneliusweig/rakkess) - Kubectl plugin to show an access matrix for all available resources. :star:350
...
* [AWS ALB Ingress Controller](https://github.com/kubernetes-sigs/aws-alb-ingress-controller) :star:1098
...
* [Gloo - Envoy-based API gateway and ingress controller](https://github.com/solo-io/gloo) :star:1603
* [HAProxy Ingress](https://github.com/jcmoraisjr/haproxy-ingress) :star:470
...
* [NGINX Ingress Controller](https://github.com/kubernetes/ingress-nginx) :star:5313
* [Nginx Plus](http://www.nginx.com/blog/load-balancing-kubernetes-services-nginx-plus/)
* [Skipper](https://github.com/zalando/skipper) - HTTP router and reverse proxy for service composition, including use cases like Kubernetes Ingress :star:1820
...
* [Spark](https://github.com/kubernetes/examples/tree/master/staging/spark) :star:2327
...
* [kubeflow](https://github.com/google/kubeflow) - Machine Learning Toolkit for Kubernetes. :star:7261
* [mxnet-operator](https://github.com/deepinsight/mxnet-operator) - Tools for ML/MXNet on Kubernetes. :star:40
* [Polyaxon](https://github.com/polyaxon/polyaxon) - An open source platform for reproducible machine learning and deep learning on kubernetes :star:2105
* [seldon-core](https://github.com/SeldonIO/seldon-core) - Open source framework for deploying machine learning models on Kubernetes :star:1053
...
* [k3OS](https://github.com/rancher/k3os) :star:1179
* [Kurma](https://github.com/apcera/kurma)
* [LinuxKit](https://github.com/linuxkit/kubernetes) :star:294
* [Talos](https://github.com/talos-systems/talos) :star:1342
...
* [kubegen](https://github.com/errordeveloper/kubegen) :star:121
* [kubeval](https://github.com/garethr/kubeval) :star:1254
...
* [popeye](https://github.com/derailed/popeye) - Kubernetes cluster resource sanitzer :star:1221
...
* [Velero](https://github.com/heptio/velero) - Utility for managing backup and restore of Kubernetes clusters. Formerly Heptio Ark. :star:2890
* [K8up](https://github.com/vshn/k8up) - Kubernetes and OpenShift Backup Operator based on restic :star:45
* [burry.sh](https://github.com/mhausenblas/burry.sh) - Cloud Native backup and recovery for etcd, zookeeper and consul :star:227
...
* [Krew - Plugin Manager](https://github.com/kubernetes-sigs/krew/) :star:1201
* [Kboom](https://github.com/mhausenblas/kboom) :star:186

## Debug

* [Kubectl-Debug](https://github.com/aylei/kubectl-debug) :star:697
...
* [Community Q&A – The Office Hours](https://github.com/kubernetes/community/blob/master/events/office-hours.md) :star:4613
* [Community](https://github.com/kubernetes/community) :star:4613
