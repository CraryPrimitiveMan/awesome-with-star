...
* [Bootkube](https://github.com/kubernetes-incubator/bootkube) - CoreOS - Cloud Agnostic :star:1066
* [Breeze](https://github.com/wise2c-devops/breeze) - CentOS - Cloud Agnostic :star:830
* [Conjure-up](https://github.com/conjure-up/conjure-up) - Ubuntu - Cloud Agnostic :star:442
...
* [KubeSphere](https://github.com/kubesphere/kubesphere) - Install Kubernetes and KubeSphere in multiple instances in an easy way, including full-stack cloud-native softwares, e.g. istio, ES, Prometheus, Fluent Bit, SonarQube, Jenkins. :star:3417
* [k3s](https://github.com/rancher/k3s) - Lightweight Kubernetes. Easy to install, half the memory, all in a binary less than 40mb :star:12818
* [k3d](https://github.com/rancher/k3d) - A tool for running k3s clusters in container nodes :star:1126
* [kind](https://kind.sigs.k8s.io) -  A tool for running local Kubernetes clusters using Docker container “nodes”
* [Kops](https://github.com/kubernetes/kops) - OS Agnostic - AWS :star:11436
...
* [Kube-ansible](https://github.com/kairen/kube-ansible) - OS Agnostic - Cloud Agnostic :star:297
* [Kube-aws](https://github.com/coreos/kube-aws) - CoreOS - AWS :star:1124
* [Kube-deploy](https://github.com/kubernetes/kube-deploy) :star:552
* [Kubeadm](http://kubernetes.io/docs/admin/kubeadm/) - OS Agnostic - Cloud Agnostic
* [KubeNow](https://github.com/kubenow/KubeNow) - Ubuntu - Cloud Agnostic :star:276
* [Kubernetes-Saltstack](https://github.com/valentin2105/Kubernetes-Saltstack) - `systemd` OS - Cloud Agnostic :star:179
* [Kubespray](https://github.com/kubernetes-incubator/kubespray) - OS Agnostic - Cloud Agnostic :star:8699
* [Kubicorn](https://github.com/kubicorn/kubicorn) - OS Agnostic - Cloud Agnostic :star:1614
...
* [matchbox](https://github.com/coreos/matchbox) - CoreOS - Network boot and provision Container Linux clusters (e.g. etcd3, Kubernetes, more). :star:869
* [MetalK8s](https://github.com/scality/metalk8s) - CentOS - On-Prem - Cloud Agnostic - [Apache-2.0](https://github.com/scality/metalk8s/blob/development/1.1/LICENSE) :star:165
* [MicroK8s](https://github.com/ubuntu/microk8s) - A single package of k8s that installs on 42 flavours of Linux :star:3255
* [Minikube](https://github.com/kubernetes/minikube) - Run Kubernetes locally :star:18281
* [RKE](https://github.com/rancher/rke) - OS Agnostic - Cloud Agnostic :star:1864
* [sealos](https://github.com/fanux/sealos) - Simple kubernetes HA installer :star:1895
* [Simplekube](https://github.com/valentin2105/Simplekube) - `systemd` OS - Cloud Agnostic :star:95
* [Terraform](https://github.com/kz8s/tack) - CoreOS - AWS :star:743
* [Typhoon](https://typhoon.psdn.io/) - Container Linux - Cloud Agnostic
* [aks-engine](https://github.com/Azure/aks-engine) - AKS Engine is the easiest way to provision a self-managed Kubernetes cluster on Azure. :star:689
...
* [Kubernetes Source](https://github.com/kubernetes/kubernetes/) :star:66320
...
* [Kubernetes-1.18](https://github.com/kubernetes/kubernetes/blob/master/CHANGELOG/CHANGELOG-1.18.md) :star:66320
* [Kubernetes-1.17](https://github.com/kubernetes/kubernetes/blob/master/CHANGELOG/CHANGELOG-1.17.md) :star:66320
* [Kubernetes-1.16](https://github.com/kubernetes/kubernetes/blob/master/CHANGELOG/CHANGELOG-1.16.md) :star:66320
* [Kubernetes-1.15](https://github.com/kubernetes/kubernetes/blob/master/CHANGELOG/CHANGELOG-1.15.md) :star:66320
* [Kubernetes-1.14](https://github.com/kubernetes/kubernetes/blob/master/CHANGELOG/CHANGELOG-1.14.md) :star:66320
* [Kubernetes-1.13](https://github.com/kubernetes/kubernetes/blob/master/CHANGELOG/CHANGELOG-1.13.md) :star:66320
* [Kubernetes-1.12](https://github.com/kubernetes/kubernetes/blob/master/CHANGELOG/CHANGELOG-1.12.md) :star:66320
* [Kubernetes-1.11](https://github.com/kubernetes/kubernetes/blob/master/CHANGELOG/CHANGELOG-1.11.md) :star:66320
* [Kubernetes-1.10](https://github.com/kubernetes/kubernetes/blob/master/CHANGELOG/CHANGELOG-1.10.md) :star:66320
* [Kubernetes-1.9](https://github.com/kubernetes/kubernetes/blob/master/CHANGELOG/CHANGELOG-1.9.md) :star:66320
* [Kubernetes-1.8](https://github.com/kubernetes/kubernetes/blob/master/CHANGELOG/CHANGELOG-1.8.md) :star:66320
* [Kubernetes-1.7](https://github.com/kubernetes/kubernetes/blob/master/CHANGELOG/CHANGELOG-1.7.md) :star:66320
* [Kubernetes-1.6](https://github.com/kubernetes/kubernetes/blob/master/CHANGELOG/CHANGELOG-1.6.md) :star:66320
* [Kubernetes-1.5](https://github.com/kubernetes/kubernetes/blob/master/CHANGELOG/CHANGELOG-1.5.md) :star:66320
* [Kubernetes-1.4](https://github.com/kubernetes/kubernetes/blob/master/CHANGELOG/CHANGELOG-1.4.md) :star:66320
* [Kubernetes-1.3](https://github.com/kubernetes/kubernetes/blob/master/CHANGELOG/CHANGELOG-1.3.md) :star:66320
* [Kubernetes-1.2](https://github.com/kubernetes/kubernetes/blob/master/CHANGELOG/CHANGELOG-1.2.md) :star:66320
...
- [Automate deep learning training with Kubernetes GPU-cluster](https://github.com/Langhalsdino/Kubernetes-GPU-Guide) :star:715
...
* [Kubernetes Production Patterns (and Anti-Patterns)](https://github.com/gravitational/workshop/blob/master/k8sprod.md) :star:1856
...
=======================================================================
  ...
  - [Gardener](https://github.com/gardener/gardener) - Alibaba, AWS, Azure, GCP, and OpenStack cluster manager :star:1480
  ...
  - [Kqueen](https://github.com/Mirantis/kqueen) :star:124
  - [Kubermatic](http://www.loodse.com/)
  - [KubeSphere](https://github.com/kubesphere/kubesphere) - Full-stack and easy-to-use container platform, with awesome user experience and wizard UI, supports installing on Linux and Kubernetes. :star:3417
  ...
  - [DevSpace](https://github.com/covexo/devspace) - Build, test and run code directly inside any Kubernetes cluster :star:1456
  - [Draft](http://draft.sh) - A tool for developers to create cloud native applications with Kubernetes
  - [Eclipse Che](https://github.com/eclipse/che) - Cloud development workspaces with SSH and multi-user support :star:6082
  ...
  - [Okteto](https://github.com/okteto/okteto) - Develop directly in any Kubernetes cluster. No commit, build or push required :star:1015
  - [Mantl](https://github.com/mantl/mantl) - A modern platform for rapidly deploying globally distributed services :star:3073
  - [Spring Cloud Kubernetes](https://github.com/spring-cloud/spring-cloud-kubernetes) - Spring Cloud integration with Kubernetes :star:2174
  - [VAMP](http://vamp.io) - Cloud-Native Release Management & Orchestration
  - [Tilt](https://github.com/windmilleng/tilt) - Manages local development instances for teams that deploy to Kubernetes :star:3464
  ...
  - [Cloud Foundry](https://github.com/cloudfoundry/cf-for-k8s) :star:73
  - [Eldarion Cloud](http://eldarion.cloud)
  - [Hasura](http://www.hasura.io)
  - [Kel](http://www.kelproject.com)
  - [KubeSail](https://kubesail.com) - An easy, free way to try Kubernetes
  - [KubeSphere](https://github.com/kubesphere/kubesphere) - Full-stack and easy-to-use container platform, with awesome user experience and wizard UI. :star:3417
  ...
  - [teresa](https://github.com/luizalabs/teresa) - Simple PAAS that runs on top of Kubernetes. :star:455
...
*List of available free online courses([MOOC](https://en.wikipedia.org/wiki/Massive_open_online_course)) and tutorials*
  ...
  - [Learning Kubernetes, The Chinese Taoist Way](https://github.com/caicloud/kube-ladder) :star:1364
...
* [Using Kubernetes on AWS](https://github.com/hjacobs/kubernetes-on-aws-users) :star:109
* [Kubernetes at Github](https://github.blog/2017-08-16-kubernetes-at-github/)
* [Kubernetes the hard way (installation from scratch)](http://github.com/kelseyhightower/kubernetes-the-hard-way/) :star:21334
* [Kubernetes Failure Stories](https://github.com/hjacobs/kubernetes-failure-stories) :star:5927
...
* [HPE](https://github.com/hpe-storage/dory) :star:29
* [Kube-Aliyun](https://github.com/kubeup/kube-aliyun) :star:99
* [Linode](https://www.linode.com/blockstorage)
* [Microsoft](https://github.com/Microsoft/K8s-Storage-Plugins) :star:31
* [NetApp Trident](https://github.com/NetApp/trident) :star:397
* [OpenEBS](http://github.com/openebs/openebs/) :star:6173
...
* [Rancher Longhorn](https://github.com/rancher/longhorn) :star:1444
* [Rook](http://rook.io/)
* [StorageOS](http://storageos.com)
* [Stork](https://github.com/libopenstorage/stork) :star:213
...
* [Alibaba Cloud](https://github.com/kubernetes-sigs/alibaba-cloud-csi-driver) :star:168
* [AWS EBS](https://github.com/kubernetes-sigs/aws-ebs-csi-driver) :star:164
* [AWS EFS](https://github.com/kubernetes-sigs/aws-efs-csi-driver) :star:118
* [AWS FSx for Lustre](https://github.com/kubernetes-sigs/aws-fsx-csi-driver) :star:48
* [Ceph](https://github.com/ceph/ceph-csi) :star:363
* [Cinder](https://github.com/kubernetes/cloud-provider-openstack/tree/master/pkg/csi/cinder) :star:268
* [Cloudscale](https://github.com/cloudscale-ch/csi-cloudscale) :star:9
* [DigitalOcean](https://github.com/digitalocean/csi-digitalocean) :star:401
* [Ember](https://ember-csi.io)
* [Google Compute Engine Persistent Disk](https://github.com/kubernetes-sigs/gcp-compute-persistent-disk-csi-driver) :star:49
* [Intel PMEM-CSI](https://github.com/intel/pmem-CSI) :star:83
* [KaDalu - Gluster](https://github.com/kadalu/kadalu) :star:103
* [Linode Block Storage](https://github.com/linode/linode-blockstorage-csi-driver) :star:32
* [Longhorn](https://github.com/longhorn/longhorn) :star:1444
* [NetApp Trident](https://github.com/NetApp/trident) :star:397
* [Nexenta](https://nexentaedge.io/docs/kubernetes-csi.html)
* [OpenSDS](https://github.com/opensds/nbp/tree/master/csi) :star:42
* [OpenStack Cinder](https://github.com/kubernetes/cloud-provider-openstack/tree/master/pkg/csi/cinder) :star:268
* [Portworx](https://github.com/libopenstorage/openstorage/tree/master/csi) :star:374
* [Quobyte](https://github.com/quobyte/quobyte-csi) :star:2
* [S3](https://github.com/ctrox/csi-s3) :star:182
* [Vault](https://github.com/kubevault/csi-driver) :star:63
* [VMware vSphere](https://github.com/kubernetes-sigs/vsphere-csi-driver) :star:61
...
*List of some [Cluster API](https://github.com/kubernetes-sigs/cluster-api) providers for Kubernetes. Check out [Kubernetes-CAPI Providers](https://cluster-api.sigs.k8s.io/reference/providers.html) for more info*
  ...
  ### Bootstrap
   ...
   - [Kubeadm](https://github.com/kubernetes-sigs/cluster-api/tree/master/bootstrap/kubeadm) :star:1145

  ### Infrastructure

   - [AWS](https://github.com/kubernetes-sigs/cluster-api-provider-aws) :star:301
   - [Azure](https://github.com/kubernetes-sigs/cluster-api-provider-azure) :star:100
   - [Metal3-io](https://github.com/metal3-io/cluster-api-provider-baremetal) :star:61
   - [DigitalOcean](https://github.com/kubernetes-sigs/cluster-api-provider-digitalocean) :star:69
   - [GCP](https://github.com/kubernetes-sigs/cluster-api-provider-gcp) :star:47
   - [IBM Cloud](https://github.com/kubernetes-sigs/cluster-api-provider-ibmcloud) :star:26
   - [OpenStack](https://github.com/kubernetes-sigs/cluster-api-provider-openstack) :star:89
   - [VMware vSphere](https://github.com/kubernetes-sigs/cluster-api-provider-vsphere) :star:148
...
*List of some libraries & scripts for executions and good referrals*
  ...
  ### [Python](#python)
   ...
   - [Pykube](https://github.com/hjacobs/pykube) :star:90

  ### [Jenkins](#jenkins)

   - [Jenkinsfile with Helm, Go, Docker, Kubectl, JNLP](https://github.com/lachie83/croc-hunter/blob/master/Jenkinsfile) :star:288
...
* [Argo](https://github.com/argoproj/argo) - The Workflow Engine for Kubernetes :star:5525
* [Bitnami Kubernetes Production Runtime](https://kubeprod.io)
* [Client Libraries](https://github.com/kubernetes/website/blob/master/content/en/docs/reference/using-api/client-libraries.md) :star:1981
* [Escalator](https://github.com/atlassian/escalator) - A batch or job optimized horizontal autoscaler for Kubernetes :star:493
* [Fission Workflows](https://github.com/fission/fission-workflows) - Workflow-based serverless function composition :star:273
* [Forecastle](https://github.com/stakater/Forecastle) - A dashboard which dynamically discovers and provides a launchpad to access applications deployed on Kubernetes :star:126
* [Git Webhook Proxy](https://github.com/stakater/GitWebhookProxy) - A proxy to let webhooks reach running services behind a firewall :star:86
* [Hypernetes](https://github.com/hyperhq/hypernetes) :star:549
* [Ingress Monitor Controller](https://github.com/stakater/IngressMonitorController) - Watches ingress endpoints and automatically registers liveness alerts on the configured uptime checker :star:235
* [k8s-label-rules-webhook](https://github.com/circa10a/k8s-label-rules-webhook) - An admission webhook to enforce standards for labels of resources being created in your k8s cluster :star:34
* [kmachine](https://github.com/skippbox/kmachine) :star:179
* [KEDA](https://github.com/kedacore/keda) - Kubernetes-based Event Driven Autoscaling :star:2006
* [kube-fledged](https://github.com/senthilrch/kube-fledged) - A K8S add-on for creating and managing a cache of container images directly on cluster worker nodes :star:150
* [kube-openvpn](https://github.com/pieterlange/kube-openvpn) :star:304
* [Kubeform](http://capgemini.github.io/kubeform/)
* [Kubefuse](http://opencredo.com/introducing-kubefuse-file-system-kubernetes/)
* [Kubefwd](https://github.com/txn2/kubefwd) - Bulk port forwarding Kubernetes services for local development. :star:1877
* [Kubernetes Cluster Federation (previously Ubernetes)](https://github.com/kubernetes-sigs/kubefed) :star:1010
* [Kubernetes Ec2 Autoscaler](https://github.com/openai/kubernetes-ec2-autoscaler) :star:831
* [Kubic-Project](https://github.com/kubic-project)
* [Reloader](https://github.com/stakater/Reloader) - Auto-load updates of ConfigMaps and Secrets into pods for Deployments, StatefulSets and DaemonSets :star:1192
* [Telepresence](http://www.telepresence.io) - Locally develop/debug services against a remote Kubernetes cluster
* [krane](https://github.com/Shopify/krane) - A command-line tool that helps you ship changes to a Kubernetes namespace and understand the result :star:1020
* [ktunnel](https://github.com/omrikiei/ktunnel) - A command-line tool that establishes a reverse tunnel between Kubernetes and your cluster, use it to locally develop/debug services or integrate with local resources. :star:131
* [k8s-platform-lcm](https://github.com/arminc/k8s-platform-lcm) - A faster and easier way to manage the lifecycle of applications and tools, running and living around your Kubernetes platform :star:68
* [Pixie](https://github.com/pixie-labs/pixie) - Live-debug multi-cluster K8s environments without changing code and moving data off-cluster. :star:56
...
* [Console](http://github.com/kubernetes/dashboard) :star:7848
* [BotKube](https://github.com/infracloudio/botkube) - App that helps you monitor your Kubernetes cluster, debug critical deployments & gives recommendations for the standard practices :star:522
* [Datadog](http://www.datadoghq.com/)
* [Dynatrace](https://www.dynatrace.com/technologies/kubernetes-monitoring/) - Kubernetes cluster and workload monitoring
* [eventrouter](https://github.com/heptiolabs/eventrouter) - simple introspective kubernetes service that forwards events to a specified sink. :star:483
* [Goldpinger](https://github.com/bloomberg/goldpinger) display, monitor and alert on inter-cluster connectivity
* [Grafana Kubernetes App](https://github.com/grafana/kubernetes-app) :star:341
* [Heapster](https://github.com/kubernetes/heapster) :star:2573
* [Instana](https://www.instana.com/) - Automatic Kubernetes Application Performance Monitoring
* [kail](https://github.com/boz/kail) - Kubernetes Log Viewer. Streams logs from all containers of all matching pods. :star:1045
* [Kubebox](https://github.com/astefanutti/kubebox) - Terminal console for Kubernetes :star:1404
* [Kubecost](https://kubecost.com/) - monitor resources following their financial cost
* [Kubedash](https://github.com/kubernetes/kubedash) - **Deprecated** repository is archived and read-only :star:218
* [Kubernetes Operational View](https://github.com/hjacobs/kube-ops-view) - read-only system dashboard for multiple K8s clusters :star:1501
* [K8Dash](https://github.com/herbrandson/k8dash) - Realtime K8S alternative dashboard :star:536
...
* [Kubespy](https://github.com/pulumi/kubespy) - Tools for observing Kubernetes resources in real time, powered by Pulumi. :star:2073
* [Kubetail](https://github.com/johanhaleby/kubetail) :star:1856
* [Kubewatch](https://github.com/skippbox/kubewatch) :star:1357
...
* [NexClipper](https://github.com/NexClipper/NexClipper) - An open source software for monitoring Kubernetes and containers. :star:449
...
* [Searchlight](https://github.com/appscode/searchlight) :star:239
* [Sematext](https://sematext.com/)
* [StatusBay](https://github.com/similarweb/statusbay) - Kubernetes deployment visibility (inc. Slack notifications, metrics and checks enrichment, resources consolidation, etc) :star:292
...
* [kube-state-metrics](https://github.com/kubernetes/kube-state-metrics) - Simple service that listens to the Kubernetes API server and generates metrics about the state of the objects. :star:2206
* [loki](https://github.com/grafana/loki) - Loki is a horizontally-scalable, highly-available, multi-tenant log aggregation system inspired by Prometheus. :star:9488
* [Loghouse](https://github.com/flant/loghouse) - Efficiently store big amounts of your logs (in ClickHouse database), process them using a simple query language and monitor them online through web UI. :star:689

## Testing

*Test your applications running on Kubernetes*

* [chaoskube](https://github.com/linki/chaoskube) - periodically kills random pods in your Kubernetes cluster :star:1155
* [k8s-testsuite](https://github.com/mrahbar/k8s-testsuite) - Helm chart for network and loadtesting of a Kubernetes cluster :star:127
* [kboom](https://github.com/mhausenblas/kboom) - The Kubernetes scale & soak load tester :star:234
* [kind](https://github.com/bsycorp/kind) - A single node cluster to run your CI tests against thats ready in 30 seconds :star:343
* [k3d](https://github.com/rancher/k3d) - Quickly create single- or multi-node k3s clusters in containerized nodes :star:1126
* [kube-monkey](https://github.com/asobti/kube-monkey) - Chaos Monkey for Kubernetes clusters :star:1706
* [Kubeadm-dind-cluster](https://github.com/kubernetes-sigs/kubeadm-dind-cluster) - multi-node test cluster based on kubeadm :star:1117
* [KUTTL](https://kuttl.dev) - KUTTL (Kubernetes Test Tool) is a toolkit for testing Kubernetes Operators 
* [PowerfulSeal](https://github.com/bloomberg/powerfulseal) - kills targeted pods and machines to test your software reliability :star:1279
* [Sonobuoy](https://github.com/vmware-tanzu/sonobuoy) - Diagnostic tool that runs Kubernetes conformance tests :star:1891
* [Test-Infra](https://github.com/kubernetes/test-infra) :star:2080
* [predator](https://github.com/Zooz/predator) - Distributed performance testing platform for Kubernetes :star:210
* [Octopus](https://github.com/kyma-incubator/octopus) - Octopus is a testing framework that allows you to run integration tests defined as Docker images on a Kubernetes cluster. :star:75
...
* [Jenkins](https://jenkins.io)
   ...
   * [Lab: Build a Continuous Deployment Pipeline with Jenkins and Kubernetes](https://github.com/GoogleCloudPlatform/continuous-deployment-on-kubernetes) :star:1287
   * [Jenkins Operator - Kubernetes native Jenkins operator](https://github.com/jenkinsci/kubernetes-operator) :star:262
...
* [Apollo](https://github.com/logzio/apollo) - Open Source application providing teams with self service UI for creating and deploying their services to Kubernetes. :star:322
* [Argo CD](https://github.com/argoproj/argo-cd) - Declarative continuous deployment for Kubernetes. :star:3013
* [autoapply](https://github.com/autoapply/autoapply) - Automatically apply changes from a Git repository to a Kubernetes cluster :star:100
* [Buildkite](https://github.com/buildkite/charts) - Lean CI/CD cloud hosted control plane with agents on your infrastructure. :star:39
...
* [k8s-deploy-helper](https://github.com/lifechurch/k8s-deploy-helper) - Framework to easily deploy Kubernetes applications via GitLab. :star:136
* [kb8or](https://github.com/UKHomeOffice/kb8or) :star:46
* [Keel](https://keel.sh/)
* [Kit](http://invisionapp.github.io/kit/)
* [Kontinuous](https://github.com/AcalephStorage/kontinuous) :star:113
* [KubeCI](https://github.com/kubeciio)
* [Razee](https://github.com/razee-io/Razee) :star:329
* [Shippable](http://blog.shippable.com/topic/kubernetes)
* [Shipper](https://github.com/bookingcom/shipper) - Kubernetes native multi-cluster canary or blue-green rollouts using Helm. :star:560
* [Spinnaker](http://www.spinnaker.io/blog/deploy-to-kubernetes-using-spinnaker)
* [Vili](https://github.com/airware/vili) :star:61
* [Weave Flux – GitOps reconcoliation operator](https://github.com/weaveworks/flux) :star:4771
...
* [FaaS-netes](https://github.com/alexellis/faas-netes) :star:1551
* [Fission](https://github.com/platform9/fission) :star:5127
* [Funktion](https://github.com/fabric8io/funktion) :star:284
* [Iron.io](http://iron.io)
* [Kubeless](https://github.com/skippbox/kubeless) :star:5724
* [Nuclio](https://github.com/nuclio/nuclio) :star:3277
* [OpenFaaS](https://github.com/alexellis/faas) :star:17635
* [OpenWhisk](https://github.com/openwhisk)
* [Virtual Kubelet](https://github.com/virtual-kubelet/virtual-kubelet) - Allows nodes to be backed by other services and providers. :star:2580

## Operators

* [Addon-operator](https://github.com/flant/addon-operator) - adds hooks and values to helm charts in order to enhance the capabilities of helm and transform charts into smart modules that configure themselves and respond to changes in the cluster. :star:212
* [Cert manager](https://github.com/kelseyhightower/kube-cert-manager) :star:1017
* [Cert Operator](https://github.com/giantswarm/cert-operator) :star:32
* [cert-manager](https://github.com/jetstack/cert-manager) :star:5639
* [Container Linux Update Operator](https://github.com/coreos/container-linux-update-operator) :star:206
* [Couchbase](https://blog.couchbase.com/introducing-couchbase-operator/)
* [DB Operator](https://github.com/k8sdb/operator) :star:292
* [Elasticsearch](https://github.com/upmc-enterprises/elasticsearch-operator) :star:646
* [etcd](https://github.com/coreos/etcd-operator) :star:1398
* [Istio](https://github.com/banzaicloud/istio-operator) :star:428
* [K8s Operator Workshop](https://github.com/lukebond/cc-au-k8s-operators-workshop) :star:19
* [Kafka](https://github.com/krallistic/kafka-operator) :star:300
* [Kong API](https://github.com/upmc-enterprises/kong-operator) :star:83
* [kooper](https://github.com/spotahome/kooper) - Simple Go library to create Kubernetes operators and controllers :star:351
* [Kubernetes Operators](https://github.com/sapcc/kubernetes-operators) :star:114
* [KubeVirt](https://github.com/kubevirt)
* [KUDO](https://kudo.dev) - KUDO (Kubernetes Universal Declarative Operator) is a toolset for writing Kubernetes Operators
* [Kured](https://github.com/weaveworks/kured) - Kured (Kubernetes Reboot Daemon) is a Kubernetes daemonset that performs safe automatic node reboots :star:827
* [Memcached](https://github.com/kbst/memcached) :star:18
* [MongoDB](https://github.com/kbst/mongodb) :star:38
* [MySQL](https://github.com/oracle/mysql-operator) :star:709
* [Operator Kit](https://github.com/rook/operator-kit) :star:262
* [Operator SDK](https://github.com/operator-framework/operator-sdk) :star:3456
...
* [PostgreSQL](https://github.com/CrunchyData/postgres-operator) :star:1064
* [PostgreSQL](https://github.com/zalando-incubator/postgres-operator) - manage PostgreSQL clusters using StatefulSets and [Patroni](https://github.com/zalando/patroni). :star:1073
* [Prometheus](https://github.com/coreos/prometheus-operator) :star:4284
* [Shell-operator](https://github.com/flant/shell-operator) - a tool for running event-driven scripts in a Kubernetes cluster. :star:590
* [TiDB Operator](https://github.com/pingcap/tidb-operator) - TiDB Operator manages TiDB clusters on Kubernetes and automates tasks related to operating a TiDB cluster. :star:596
* [Vitess Operator](https://github.com/planetscale/vitess-operator) :star:28

## Custom Schedulers

* [bashScheduler](https://github.com/rothgar/bashScheduler) - Written in bash :star:64
* [escheduler](https://github.com/agonzalezro/escheduler) - Written in elixir :star:19
* [firmament](https://github.com/camsas/firmament) :star:377
* [ksched](https://github.com/coreos/ksched) - Experimental flow based scheduler :star:35
* [Scheduler](https://github.com/kelseyhightower/scheduler) - Cost based scheduler :star:134
* [Sticky Node Scheduler](https://github.com/philipn/kubernetes-sticky-node-scheduler) :star:25
...
* [containerd](https://github.com/containerd/containerd) :star:5641
* [cri-containerd](https://github.com/kubernetes-incubator/cri-containerd) - Containerd-based implementation of Kubernetes Container Runtime Interface :star:693
* [CRI-O](https://github.com/kubernetes-incubator/cri-o) :star:2451
* [Hyper.sh/frakti](https://github.com/kubernetes/frakti) - Hypervisor-based container runtime :star:575
* [virtlet](https://github.com/Mirantis/virtlet) - Kubernetes CRI implementation for running VM workloads :star:574
* [infranetes](https://github.com/apporbit/infranetes) :star:25
...
* [RDS](https://github.com/sorenmat/k8s-rds) - Provision RDS databases via CRD from Kubernetes :star:111
* [TiDB](https://github.com/pingcap/tidb) -  Distributed HTAP database compatible with the MySQL protocol  :star:23608
...
* [AWS VPC CNI](https://github.com/aws/amazon-vpc-cni-k8s) - Networking plugin using Elastic Network Interfaces :star:1183
* [Calico](http://www.projectcalico.org/)
* [Canal](https://github.com/tigera/canal) by [Tigera](https://github.com/tigera)
* [Cilium](https://github.com/cilium/cilium) :star:5482
...
* [CNI-Genie](https://github.com/Huawei-PaaS/CNI-Genie) :star:55
* [cni-ipvlan-vpc-k8s](https://github.com/lyft/cni-ipvlan-vpc-k8s) :star:295
* [Contiv](http://contiv.github.io/)
* [External DNS](https://github.com/kubernetes-incubator/external-dns) - To control DNS records dynamically via Kube resources :star:3069
* [Goldpinger](https://github.com/bloomberg/goldpinger) display, monitor and alert on inter-cluster connectivity
* [illuminatio](https://github.com/inovex/illuminatio) is a tool for automatically testing kubernetes network policies
* [Infoblox](https://github.com/infobloxopen/cni-infoblox) :star:5
* [Kube-router](http://github.com/cloudnativelabs/kube-router) :star:1431
* [KubeIP](http://github.com/doitintl/kubeip) Set static ip for nodes on GKE (useful for whitelisting ips) :star:140
* [kubernetes-network-policy-recipes](https://github.com/ahmetb/kubernetes-network-policy-recipes) :star:2175
* [Kuryr](https://github.com/openstack/kuryr-kubernetes) :star:130
* [Linen](https://github.com/John-Lin/linen-cni) :star:43
* [Multus-cni](https://github.com/Intel-Corp/multus-cni) - Multi-homed pod cni :star:752
* [Network-Controller](https://github.com/linkernetworks/network-controller) - Open vSwitch, Multiple network interfaces that associate with Kubernetes pods :star:19
...
* [Nuage](https://github.com/nuagenetworks/nuage-kubernetes) :star:45
* [OpenContrail](https://github.com/Juniper/contrail-kubernetes) :star:44
...
* [Weave Mesh](https://github.com/weaveworks/mesh) :star:629
* [Maesh: Simpler Service Mesh](https://github.com/containous/maesh) - Maesh is a straight-forward, easy to configure, and non-invasive service mesh that allows visibility and management of the traffic flows inside any Kubernetes cluster. :star:1160
* [Kuma: The Universal Service Mesh](https://github.com/kong/kuma) - Build, Secure and Observe your modern Service Mesh. :star:1488
...
* [k8sec](https://github.com/dtan4/k8sec) :star:233
* [Kamus](https://github.com/Soluto/kamus) - A GitOps, zero-trust solution for secrets encryption/decryption solution. :star:586
* [kube-lego](https://github.com/jetstack/kube-lego) :star:2174
* [kubernetes-vault](https://github.com/Boostport/kubernetes-vault) :star:952
* [kubesec](https://github.com/shyiko/kubesec) - Secure Secret management :star:505
* [Sealed Secrets](https://github.com/bitnami-labs/sealed-secrets) :star:2140
...
* [Vault controller](https://github.com/kelseyhightower/vault-controller) :star:440

## Web applications

* [Kubernator](https://github.com/smpio/kubernator) :star:451
* [Kubernetes Resource Report](https://github.com/hjacobs/kube-resource-report) - report Kubernetes cluster and pod resource requests vs usage and generate static HTML :star:556
* [Kubeapps](https://github.com/kubeapps/kubeapps) - A web-based UI for deploying and managing applications in Kubernetes clusters :star:2059
* [Kubevious](https://github.com/kubevious/kubevious) - An open source UI to make Kubernetes configuration and state obvious and safe. :star:430
* [Polaris](https://github.com/reactiveops/polaris) - An open source dashboard for Kubernetes best practices :star:1205
* [Octant](https://github.com/vmware/octant) - A web-based, highly extensible platform for developers to better understand the complexity of Kubernetes clusters. :star:3968

## Desktop applications

* [Kubernetic](https://kubernetic.com/)
* [Kube Forwarder](http://kube-forwarder.pixelpoint.io) – An open source Kubernetes port forwarding manager
* [Kontena Lens](https://github.com/kontena/lens) - The Ultimate Dashboard For Kubernetes. :star:4421

## Mobile applications

* [Cabin](https://github.com/bitnami/cabin) :star:600
* [Cockpit](http://cockpit-project.org/guide/latest/feature-kubernetes.html)

## API/CLI adaptors

* [awesome-kubectl-plugins](https://github.com/ishantanu/awesome-kubectl-plugins) - Curated list of kubectl plugins. :star:162
* [click](https://github.com/databricks/click) - A CLI focused REPL for quickly interacting with Kubernetes objects. :star:1147
* [Ksql](https://github.com/brendandburns/ksql) :star:119
* [kube-prompt](https://github.com/c-bata/kube-prompt) - Interactive kubernetes client built using go-prompt. :star:1294
* [kube-ps1](https://github.com/jonmosco/kube-ps1) - Kubernetes prompt helper for bash and zsh. :star:1703
* [Kube-shell](https://github.com/cloudnativelabs/kube-shell) - Integrated shell for working with the Kubernetes CLI :star:1593
* [kube-tmux](https://github.com/jonmosco/kube-tmux) - Kubernetes tmux plugin to display the current context and namespace :star:204
* [Kubectl Aliases](https://github.com/ahmetb/kubectl-aliases) - Aliases for Kubectl :star:1377
* [kubectl-plugins](https://github.com/jordanwilson230/kubectl-plugins) - A collection of kubectl plugins handling everything from easy context switches to connecting to a container as any user (root included) via exec. Slightly tailored towards GKE users. :star:242
* [kubectl-trace](https://github.com/iovisor/kubectl-trace) - Schedule bpftrace programs on your kubernetes cluster using this kubectl plugin :star:903
* [kubectld](https://github.com/rancher/kubectld) :star:12
* [kubectx](https://github.com/ahmetb/kubectx) - switch between clusters on kubectl :star:7374
* [Kubefuse](http://opencredo.com/introducing-kubefuse-file-system-kubernetes/)
* [kubens](https://github.com/ahmetb/kubectx) - switch between namespaces on kubectl :star:7374
* [kubensx](https://github.com/shyiko/kubensx) - Simpler Cluster/User/Namespace switching for Kubernetes (featuring interactive mode and wildcard/fuzzy matching). :star:37
* [kubeplay](https://github.com/errordeveloper/kubeplay) :star:82
* [Kubesh](https://github.com/projectodd/kubernetes/blob/kubesh/cmd/kubesh/README.md) - Work around kubectl :star:5
* [Kui](https://github.com/IBM/kui) - Hybrid CLI/GUI alternative to kubectl :star:1252
* [StackStorm](https://github.com/StackStorm/st2) :star:3810
* [stern](https://github.com/wercker/stern) - Multi pod and container log tailing :star:3690
* [Vikube](https://github.com/c9s/vikube.vim) - Kubernetes operations from Vim, in Vim :star:190
* [K9s](https://github.com/derailed/k9s) - Kubernetes CLI To Manage Your Clusters In Style! :star:6722
* [tubectl](https://github.com/reconquest/tubekit) - Kubernetes CLI on steroids with pattern matching :star:173
* [webkubectl](https://github.com/webkubectl/webkubectl) - A web based tool helps you to manage kubernetes credentials and run kubectl command in web browser. :star:266
* [kubectl-neat](https://github.com/itaysk/kubectl-neat) - Clean up Kuberntes yaml and json output :star:75

## Application deployment orchestration

* [AppController](https://github.com/Mirantis/k8s-AppController) :star:204
* [Brigade](https://github.com/Azure/brigade) - Event Based Scripting using JavaScript :star:1936
* [Deployment manager](https://cloud.google.com/deployment-manager/)
* [ElasticKube](https://elasticbox.com/kubernetes)
* [Gitkube](https://github.com/hasura/gitkube/) - Build and deploy docker images on Kubernetes using `git push`. :star:3198
* [IBM UrbanCode](https://developer.ibm.com/urbancode/plugin/kubernetes/)
* [Kb8or](https://github.com/UKHomeOffice/kb8or) :star:46
* [Nulecule](https://github.com/projectatomic/nulecule) :star:217
* [Psykube](https://github.com/commercialtribe/psykube) :star:101
* [Skaffold](https://github.com/GoogleCloudPlatform/skaffold) - Command line tool that facilitates continuous development for Kubernetes applications. :star:9683
* [kubedog](https://github.com/flant/kubedog) - Kubedog is a library and cli utility that allows watching and following kubernetes resources in CI/CD deploy pipelines. :star:269
* [kapp](https://github.com/k14s/kapp) - simple deployment tool focused on the concept of "Kubernetes application" — a set of resources with the same label :star:317
...
* [Jsonnet](https://github.com/google/jsonnet/tree/master/case_studies/kubernetes) :star:4089
* [K8comp](https://github.com/cststack/k8comp) :star:27
* [kapitan](https://github.com/deepmind/kapitan) - Manage complex deployments using jsonnet and jinja2 :star:1182
* [kenv](https://github.com/thisendout/kenv) :star:145
* [Kompose](https://github.com/kubernetes/kompose) :star:5191
* [Konfd](https://github.com/kelseyhightower/konfd) :star:484
* [Ktmpl](https://github.com/jimmycuadra/ktmpl) :star:79
* [kubecfg](https://github.com/bitnami/kubecfg) - Combines jsonnet and kubectl to let you declare systems in an easy to override way :star:595
* [kubediff](https://github.com/weaveworks/kubediff) :star:812
* [kubegen](https://github.com/errordeveloper/kubegen) :star:135
* [kustomize](https://github.com/kubernetes-sigs/kustomize) - Customization using partial specs :star:5436
...
* [ytt](https://github.com/k14s/ytt) - YAML templating tool that works on YAML structure allowing you to focus on your data instead of how to properly escape it. :star:498
* [kosko](https://github.com/tommy351/kosko) - Write Kubernetes manifests in JavaScript and validate against Kubernetes OpenAPI definitions. :star:110

## Security
* [kubiscan](https://github.com/cyberark/KubiScan) - A tool to scan Kubernetes cluster for risky pods and RBAC permissions :star:378
* [kubeletctl](https://github.com/cyberark/kubeletctl) - A client for kubelet with advanced capabilities like scanning for pods vulnerable for RCE :star:75
* [Aquasec](http://blog.aquasec.com/topic/kubernetes)
* [Authenticator](https://github.com/kubernetes-sigs/aws-iam-authenticator) - A tool for using AWS IAM credentials to authenticate to a Kubernetes cluster :star:1408
...
* [Deepfence Threat Mapper](https://github.com/deepfence/ThreatMapper) - Powerful runtime vulnerability scanner for kubernetes, virtual machines and serverless. :star:141
* [Dex](https://github.com/coreos/dex) - OpenID and OAuth for Kubernetes :star:4511
* [Guard](https://github.com/appscode/guard) - Authenticaton webhook server with support for Github, Gitlab, Google, Azure and LDAP (AD) as identity providers. :star:403
* [kiam](https://github.com/uswitch/kiam) -  Allows cluster users to associate AWS IAM roles to Pods. :star:834
* [kube-bench](https://github.com/aquasecurity/kube-bench) - The Kubernetes Bench for Security is a Go application that checks whether Kubernetes is deployed according to security best practices. :star:2605
* [kube-hunter](https://github.com/aquasecurity/kube-hunter) - Hunt for security weaknesses in Kubernetes clusters. :star:2182
* [kube-psp-advisor](https://github.com/sysdiglabs/kube-psp-advisor) - Help building an adaptive and fine-grained pod security policy. :star:195
* [kube2iam](https://github.com/jtblin/kube2iam) - Provides different AWS IAM roles for pods running on Kubernetes :star:1494
* [kubeaudit](https://github.com/Shopify/kubeaudit) - Helps you audit your Kubernetes clusters against common security controls :star:683
* [Kubesec.io](http://kubesec.io/)
* [Pomerium](http://www.pomerium.io/) - a zero-trust identity-aware access proxy inspired by BeyondCorp.
* [Rakkess](https://github.com/corneliusweig/rakkess) - Kubectl plugin to show an access matrix for all available resources. :star:553
...
* [Trireme](http://github.com/aporeto-inc/trireme-kubernetes) :star:126
...
* [AWS ALB Ingress Controller](https://github.com/kubernetes-sigs/aws-alb-ingress-controller) :star:1500
* [Cloudflare Warp Ingress](https://github.com/cloudflare/cloudflare-ingress-controller) :star:220
* [Contour](https://github.com/projectcontour/contour) - Kubernetes ingress controller for Lyft's Envoy proxy :star:2269
* [F5 Big IP Controller](https://github.com/F5Networks/k8s-bigip-ctlr) :star:148
* [Gimbal](https://github.com/vmware-tanzu/gimbal) - Platform capable of routing traffic to multiple Kubernetes and OpenStack clusters :star:605
* [Gloo - Envoy-based API gateway and ingress controller](https://github.com/solo-io/gloo) :star:2347
* [HAProxy Ingress](https://github.com/jcmoraisjr/haproxy-ingress) :star:604
* [Linode NodeBalancer Ingress](https://github.com/linode/linode-cloud-controller-manager) :star:30
...
* [Porter](https://github.com/kubesphere/porter) - a load balancer which is designed for a bare metal Kubernetes cluster. It's implemented by physical switch, and uses BGP and ECMP to achieve optimal performance and HA. :star:304
* [NGINX Ingress Controller](https://github.com/kubernetes/ingress-nginx) :star:7649
* [Nginx Plus](http://www.nginx.com/blog/load-balancing-kubernetes-services-nginx-plus/)
* [Skipper](https://github.com/zalando/skipper) - HTTP router and reverse proxy for service composition, including use cases like Kubernetes Ingress :star:2142
* [Traefik](https://containo.us/traefik/)
* [Voyager - Secure HAProxy based Ingress Controller](https://github.com/appscode/voyager) :star:1227
* [Yggdrasil - Envoy Control Plane for Kubernetes Multi-cluster Ingress](https://github.com/uswitch/yggdrasil) :star:114

## Big Data

* [Kube-Yarn](https://github.com/Comcast/kube-yarn) :star:137
* [Spark](https://github.com/kubernetes/examples/tree/master/staging/spark) :star:3262

## Machine Learning

* [FfDL](https://github.com/IBM/FfDL) - Deep Learning Platform offering TensorFlow, Caffe, PyTorch etc. as a Service on Kubernetes :star:601
* [Fiber](https://github.com/uber/fiber) - Distributed computing library for AI on Kubernetes. :star:496
* [kubeflow](https://github.com/google/kubeflow) - Machine Learning Toolkit for Kubernetes. :star:8908
* [mxnet-operator](https://github.com/deepinsight/mxnet-operator) - Tools for ML/MXNet on Kubernetes. :star:43
* [Polyaxon](https://github.com/polyaxon/polyaxon) - An open source platform for reproducible machine learning and deep learning on kubernetes :star:2452
* [seldon-core](https://github.com/SeldonIO/seldon-core) - Open source framework for deploying machine learning models on Kubernetes :star:1554
* [TensorFlow k8s](https://github.com/tensorflow/k8s) :star:795

## Service Discovery

* [Consul](http://consul.io)
  * [Kelsey Hightower Consul](https://github.com/kelseyhightower/consul-on-kubernetes) :star:561
  * [Bridge between Kubernetes and Consul](https://github.com/Beldur/kube2consul) :star:58

## Operating System

* [CoreOS](http://coreos.com)
* [GCI](https://cloud.google.com/container-optimized-os/docs/)
* [k3OS](https://github.com/rancher/k3os) :star:1766
* [LinuxKit](https://github.com/linuxkit/kubernetes) :star:322
* [Talos](https://github.com/talos-systems/talos) :star:1752
...
* [cdk8s](https://cdk8s.io) - Define Kubernetes apps and reusable components using familiar programming languages
* [kompose](https://github.com/kubernetes/kompose) :star:5191
* [ksonnet-lib](https://github.com/ksonnet/ksonnet-lib) :star:430
* [kube-libsonnet](https://github.com/bitnami-labs/kube-libsonnet/blob/master/kube.libsonnet) - Generic library of Kubernetes objects for Jsonnet/Kubecfg with object to array mapping for painless overrides. :star:87
* [kubegen](https://github.com/errordeveloper/kubegen) :star:135
* [kubeval](https://github.com/garethr/kubeval) :star:1808

## Static Analysis

* [kube-score](https://github.com/zegl/kube-score) - Kubernetes object analysis with recommendations for improved reliability and security :star:722
* [popeye](https://github.com/derailed/popeye) - Kubernetes cluster resource sanitzer :star:1934

## Tuning

* [Ktune](https://github.com/skippbox/ktune) :star:27

## Backup and Disaster Recovery

* [Velero](https://github.com/vmware-tanzu/velero) - Utility for managing backup and restore of Kubernetes clusters. Formerly Heptio Ark. :star:3892
* [K8up](https://github.com/vshn/k8up) - Kubernetes and OpenShift Backup Operator based on restic :star:99
* [burry.sh](https://github.com/mhausenblas/burry.sh) - Cloud Native backup and recovery for etcd, zookeeper and consul :star:247
* [kube-backup](https://github.com/pieterlange/kube-backup) - Sync kubernetes state to git. :star:381
* [Stash](https://github.com/stashed/stash) - Stash is a Kubernetes operator that uses restic or Kubernetes CSI Driver VolumeSnapshotter  to backup your volumes and kubernetes state. :star:810

## Policy Management

* [Kyverno](https://github.com/nirmata/kyverno) - Kubernetes Native Policy Management :star:265

## Plugins

* [Krew - Plugin Manager](https://github.com/kubernetes-sigs/krew/) :star:2595
* [Kboom](https://github.com/mhausenblas/kboom) :star:234
* [View-utilization](https://github.com/etopeter/kubectl-view-utilization) :star:102

## Debug

* [Kubectl-Debug](https://github.com/aylei/kubectl-debug) :star:1330

## Benchmark Tools

* [Kubestone](https://github.com/xridge/kubestone/) :star:105
...
* [KubeInvaders](https://github.com/lucky-sideburn/KubeInvaders) - Gamified Chaos engineering tool for Kubernetes Clusters. It is like Space Invaders but alien ships are pods. :star:562
...
* [Practice Mock Tests](https://github.com/ShubhamTatvamasi/kubernetes-practice-tests) :star:10
...
* [Community Q&A – The Office Hours](https://github.com/kubernetes/community/blob/master/events/office-hours.md) :star:6349
* [Community](https://github.com/kubernetes/community) :star:6349
