...
* [Minikube](https://github.com/kubernetes/minikube) - Run Kubernetes locally :star:8694
* [Kops](https://github.com/kubernetes/kops) - OS Agnostique - AWS - [Apache-2.0](https://github.com/kubernetes/kops/blob/master/LICENSE)
* [Kube-deploy](https://github.com/kubernetes/kube-deploy) :star:465
...
* [Automate deep learning training with Kubernetes GPU-cluster](https://github.com/Langhalsdino/Kubernetes-GPU-Guide) :star:506
...
* [Hypernetes](https://github.com/hyperhq/hypernetes) :star:501
...
* [Console](http://github.com/kubernetes/dashboard) :star:2551
...
* [Heapster](https://github.com/kubernetes/heapster) :star:2056
* [Kubebox](https://github.com/astefanutti/kubebox) - Terminal console for Kubernetes :star:57
* [Kubedash](https://github.com/kubernetes/kubedash) :star:202
* [Kubernetes Operational View](https://github.com/hjacobs/kube-ops-view) - read-only system dashboard for multiple K8s clusters :star:446
* [Kubetail](https://github.com/johanhaleby/kubetail) :star:623
* [Kubewatch](https://github.com/skippbox/kubewatch) :star:295
...
* [Ingress Monitor Controller](https://github.com/stakater/IngressMonitorController) - A Kubernetes Controller to watch your ingresses and create liveness alerts for your endpoints :star:32

## Testing

*Test your applications running on Kubernetes*

* [kube-monkey](https://github.com/asobti/kube-monkey) - Chaos Monkey for Kubernetes clusters :star:663
...
* [Test-Infra](https://github.com/kubernetes/test-infra) :star:354
* [Sonobuoy](https://github.com/heptio/sonobuoy) - Diagnostic tool that runs Kubernetes conformance tests :star:729
* [PowerfulSeal](https://github.com/bloomberg/powerfulseal) - kills targeted pods and machines to test your software reliability :star:602
...
* [Jenkins](https://jenkins.io)
   ...
   * [Lab: Build a Continuous Deployment Pipeline with Jenkins and Kubernetes](https://github.com/GoogleCloudPlatform/continuous-deployment-on-kubernetes) :star:741
...
* [Weave Flux – GitOps reconcoliation operator](https://github.com/weaveworks/flux) :star:463

## Serverless Implementations

* [Funktion](https://github.com/fabric8io/funktion) :star:243
* [Fission](https://github.com/platform9/fission) :star:3250
* [Kubeless](https://github.com/skippbox/kubeless) :star:2410
* [OpenWhisk](https://github.com/openwhisk)
* [Iron.io](http://iron.io)
* [OpenFaaS](https://github.com/alexellis/faas) :star:9945
* [FaaS-netes](https://github.com/alexellis/faas-netes) :star:1024
* [Nuclio](https://github.com/nuclio/nuclio) :star:1961
* [Virtual Kubelet](https://github.com/virtual-kubelet/virtual-kubelet) - Allows nodes to be backed by other services and providers. :star:790

## Operators

* [Prometheus](https://github.com/coreos/prometheus-operator) :star:1157
...
* [etcd](https://github.com/coreos/etcd-operator) :star:641
* [Elasticsearch](https://github.com/upmc-enterprises/elasticsearch-operator) :star:311
* [Memcached](https://github.com/kbst/memcached) :star:11
* [MySQL](https://github.com/oracle/mysql-operator) :star:115
* [MongoDB](https://github.com/kbst/mongodb) :star:12
* [PostgreSQL](https://github.com/CrunchyData/postgres-operator) :star:313
...
* [containerd](https://github.com/containerd/containerd) :star:2511
* [cri-containerd](https://github.com/kubernetes-incubator/cri-containerd) - Containerd-based implementation of Kubernetes Container Runtime Interface :star:280
* [CRI-O (OCI)](https://github.com/kubernetes-incubator/cri-o) :star:1057
* [Hyper.sh/frakti](https://github.com/kubernetes/frakti) - Hypervisor-based container runtime :star:309
* [virtlet](https://github.com/Mirantis/virtlet) - Kubernetes CRI implementation for running VM workloads :star:159
...
* [RDS](https://github.com/sorenmat/k8s-rds) - Provision RDS databases via CRD from Kubernetes :star:46
...
* [Kube-router](http://github.com/cloudnativelabs/kube-router) :star:649
* [Cilium](https://github.com/cilium/cilium) :star:1960
...
* [External DNS](https://github.com/kubernetes-incubator/external-dns) - To control DNS records dynamically via Kube resources :star:862
* [cni-ipvlan-vpc-k8s](https://github.com/lyft/cni-ipvlan-vpc-k8s) :star:165
* [kubernetes-network-policy-recipes](https://github.com/ahmetb/kubernetes-network-policy-recipes) :star:365
* [Multus-cni](https://github.com/Intel-Corp/multus-cni) - Multi-homed pod cni :star:155
...
* [Weave Mesh](https://github.com/weaveworks/mesh) :star:354
...
* [kube-lego](https://github.com/jetstack/kube-lego) :star:1699
...
* [Sealed Secrets](https://github.com/bitnami-labs/sealed-secrets) :star:396
...
* [Kubernator](https://github.com/smpio/kubernator) :star:207
...
* [click](https://github.com/databricks/click) - A CLI focused REPL for quickly interacting with Kubernetes objects. :star:613
* [kube-prompt](https://github.com/c-bata/kube-prompt) - Interactive kubernetes client built using go-prompt. :star:571
* [Kube-shell](https://github.com/cloudnativelabs/kube-shell) - Integrated shell for working with the Kubernetes CLI :star:714
* [Kubebot](https://github.com/harbur/kubebot) :star:82
* [kubectx](https://github.com/ahmetb/kubectx) - switch between clusters on kubectl :star:1155
* [kubens](https://github.com/ahmetb/kubectx) - switch between namespaces on kubectl :star:1155
* [StackStorm](https://github.com/StackStorm/st2) :star:2598
* [Kubefuse](http://opencredo.com/introducing-kubefuse-file-system-kubernetes/)
...
* [Kubectl Aliases](https://github.com/ahmetb/kubectl-aliases) - Aliases for Kubectl :star:214
* [Vikube](https://github.com/c9s/vikube.vim) - Kubernetes operations from Vim, in Vim :star:81
* [kube-ps1](https://github.com/jonmosco/kube-ps1) - Kubernetes prompt helper for bash and zsh. :star:322
* [kube-tmux](https://github.com/jonmosco/kube-tmux) - Kubernetes tmux plugin to display the current context and namespace :star:47
...
* [Brigade](https://github.com/Azure/brigade) - Event Based Scripting using JavaScript :star:1036
* [Skaffold](https://github.com/GoogleCloudPlatform/skaffold) - Command line tool that facilitates continuous development for Kubernetes applications. :star:3447
* [Gitkube](https://gitkube.sh/) - Build and deploy docker images on Kubernetes using `git push`.

## Configuration

* [Kompose](https://github.com/kubernetes/kompose) :star:2433
...
* [kubediff](https://github.com/weaveworks/kubediff) :star:240
...
* [Dex](https://github.com/coreos/dex) - OpenID and OAuth for Kubernetes :star:2124
...
* [Authenticator](https://github.com/heptio/authenticator) - A tool for using AWS IAM credentials to authenticate to a Kubernetes cluster :star:340
...
* [NGINX Ingress Controller](https://github.com/kubernetes/ingress-nginx) :star:1844
...
* [mxnet-operator](https://github.com/deepinsight/mxnet-operator) - Tools for ML/MXNet on Kubernetes. :star:25
* [kubeflow](https://github.com/google/kubeflow) - Machine Learning Toolkit for Kubernetes. :star:3221
* [seldon-core](https://github.com/SeldonIO/seldon-core) - Open source framework for deploying machine learning models on Kubernetes :star:227
* [FfDL](https://github.com/IBM/FfDL) - Deep Learning Platform offering TensorFlow, Caffe, PyTorch etc. as a Service on Kubernetes :star:171
...
* [kompose](https://github.com/kubernetes/kompose) :star:2433
* [kubeval](https://github.com/garethr/kubeval) :star:530
* [kubegen](https://github.com/errordeveloper/kubegen) :star:87
...
* [Ark](https://github.com/heptio/ark) - Utility for managing backup and restore of Kubernetes clusters. :star:1060
...
* [Community](https://github.com/kubernetes/community) :star:1792
