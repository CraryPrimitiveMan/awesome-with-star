# Information comes from [academic/awesome-datascience](https://github.com/academic/awesome-datascience)
...
* [A list of colleges and universities offering degrees in data science.](https://github.com/ryanswanstrom/awesome-datascience-colleges) :star:123
...
* [Data Science Specialization](https://github.com/DataScienceSpecialization/courses) :star:3397
...
* [Open Data Sources](https://github.com/datasciencemasters/data) :star:373
...
* [Public Git Archive](https://github.com/src-d/datasets/tree/master/PublicGitArchive) :star:174
* [GHTorrent](http://ghtorrent.org/)
* [Microsoft Research Open Data](https://msropendata.com/)
* [Open Government Data Platform India](https://data.gov.in/)
* [Google Dataset Search (beta)](https://toolbox.google.com/datasetsearch)
* [NAYN.CO Turkish News with categories](https://github.com/naynco/nayn.data) :star:3
 ...
 * [Karate Club](https://github.com/benedekrozemberczki/karateclub) - An unsupervised machine learning extension library for NetworkX with a Scikit-Learn like API. :star:671
 ...
 * [Hydrosphere Mist](https://github.com/Hydrospheredata/mist) - a service for exposing Apache Spark analytics jobs and machine learning models as realtime, batch or reactive web services. :star:285
 * [Caffe](http://caffe.berkeleyvision.org/) Deep Learning Framework
 * [Torch](http://torch.ch/) A SCIENTIFIC COMPUTING FRAMEWORK FOR LUAJIT
 * [Nervana's python based Deep Learning Framework](https://github.com/NervanaSystems/neon) :star:3835
 * [Skale](https://github.com/skale-me/skale-engine) - High performance distributed data processing in NodeJS :star:374
 * [Aerosolve](http://airbnb.io/aerosolve/) - A machine learning package built for humans.
 * [Intel framework](https://github.com/01org/idlf) - Intel® Deep Learning Framework :star:319
 * [Datawrapper](https://www.datawrapper.de/) – An open source data visualization platform helping everyone to create simple, correct and embeddable charts. Also at [github.com](https://github.com/datawrapper/datawrapper) :star:1062
...
* [Featuretools](https://github.com/featuretools/featuretools/) - An open source framework for automated feature engineering written in python :star:4757
* [Optimus](https://github.com/ironmussa/Optimus) - Cleansing, pre-processing, feature engineering, exploratory data analysis and easy ML with PySpark backend.  :star:880
...
* [DVC](https://github.com/iterative/dvc) - An open-source data science version control system. It helps track, organize and make data science projects reproducible. In its very basic scenario it helps version control and share large data and model files. :star:4915
...
* [Trains](https://github.com/allegroai/trains) - Auto-Magical Experiment Manager, Version Control & DevOps for AI :star:1262
* [Hopsworks](https://github.com/logicalclocks/hopsworks) - Open-source data-intensive machine learning platform with a feature store. Ingest and manage features for both online (MySQL Cluster) and offline (Apache Hive) access, train and serve models at scale. :star:148
* [MindsDB](https://github.com/mindsdb/mindsdb) - MindsDB is an Explainable AutoML framework for developers. With MindsDB you can build, train and use state of the art ML models in as simple as one line of code. :star:2548
* [Lightwood](https://github.com/mindsdb/lightwood) -  A Pytorch based framework that breaks down machine learning problems into smaller blocks that can be glued together seamlessly with an objective to build predictive models with one line of code. :star:39
* [AWS Data Wrangler](https://github.com/awslabs/aws-data-wrangler) - An open-source Python package that extends the power of Pandas library to AWS connecting DataFrames and AWS data related services (Amazon Redshift, AWS Glue, Amazon Athena, Amazon EMR, etc). :star:617
 ...
 * [TensorWatch](https://github.com/microsoft/tensorwatch) - Debugging and visualization for data science and machine learning :star:2766
...
* [How to Share Data with a Statistician](https://github.com/jtleek/datasharing) :star:5089
...
* [Data science your way](https://github.com/jadianes/data-science-your-way) :star:505
* [PySpark Cheatsheet](https://github.com/kevinschaich/pyspark-cheatsheet) :star:59
...
## Other Awesome Lists
 ...
 - [awesome-dataviz](https://github.com/fasouto/awesome-dataviz) :star:2473
 - [awesome-python](https://github.com/vinta/awesome-python) :star:81408
 - [Data Science IPython Notebooks.](https://github.com/donnemartin/data-science-ipython-notebooks) :star:18298
 - [awesome-r](https://github.com/qinwf/awesome-R) :star:3966
 ...
 - [awesome-Machine Learning & Deep Learning Tutorials](https://github.com/ujjwalkarn/Machine-Learning-Tutorials/blob/master/README.md) :star:10162
 - [Awesome Data Science Ideas](https://github.com/JosPolfliet/awesome-datascience-ideas) :star:544
 - [Machine Learning for Software Engineers](https://github.com/ZuzooVn/machine-learning-for-software-engineers) :star:23640
 - [Community Curated Data Science Resources](https://hackr.io/tutorials/learn-data-science)
 - [Awesome Machine Learning On Source Code](https://github.com/src-d/awesome-machine-learning-on-source-code) :star:4705
 - [Awesome Community Detection](https://github.com/benedekrozemberczki/awesome-community-detection) :star:1237
 - [Awesome Graph Classification](https://github.com/benedekrozemberczki/awesome-graph-classification) :star:3282
 - [Awesome Decision Tree Papers](https://github.com/benedekrozemberczki/awesome-decision-tree-papers) :star:1281
 - [Awesome Fraud Detection Papers](https://github.com/benedekrozemberczki/awesome-fraud-detection-papers) :star:516
 - [Awesome Gradient Boosting Papers](https://github.com/benedekrozemberczki/awesome-gradient-boosting-papers) :star:547
 - [Awesome Computer Vision Models](https://github.com/nerox8664/awesome-computer-vision-models) :star:179
 ...
 - [100 NLP Papers](https://github.com/mhagiwara/100-nlp-papers) :star:1078
