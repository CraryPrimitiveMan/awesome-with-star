...
- [Docs](https://github.com/substack/node-browserify#usage) :star:12285
- [Handbook](https://github.com/substack/browserify-handbook) :star:4289
- [Repo](https://github.com/substack/node-browserify) :star:12285
...
- [budo](https://github.com/mattdesl/budo) - Dev server for rapid prototyping. :star:1837
- [beefy](https://github.com/chrisdickinson/beefy) - Local development server that aims to make using browserify fast and fun. :star:785
...
- [watchify](https://github.com/substack/watchify) - Watch mode for browserify builds. :star:1717
- [persistify](https://github.com/royriojas/persistify) - Wrapper around `browserify` to make incremental builds. :star:78

### CSS bundlers

- [sheetify](https://github.com/stackcss/sheetify) - Modular CSS bundler for browserify. :star:422
...
- [babelify](https://github.com/babel/babelify) - Browserify transform for babel. :star:1570
- [aliasify](https://github.com/benbria/aliasify) - Remap require calls at build time. :star:198
- [brfs](https://github.com/substack/brfs) - `fs.readFileSync()` and `fs.readFile()` static asset browserify transform. :star:524

### Node in the Browser

- [crypto-browserify](https://github.com/crypto-browserify/crypto-browserify) - Port of node's `crypto` module to the browser. :star:329
- [stream-browserify](https://github.com/substack/stream-browserify) - The `stream` module from node core, for browsers! :star:56
- [buffer](https://github.com/feross/buffer) - The `buffer` module from node.js, for the browser. :star:656
...
- [bankai](https://github.com/yoshuawuyts/bankai) - DIY asset server. Serves HTML, CSS and JS as streams. :star:980
