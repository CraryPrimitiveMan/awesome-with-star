...
- [Docs](https://github.com/substack/node-browserify#usage) :star:13117
- [Handbook](https://github.com/substack/browserify-handbook) :star:4411
- [Repo](https://github.com/substack/node-browserify) :star:13117
...
- [budo](https://github.com/mattdesl/budo) - Dev server for rapid prototyping. :star:2050
...
- [brfs](https://github.com/substack/brfs) - `fs.readFileSync()` and `fs.readFile()` static asset browserify transform. :star:548

### Node in the Browser

- [crypto-browserify](https://github.com/crypto-browserify/crypto-browserify) - Port of node's `crypto` module to the browser. :star:413
- [stream-browserify](https://github.com/substack/stream-browserify) - The `stream` module from node core, for browsers! :star:68
- [buffer](https://github.com/feross/buffer) - The `buffer` module from node.js, for the browser. :star:991
