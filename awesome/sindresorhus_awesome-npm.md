...
- [np](https://github.com/sindresorhus/np) - A better `npm publish`. :star:3123
...
- [semantic-release](https://github.com/semantic-release/semantic-release) - Fully automated package publishing. :star:4130
...
- [nrm](https://github.com/Pana/nrm) - Registry manager. :star:1007
- [npm-register](https://github.com/dickeyxxx/npm-register) - Easy to set up and maintain npm registry and proxy. :star:304
- [verdaccio](https://github.com/verdaccio/verdaccio) - Lightweight private npm proxy registry. :star:2740
...
- [npm-check](https://github.com/dylang/npm-check) - Check for outdated, incorrect, and unused dependencies, as well as interactive update. :star:4077
...
- [npm-windows-upgrade](https://github.com/felixrieseberg/npm-windows-upgrade) - Upgrade npm on Windows. :star:1426
...
- [npm-run-all](https://github.com/mysticatea/npm-run-all) - CLI tool to run multiple npm-scripts in parallel or serial. :star:1779
...
- [yarn](https://github.com/yarnpkg/yarn) - Fast, reliable, and secure dependency management. :star:31351
- [npm](https://github.com/npm/npm) - The official client. :star:16178
- [pnpm](https://github.com/pnpm/pnpm) - Fast, disk space efficient package manager. :star:3446
